...
// checks if the InstancesChildVirtualNetworkInterfacesInner3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstancesChildVirtualNetworkInterfacesInner3{}

// InstancesChildVirtualNetworkInterfacesInner3 struct for InstancesChildVirtualNetworkInterfacesInner3
type InstancesChildVirtualNetworkInterfacesInner3 struct {
	Network InstancesChildVirtualNetworkInterfacesInner3Network `json:"network"`
...
type _InstancesChildVirtualNetworkInterfacesInner3 InstancesChildVirtualNetworkInterfacesInner3
...
func NewInstancesChildVirtualNetworkInterfacesInner3(network InstancesChildVirtualNetworkInterfacesInner3Network) *InstancesChildVirtualNetworkInterfacesInner3 {
	this := InstancesChildVirtualNetworkInterfacesInner3{}
...
func (o *InstancesChildVirtualNetworkInterfacesInner3) GetNetwork() InstancesChildVirtualNetworkInterfacesInner3Network {
	if o == nil {
		var ret InstancesChildVirtualNetworkInterfacesInner3Network
		return ret
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner3) IsSetNetworkInterfaceTypeId() bool {
	if o != nil && !IsNil(o.NetworkInterfaceTypeId) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner3) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner3) IsSetIpAddress() bool {
	if o != nil && !IsNil(o.IpAddress) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner3) IsSetMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner3) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o InstancesChildVirtualNetworkInterfacesInner3) MarshalJSON() ([]byte, error) {
...
func (o InstancesChildVirtualNetworkInterfacesInner3) ToMap() (map[string]interface{}, error) {
...
type NullableInstancesChildVirtualNetworkInterfacesInner3 struct {
	value *InstancesChildVirtualNetworkInterfacesInner3
	isSet bool
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner3) Get() *InstancesChildVirtualNetworkInterfacesInner3 {
	return v.value
}

func (v *NullableInstancesChildVirtualNetworkInterfacesInner3) Set(val *InstancesChildVirtualNetworkInterfacesInner3) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner3) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesChildVirtualNetworkInterfacesInner3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesChildVirtualNetworkInterfacesInner3(val *InstancesChildVirtualNetworkInterfacesInner3) *NullableInstancesChildVirtualNetworkInterfacesInner3 {
	return &NullableInstancesChildVirtualNetworkInterfacesInner3{value: val, isSet: true}
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesChildVirtualNetworkInterfacesInner3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstancesChildVirtualNetworkInterfacesInner3) UnmarshalJSON(data []byte) (err error) {
