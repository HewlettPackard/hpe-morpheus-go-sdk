...
type ListSecurityPackages200ResponseAllOfSecurityPackagesInner struct {
	...
	Type                 *ListSecurityPackages200ResponseAllOfSecurityPackagesInnerType `json:"type,omitempty"`
...
func (o *ListSecurityPackages200ResponseAllOfSecurityPackagesInner) GetType() ListSecurityPackages200ResponseAllOfSecurityPackagesInnerType {
	if o == nil || IsNil(o.Type) {
		var ret ListSecurityPackages200ResponseAllOfSecurityPackagesInnerType
		return ret
	}
	return *o.Type
}
...
// SetType gets a reference to the given ListSecurityPackages200ResponseAllOfSecurityPackagesInnerType and assigns it to the Type field.
...
func (v NullableListSecurityPackages200ResponseAllOfSecurityPackagesInner) UnmarshalMapstructure(data any) (any, error) {
