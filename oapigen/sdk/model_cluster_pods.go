...
func (o *ClusterPods) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ClusterPods) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ClusterPods) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ClusterPods) IsSetDescription() bool {
...
func (o *ClusterPods) SetDescriptionNil() {
...
func (o *ClusterPods) IsSetCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *ClusterPods) IsSetResourceLevel() bool {
...
func (o *ClusterPods) SetResourceLevelNil() {
...
func (o *ClusterPods) IsSetResourceType() bool {
	if o != nil && !IsNil(o.ResourceType) {
		return true
	}
...
func (o *ClusterPods) IsSetManaged() bool {
	if o != nil && !IsNil(o.Managed) {
		return true
	}
...
func (o *ClusterPods) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *ClusterPods) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *ClusterPods) IsSetOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
// SetOwner gets a reference to the given ClusterPodsOwner and assigns it to the Owner field.
...
func (o *ClusterPods) IsSetTotalCpuUsage() bool {
	if o != nil && !IsNil(o.TotalCpuUsage) {
		return true
	}
...
func (o *ClusterPods) IsSetStats() bool {
	if o != nil && !IsNil(o.Stats) {
		return true
	}
