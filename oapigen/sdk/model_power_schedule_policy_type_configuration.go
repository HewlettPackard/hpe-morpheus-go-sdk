...
func (o *PowerSchedulePolicyTypeConfiguration) IsSetPowerSchedule() bool {
	if o != nil && !IsNil(o.PowerSchedule) {
		return true
	}
...
func (o *PowerSchedulePolicyTypeConfiguration) IsSetPowerScheduleHideFixed() bool {
	if o != nil && !IsNil(o.PowerScheduleHideFixed) {
		return true
	}
...
func (v NullablePowerSchedulePolicyTypeConfiguration) UnmarshalMapstructure(data any) (any, error) {
