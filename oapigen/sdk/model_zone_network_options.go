...
func (o *ZoneNetworkOptions) GetNetworkGroups() []ZoneNetworkOptionsNetworkGroupsInner {
	if o == nil || IsNil(o.NetworkGroups) {
		var ret []ZoneNetworkOptionsNetworkGroupsInner
		return ret
	}
...
// SetNetworkGroups gets a reference to the given []ZoneNetworkOptionsNetworkGroupsInner and assigns it to the NetworkGroups field.
