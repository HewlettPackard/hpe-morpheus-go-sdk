...
type ZoneNetworkOptionsNetworksInner struct {
	...
	Pool                 NullableZoneNetworkOptionsNetworksInnerPool `json:"pool,omitempty"`
...
func (o *ZoneNetworkOptionsNetworksInner) GetPool() ZoneNetworkOptionsNetworksInnerPool {
	if o == nil || IsNil(o.Pool.Get()) {
		var ret ZoneNetworkOptionsNetworksInnerPool
		return ret
	}
	return *o.Pool.Get()
}
...
// SetPool gets a reference to the given NullableZoneNetworkOptionsNetworksInnerPool and assigns it to the Pool field.
...
func (v NullableZoneNetworkOptionsNetworksInner) UnmarshalMapstructure(data any) (any, error) {
