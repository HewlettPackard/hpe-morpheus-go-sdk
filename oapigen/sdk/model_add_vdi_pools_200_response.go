...
type AddVDIPools200Response struct {
	...
	AddVDIPools200ResponseAnyOf1 *AddVDIPools200ResponseAnyOf1
}
...
func (dst *AddVDIPools200Response) UnmarshalMapstructure(data any) (any, error) {
	...
	mapstructDecode(data, &dst.AddVDIPools200ResponseAnyOf1)

	if IsEmpty(dst.AddVDIPools200ResponseAnyOf1) {
...
func (src AddVDIPools200Response) MarshalJSON() ([]byte, error) {
	...
	if src.AddVDIPools200ResponseAnyOf1 != nil {
...
func (v NullableAddVDIPools200Response) UnmarshalMapstructure(data any) (any, error) {
