...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServiceMode() bool {
	if o != nil && !IsNil(o.ServiceMode) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetSecondary() bool {
	if o != nil && !IsNil(o.Secondary) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServicePort() bool {
	if o != nil && !IsNil(o.ServicePort) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServicePassword() bool {
	if o != nil && !IsNil(o.ServicePassword) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServiceKey() bool {
	if o != nil && !IsNil(o.ServiceKey) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetAuthKey() bool {
	if o != nil && !IsNil(o.AuthKey) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServicePath() bool {
	if o != nil && !IsNil(o.ServicePath) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServiceVersion() bool {
	if o != nil && !IsNil(o.ServiceVersion) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServiceWindowsVersion() bool {
	if o != nil && !IsNil(o.ServiceWindowsVersion) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetRepoUrl() bool {
	if o != nil && !IsNil(o.RepoUrl) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServiceConfig() bool {
	if o != nil && !IsNil(o.ServiceConfig) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetServiceCommand() bool {
	if o != nil && !IsNil(o.ServiceCommand) {
		return true
	}
...
func (o *UpdateIntegrationsRequestOneOf3Integration) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
