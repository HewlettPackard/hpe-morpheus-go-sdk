...
// checks if the ExpirationPolicyTypeConfiguration2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration2{}
...
func NewExpirationPolicyTypeConfiguration2(lifecycleType string) *ExpirationPolicyTypeConfiguration2 {
	this := ExpirationPolicyTypeConfiguration2{}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration2) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration2) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration2) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration2 struct {
	value *ExpirationPolicyTypeConfiguration2
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration2) Get() *ExpirationPolicyTypeConfiguration2 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration2) Set(val *ExpirationPolicyTypeConfiguration2) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration2) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration2(val *ExpirationPolicyTypeConfiguration2) *NullableExpirationPolicyTypeConfiguration2 {
	return &NullableExpirationPolicyTypeConfiguration2{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration2) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration2) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration2) UnmarshalJSON(data []byte) (err error) {
