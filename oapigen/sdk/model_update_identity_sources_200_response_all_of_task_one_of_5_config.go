...
// checks if the UpdateIdentitySources200ResponseAllOfTaskOneOf5Config type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateIdentitySources200ResponseAllOfTaskOneOf5Config{}

// UpdateIdentitySources200ResponseAllOfTaskOneOf5Config struct for UpdateIdentitySources200ResponseAllOfTaskOneOf5Config
type UpdateIdentitySources200ResponseAllOfTaskOneOf5Config struct {
...
type _UpdateIdentitySources200ResponseAllOfTaskOneOf5Config UpdateIdentitySources200ResponseAllOfTaskOneOf5Config
...
func NewUpdateIdentitySources200ResponseAllOfTaskOneOf5Config() *UpdateIdentitySources200ResponseAllOfTaskOneOf5Config {
	this := UpdateIdentitySources200ResponseAllOfTaskOneOf5Config{}
	return &this
}
...
func (o UpdateIdentitySources200ResponseAllOfTaskOneOf5Config) MarshalJSON() ([]byte, error) {
...
func (o UpdateIdentitySources200ResponseAllOfTaskOneOf5Config) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config struct {
	value *UpdateIdentitySources200ResponseAllOfTaskOneOf5Config
	isSet bool
}

func (v NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config) Get() *UpdateIdentitySources200ResponseAllOfTaskOneOf5Config {
	return v.value
}

func (v *NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config) Set(val *UpdateIdentitySources200ResponseAllOfTaskOneOf5Config) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config(val *UpdateIdentitySources200ResponseAllOfTaskOneOf5Config) *NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config {
	return &NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config{value: val, isSet: true}
}

func (v NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateIdentitySources200ResponseAllOfTaskOneOf5Config) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateIdentitySources200ResponseAllOfTaskOneOf5Config) UnmarshalJSON(data []byte) (err error) {
