...
// checks if the CheckSNMPConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckSNMPConfig{}

// CheckSNMPConfig struct for CheckSNMPConfig
type CheckSNMPConfig struct {
...
type _CheckSNMPConfig CheckSNMPConfig
...
func (o *CheckSNMPConfig) IsSetSshHost() bool {
	if o != nil && !IsNil(o.SshHost) {
		return true
	}
...
func (o *CheckSNMPConfig) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *CheckSNMPConfig) IsSetSshUser() bool {
	if o != nil && !IsNil(o.SshUser) {
		return true
	}
...
func (o *CheckSNMPConfig) IsSetSshPassword() bool {
	if o != nil && !IsNil(o.SshPassword) {
		return true
	}
...
func (o CheckSNMPConfig) MarshalJSON() ([]byte, error) {
...
func (o CheckSNMPConfig) ToMap() (map[string]interface{}, error) {
...
type NullableCheckSNMPConfig struct {
	value *CheckSNMPConfig
	isSet bool
}

func (v NullableCheckSNMPConfig) Get() *CheckSNMPConfig {
	return v.value
}

func (v *NullableCheckSNMPConfig) Set(val *CheckSNMPConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckSNMPConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckSNMPConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckSNMPConfig(val *CheckSNMPConfig) *NullableCheckSNMPConfig {
	return &NullableCheckSNMPConfig{value: val, isSet: true}
}

func (v NullableCheckSNMPConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckSNMPConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableCheckSNMPConfig) UnmarshalMapstructure(data any) (any, error) {
...
func (o *CheckSNMPConfig) UnmarshalJSON(data []byte) (err error) {
