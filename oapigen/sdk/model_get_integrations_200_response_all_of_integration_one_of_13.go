...
// checks if the GetIntegrations200ResponseAllOfIntegrationOneOf13 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIntegrations200ResponseAllOfIntegrationOneOf13{}

// GetIntegrations200ResponseAllOfIntegrationOneOf13 struct for GetIntegrations200ResponseAllOfIntegrationOneOf13
type GetIntegrations200ResponseAllOfIntegrationOneOf13 struct {
	Id                   *int64                                                            `json:"id,omitempty"`
	Name                 *string                                                           `json:"name,omitempty"`
	Enabled              *bool                                                             `json:"enabled,omitempty"`
	Type                 *string                                                           `json:"type,omitempty"`
	IntegrationType      *GetIntegrations200ResponseAllOfIntegrationOneOf13IntegrationType `json:"integrationType,omitempty"`
	...
	Credential           *GetIntegrations200ResponseAllOfIntegrationOneOf13Credential      `json:"credential,omitempty"`
	AdditionalProperties map[string]interface{}                                            `json:",remain"`
}

type _GetIntegrations200ResponseAllOfIntegrationOneOf13 GetIntegrations200ResponseAllOfIntegrationOneOf13
...
func NewGetIntegrations200ResponseAllOfIntegrationOneOf13() *GetIntegrations200ResponseAllOfIntegrationOneOf13 {
	this := GetIntegrations200ResponseAllOfIntegrationOneOf13{}
	return &this
}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) GetIntegrationType() GetIntegrations200ResponseAllOfIntegrationOneOf13IntegrationType {
	if o == nil || IsNil(o.IntegrationType) {
		var ret GetIntegrations200ResponseAllOfIntegrationOneOf13IntegrationType
		return ret
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetIntegrationType() bool {
	if o != nil && !IsNil(o.IntegrationType) {
		return true
	}
...
// SetIntegrationType gets a reference to the given GetIntegrations200ResponseAllOfIntegrationOneOf13IntegrationType and assigns it to the IntegrationType field.
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetIsPlugin() bool {
	if o != nil && !IsNil(o.IsPlugin) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetStatusDate() bool {
	if o != nil && !IsNil(o.StatusDate) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetStatusMessage() bool {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) SetStatusMessageNil() {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetLastSync() bool {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) SetLastSyncNil() {
	o.LastSync.Set(nil)
}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetLastSyncDuration() bool {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) SetLastSyncDurationNil() {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) GetCredential() GetIntegrations200ResponseAllOfIntegrationOneOf13Credential {
	if o == nil || IsNil(o.Credential) {
		var ret GetIntegrations200ResponseAllOfIntegrationOneOf13Credential
		return ret
	}
	return *o.Credential
}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
// SetCredential gets a reference to the given GetIntegrations200ResponseAllOfIntegrationOneOf13Credential and assigns it to the Credential field.
...
func (o GetIntegrations200ResponseAllOfIntegrationOneOf13) MarshalJSON() ([]byte, error) {
...
func (o GetIntegrations200ResponseAllOfIntegrationOneOf13) ToMap() (map[string]interface{}, error) {
...
type NullableGetIntegrations200ResponseAllOfIntegrationOneOf13 struct {
	value *GetIntegrations200ResponseAllOfIntegrationOneOf13
	isSet bool
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf13) Get() *GetIntegrations200ResponseAllOfIntegrationOneOf13 {
	return v.value
}

func (v *NullableGetIntegrations200ResponseAllOfIntegrationOneOf13) Set(val *GetIntegrations200ResponseAllOfIntegrationOneOf13) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf13) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIntegrations200ResponseAllOfIntegrationOneOf13) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIntegrations200ResponseAllOfIntegrationOneOf13(val *GetIntegrations200ResponseAllOfIntegrationOneOf13) *NullableGetIntegrations200ResponseAllOfIntegrationOneOf13 {
	return &NullableGetIntegrations200ResponseAllOfIntegrationOneOf13{value: val, isSet: true}
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf13) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIntegrations200ResponseAllOfIntegrationOneOf13) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf13) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf13) UnmarshalJSON(data []byte) (err error) {
