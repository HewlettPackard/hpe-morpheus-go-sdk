...
func (o *GetGuidances200ResponseDiscoveryAnyOfZone) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetGuidances200ResponseDiscoveryAnyOfZone) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetGuidances200ResponseDiscoveryAnyOfZone) IsSetZoneType() bool {
	if o != nil && !IsNil(o.ZoneType) {
		return true
	}
