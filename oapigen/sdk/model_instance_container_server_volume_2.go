...
// checks if the InstanceContainerServerVolume2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceContainerServerVolume2{}

// InstanceContainerServerVolume2 struct for InstanceContainerServerVolume2
type InstanceContainerServerVolume2 struct {
...
type _InstanceContainerServerVolume2 InstanceContainerServerVolume2
...
func NewInstanceContainerServerVolume2() *InstanceContainerServerVolume2 {
	this := InstanceContainerServerVolume2{}
	return &this
}
...
func (o *InstanceContainerServerVolume2) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetControllerId() bool {
...
func (o *InstanceContainerServerVolume2) SetControllerIdNil() {
...
func (o *InstanceContainerServerVolume2) IsSetControllerMountPoint() bool {
...
func (o *InstanceContainerServerVolume2) SetControllerMountPointNil() {
...
func (o *InstanceContainerServerVolume2) IsSetResizeable() bool {
	if o != nil && !IsNil(o.Resizeable) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetRootVolume() bool {
	if o != nil && !IsNil(o.RootVolume) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetDeviceName() bool {
	if o != nil && !IsNil(o.DeviceName) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetDeviceDisplayName() bool {
	if o != nil && !IsNil(o.DeviceDisplayName) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetDiskMode() bool {
...
func (o *InstanceContainerServerVolume2) SetDiskModeNil() {
	o.DiskMode.Set(nil)
}
...
func (o *InstanceContainerServerVolume2) IsSetDiskType() bool {
...
func (o *InstanceContainerServerVolume2) SetDiskTypeNil() {
	o.DiskType.Set(nil)
}
...
func (o *InstanceContainerServerVolume2) IsSetCategory() bool {
...
func (o *InstanceContainerServerVolume2) SetCategoryNil() {
	o.Category.Set(nil)
}
...
func (o *InstanceContainerServerVolume2) IsSetStorageServer() bool {
	if o != nil && !IsNil(o.StorageServer) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetZoneId() bool {
...
func (o *InstanceContainerServerVolume2) SetZoneIdNil() {
	o.ZoneId.Set(nil)
}
...
func (o *InstanceContainerServerVolume2) IsSetZone() bool {
	if o != nil && !IsNil(o.Zone) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetDatastore() bool {
	if o != nil && !IsNil(o.Datastore) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetUnitNumber() bool {
...
func (o *InstanceContainerServerVolume2) SetUnitNumberNil() {
...
func (o *InstanceContainerServerVolume2) IsSetTypeId() bool {
	if o != nil && !IsNil(o.TypeId) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetConfigurableIOPS() bool {
	if o != nil && !IsNil(o.ConfigurableIOPS) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetDatastoreId() bool {
...
func (o *InstanceContainerServerVolume2) SetDatastoreIdNil() {
...
func (o *InstanceContainerServerVolume2) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetMaxIOPS() bool {
...
func (o *InstanceContainerServerVolume2) SetMaxIOPSNil() {
	o.MaxIOPS.Set(nil)
}
...
func (o *InstanceContainerServerVolume2) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetUniqueId() bool {
	if o != nil && !IsNil(o.UniqueId) {
		return true
	}
...
func (o *InstanceContainerServerVolume2) IsSetExternalId() bool {
...
func (o *InstanceContainerServerVolume2) SetExternalIdNil() {
...
func (o *InstanceContainerServerVolume2) IsSetInternalId() bool {
...
func (o *InstanceContainerServerVolume2) SetInternalIdNil() {
...
func (o InstanceContainerServerVolume2) MarshalJSON() ([]byte, error) {
...
func (o InstanceContainerServerVolume2) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceContainerServerVolume2 struct {
	value *InstanceContainerServerVolume2
	isSet bool
}

func (v NullableInstanceContainerServerVolume2) Get() *InstanceContainerServerVolume2 {
	return v.value
}

func (v *NullableInstanceContainerServerVolume2) Set(val *InstanceContainerServerVolume2) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceContainerServerVolume2) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceContainerServerVolume2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceContainerServerVolume2(val *InstanceContainerServerVolume2) *NullableInstanceContainerServerVolume2 {
	return &NullableInstanceContainerServerVolume2{value: val, isSet: true}
}

func (v NullableInstanceContainerServerVolume2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceContainerServerVolume2) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceContainerServerVolume2) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceContainerServerVolume2) UnmarshalJSON(data []byte) (err error) {
