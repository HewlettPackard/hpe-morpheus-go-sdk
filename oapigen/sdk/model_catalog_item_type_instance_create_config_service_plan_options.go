...
// checks if the CatalogItemTypeInstanceCreateConfigServicePlanOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogItemTypeInstanceCreateConfigServicePlanOptions{}

// CatalogItemTypeInstanceCreateConfigServicePlanOptions Map of custom options depending on selected service plan.
type CatalogItemTypeInstanceCreateConfigServicePlanOptions struct {
	// Core Count
...
type _CatalogItemTypeInstanceCreateConfigServicePlanOptions CatalogItemTypeInstanceCreateConfigServicePlanOptions
...
func NewCatalogItemTypeInstanceCreateConfigServicePlanOptions() *CatalogItemTypeInstanceCreateConfigServicePlanOptions {
	this := CatalogItemTypeInstanceCreateConfigServicePlanOptions{}
	return &this
}
...
func (o *CatalogItemTypeInstanceCreateConfigServicePlanOptions) IsSetMaxCores() bool {
	if o != nil && !IsNil(o.MaxCores) {
		return true
	}
...
func (o *CatalogItemTypeInstanceCreateConfigServicePlanOptions) IsSetCoresPerSocket() bool {
	if o != nil && !IsNil(o.CoresPerSocket) {
		return true
	}
...
func (o *CatalogItemTypeInstanceCreateConfigServicePlanOptions) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o CatalogItemTypeInstanceCreateConfigServicePlanOptions) MarshalJSON() ([]byte, error) {
...
func (o CatalogItemTypeInstanceCreateConfigServicePlanOptions) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions struct {
	value *CatalogItemTypeInstanceCreateConfigServicePlanOptions
	isSet bool
}

func (v NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions) Get() *CatalogItemTypeInstanceCreateConfigServicePlanOptions {
	return v.value
}

func (v *NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions) Set(val *CatalogItemTypeInstanceCreateConfigServicePlanOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogItemTypeInstanceCreateConfigServicePlanOptions(val *CatalogItemTypeInstanceCreateConfigServicePlanOptions) *NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions {
	return &NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions{value: val, isSet: true}
}

func (v NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableCatalogItemTypeInstanceCreateConfigServicePlanOptions) UnmarshalMapstructure(data any) (any, error) {
