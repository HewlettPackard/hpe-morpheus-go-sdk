...
// checks if the ExpirationPolicyTypeConfiguration15 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration15{}

// ExpirationPolicyTypeConfiguration15 Configuration settings for the following policy types: - Expiration
type ExpirationPolicyTypeConfiguration15 struct {
...
type _ExpirationPolicyTypeConfiguration15 ExpirationPolicyTypeConfiguration15
...
func NewExpirationPolicyTypeConfiguration15() *ExpirationPolicyTypeConfiguration15 {
	this := ExpirationPolicyTypeConfiguration15{}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleType() bool {
	if o != nil && !IsNil(o.LifecycleType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration15) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration15) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration15) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration15 struct {
	value *ExpirationPolicyTypeConfiguration15
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration15) Get() *ExpirationPolicyTypeConfiguration15 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration15) Set(val *ExpirationPolicyTypeConfiguration15) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration15) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration15) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration15(val *ExpirationPolicyTypeConfiguration15) *NullableExpirationPolicyTypeConfiguration15 {
	return &NullableExpirationPolicyTypeConfiguration15{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration15) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration15) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration15) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration15) UnmarshalJSON(data []byte) (err error) {
