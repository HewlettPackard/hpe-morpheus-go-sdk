...
func (o *InstanceServicePlan) GetStorageTypes() []InstanceServicePlanStorageTypesInner {
	if o == nil || IsNil(o.StorageTypes) {
		var ret []InstanceServicePlanStorageTypesInner
		return ret
	}
...
// SetStorageTypes gets a reference to the given []InstanceServicePlanStorageTypesInner and assigns it to the StorageTypes field.
...
func (o *InstanceServicePlan) GetRootStorageTypes() []InstanceServicePlanRootStorageTypesInner {
	if o == nil || IsNil(o.RootStorageTypes) {
		var ret []InstanceServicePlanRootStorageTypesInner
		return ret
	}
...
// SetRootStorageTypes gets a reference to the given []InstanceServicePlanRootStorageTypesInner and assigns it to the RootStorageTypes field.
...
func (o *InstanceServicePlan) GetAutoOptions() []InstanceServicePlanAutoOptionsInner {
	if o == nil || IsNil(o.AutoOptions) {
		var ret []InstanceServicePlanAutoOptionsInner
		return ret
	}
...
// SetAutoOptions gets a reference to the given []InstanceServicePlanAutoOptionsInner and assigns it to the AutoOptions field.
