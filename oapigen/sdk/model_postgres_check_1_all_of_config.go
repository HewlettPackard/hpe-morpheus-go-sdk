...
func (o *PostgresCheck1AllOfConfig) IsSetDbPasswordHash() bool {
	if o != nil && !IsNil(o.DbPasswordHash) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetCheckResult() bool {
	if o != nil && !IsNil(o.CheckResult) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetTunnelOn() bool {
	if o != nil && !IsNil(o.TunnelOn) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetSshHost() bool {
	if o != nil && !IsNil(o.SshHost) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetSshUser() bool {
	if o != nil && !IsNil(o.SshUser) {
		return true
	}
...
func (o *PostgresCheck1AllOfConfig) IsSetSshPassword() bool {
	if o != nil && !IsNil(o.SshPassword) {
		return true
	}
