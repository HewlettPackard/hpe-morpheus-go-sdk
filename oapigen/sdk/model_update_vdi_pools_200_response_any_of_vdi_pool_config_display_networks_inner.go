...
func (o *UpdateVDIPools200ResponseAnyOfVdiPoolConfigDisplayNetworksInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *UpdateVDIPools200ResponseAnyOfVdiPoolConfigDisplayNetworksInner) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *UpdateVDIPools200ResponseAnyOfVdiPoolConfigDisplayNetworksInner) IsSetPool() bool {
	if o != nil && !IsNil(o.Pool) {
		return true
	}
...
func (o *UpdateVDIPools200ResponseAnyOfVdiPoolConfigDisplayNetworksInner) IsSetUsePool() bool {
	if o != nil && !IsNil(o.UsePool) {
		return true
	}
