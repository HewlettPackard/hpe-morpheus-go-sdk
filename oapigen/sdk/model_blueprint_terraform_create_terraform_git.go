...
type _BlueprintTerraformCreateTerraformGit BlueprintTerraformCreateTerraformGit
...
func (v NullableBlueprintTerraformCreateTerraformGit) UnmarshalMapstructure(data any) (any, error) {
...
func (o *BlueprintTerraformCreateTerraformGit) UnmarshalJSON(data []byte) (err error) {
