...
func (r ApiRemoveCredentialsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *CredentialsAPIService) RemoveCredentialsExecute(r ApiRemoveCredentialsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiUpdateCredentialsRequest) Execute() (*UpdateCredentials200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateCredentials200Response
func (a *CredentialsAPIService) UpdateCredentialsExecute(r ApiUpdateCredentialsRequest) (*UpdateCredentials200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateCredentials200Response
	)
