...
// checks if the InstancesChildVirtualNetworkInterfacesInner6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstancesChildVirtualNetworkInterfacesInner6{}

// InstancesChildVirtualNetworkInterfacesInner6 struct for InstancesChildVirtualNetworkInterfacesInner6
type InstancesChildVirtualNetworkInterfacesInner6 struct {
	Network InstancesChildVirtualNetworkInterfacesInner6Network `json:"network"`
...
type _InstancesChildVirtualNetworkInterfacesInner6 InstancesChildVirtualNetworkInterfacesInner6
...
func NewInstancesChildVirtualNetworkInterfacesInner6(network InstancesChildVirtualNetworkInterfacesInner6Network) *InstancesChildVirtualNetworkInterfacesInner6 {
	this := InstancesChildVirtualNetworkInterfacesInner6{}
...
func (o *InstancesChildVirtualNetworkInterfacesInner6) GetNetwork() InstancesChildVirtualNetworkInterfacesInner6Network {
	if o == nil {
		var ret InstancesChildVirtualNetworkInterfacesInner6Network
		return ret
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner6) IsSetNetworkInterfaceTypeId() bool {
	if o != nil && !IsNil(o.NetworkInterfaceTypeId) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner6) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner6) IsSetIpAddress() bool {
	if o != nil && !IsNil(o.IpAddress) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner6) IsSetMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *InstancesChildVirtualNetworkInterfacesInner6) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o InstancesChildVirtualNetworkInterfacesInner6) MarshalJSON() ([]byte, error) {
...
func (o InstancesChildVirtualNetworkInterfacesInner6) ToMap() (map[string]interface{}, error) {
...
type NullableInstancesChildVirtualNetworkInterfacesInner6 struct {
	value *InstancesChildVirtualNetworkInterfacesInner6
	isSet bool
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner6) Get() *InstancesChildVirtualNetworkInterfacesInner6 {
	return v.value
}

func (v *NullableInstancesChildVirtualNetworkInterfacesInner6) Set(val *InstancesChildVirtualNetworkInterfacesInner6) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner6) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesChildVirtualNetworkInterfacesInner6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesChildVirtualNetworkInterfacesInner6(val *InstancesChildVirtualNetworkInterfacesInner6) *NullableInstancesChildVirtualNetworkInterfacesInner6 {
	return &NullableInstancesChildVirtualNetworkInterfacesInner6{value: val, isSet: true}
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesChildVirtualNetworkInterfacesInner6) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstancesChildVirtualNetworkInterfacesInner6) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstancesChildVirtualNetworkInterfacesInner6) UnmarshalJSON(data []byte) (err error) {
