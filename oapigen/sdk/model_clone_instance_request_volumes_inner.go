...
// checks if the CloneInstanceRequestVolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloneInstanceRequestVolumesInner{}

// CloneInstanceRequestVolumesInner struct for CloneInstanceRequestVolumesInner
type CloneInstanceRequestVolumesInner struct {
...
type _CloneInstanceRequestVolumesInner CloneInstanceRequestVolumesInner

func (o CloneInstanceRequestVolumesInner) MarshalJSON() ([]byte, error) {
...
func (o CloneInstanceRequestVolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableCloneInstanceRequestVolumesInner struct {
	value *CloneInstanceRequestVolumesInner
	isSet bool
}

func (v NullableCloneInstanceRequestVolumesInner) Get() *CloneInstanceRequestVolumesInner {
	return v.value
}

func (v *NullableCloneInstanceRequestVolumesInner) Set(val *CloneInstanceRequestVolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCloneInstanceRequestVolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCloneInstanceRequestVolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloneInstanceRequestVolumesInner(val *CloneInstanceRequestVolumesInner) *NullableCloneInstanceRequestVolumesInner {
	return &NullableCloneInstanceRequestVolumesInner{value: val, isSet: true}
}

func (v NullableCloneInstanceRequestVolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloneInstanceRequestVolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableCloneInstanceRequestVolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *CloneInstanceRequestVolumesInner) UnmarshalJSON(data []byte) (err error) {
