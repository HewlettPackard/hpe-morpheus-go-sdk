...
// checks if the InstancesNetworkInterfaces3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstancesNetworkInterfaces3{}

// InstancesNetworkInterfaces3 struct for InstancesNetworkInterfaces3
type InstancesNetworkInterfaces3 struct {
	...
	NetworkInterfaces    []InstancesChildVirtualNetworkInterfacesInner3 `json:"networkInterfaces,omitempty"`
	AdditionalProperties map[string]interface{}                         `json:",remain"`
}

type _InstancesNetworkInterfaces3 InstancesNetworkInterfaces3
...
func NewInstancesNetworkInterfaces3(network InstancesNetworkInterfaces3Network) *InstancesNetworkInterfaces3 {
	this := InstancesNetworkInterfaces3{}
...
func (o *InstancesNetworkInterfaces3) IsSetNetworkInterfaceTypeId() bool {
	if o != nil && !IsNil(o.NetworkInterfaceTypeId) {
		return true
	}
...
func (o *InstancesNetworkInterfaces3) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *InstancesNetworkInterfaces3) IsSetIpAddress() bool {
	if o != nil && !IsNil(o.IpAddress) {
		return true
	}
...
func (o *InstancesNetworkInterfaces3) IsSetMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *InstancesNetworkInterfaces3) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstancesNetworkInterfaces3) GetNetworkInterfaces() []InstancesChildVirtualNetworkInterfacesInner3 {
	if o == nil || IsNil(o.NetworkInterfaces) {
		var ret []InstancesChildVirtualNetworkInterfacesInner3
		return ret
	}
...
func (o *InstancesNetworkInterfaces3) IsSetNetworkInterfaces() bool {
	if o != nil && !IsNil(o.NetworkInterfaces) {
		return true
	}
...
// SetNetworkInterfaces gets a reference to the given []InstancesChildVirtualNetworkInterfacesInner3 and assigns it to the NetworkInterfaces field.
...
func (o InstancesNetworkInterfaces3) MarshalJSON() ([]byte, error) {
...
func (o InstancesNetworkInterfaces3) ToMap() (map[string]interface{}, error) {
...
type NullableInstancesNetworkInterfaces3 struct {
	value *InstancesNetworkInterfaces3
	isSet bool
}

func (v NullableInstancesNetworkInterfaces3) Get() *InstancesNetworkInterfaces3 {
	return v.value
}

func (v *NullableInstancesNetworkInterfaces3) Set(val *InstancesNetworkInterfaces3) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesNetworkInterfaces3) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesNetworkInterfaces3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesNetworkInterfaces3(val *InstancesNetworkInterfaces3) *NullableInstancesNetworkInterfaces3 {
	return &NullableInstancesNetworkInterfaces3{value: val, isSet: true}
}

func (v NullableInstancesNetworkInterfaces3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesNetworkInterfaces3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstancesNetworkInterfaces3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstancesNetworkInterfaces3) UnmarshalJSON(data []byte) (err error) {
