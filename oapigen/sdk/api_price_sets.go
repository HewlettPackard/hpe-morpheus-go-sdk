...
func (r ApiDeactivatePriceSetsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *PriceSetsAPIService) DeactivatePriceSetsExecute(r ApiDeactivatePriceSetsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiUpdatePriceSetsRequest) Execute() (*UpdatePriceSets200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdatePriceSets200Response
func (a *PriceSetsAPIService) UpdatePriceSetsExecute(r ApiUpdatePriceSetsRequest) (*UpdatePriceSets200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdatePriceSets200Response
	)
