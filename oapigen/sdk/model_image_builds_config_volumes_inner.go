...
func NewImageBuildsConfigVolumesInner() *ImageBuildsConfigVolumesInner {
	this := ImageBuildsConfigVolumesInner{}
	return &this
}
...
func (o *ImageBuildsConfigVolumesInner) IsSetVolumeCustomizable() bool {
	if o != nil && !IsNil(o.VolumeCustomizable) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetVId() bool {
	if o != nil && !IsNil(o.VId) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetReadonlyName() bool {
	if o != nil && !IsNil(o.ReadonlyName) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetMaxIOPS() bool {
...
func (o *ImageBuildsConfigVolumesInner) SetMaxIOPSNil() {
	o.MaxIOPS.Set(nil)
}
...
func (o *ImageBuildsConfigVolumesInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetRootVolume() bool {
	if o != nil && !IsNil(o.RootVolume) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetStorageType() bool {
	if o != nil && !IsNil(o.StorageType) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetDatastoreId() bool {
	if o != nil && !IsNil(o.DatastoreId) {
		return true
	}
...
func (o *ImageBuildsConfigVolumesInner) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
