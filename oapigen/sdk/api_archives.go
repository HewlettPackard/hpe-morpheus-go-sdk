...
func (a *ArchivesAPIService) AddArchiveFileLinkExecute(r ApiAddArchiveFileLinkRequest) (*AddArchiveFileLink200Response, *http.Response, error) {
	...
	if r.expireSeconds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "expireSeconds", r.expireSeconds, "form", "")
	} else {
		var defaultValue int64 = 0
		r.expireSeconds = &defaultValue
	}
	// to determine the Content-Type header
...
func (r ApiDeleteArchiveBucketRequest) Execute() (*DeleteArchiveBucket200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteArchiveBucket200Response
func (a *ArchivesAPIService) DeleteArchiveBucketExecute(r ApiDeleteArchiveBucketRequest) (*DeleteArchiveBucket200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteArchiveBucket200Response
	)
...
func (r ApiDeleteArchiveFileRequest) Execute() (*DeleteArchiveFile200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteArchiveFile200Response
func (a *ArchivesAPIService) DeleteArchiveFileExecute(r ApiDeleteArchiveFileRequest) (*DeleteArchiveFile200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteArchiveFile200Response
	)
...
func (r ApiDeleteArchiveFileLinkRequest) Execute() (*DeleteArchiveFileLink200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteArchiveFileLink200Response
func (a *ArchivesAPIService) DeleteArchiveFileLinkExecute(r ApiDeleteArchiveFileLinkRequest) (*DeleteArchiveFileLink200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteArchiveFileLink200Response
	)
...
func (r ApiGetArchivePublicFileLinkRequest) Execute() (*http.Response, error) {
...
func (a *ArchivesAPIService) ListArchiveFilesExecute(r ApiListArchiveFilesRequest) (*ListArchiveFiles200Response, *http.Response, error) {
	...
	if r.fullTree != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fullTree", r.fullTree, "form", "")
	} else {
		var defaultValue bool = false
		r.fullTree = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiUpdateArchiveBucketRequest) Execute() (*UpdateArchiveBucket200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateArchiveBucket200Response
func (a *ArchivesAPIService) UpdateArchiveBucketExecute(r ApiUpdateArchiveBucketRequest) (*UpdateArchiveBucket200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateArchiveBucket200Response
	)
