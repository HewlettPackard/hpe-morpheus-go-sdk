...
func (o *BlueprintTerraformCreateTerraform) IsSetJson() bool {
	if o != nil && !IsNil(o.Json) {
		return true
	}
...
func (o *BlueprintTerraformCreateTerraform) IsSetTf() bool {
	if o != nil && !IsNil(o.Tf) {
		return true
	}
...
func (o *BlueprintTerraformCreateTerraform) IsSetGit() bool {
	if o != nil && !IsNil(o.Git) {
		return true
	}
...
func (o *BlueprintTerraformCreateTerraform) IsSetTfvarSecret() bool {
	if o != nil && !IsNil(o.TfvarSecret) {
		return true
	}
