...
// checks if the PolicyCloudCreatePolicyTypeConfigOneOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyCloudCreatePolicyTypeConfigOneOf7{}

// PolicyCloudCreatePolicyTypeConfigOneOf7 - Expiration
type PolicyCloudCreatePolicyTypeConfigOneOf7 struct {
...
type _PolicyCloudCreatePolicyTypeConfigOneOf7 PolicyCloudCreatePolicyTypeConfigOneOf7
...
func NewPolicyCloudCreatePolicyTypeConfigOneOf7() *PolicyCloudCreatePolicyTypeConfigOneOf7 {
	this := PolicyCloudCreatePolicyTypeConfigOneOf7{}
...
// NewPolicyCloudCreatePolicyTypeConfigOneOf7WithDefaults instantiates a new PolicyCloudCreatePolicyTypeConfigOneOf7 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPolicyCloudCreatePolicyTypeConfigOneOf7WithDefaults() *PolicyCloudCreatePolicyTypeConfigOneOf7 {
	this := PolicyCloudCreatePolicyTypeConfigOneOf7{}
	var lifecycleAutoRenew string = "off"
	this.LifecycleAutoRenew = &lifecycleAutoRenew
	var lifecycleAllowExtend string = "off"
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleType() bool {
	if o != nil && !IsNil(o.LifecycleType) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o PolicyCloudCreatePolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
...
func (o PolicyCloudCreatePolicyTypeConfigOneOf7) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyCloudCreatePolicyTypeConfigOneOf7 struct {
	value *PolicyCloudCreatePolicyTypeConfigOneOf7
	isSet bool
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf7) Get() *PolicyCloudCreatePolicyTypeConfigOneOf7 {
	return v.value
}

func (v *NullablePolicyCloudCreatePolicyTypeConfigOneOf7) Set(val *PolicyCloudCreatePolicyTypeConfigOneOf7) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf7) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyCloudCreatePolicyTypeConfigOneOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyCloudCreatePolicyTypeConfigOneOf7(val *PolicyCloudCreatePolicyTypeConfigOneOf7) *NullablePolicyCloudCreatePolicyTypeConfigOneOf7 {
	return &NullablePolicyCloudCreatePolicyTypeConfigOneOf7{value: val, isSet: true}
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyCloudCreatePolicyTypeConfigOneOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf7) UnmarshalJSON(data []byte) (err error) {
