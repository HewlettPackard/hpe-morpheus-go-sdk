...
// checks if the ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType{}
...
func NewListVirtualImages200ResponseAllOfVirtualImagesInnerOsType() *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType {
	this := ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType{}
	return &this
}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetDescription() bool {
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) SetDescriptionNil() {
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetVendor() bool {
	if o != nil && !IsNil(o.Vendor) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetOsFamily() bool {
	if o != nil && !IsNil(o.OsFamily) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetOsVersion() bool {
	if o != nil && !IsNil(o.OsVersion) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetBitCount() bool {
	if o != nil && !IsNil(o.BitCount) {
		return true
	}
...
func (o *ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) IsSetPlatform() bool {
	if o != nil && !IsNil(o.Platform) {
		return true
	}
...
func (o ListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) ToMap() (map[string]interface{}, error) {
...
func (v NullableListVirtualImages200ResponseAllOfVirtualImagesInnerOsType) UnmarshalMapstructure(data any) (any, error) {
