...
func (o *ElasticCheck) IsSetDescription() bool {
...
func (o *ElasticCheck) SetDescriptionNil() {
...
func (o *ElasticCheck) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *ElasticCheck) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *ElasticCheck) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *ElasticCheck) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *ElasticCheck) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
func (o *ElasticCheck) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
