...
func NewInstanceCreateSuccessInstanceStats() *InstanceCreateSuccessInstanceStats {
	this := InstanceCreateSuccessInstanceStats{}
	return &this
}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetUsedStorage() bool {
	if o != nil && !IsNil(o.UsedStorage) {
		return true
	}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetUsedMemory() bool {
	if o != nil && !IsNil(o.UsedMemory) {
		return true
	}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetUsedCpu() bool {
	if o != nil && !IsNil(o.UsedCpu) {
		return true
	}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetCpuUsage() bool {
	if o != nil && !IsNil(o.CpuUsage) {
		return true
	}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetCpuUsagePeak() bool {
	if o != nil && !IsNil(o.CpuUsagePeak) {
		return true
	}
...
func (o *InstanceCreateSuccessInstanceStats) IsSetCpuUsageAvg() bool {
	if o != nil && !IsNil(o.CpuUsageAvg) {
		return true
	}
