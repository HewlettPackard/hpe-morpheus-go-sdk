...
// checks if the ExpirationPolicyTypeConfiguration11 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration11{}

// ExpirationPolicyTypeConfiguration11 - Expiration
type ExpirationPolicyTypeConfiguration11 struct {
...
type _ExpirationPolicyTypeConfiguration11 ExpirationPolicyTypeConfiguration11
...
func NewExpirationPolicyTypeConfiguration11(lifecycleType string) *ExpirationPolicyTypeConfiguration11 {
	this := ExpirationPolicyTypeConfiguration11{}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration11) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration11) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration11) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration11 struct {
	value *ExpirationPolicyTypeConfiguration11
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration11) Get() *ExpirationPolicyTypeConfiguration11 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration11) Set(val *ExpirationPolicyTypeConfiguration11) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration11) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration11) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration11(val *ExpirationPolicyTypeConfiguration11) *NullableExpirationPolicyTypeConfiguration11 {
	return &NullableExpirationPolicyTypeConfiguration11{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration11) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration11) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration11) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration11) UnmarshalJSON(data []byte) (err error) {
