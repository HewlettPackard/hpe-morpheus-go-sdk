...
func (o *UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2) GetWorkflow() UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2Workflow {
	if o == nil || IsNil(o.Workflow) {
		var ret UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2Workflow
		return ret
	}
	return *o.Workflow
}
...
// SetWorkflow gets a reference to the given UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2Workflow and assigns it to the Workflow field.
...
func (o *UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2) GetForm() UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2Form {
	if o == nil || IsNil(o.Form) {
		var ret UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2Form
		return ret
	}
	return *o.Form
}
...
// SetForm gets a reference to the given UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2Form and assigns it to the Form field.
