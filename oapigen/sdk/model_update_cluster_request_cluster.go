...
type UpdateClusterRequestCluster struct {
	...
	Config               *UpdateClusterRequestClusterConfig             `json:"config,omitempty"`
...
func (o *UpdateClusterRequestCluster) GetConfig() UpdateClusterRequestClusterConfig {
	if o == nil || IsNil(o.Config) {
		var ret UpdateClusterRequestClusterConfig
		return ret
	}
	return *o.Config
}
...
func (v NullableUpdateClusterRequestCluster) UnmarshalMapstructure(data any) (any, error) {
