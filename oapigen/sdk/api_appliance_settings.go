...
func (r ApiSetApplianceSettingsMaintenanceModeRequest) Execute() (*SetApplianceSettingsMaintenanceMode200Response, *http.Response, error) {
...
func (a *ApplianceSettingsAPIService) SetApplianceSettingsMaintenanceModeExecute(r ApiSetApplianceSettingsMaintenanceModeRequest) (*SetApplianceSettingsMaintenanceMode200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateApplianceSettingsRequest) Execute() (*UpdateApplianceSettings200Response, *http.Response, error) {
...
func (a *ApplianceSettingsAPIService) UpdateApplianceSettingsExecute(r ApiUpdateApplianceSettingsRequest) (*UpdateApplianceSettings200Response, *http.Response, error) {
	var (
