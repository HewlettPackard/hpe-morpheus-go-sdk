...
// checks if the UpdateHostInstallAgentRequestServerServerOs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateHostInstallAgentRequestServerServerOs{}
...
func NewUpdateHostInstallAgentRequestServerServerOs() *UpdateHostInstallAgentRequestServerServerOs {
	this := UpdateHostInstallAgentRequestServerServerOs{}
	return &this
}
...
func (o *UpdateHostInstallAgentRequestServerServerOs) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o UpdateHostInstallAgentRequestServerServerOs) MarshalJSON() ([]byte, error) {
...
func (o UpdateHostInstallAgentRequestServerServerOs) ToMap() (map[string]interface{}, error) {
...
func (v NullableUpdateHostInstallAgentRequestServerServerOs) UnmarshalMapstructure(data any) (any, error) {
