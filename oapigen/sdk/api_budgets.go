...
func (r ApiRemoveBudgetsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *BudgetsAPIService) RemoveBudgetsExecute(r ApiRemoveBudgetsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
type ApiUpdateBudgetsRequest struct {
	...
	ApiService           *BudgetsAPIService
	id                   int64
	updateBudgetsRequest *UpdateBudgetsRequest
}

func (r ApiUpdateBudgetsRequest) UpdateBudgetsRequest(updateBudgetsRequest UpdateBudgetsRequest) ApiUpdateBudgetsRequest {
	r.updateBudgetsRequest = &updateBudgetsRequest
	return r
}

func (r ApiUpdateBudgetsRequest) Execute() (*UpdateBudgets200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateBudgets200Response
func (a *BudgetsAPIService) UpdateBudgetsExecute(r ApiUpdateBudgetsRequest) (*UpdateBudgets200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateBudgets200Response
	)
	...
	// body params
	localVarPostBody = r.updateBudgetsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
