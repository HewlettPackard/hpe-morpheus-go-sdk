...
func (r ApiUpdateMonitoringSettingsRequest) UpdateMonitoringSettingsRequest(updateMonitoringSettingsRequest UpdateMonitoringSettingsRequest) ApiUpdateMonitoringSettingsRequest {
	r.updateMonitoringSettingsRequest = &updateMonitoringSettingsRequest
	return r
}

func (r ApiUpdateMonitoringSettingsRequest) Execute() (*UpdateMonitoringSettings200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateMonitoringSettings200Response
func (a *MonitoringSettingsAPIService) UpdateMonitoringSettingsExecute(r ApiUpdateMonitoringSettingsRequest) (*UpdateMonitoringSettings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateMonitoringSettings200Response
	)
	...
	// body params
	localVarPostBody = r.updateMonitoringSettingsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
