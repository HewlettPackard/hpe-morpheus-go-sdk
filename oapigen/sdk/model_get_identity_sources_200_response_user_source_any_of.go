...
// checks if the GetIdentitySources200ResponseUserSourceAnyOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIdentitySources200ResponseUserSourceAnyOf{}

// GetIdentitySources200ResponseUserSourceAnyOf struct for GetIdentitySources200ResponseUserSourceAnyOf
type GetIdentitySources200ResponseUserSourceAnyOf struct {
	...
	Account              *GetIdentitySources200ResponseUserSourceAnyOfAccount            `json:"account,omitempty"`
	DefaultAccountRole   *GetIdentitySources200ResponseUserSourceAnyOfDefaultAccountRole `json:"defaultAccountRole,omitempty"`
	Config               *GetIdentitySources200ResponseUserSourceAnyOfConfig             `json:"config,omitempty"`
	RoleMappings         []GetIdentitySources200ResponseUserSourceAnyOfRoleMappingsInner `json:"roleMappings,omitempty"`
...
type _GetIdentitySources200ResponseUserSourceAnyOf GetIdentitySources200ResponseUserSourceAnyOf
...
func NewGetIdentitySources200ResponseUserSourceAnyOf() *GetIdentitySources200ResponseUserSourceAnyOf {
	this := GetIdentitySources200ResponseUserSourceAnyOf{}
	return &this
}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetDeleted() bool {
	if o != nil && !IsNil(o.Deleted) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetAutoSyncOnLogin() bool {
	if o != nil && !IsNil(o.AutoSyncOnLogin) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetExternalLogin() bool {
	if o != nil && !IsNil(o.ExternalLogin) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetAllowCustomMappings() bool {
	if o != nil && !IsNil(o.AllowCustomMappings) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetManualRoleAssignment() bool {
	if o != nil && !IsNil(o.ManualRoleAssignment) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) GetAccount() GetIdentitySources200ResponseUserSourceAnyOfAccount {
	if o == nil || IsNil(o.Account) {
		var ret GetIdentitySources200ResponseUserSourceAnyOfAccount
		return ret
	}
	return *o.Account
}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
// SetAccount gets a reference to the given GetIdentitySources200ResponseUserSourceAnyOfAccount and assigns it to the Account field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) GetDefaultAccountRole() GetIdentitySources200ResponseUserSourceAnyOfDefaultAccountRole {
	if o == nil || IsNil(o.DefaultAccountRole) {
		var ret GetIdentitySources200ResponseUserSourceAnyOfDefaultAccountRole
		return ret
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetDefaultAccountRole() bool {
	if o != nil && !IsNil(o.DefaultAccountRole) {
		return true
	}
...
// SetDefaultAccountRole gets a reference to the given GetIdentitySources200ResponseUserSourceAnyOfDefaultAccountRole and assigns it to the DefaultAccountRole field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) GetConfig() GetIdentitySources200ResponseUserSourceAnyOfConfig {
	if o == nil || IsNil(o.Config) {
		var ret GetIdentitySources200ResponseUserSourceAnyOfConfig
		return ret
	}
	return *o.Config
}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given GetIdentitySources200ResponseUserSourceAnyOfConfig and assigns it to the Config field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) GetRoleMappings() []GetIdentitySources200ResponseUserSourceAnyOfRoleMappingsInner {
	if o == nil || IsNil(o.RoleMappings) {
		var ret []GetIdentitySources200ResponseUserSourceAnyOfRoleMappingsInner
		return ret
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetRoleMappings() bool {
	if o != nil && !IsNil(o.RoleMappings) {
		return true
	}
...
// SetRoleMappings gets a reference to the given []GetIdentitySources200ResponseUserSourceAnyOfRoleMappingsInner and assigns it to the RoleMappings field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetSubdomain() bool {
	if o != nil && !IsNil(o.Subdomain) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetLoginURL() bool {
	if o != nil && !IsNil(o.LoginURL) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetProviderSettings() bool {
	if o != nil && !IsNil(o.ProviderSettings) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o GetIdentitySources200ResponseUserSourceAnyOf) MarshalJSON() ([]byte, error) {
...
func (o GetIdentitySources200ResponseUserSourceAnyOf) ToMap() (map[string]interface{}, error) {
...
type NullableGetIdentitySources200ResponseUserSourceAnyOf struct {
	value *GetIdentitySources200ResponseUserSourceAnyOf
	isSet bool
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf) Get() *GetIdentitySources200ResponseUserSourceAnyOf {
	return v.value
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf) Set(val *GetIdentitySources200ResponseUserSourceAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIdentitySources200ResponseUserSourceAnyOf(val *GetIdentitySources200ResponseUserSourceAnyOf) *NullableGetIdentitySources200ResponseUserSourceAnyOf {
	return &NullableGetIdentitySources200ResponseUserSourceAnyOf{value: val, isSet: true}
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf) UnmarshalJSON(data []byte) (err error) {
