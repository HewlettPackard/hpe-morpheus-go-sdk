...
func (o *Container) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *Container) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *Container) IsSetInstance() bool {
	if o != nil && !IsNil(o.Instance) {
		return true
	}
...
func (o *Container) IsSetContainerType() bool {
	if o != nil && !IsNil(o.ContainerType) {
		return true
	}
...
func (o *Container) IsSetContainerTypeSet() bool {
	if o != nil && !IsNil(o.ContainerTypeSet) {
		return true
	}
...
func (o *Container) IsSetServer() bool {
	if o != nil && !IsNil(o.Server) {
		return true
	}
...
func (o *Container) IsSetCloud() bool {
	if o != nil && !IsNil(o.Cloud) {
		return true
	}
...
func (o *Container) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *Container) IsSetInternalIp() bool {
	if o != nil && !IsNil(o.InternalIp) {
		return true
	}
...
func (o *Container) IsSetInternalHostname() bool {
	if o != nil && !IsNil(o.InternalHostname) {
		return true
	}
...
func (o *Container) IsSetExternalHostname() bool {
	if o != nil && !IsNil(o.ExternalHostname) {
		return true
	}
...
func (o *Container) IsSetExternalDomain() bool {
	if o != nil && !IsNil(o.ExternalDomain) {
		return true
	}
...
func (o *Container) IsSetExternalFqdn() bool {
	if o != nil && !IsNil(o.ExternalFqdn) {
		return true
	}
...
func (o *Container) IsSetPorts() bool {
	if o != nil && !IsNil(o.Ports) {
		return true
	}
...
func (o *Container) IsSetPlan() bool {
	if o != nil && !IsNil(o.Plan) {
		return true
	}
...
func (o *Container) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *Container) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *Container) IsSetStatsEnabled() bool {
	if o != nil && !IsNil(o.StatsEnabled) {
		return true
	}
...
func (o *Container) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *Container) IsSetUserStatus() bool {
	if o != nil && !IsNil(o.UserStatus) {
		return true
	}
...
func (o *Container) IsSetEnvironmentPrefix() bool {
...
func (o *Container) IsSetStats() bool {
	if o != nil && !IsNil(o.Stats) {
		return true
	}
...
func (o *Container) IsSetRuntimeInfo() bool {
	if o != nil && !IsNil(o.RuntimeInfo) {
		return true
	}
...
func (o *Container) IsSetContainerVersion() bool {
...
func (o *Container) IsSetRepositoryImage() bool {
...
func (o *Container) IsSetPlanCategory() bool {
...
func (o *Container) IsSetHostname() bool {
	if o != nil && !IsNil(o.Hostname) {
		return true
	}
...
func (o *Container) IsSetDomainName() bool {
...
func (o *Container) IsSetVolumeCreated() bool {
	if o != nil && !IsNil(o.VolumeCreated) {
		return true
	}
...
func (o *Container) IsSetContainerCreated() bool {
	if o != nil && !IsNil(o.ContainerCreated) {
		return true
	}
...
func (o *Container) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *Container) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *Container) IsSetMaxCores() bool {
	if o != nil && !IsNil(o.MaxCores) {
		return true
	}
...
func (o *Container) IsSetMaxCpu() bool {
...
func (o *Container) IsSetAvailableActions() bool {
	if o != nil && !IsNil(o.AvailableActions) {
		return true
	}
...
func (o *Container) IsSetConfigGroup() bool {
...
func (o *Container) IsSetConfigId() bool {
...
func (o *Container) IsSetConfigRole() bool {
...
func (o *Container) IsSetHourlyCost() bool {
	if o != nil && !IsNil(o.HourlyCost) {
		return true
	}
...
func (o *Container) IsSetHourlyPrice() bool {
	if o != nil && !IsNil(o.HourlyPrice) {
		return true
	}
...
func (v NullableContainer) UnmarshalMapstructure(data any) (any, error) {
