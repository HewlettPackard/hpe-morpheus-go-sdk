...
func (o *CheckMysql) IsSetDescription() bool {
...
func (o *CheckMysql) SetDescriptionNil() {
...
func (o *CheckMysql) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *CheckMysql) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *CheckMysql) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *CheckMysql) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *CheckMysql) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
func (o *CheckMysql) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
