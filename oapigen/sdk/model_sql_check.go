...
// checks if the SqlCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SqlCheck{}

// SqlCheck SQL Server check allows to execute a query so that you may validate the value returned in addition to verifying the database is responding.  This can be useful for doing a slow query check or just making sure something isn't growing out of control.
...
func (o *SqlCheck) IsSetDescription() bool {
...
func (o *SqlCheck) SetDescriptionNil() {
...
func (o *SqlCheck) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *SqlCheck) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *SqlCheck) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *SqlCheck) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *SqlCheck) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
func (o *SqlCheck) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o SqlCheck) MarshalJSON() ([]byte, error) {
...
func (o SqlCheck) ToMap() (map[string]interface{}, error) {
...
func (v NullableSqlCheck) UnmarshalMapstructure(data any) (any, error) {
