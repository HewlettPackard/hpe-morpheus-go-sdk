...
// checks if the PolicyGroupUpdatePolicyTypeConfigOneOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyGroupUpdatePolicyTypeConfigOneOf7{}

// PolicyGroupUpdatePolicyTypeConfigOneOf7 - Expiration
type PolicyGroupUpdatePolicyTypeConfigOneOf7 struct {
...
type _PolicyGroupUpdatePolicyTypeConfigOneOf7 PolicyGroupUpdatePolicyTypeConfigOneOf7
...
func NewPolicyGroupUpdatePolicyTypeConfigOneOf7() *PolicyGroupUpdatePolicyTypeConfigOneOf7 {
	this := PolicyGroupUpdatePolicyTypeConfigOneOf7{}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleType() bool {
	if o != nil && !IsNil(o.LifecycleType) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o PolicyGroupUpdatePolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
...
func (o PolicyGroupUpdatePolicyTypeConfigOneOf7) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyGroupUpdatePolicyTypeConfigOneOf7 struct {
	value *PolicyGroupUpdatePolicyTypeConfigOneOf7
	isSet bool
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf7) Get() *PolicyGroupUpdatePolicyTypeConfigOneOf7 {
	return v.value
}

func (v *NullablePolicyGroupUpdatePolicyTypeConfigOneOf7) Set(val *PolicyGroupUpdatePolicyTypeConfigOneOf7) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf7) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyGroupUpdatePolicyTypeConfigOneOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyGroupUpdatePolicyTypeConfigOneOf7(val *PolicyGroupUpdatePolicyTypeConfigOneOf7) *NullablePolicyGroupUpdatePolicyTypeConfigOneOf7 {
	return &NullablePolicyGroupUpdatePolicyTypeConfigOneOf7{value: val, isSet: true}
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyGroupUpdatePolicyTypeConfigOneOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf7) UnmarshalJSON(data []byte) (err error) {
