...
// checks if the UpdatePoliciesCloud200ResponseAllOfPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePoliciesCloud200ResponseAllOfPolicy{}

// UpdatePoliciesCloud200ResponseAllOfPolicy struct for UpdatePoliciesCloud200ResponseAllOfPolicy
type UpdatePoliciesCloud200ResponseAllOfPolicy struct {
	Id                   *int64                                                   `json:"id,omitempty"`
	Name                 *string                                                  `json:"name,omitempty"`
	Description          NullableString                                           `json:"description,omitempty"`
	PolicyType           *UpdatePoliciesCloud200ResponseAllOfPolicyPolicyType     `json:"policyType,omitempty"`
	Zone                 *UpdatePoliciesCloud200ResponseAllOfPolicyZone           `json:"zone,omitempty"`
	Site                 *UpdatePoliciesCloud200ResponseAllOfPolicySite           `json:"site,omitempty"`
	User                 *UpdatePoliciesCloud200ResponseAllOfPolicyUser           `json:"user,omitempty"`
	Role                 *UpdatePoliciesCloud200ResponseAllOfPolicyRole           `json:"role,omitempty"`
	...
	Config               *UpdatePoliciesCloud200ResponseAllOfPolicyConfig         `json:"config,omitempty"`
	Enabled              *bool                                                    `json:"enabled,omitempty"`
	Owner                NullableUpdatePoliciesCloud200ResponseAllOfPolicyOwner   `json:"owner,omitempty"`
	Accounts             []ListPolicies200ResponseAllOfPoliciesInnerAccountsInner `json:"accounts,omitempty"`
	AdditionalProperties map[string]interface{}                                   `json:",remain"`
}

type _UpdatePoliciesCloud200ResponseAllOfPolicy UpdatePoliciesCloud200ResponseAllOfPolicy
...
func NewUpdatePoliciesCloud200ResponseAllOfPolicy() *UpdatePoliciesCloud200ResponseAllOfPolicy {
	this := UpdatePoliciesCloud200ResponseAllOfPolicy{}
	return &this
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetDescription() bool {
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) SetDescriptionNil() {
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) GetPolicyType() UpdatePoliciesCloud200ResponseAllOfPolicyPolicyType {
	if o == nil || IsNil(o.PolicyType) {
		var ret UpdatePoliciesCloud200ResponseAllOfPolicyPolicyType
		return ret
	}
	return *o.PolicyType
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetPolicyType() bool {
	if o != nil && !IsNil(o.PolicyType) {
		return true
	}
...
// SetPolicyType gets a reference to the given UpdatePoliciesCloud200ResponseAllOfPolicyPolicyType and assigns it to the PolicyType field.
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) GetZone() UpdatePoliciesCloud200ResponseAllOfPolicyZone {
	if o == nil || IsNil(o.Zone) {
		var ret UpdatePoliciesCloud200ResponseAllOfPolicyZone
		return ret
	}
	return *o.Zone
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetZone() bool {
	if o != nil && !IsNil(o.Zone) {
		return true
	}
...
// SetZone gets a reference to the given UpdatePoliciesCloud200ResponseAllOfPolicyZone and assigns it to the Zone field.
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) GetSite() UpdatePoliciesCloud200ResponseAllOfPolicySite {
	if o == nil || IsNil(o.Site) {
		var ret UpdatePoliciesCloud200ResponseAllOfPolicySite
		return ret
	}
	return *o.Site
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetSite() bool {
	if o != nil && !IsNil(o.Site) {
		return true
	}
...
// SetSite gets a reference to the given UpdatePoliciesCloud200ResponseAllOfPolicySite and assigns it to the Site field.
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) GetUser() UpdatePoliciesCloud200ResponseAllOfPolicyUser {
	if o == nil || IsNil(o.User) {
		var ret UpdatePoliciesCloud200ResponseAllOfPolicyUser
		return ret
	}
	return *o.User
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetUser() bool {
	if o != nil && !IsNil(o.User) {
		return true
	}
...
// SetUser gets a reference to the given UpdatePoliciesCloud200ResponseAllOfPolicyUser and assigns it to the User field.
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) GetRole() UpdatePoliciesCloud200ResponseAllOfPolicyRole {
	if o == nil || IsNil(o.Role) {
		var ret UpdatePoliciesCloud200ResponseAllOfPolicyRole
		return ret
	}
	return *o.Role
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetRole() bool {
	if o != nil && !IsNil(o.Role) {
		return true
	}
...
// SetRole gets a reference to the given UpdatePoliciesCloud200ResponseAllOfPolicyRole and assigns it to the Role field.
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetRefType() bool {
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) SetRefTypeNil() {
	o.RefType.Set(nil)
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetRefId() bool {
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) SetRefIdNil() {
	o.RefId.Set(nil)
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetEachUser() bool {
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) SetEachUserNil() {
	o.EachUser.Set(nil)
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) GetConfig() UpdatePoliciesCloud200ResponseAllOfPolicyConfig {
	if o == nil || IsNil(o.Config) {
		var ret UpdatePoliciesCloud200ResponseAllOfPolicyConfig
		return ret
	}
	return *o.Config
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given UpdatePoliciesCloud200ResponseAllOfPolicyConfig and assigns it to the Config field.
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) GetOwner() UpdatePoliciesCloud200ResponseAllOfPolicyOwner {
	if o == nil || IsNil(o.Owner.Get()) {
		var ret UpdatePoliciesCloud200ResponseAllOfPolicyOwner
		return ret
	}
	return *o.Owner.Get()
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetOwner() bool {
...
// SetOwner gets a reference to the given NullableUpdatePoliciesCloud200ResponseAllOfPolicyOwner and assigns it to the Owner field.
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) SetOwner(v UpdatePoliciesCloud200ResponseAllOfPolicyOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) IsSetAccounts() bool {
	if o != nil && !IsNil(o.Accounts) {
		return true
	}
...
func (o UpdatePoliciesCloud200ResponseAllOfPolicy) MarshalJSON() ([]byte, error) {
...
func (o UpdatePoliciesCloud200ResponseAllOfPolicy) ToMap() (map[string]interface{}, error) {
...
type NullableUpdatePoliciesCloud200ResponseAllOfPolicy struct {
	value *UpdatePoliciesCloud200ResponseAllOfPolicy
	isSet bool
}

func (v NullableUpdatePoliciesCloud200ResponseAllOfPolicy) Get() *UpdatePoliciesCloud200ResponseAllOfPolicy {
	return v.value
}

func (v *NullableUpdatePoliciesCloud200ResponseAllOfPolicy) Set(val *UpdatePoliciesCloud200ResponseAllOfPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePoliciesCloud200ResponseAllOfPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePoliciesCloud200ResponseAllOfPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePoliciesCloud200ResponseAllOfPolicy(val *UpdatePoliciesCloud200ResponseAllOfPolicy) *NullableUpdatePoliciesCloud200ResponseAllOfPolicy {
	return &NullableUpdatePoliciesCloud200ResponseAllOfPolicy{value: val, isSet: true}
}

func (v NullableUpdatePoliciesCloud200ResponseAllOfPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePoliciesCloud200ResponseAllOfPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdatePoliciesCloud200ResponseAllOfPolicy) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdatePoliciesCloud200ResponseAllOfPolicy) UnmarshalJSON(data []byte) (err error) {
