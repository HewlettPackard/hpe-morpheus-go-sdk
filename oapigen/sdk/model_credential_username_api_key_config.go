...
var _ MappedNullable = &CredentialUsernameAPIKeyConfig{}
...
func (o *CredentialUsernameAPIKeyConfig) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *CredentialUsernameAPIKeyConfig) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *CredentialUsernameAPIKeyConfig) IsSetIntegration() bool {
	if o != nil && !IsNil(o.Integration) {
		return true
	}
...
func (o CredentialUsernameAPIKeyConfig) ToMap() (map[string]interface{}, error) {
...
func (v NullableCredentialUsernameAPIKeyConfig) UnmarshalMapstructure(data any) (any, error) {
