...
// checks if the NetworkDomainCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDomainCreate{}
...
func (o NetworkDomainCreate) ToMap() (map[string]interface{}, error) {
...
func (v NullableNetworkDomainCreate) UnmarshalMapstructure(data any) (any, error) {
