...
// checks if the PolicyGroupUpdatePolicyTypeConfigOneOf26 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyGroupUpdatePolicyTypeConfigOneOf26{}

// PolicyGroupUpdatePolicyTypeConfigOneOf26 - Shutdown
type PolicyGroupUpdatePolicyTypeConfigOneOf26 struct {
...
type _PolicyGroupUpdatePolicyTypeConfigOneOf26 PolicyGroupUpdatePolicyTypeConfigOneOf26
...
func NewPolicyGroupUpdatePolicyTypeConfigOneOf26() *PolicyGroupUpdatePolicyTypeConfigOneOf26 {
	this := PolicyGroupUpdatePolicyTypeConfigOneOf26{}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o PolicyGroupUpdatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
...
func (o PolicyGroupUpdatePolicyTypeConfigOneOf26) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyGroupUpdatePolicyTypeConfigOneOf26 struct {
	value *PolicyGroupUpdatePolicyTypeConfigOneOf26
	isSet bool
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf26) Get() *PolicyGroupUpdatePolicyTypeConfigOneOf26 {
	return v.value
}

func (v *NullablePolicyGroupUpdatePolicyTypeConfigOneOf26) Set(val *PolicyGroupUpdatePolicyTypeConfigOneOf26) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf26) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyGroupUpdatePolicyTypeConfigOneOf26) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyGroupUpdatePolicyTypeConfigOneOf26(val *PolicyGroupUpdatePolicyTypeConfigOneOf26) *NullablePolicyGroupUpdatePolicyTypeConfigOneOf26 {
	return &NullablePolicyGroupUpdatePolicyTypeConfigOneOf26{value: val, isSet: true}
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyGroupUpdatePolicyTypeConfigOneOf26) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePolicyGroupUpdatePolicyTypeConfigOneOf26) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyGroupUpdatePolicyTypeConfigOneOf26) UnmarshalJSON(data []byte) (err error) {
