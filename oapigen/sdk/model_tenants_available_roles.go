...
type TenantsAvailableRoles struct {
	Roles                []TenantsAvailableRolesRolesInner `json:"roles,omitempty"`
...
func (o *TenantsAvailableRoles) GetRoles() []TenantsAvailableRolesRolesInner {
	if o == nil || IsNil(o.Roles) {
		var ret []TenantsAvailableRolesRolesInner
		return ret
	}
	return o.Roles
}
...
// SetRoles gets a reference to the given []TenantsAvailableRolesRolesInner and assigns it to the Roles field.
...
func (v NullableTenantsAvailableRoles) UnmarshalMapstructure(data any) (any, error) {
