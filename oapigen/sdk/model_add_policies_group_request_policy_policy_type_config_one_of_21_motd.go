...
func (o *AddPoliciesGroupRequestPolicyPolicyTypeConfigOneOf21Motd) IsSetTitle() bool {
	if o != nil && !IsNil(o.Title) {
		return true
	}
...
func (o *AddPoliciesGroupRequestPolicyPolicyTypeConfigOneOf21Motd) IsSetMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *AddPoliciesGroupRequestPolicyPolicyTypeConfigOneOf21Motd) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *AddPoliciesGroupRequestPolicyPolicyTypeConfigOneOf21Motd) IsSetFullPage() bool {
...
func (o *AddPoliciesGroupRequestPolicyPolicyTypeConfigOneOf21Motd) SetFullPageNil() {
	o.FullPage.Set(nil)
}
