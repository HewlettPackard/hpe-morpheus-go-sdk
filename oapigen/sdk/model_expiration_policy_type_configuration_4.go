...
// checks if the ExpirationPolicyTypeConfiguration4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration4{}

// ExpirationPolicyTypeConfiguration4 Configuration settings for the following policy types: - Expiration
type ExpirationPolicyTypeConfiguration4 struct {
...
type _ExpirationPolicyTypeConfiguration4 ExpirationPolicyTypeConfiguration4
...
func NewExpirationPolicyTypeConfiguration4() *ExpirationPolicyTypeConfiguration4 {
	this := ExpirationPolicyTypeConfiguration4{}
...
// NewExpirationPolicyTypeConfiguration4WithDefaults instantiates a new ExpirationPolicyTypeConfiguration4 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewExpirationPolicyTypeConfiguration4WithDefaults() *ExpirationPolicyTypeConfiguration4 {
	this := ExpirationPolicyTypeConfiguration4{}
	var lifecycleAutoRenew string = "off"
	this.LifecycleAutoRenew = &lifecycleAutoRenew
	var lifecycleAllowExtend string = "off"
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleType() bool {
	if o != nil && !IsNil(o.LifecycleType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration4) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration4) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration4) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration4 struct {
	value *ExpirationPolicyTypeConfiguration4
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration4) Get() *ExpirationPolicyTypeConfiguration4 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration4) Set(val *ExpirationPolicyTypeConfiguration4) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration4) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration4(val *ExpirationPolicyTypeConfiguration4) *NullableExpirationPolicyTypeConfiguration4 {
	return &NullableExpirationPolicyTypeConfiguration4{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration4) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration4) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration4) UnmarshalJSON(data []byte) (err error) {
