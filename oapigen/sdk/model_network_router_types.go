...
func (o *NetworkRouterTypes) GetOptionTypes() []NetworkRouterTypesOptionTypesInner {
	if o == nil || IsNil(o.OptionTypes) {
		var ret []NetworkRouterTypesOptionTypesInner
		return ret
	}
...
// SetOptionTypes gets a reference to the given []NetworkRouterTypesOptionTypesInner and assigns it to the OptionTypes field.
