...
func (r ApiDeleteBootScriptRequest) Execute() (*DeleteBootScript200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteBootScript200Response
func (a *ImageBuildsAPIService) DeleteBootScriptExecute(r ApiDeleteBootScriptRequest) (*DeleteBootScript200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteBootScript200Response
	)
...
func (r ApiDeleteImageBuildRequest) Execute() (*DeleteImageBuild200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteImageBuild200Response
func (a *ImageBuildsAPIService) DeleteImageBuildExecute(r ApiDeleteImageBuildRequest) (*DeleteImageBuild200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteImageBuild200Response
	)
...
func (r ApiDeletePreseedScriptRequest) Execute() (*DeletePreseedScript200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeletePreseedScript200Response
func (a *ImageBuildsAPIService) DeletePreseedScriptExecute(r ApiDeletePreseedScriptRequest) (*DeletePreseedScript200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeletePreseedScript200Response
	)
...
func (r ApiExecuteImageBuildRequest) Execute() (*ExecuteImageBuild200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ExecuteImageBuild200Response
func (a *ImageBuildsAPIService) ExecuteImageBuildExecute(r ApiExecuteImageBuildRequest) (*ExecuteImageBuild200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ExecuteImageBuild200Response
	)
...
type ApiUpdateBootScriptRequest struct {
	...
	ApiService              *ImageBuildsAPIService
	id                      int64
	updateBootScriptRequest *UpdateBootScriptRequest
}

func (r ApiUpdateBootScriptRequest) UpdateBootScriptRequest(updateBootScriptRequest UpdateBootScriptRequest) ApiUpdateBootScriptRequest {
	r.updateBootScriptRequest = &updateBootScriptRequest
	return r
}

func (r ApiUpdateBootScriptRequest) Execute() (*UpdateBootScript200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateBootScript200Response
func (a *ImageBuildsAPIService) UpdateBootScriptExecute(r ApiUpdateBootScriptRequest) (*UpdateBootScript200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateBootScript200Response
	)
	...
	// body params
	localVarPostBody = r.updateBootScriptRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiUpdateImageBuildRequest struct {
	...
	ApiService              *ImageBuildsAPIService
	id                      int64
	updateImageBuildRequest *UpdateImageBuildRequest
}

func (r ApiUpdateImageBuildRequest) UpdateImageBuildRequest(updateImageBuildRequest UpdateImageBuildRequest) ApiUpdateImageBuildRequest {
	r.updateImageBuildRequest = &updateImageBuildRequest
	return r
}
...
func (a *ImageBuildsAPIService) UpdateImageBuildExecute(r ApiUpdateImageBuildRequest) (*UpdateImageBuild200Response, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.updateImageBuildRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiUpdatePreseedScriptRequest struct {
	...
	ApiService                 *ImageBuildsAPIService
	id                         int64
	updatePreseedScriptRequest *UpdatePreseedScriptRequest
}

func (r ApiUpdatePreseedScriptRequest) UpdatePreseedScriptRequest(updatePreseedScriptRequest UpdatePreseedScriptRequest) ApiUpdatePreseedScriptRequest {
	r.updatePreseedScriptRequest = &updatePreseedScriptRequest
	return r
}

func (r ApiUpdatePreseedScriptRequest) Execute() (*UpdatePreseedScript200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdatePreseedScript200Response
func (a *ImageBuildsAPIService) UpdatePreseedScriptExecute(r ApiUpdatePreseedScriptRequest) (*UpdatePreseedScript200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdatePreseedScript200Response
	)
	...
	// body params
	localVarPostBody = r.updatePreseedScriptRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
