...
// checks if the ProvisioningSettingsUpdateDefaultTemplateType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvisioningSettingsUpdateDefaultTemplateType{}
...
type _ProvisioningSettingsUpdateDefaultTemplateType ProvisioningSettingsUpdateDefaultTemplateType
...
func (o *ProvisioningSettingsUpdateDefaultTemplateType) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o ProvisioningSettingsUpdateDefaultTemplateType) ToMap() (map[string]interface{}, error) {
...
func (v NullableProvisioningSettingsUpdateDefaultTemplateType) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ProvisioningSettingsUpdateDefaultTemplateType) UnmarshalJSON(data []byte) (err error) {
