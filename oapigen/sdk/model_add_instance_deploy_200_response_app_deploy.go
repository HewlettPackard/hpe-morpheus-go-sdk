...
// checks if the AddInstanceDeploy200ResponseAppDeploy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddInstanceDeploy200ResponseAppDeploy{}

// AddInstanceDeploy200ResponseAppDeploy struct for AddInstanceDeploy200ResponseAppDeploy
type AddInstanceDeploy200ResponseAppDeploy struct {
	Id                   *int64                                                  `json:"id,omitempty"`
	InstanceId           *int64                                                  `json:"instanceId,omitempty"`
	Instance             *AddInstanceDeploy200ResponseAppDeployInstance          `json:"instance,omitempty"`
	Deployment           *AddInstanceDeploy200ResponseAppDeployDeployment        `json:"deployment,omitempty"`
	DeploymentVersionId  *int64                                                  `json:"deploymentVersionId,omitempty"`
	DeploymentVersion    *AddInstanceDeploy200ResponseAppDeployDeploymentVersion `json:"deploymentVersion,omitempty"`
...
type _AddInstanceDeploy200ResponseAppDeploy AddInstanceDeploy200ResponseAppDeploy
...
func NewAddInstanceDeploy200ResponseAppDeploy() *AddInstanceDeploy200ResponseAppDeploy {
	this := AddInstanceDeploy200ResponseAppDeploy{}
	return &this
}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetInstanceId() bool {
	if o != nil && !IsNil(o.InstanceId) {
		return true
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) GetInstance() AddInstanceDeploy200ResponseAppDeployInstance {
	if o == nil || IsNil(o.Instance) {
		var ret AddInstanceDeploy200ResponseAppDeployInstance
		return ret
	}
	return *o.Instance
}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetInstance() bool {
	if o != nil && !IsNil(o.Instance) {
		return true
	}
...
// SetInstance gets a reference to the given AddInstanceDeploy200ResponseAppDeployInstance and assigns it to the Instance field.
...
func (o *AddInstanceDeploy200ResponseAppDeploy) GetDeployment() AddInstanceDeploy200ResponseAppDeployDeployment {
	if o == nil || IsNil(o.Deployment) {
		var ret AddInstanceDeploy200ResponseAppDeployDeployment
		return ret
	}
	return *o.Deployment
}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetDeployment() bool {
	if o != nil && !IsNil(o.Deployment) {
		return true
	}
...
// SetDeployment gets a reference to the given AddInstanceDeploy200ResponseAppDeployDeployment and assigns it to the Deployment field.
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetDeploymentVersionId() bool {
	if o != nil && !IsNil(o.DeploymentVersionId) {
		return true
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) GetDeploymentVersion() AddInstanceDeploy200ResponseAppDeployDeploymentVersion {
	if o == nil || IsNil(o.DeploymentVersion) {
		var ret AddInstanceDeploy200ResponseAppDeployDeploymentVersion
		return ret
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetDeploymentVersion() bool {
	if o != nil && !IsNil(o.DeploymentVersion) {
		return true
	}
...
// SetDeploymentVersion gets a reference to the given AddInstanceDeploy200ResponseAppDeployDeploymentVersion and assigns it to the DeploymentVersion field.
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetDeployDate() bool {
	if o != nil && !IsNil(o.DeployDate) {
		return true
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *AddInstanceDeploy200ResponseAppDeploy) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o AddInstanceDeploy200ResponseAppDeploy) MarshalJSON() ([]byte, error) {
...
func (o AddInstanceDeploy200ResponseAppDeploy) ToMap() (map[string]interface{}, error) {
...
type NullableAddInstanceDeploy200ResponseAppDeploy struct {
	value *AddInstanceDeploy200ResponseAppDeploy
	isSet bool
}

func (v NullableAddInstanceDeploy200ResponseAppDeploy) Get() *AddInstanceDeploy200ResponseAppDeploy {
	return v.value
}

func (v *NullableAddInstanceDeploy200ResponseAppDeploy) Set(val *AddInstanceDeploy200ResponseAppDeploy) {
	v.value = val
	v.isSet = true
}

func (v NullableAddInstanceDeploy200ResponseAppDeploy) IsSet() bool {
	return v.isSet
}

func (v *NullableAddInstanceDeploy200ResponseAppDeploy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddInstanceDeploy200ResponseAppDeploy(val *AddInstanceDeploy200ResponseAppDeploy) *NullableAddInstanceDeploy200ResponseAppDeploy {
	return &NullableAddInstanceDeploy200ResponseAppDeploy{value: val, isSet: true}
}

func (v NullableAddInstanceDeploy200ResponseAppDeploy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddInstanceDeploy200ResponseAppDeploy) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddInstanceDeploy200ResponseAppDeploy) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddInstanceDeploy200ResponseAppDeploy) UnmarshalJSON(data []byte) (err error) {
