...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetDefaultStore() bool {
	if o != nil && !IsNil(o.DefaultStore) {
		return true
	}
...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetDefaultTarget() bool {
	if o != nil && !IsNil(o.DefaultTarget) {
		return true
	}
...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetCanManage() bool {
	if o != nil && !IsNil(o.CanManage) {
		return true
	}
...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetAll() bool {
	if o != nil && !IsNil(o.All) {
		return true
	}
...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetSites() bool {
	if o != nil && !IsNil(o.Sites) {
		return true
	}
...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetAllPlans() bool {
	if o != nil && !IsNil(o.AllPlans) {
		return true
	}
...
func (o *ListCloudFolders200ResponseAllOfFoldersInnerResourcePermissions) IsSetPlans() bool {
	if o != nil && !IsNil(o.Plans) {
		return true
	}
