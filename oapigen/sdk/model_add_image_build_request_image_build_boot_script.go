...
// checks if the AddImageBuildRequestImageBuildBootScript type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddImageBuildRequestImageBuildBootScript{}
...
func (o *AddImageBuildRequestImageBuildBootScript) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddImageBuildRequestImageBuildBootScript) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddImageBuildRequestImageBuildBootScript) UnmarshalMapstructure(data any) (any, error) {
