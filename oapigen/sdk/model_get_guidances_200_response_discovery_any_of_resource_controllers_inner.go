...
// checks if the GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner{}

// GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner struct for GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner
type GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner struct {
	Id                   *int64                                                             `json:"id,omitempty"`
	Name                 *string                                                            `json:"name,omitempty"`
	Type                 *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInnerType `json:"type,omitempty"`
	MaxDevices           *int64                                                             `json:"maxDevices,omitempty"`
	ReservedUnitNumber   *int64                                                             `json:"reservedUnitNumber,omitempty"`
	AdditionalProperties map[string]interface{}                                             `json:",remain"`
}

type _GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner
...
func NewGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner() *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner {
	this := GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner{}
	return &this
}
...
func (o *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) GetType() GetGuidances200ResponseDiscoveryAnyOfResourceControllersInnerType {
	if o == nil || IsNil(o.Type) {
		var ret GetGuidances200ResponseDiscoveryAnyOfResourceControllersInnerType
		return ret
	}
	return *o.Type
}
...
func (o GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) MarshalJSON() ([]byte, error) {
...
func (o GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner struct {
	value *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner
	isSet bool
}

func (v NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) Get() *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner {
	return v.value
}

func (v *NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) Set(val *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner(val *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) *NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner {
	return &NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner{value: val, isSet: true}
}

func (v NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetGuidances200ResponseDiscoveryAnyOfResourceControllersInner) UnmarshalJSON(data []byte) (err error) {
