...
// checks if the AddClusterRequestClusterCloud type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddClusterRequestClusterCloud{}
...
func NewAddClusterRequestClusterCloud() *AddClusterRequestClusterCloud {
	this := AddClusterRequestClusterCloud{}
	return &this
}
...
func (o *AddClusterRequestClusterCloud) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddClusterRequestClusterCloud) MarshalJSON() ([]byte, error) {
...
func (o AddClusterRequestClusterCloud) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddClusterRequestClusterCloud) UnmarshalMapstructure(data any) (any, error) {
