...
func (o *BillingInstancesInstancesInnerContainersInnerUsagesInnerPricesUsedInner) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *BillingInstancesInstancesInnerContainersInnerUsagesInnerPricesUsedInner) IsSetPricePerUnit() bool {
	if o != nil && !IsNil(o.PricePerUnit) {
		return true
	}
...
func (o *BillingInstancesInstancesInnerContainersInnerUsagesInnerPricesUsedInner) IsSetCostPerUnit() bool {
	if o != nil && !IsNil(o.CostPerUnit) {
		return true
	}
...
func (o *BillingInstancesInstancesInnerContainersInnerUsagesInnerPricesUsedInner) IsSetQuantity() bool {
	if o != nil && !IsNil(o.Quantity) {
		return true
	}
