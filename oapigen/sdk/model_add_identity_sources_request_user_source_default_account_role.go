...
type NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole struct {
	value *AddIdentitySourcesRequestUserSourceDefaultAccountRole
	isSet bool
}

func (v NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole) Get() *AddIdentitySourcesRequestUserSourceDefaultAccountRole {
	return v.value
}

func (v *NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole) Set(val *AddIdentitySourcesRequestUserSourceDefaultAccountRole) {
	v.value = val
	v.isSet = true
}

func (v NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole) IsSet() bool {
	return v.isSet
}

func (v *NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddIdentitySourcesRequestUserSourceDefaultAccountRole(val *AddIdentitySourcesRequestUserSourceDefaultAccountRole) *NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole {
	return &NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole{value: val, isSet: true}
}

func (v NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddIdentitySourcesRequestUserSourceDefaultAccountRole) UnmarshalMapstructure(data any) (any, error) {
