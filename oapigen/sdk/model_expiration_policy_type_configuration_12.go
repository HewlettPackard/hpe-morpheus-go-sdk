...
// checks if the ExpirationPolicyTypeConfiguration12 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration12{}

// ExpirationPolicyTypeConfiguration12 - Expiration
type ExpirationPolicyTypeConfiguration12 struct {
...
type _ExpirationPolicyTypeConfiguration12 ExpirationPolicyTypeConfiguration12
...
func NewExpirationPolicyTypeConfiguration12(lifecycleType string) *ExpirationPolicyTypeConfiguration12 {
	this := ExpirationPolicyTypeConfiguration12{}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration12) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration12) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration12) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration12 struct {
	value *ExpirationPolicyTypeConfiguration12
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration12) Get() *ExpirationPolicyTypeConfiguration12 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration12) Set(val *ExpirationPolicyTypeConfiguration12) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration12) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration12) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration12(val *ExpirationPolicyTypeConfiguration12) *NullableExpirationPolicyTypeConfiguration12 {
	return &NullableExpirationPolicyTypeConfiguration12{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration12) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration12) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration12) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration12) UnmarshalJSON(data []byte) (err error) {
