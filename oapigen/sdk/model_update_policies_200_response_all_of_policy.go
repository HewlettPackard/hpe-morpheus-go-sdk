...
// SetOwner gets a reference to the given NullableUpdatePolicies200ResponseAllOfPolicyOwner and assigns it to the Owner field.
func (o *UpdatePolicies200ResponseAllOfPolicy) SetOwner(v UpdatePolicies200ResponseAllOfPolicyOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *UpdatePolicies200ResponseAllOfPolicy) SetOwnerNil() {
	o.Owner.Set(nil)
}
