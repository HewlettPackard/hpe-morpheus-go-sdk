...
func (o *SecurityGroupLocation) GetZone() SecurityGroupLocationZone {
	if o == nil || IsNil(o.Zone) {
		var ret SecurityGroupLocationZone
		return ret
	}
	return *o.Zone
}
...
// SetZone gets a reference to the given SecurityGroupLocationZone and assigns it to the Zone field.
...
func (o *SecurityGroupLocation) GetZonePool() SecurityGroupLocationZonePool {
	if o == nil || IsNil(o.ZonePool) {
		var ret SecurityGroupLocationZonePool
		return ret
	}
	return *o.ZonePool
}
...
// SetZonePool gets a reference to the given SecurityGroupLocationZonePool and assigns it to the ZonePool field.
