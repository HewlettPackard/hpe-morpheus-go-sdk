...
func (o *WebGetConfig8) IsSetIgnoreSSL() bool {
	if o != nil && !IsNil(o.IgnoreSSL) {
		return true
	}
...
func (o *WebGetConfig8) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *WebGetConfig8) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *WebGetConfig8) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *WebGetConfig8) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
