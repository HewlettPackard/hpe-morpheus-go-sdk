...
// checks if the InstancesNetworkInterfaces7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstancesNetworkInterfaces7{}

// InstancesNetworkInterfaces7 struct for InstancesNetworkInterfaces7
type InstancesNetworkInterfaces7 struct {
	Network InstancesNetworkInterfaces7Network `json:"network"`
	...
	NetworkInterfaces    []InstancesNetworkInterfaces7NetworkInterfacesInner `json:"networkInterfaces,omitempty"`
	AdditionalProperties map[string]interface{}                              `json:",remain"`
}

type _InstancesNetworkInterfaces7 InstancesNetworkInterfaces7
...
func NewInstancesNetworkInterfaces7(network InstancesNetworkInterfaces7Network) *InstancesNetworkInterfaces7 {
	this := InstancesNetworkInterfaces7{}
...
func (o *InstancesNetworkInterfaces7) GetNetwork() InstancesNetworkInterfaces7Network {
	if o == nil {
		var ret InstancesNetworkInterfaces7Network
		return ret
	}
...
func (o *InstancesNetworkInterfaces7) IsSetNetworkInterfaceTypeId() bool {
	if o != nil && !IsNil(o.NetworkInterfaceTypeId) {
		return true
	}
...
func (o *InstancesNetworkInterfaces7) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *InstancesNetworkInterfaces7) IsSetIpAddress() bool {
	if o != nil && !IsNil(o.IpAddress) {
		return true
	}
...
func (o *InstancesNetworkInterfaces7) IsSetMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *InstancesNetworkInterfaces7) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstancesNetworkInterfaces7) GetNetworkInterfaces() []InstancesNetworkInterfaces7NetworkInterfacesInner {
	if o == nil || IsNil(o.NetworkInterfaces) {
		var ret []InstancesNetworkInterfaces7NetworkInterfacesInner
		return ret
	}
...
func (o *InstancesNetworkInterfaces7) IsSetNetworkInterfaces() bool {
	if o != nil && !IsNil(o.NetworkInterfaces) {
		return true
	}
...
// SetNetworkInterfaces gets a reference to the given []InstancesNetworkInterfaces7NetworkInterfacesInner and assigns it to the NetworkInterfaces field.
...
func (o InstancesNetworkInterfaces7) MarshalJSON() ([]byte, error) {
...
func (o InstancesNetworkInterfaces7) ToMap() (map[string]interface{}, error) {
...
type NullableInstancesNetworkInterfaces7 struct {
	value *InstancesNetworkInterfaces7
	isSet bool
}

func (v NullableInstancesNetworkInterfaces7) Get() *InstancesNetworkInterfaces7 {
	return v.value
}

func (v *NullableInstancesNetworkInterfaces7) Set(val *InstancesNetworkInterfaces7) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesNetworkInterfaces7) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesNetworkInterfaces7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesNetworkInterfaces7(val *InstancesNetworkInterfaces7) *NullableInstancesNetworkInterfaces7 {
	return &NullableInstancesNetworkInterfaces7{value: val, isSet: true}
}

func (v NullableInstancesNetworkInterfaces7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesNetworkInterfaces7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstancesNetworkInterfaces7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstancesNetworkInterfaces7) UnmarshalJSON(data []byte) (err error) {
