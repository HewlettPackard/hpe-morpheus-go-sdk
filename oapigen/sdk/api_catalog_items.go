...
func (r ApiRemoveCatalogItemTypeRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *CatalogItemsAPIService) RemoveCatalogItemTypeExecute(r ApiRemoveCatalogItemTypeRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiUpdateCatalogItemTypeLogoRequest) Execute() (*UpdateCatalogItemTypeLogo200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateCatalogItemTypeLogo200Response
func (a *CatalogItemsAPIService) UpdateCatalogItemTypeLogoExecute(r ApiUpdateCatalogItemTypeLogoRequest) (*UpdateCatalogItemTypeLogo200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateCatalogItemTypeLogo200Response
	)
