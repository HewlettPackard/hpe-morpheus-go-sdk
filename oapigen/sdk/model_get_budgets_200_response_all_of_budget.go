...
type GetBudgets200ResponseAllOfBudget struct {
	...
	Account              NullableGetBudgets200ResponseAllOfBudgetAccount `json:"account,omitempty"`
...
func (o *GetBudgets200ResponseAllOfBudget) GetAccount() GetBudgets200ResponseAllOfBudgetAccount {
	if o == nil || IsNil(o.Account.Get()) {
		var ret GetBudgets200ResponseAllOfBudgetAccount
		return ret
	}
...
// SetAccount gets a reference to the given NullableGetBudgets200ResponseAllOfBudgetAccount and assigns it to the Account field.
...
func (v NullableGetBudgets200ResponseAllOfBudget) UnmarshalMapstructure(data any) (any, error) {
