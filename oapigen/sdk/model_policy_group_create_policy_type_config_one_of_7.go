...
// checks if the PolicyGroupCreatePolicyTypeConfigOneOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyGroupCreatePolicyTypeConfigOneOf7{}

// PolicyGroupCreatePolicyTypeConfigOneOf7 - Expiration
type PolicyGroupCreatePolicyTypeConfigOneOf7 struct {
...
type _PolicyGroupCreatePolicyTypeConfigOneOf7 PolicyGroupCreatePolicyTypeConfigOneOf7
...
func NewPolicyGroupCreatePolicyTypeConfigOneOf7() *PolicyGroupCreatePolicyTypeConfigOneOf7 {
	this := PolicyGroupCreatePolicyTypeConfigOneOf7{}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleType() bool {
	if o != nil && !IsNil(o.LifecycleType) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o PolicyGroupCreatePolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
...
func (o PolicyGroupCreatePolicyTypeConfigOneOf7) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyGroupCreatePolicyTypeConfigOneOf7 struct {
	value *PolicyGroupCreatePolicyTypeConfigOneOf7
	isSet bool
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf7) Get() *PolicyGroupCreatePolicyTypeConfigOneOf7 {
	return v.value
}

func (v *NullablePolicyGroupCreatePolicyTypeConfigOneOf7) Set(val *PolicyGroupCreatePolicyTypeConfigOneOf7) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf7) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyGroupCreatePolicyTypeConfigOneOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyGroupCreatePolicyTypeConfigOneOf7(val *PolicyGroupCreatePolicyTypeConfigOneOf7) *NullablePolicyGroupCreatePolicyTypeConfigOneOf7 {
	return &NullablePolicyGroupCreatePolicyTypeConfigOneOf7{value: val, isSet: true}
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyGroupCreatePolicyTypeConfigOneOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf7) UnmarshalJSON(data []byte) (err error) {
