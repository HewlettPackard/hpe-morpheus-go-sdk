...
// checks if the ShutdownPolicyTypeConfiguration15 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShutdownPolicyTypeConfiguration15{}

// ShutdownPolicyTypeConfiguration15 Configuration settings for the following policy types: - Shutdown
type ShutdownPolicyTypeConfiguration15 struct {
...
type _ShutdownPolicyTypeConfiguration15 ShutdownPolicyTypeConfiguration15
...
func NewShutdownPolicyTypeConfiguration15() *ShutdownPolicyTypeConfiguration15 {
	this := ShutdownPolicyTypeConfiguration15{}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration15) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration15) MarshalJSON() ([]byte, error) {
...
func (o ShutdownPolicyTypeConfiguration15) ToMap() (map[string]interface{}, error) {
...
type NullableShutdownPolicyTypeConfiguration15 struct {
	value *ShutdownPolicyTypeConfiguration15
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration15) Get() *ShutdownPolicyTypeConfiguration15 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration15) Set(val *ShutdownPolicyTypeConfiguration15) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration15) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration15) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration15(val *ShutdownPolicyTypeConfiguration15) *NullableShutdownPolicyTypeConfiguration15 {
	return &NullableShutdownPolicyTypeConfiguration15{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration15) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration15) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration15) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ShutdownPolicyTypeConfiguration15) UnmarshalJSON(data []byte) (err error) {
