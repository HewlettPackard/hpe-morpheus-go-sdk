...
// checks if the ShutdownPolicyTypeConfiguration4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShutdownPolicyTypeConfiguration4{}

// ShutdownPolicyTypeConfiguration4 Configuration settings for the following policy types: - Shutdown
type ShutdownPolicyTypeConfiguration4 struct {
...
type _ShutdownPolicyTypeConfiguration4 ShutdownPolicyTypeConfiguration4
...
func NewShutdownPolicyTypeConfiguration4() *ShutdownPolicyTypeConfiguration4 {
	this := ShutdownPolicyTypeConfiguration4{}
...
// NewShutdownPolicyTypeConfiguration4WithDefaults instantiates a new ShutdownPolicyTypeConfiguration4 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewShutdownPolicyTypeConfiguration4WithDefaults() *ShutdownPolicyTypeConfiguration4 {
	this := ShutdownPolicyTypeConfiguration4{}
	var shutdownAutoRenew string = "off"
	this.ShutdownAutoRenew = &shutdownAutoRenew
	var shutdownAllowExtend string = "off"
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration4) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration4) MarshalJSON() ([]byte, error) {
...
func (o ShutdownPolicyTypeConfiguration4) ToMap() (map[string]interface{}, error) {
...
type NullableShutdownPolicyTypeConfiguration4 struct {
	value *ShutdownPolicyTypeConfiguration4
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration4) Get() *ShutdownPolicyTypeConfiguration4 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration4) Set(val *ShutdownPolicyTypeConfiguration4) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration4) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration4(val *ShutdownPolicyTypeConfiguration4) *NullableShutdownPolicyTypeConfiguration4 {
	return &NullableShutdownPolicyTypeConfiguration4{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration4) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration4) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ShutdownPolicyTypeConfiguration4) UnmarshalJSON(data []byte) (err error) {
