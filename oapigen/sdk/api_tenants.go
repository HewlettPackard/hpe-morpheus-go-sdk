...
type ApiAddSubtenantIdentitySourcesRequest struct {
	...
	accountId                    int64
	updateIdentitySourcesRequest *UpdateIdentitySourcesRequest
}

func (r ApiAddSubtenantIdentitySourcesRequest) UpdateIdentitySourcesRequest(updateIdentitySourcesRequest UpdateIdentitySourcesRequest) ApiAddSubtenantIdentitySourcesRequest {
	r.updateIdentitySourcesRequest = &updateIdentitySourcesRequest
	return r
}

func (r ApiAddSubtenantIdentitySourcesRequest) Execute() (*UpdateIdentitySources200Response, *http.Response, error) {
...
//
//	@return UpdateIdentitySources200Response
func (a *TenantsAPIService) AddSubtenantIdentitySourcesExecute(r ApiAddSubtenantIdentitySourcesRequest) (*UpdateIdentitySources200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateIdentitySources200Response
	)
	...
	// body params
	localVarPostBody = r.updateIdentitySourcesRequest
...
func (r ApiRemoveTenantRequest) Execute() (*RemoveTenant200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return RemoveTenant200Response
func (a *TenantsAPIService) RemoveTenantExecute(r ApiRemoveTenantRequest) (*RemoveTenant200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RemoveTenant200Response
	)
...
func (r ApiRemoveTenantSubtenantGroupRequest) Execute() (*RemoveTenantSubtenantGroup200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return RemoveTenantSubtenantGroup200Response
func (a *TenantsAPIService) RemoveTenantSubtenantGroupExecute(r ApiRemoveTenantSubtenantGroupRequest) (*RemoveTenantSubtenantGroup200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RemoveTenantSubtenantGroup200Response
	)
...
func (r ApiUpdateTenantSubtenantGroupRequest) Execute() (*UpdateTenantSubtenantGroup200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateTenantSubtenantGroup200Response
func (a *TenantsAPIService) UpdateTenantSubtenantGroupExecute(r ApiUpdateTenantSubtenantGroupRequest) (*UpdateTenantSubtenantGroup200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateTenantSubtenantGroup200Response
	)
...
func (r ApiUpdateTenantSubtenantGroupZonesRequest) Execute() (*UpdateTenantSubtenantGroupZones200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateTenantSubtenantGroupZones200Response
func (a *TenantsAPIService) UpdateTenantSubtenantGroupZonesExecute(r ApiUpdateTenantSubtenantGroupZonesRequest) (*UpdateTenantSubtenantGroupZones200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateTenantSubtenantGroupZones200Response
	)
