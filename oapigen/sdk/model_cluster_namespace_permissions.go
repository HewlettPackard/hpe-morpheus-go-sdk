...
// checks if the ClusterNamespacePermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterNamespacePermissions{}
...
func (o ClusterNamespacePermissions) ToMap() (map[string]interface{}, error) {
...
func (v NullableClusterNamespacePermissions) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ClusterNamespacePermissions) UnmarshalJSON(data []byte) (err error) {
