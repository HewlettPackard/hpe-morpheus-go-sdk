...
// checks if the CreateLoadBalancerProfileRequestLoadBalancerProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateLoadBalancerProfileRequestLoadBalancerProfile{}

// CreateLoadBalancerProfileRequestLoadBalancerProfile struct for CreateLoadBalancerProfileRequestLoadBalancerProfile
type CreateLoadBalancerProfileRequestLoadBalancerProfile struct {
	// Name
...
func (o *CreateLoadBalancerProfileRequestLoadBalancerProfile) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *CreateLoadBalancerProfileRequestLoadBalancerProfile) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *CreateLoadBalancerProfileRequestLoadBalancerProfile) IsSetServiceType() bool {
	if o != nil && !IsNil(o.ServiceType) {
		return true
	}
...
func (o *CreateLoadBalancerProfileRequestLoadBalancerProfile) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o CreateLoadBalancerProfileRequestLoadBalancerProfile) ToMap() (map[string]interface{}, error) {
...
func (v NullableCreateLoadBalancerProfileRequestLoadBalancerProfile) UnmarshalMapstructure(data any) (any, error) {
