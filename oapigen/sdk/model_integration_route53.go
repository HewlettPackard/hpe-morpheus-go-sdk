...
// checks if the IntegrationRoute53 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationRoute53{}
...
func (o *IntegrationRoute53) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetIntegrationType() bool {
	if o != nil && !IsNil(o.IntegrationType) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetIsPlugin() bool {
	if o != nil && !IsNil(o.IsPlugin) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetStatusDate() bool {
	if o != nil && !IsNil(o.StatusDate) {
		return true
	}
...
func (o *IntegrationRoute53) IsSetStatusMessage() bool {
...
func (o *IntegrationRoute53) IsSetLastSync() bool {
...
func (o *IntegrationRoute53) IsSetLastSyncDuration() bool {
...
func (o *IntegrationRoute53) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o IntegrationRoute53) ToMap() (map[string]interface{}, error) {
...
func (v NullableIntegrationRoute53) UnmarshalMapstructure(data any) (any, error) {
