...
// checks if the ImageBuildsLastResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageBuildsLastResult{}

// ImageBuildsLastResult struct for ImageBuildsLastResult
type ImageBuildsLastResult struct {
	Id                   *int64                           `json:"id,omitempty"`
	ImageBuild           *ImageBuildsLastResultImageBuild `json:"imageBuild,omitempty"`
	...
	CreatedBy            *ImageBuildsLastResultCreatedBy  `json:"createdBy,omitempty"`
...
type _ImageBuildsLastResult ImageBuildsLastResult
...
func (o *ImageBuildsLastResult) GetImageBuild() ImageBuildsLastResultImageBuild {
	if o == nil || IsNil(o.ImageBuild) {
		var ret ImageBuildsLastResultImageBuild
		return ret
	}
	return *o.ImageBuild
}
...
func (o *ImageBuildsLastResult) GetCreatedBy() ImageBuildsLastResultCreatedBy {
	if o == nil || IsNil(o.CreatedBy) {
		var ret ImageBuildsLastResultCreatedBy
		return ret
	}
	return *o.CreatedBy
}
...
func (o ImageBuildsLastResult) ToMap() (map[string]interface{}, error) {
...
func (v NullableImageBuildsLastResult) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ImageBuildsLastResult) UnmarshalJSON(data []byte) (err error) {
