...
// checks if the AddClusterRequestClusterServerUserGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddClusterRequestClusterServerUserGroup{}

// AddClusterRequestClusterServerUserGroup struct for AddClusterRequestClusterServerUserGroup
...
func NewAddClusterRequestClusterServerUserGroup() *AddClusterRequestClusterServerUserGroup {
	this := AddClusterRequestClusterServerUserGroup{}
	return &this
}
...
func (o *AddClusterRequestClusterServerUserGroup) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddClusterRequestClusterServerUserGroup) MarshalJSON() ([]byte, error) {
...
func (o AddClusterRequestClusterServerUserGroup) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddClusterRequestClusterServerUserGroup) UnmarshalMapstructure(data any) (any, error) {
