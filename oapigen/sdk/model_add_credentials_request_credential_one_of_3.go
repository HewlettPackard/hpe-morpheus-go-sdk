...
func NewAddCredentialsRequestCredentialOneOf3(type_ string, name string, authPath string, username string, authKey AddCredentialsRequestCredentialOneOf3AuthKey) *AddCredentialsRequestCredentialOneOf3 {
	this := AddCredentialsRequestCredentialOneOf3{}
	this.Type = type_
	this.Name = name
...
func (o *AddCredentialsRequestCredentialOneOf3) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *AddCredentialsRequestCredentialOneOf3) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *AddCredentialsRequestCredentialOneOf3) GetIntegration() AddCredentialsRequestCredentialOneOf3Integration {
	if o == nil || IsNil(o.Integration) {
		var ret AddCredentialsRequestCredentialOneOf3Integration
		return ret
	}
...
func (o *AddCredentialsRequestCredentialOneOf3) IsSetIntegration() bool {
	if o != nil && !IsNil(o.Integration) {
		return true
	}
...
// SetIntegration gets a reference to the given AddCredentialsRequestCredentialOneOf3Integration and assigns it to the Integration field.
...
func (o *AddCredentialsRequestCredentialOneOf3) GetAuthKey() AddCredentialsRequestCredentialOneOf3AuthKey {
	if o == nil {
		var ret AddCredentialsRequestCredentialOneOf3AuthKey
		return ret
	}
