...
// checks if the SetInstanceSecurityGroups200ResponseAllOfSecurityGroupsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetInstanceSecurityGroups200ResponseAllOfSecurityGroupsInner{}

// SetInstanceSecurityGroups200ResponseAllOfSecurityGroupsInner struct for SetInstanceSecurityGroups200ResponseAllOfSecurityGroupsInner
type SetInstanceSecurityGroups200ResponseAllOfSecurityGroupsInner struct {
	// Security group ID
...
func (o SetInstanceSecurityGroups200ResponseAllOfSecurityGroupsInner) ToMap() (map[string]interface{}, error) {
...
func (v NullableSetInstanceSecurityGroups200ResponseAllOfSecurityGroupsInner) UnmarshalMapstructure(data any) (any, error) {
