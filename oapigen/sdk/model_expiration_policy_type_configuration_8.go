...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration8) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
