...
func (o *UpdateLogSettingsRequestLogSettings) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *UpdateLogSettingsRequestLogSettings) IsSetRetentionDays() bool {
	if o != nil && !IsNil(o.RetentionDays) {
		return true
	}
...
func (o *UpdateLogSettingsRequestLogSettings) IsSetSyslogRules() bool {
	if o != nil && !IsNil(o.SyslogRules) {
		return true
	}
...
func (o *UpdateLogSettingsRequestLogSettings) IsSetIntegrations() bool {
	if o != nil && !IsNil(o.Integrations) {
		return true
	}
