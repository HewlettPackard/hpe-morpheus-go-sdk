...
// checks if the ListBackups200ResponseAllOfBackupsInnerBackupProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListBackups200ResponseAllOfBackupsInnerBackupProvider{}

// ListBackups200ResponseAllOfBackupsInnerBackupProvider struct for ListBackups200ResponseAllOfBackupsInnerBackupProvider
type ListBackups200ResponseAllOfBackupsInnerBackupProvider struct {
	// Backup Provider ID
...
func NewListBackups200ResponseAllOfBackupsInnerBackupProvider() *ListBackups200ResponseAllOfBackupsInnerBackupProvider {
	this := ListBackups200ResponseAllOfBackupsInnerBackupProvider{}
	return &this
}
...
func (o *ListBackups200ResponseAllOfBackupsInnerBackupProvider) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListBackups200ResponseAllOfBackupsInnerBackupProvider) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o ListBackups200ResponseAllOfBackupsInnerBackupProvider) MarshalJSON() ([]byte, error) {
...
func (o ListBackups200ResponseAllOfBackupsInnerBackupProvider) ToMap() (map[string]interface{}, error) {
...
func (v NullableListBackups200ResponseAllOfBackupsInnerBackupProvider) UnmarshalMapstructure(data any) (any, error) {
