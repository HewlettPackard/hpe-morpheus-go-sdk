...
func (o *UpdateSecurityGroupRulesRequestRule) GetSourceGroup() UpdateSecurityGroupRulesRequestRuleSourceGroup {
	if o == nil || IsNil(o.SourceGroup) {
		var ret UpdateSecurityGroupRulesRequestRuleSourceGroup
		return ret
	}
...
// SetSourceGroup gets a reference to the given UpdateSecurityGroupRulesRequestRuleSourceGroup and assigns it to the SourceGroup field.
...
func (o *UpdateSecurityGroupRulesRequestRule) GetSourceTier() UpdateSecurityGroupRulesRequestRuleSourceTier {
	if o == nil || IsNil(o.SourceTier) {
		var ret UpdateSecurityGroupRulesRequestRuleSourceTier
		return ret
	}
	return *o.SourceTier
}
...
// SetSourceTier gets a reference to the given UpdateSecurityGroupRulesRequestRuleSourceTier and assigns it to the SourceTier field.
...
func (o *UpdateSecurityGroupRulesRequestRule) GetDestinationGroup() UpdateSecurityGroupRulesRequestRuleDestinationGroup {
	if o == nil || IsNil(o.DestinationGroup) {
		var ret UpdateSecurityGroupRulesRequestRuleDestinationGroup
		return ret
	}
...
// SetDestinationGroup gets a reference to the given UpdateSecurityGroupRulesRequestRuleDestinationGroup and assigns it to the DestinationGroup field.
...
func (o *UpdateSecurityGroupRulesRequestRule) GetDestinationTier() UpdateSecurityGroupRulesRequestRuleDestinationTier {
	if o == nil || IsNil(o.DestinationTier) {
		var ret UpdateSecurityGroupRulesRequestRuleDestinationTier
		return ret
	}
...
// SetDestinationTier gets a reference to the given UpdateSecurityGroupRulesRequestRuleDestinationTier and assigns it to the DestinationTier field.
