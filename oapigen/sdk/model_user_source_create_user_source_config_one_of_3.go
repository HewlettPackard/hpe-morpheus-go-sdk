...
func (o *UserSourceCreateUserSourceConfigOneOf3) IsSetUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *UserSourceCreateUserSourceConfigOneOf3) IsSetAdministratorAPIToken() bool {
	if o != nil && !IsNil(o.AdministratorAPIToken) {
		return true
	}
...
func (o *UserSourceCreateUserSourceConfigOneOf3) IsSetRequiredGroup() bool {
	if o != nil && !IsNil(o.RequiredGroup) {
		return true
	}
