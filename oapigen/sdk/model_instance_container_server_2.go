...
type InstanceContainerServer2 struct {
	...
	Volumes              []InstanceContainerServerVolume2           `json:"volumes,omitempty"`
	Interfaces           []InstanceContainerServerInterfacesInner2  `json:"interfaces,omitempty"`
...
func (o *InstanceContainerServer2) GetVolumes() []InstanceContainerServerVolume2 {
	if o == nil || IsNil(o.Volumes) {
		var ret []InstanceContainerServerVolume2
		return ret
	}
	return o.Volumes
}
...
// SetVolumes gets a reference to the given []InstanceContainerServerVolume2 and assigns it to the Volumes field.
...
func (o *InstanceContainerServer2) GetInterfaces() []InstanceContainerServerInterfacesInner2 {
	if o == nil || IsNil(o.Interfaces) {
		var ret []InstanceContainerServerInterfacesInner2
		return ret
	}
	return o.Interfaces
}
...
// SetInterfaces gets a reference to the given []InstanceContainerServerInterfacesInner2 and assigns it to the Interfaces field.
