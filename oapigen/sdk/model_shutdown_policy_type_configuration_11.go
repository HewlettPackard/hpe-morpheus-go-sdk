...
// checks if the ShutdownPolicyTypeConfiguration11 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShutdownPolicyTypeConfiguration11{}

// ShutdownPolicyTypeConfiguration11 - Shutdown
type ShutdownPolicyTypeConfiguration11 struct {
...
type _ShutdownPolicyTypeConfiguration11 ShutdownPolicyTypeConfiguration11
...
func NewShutdownPolicyTypeConfiguration11(shutdownType string) *ShutdownPolicyTypeConfiguration11 {
	this := ShutdownPolicyTypeConfiguration11{}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration11) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration11) MarshalJSON() ([]byte, error) {
...
func (o ShutdownPolicyTypeConfiguration11) ToMap() (map[string]interface{}, error) {
...
type NullableShutdownPolicyTypeConfiguration11 struct {
	value *ShutdownPolicyTypeConfiguration11
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration11) Get() *ShutdownPolicyTypeConfiguration11 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration11) Set(val *ShutdownPolicyTypeConfiguration11) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration11) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration11) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration11(val *ShutdownPolicyTypeConfiguration11) *NullableShutdownPolicyTypeConfiguration11 {
	return &NullableShutdownPolicyTypeConfiguration11{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration11) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration11) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration11) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ShutdownPolicyTypeConfiguration11) UnmarshalJSON(data []byte) (err error) {
