...
func (o *AddPoliciesCloudRequestPolicyPolicyTypeConfigOneOf4) IsSetServerNamingType() bool {
	if o != nil && !IsNil(o.ServerNamingType) {
		return true
	}
...
func (o *AddPoliciesCloudRequestPolicyPolicyTypeConfigOneOf4) IsSetServerNamingPattern() bool {
	if o != nil && !IsNil(o.ServerNamingPattern) {
		return true
	}
...
func (o *AddPoliciesCloudRequestPolicyPolicyTypeConfigOneOf4) IsSetServerNamingConflict() bool {
	if o != nil && !IsNil(o.ServerNamingConflict) {
		return true
	}
