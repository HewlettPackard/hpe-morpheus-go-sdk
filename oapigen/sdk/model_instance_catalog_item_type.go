...
// checks if the InstanceCatalogItemType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceCatalogItemType{}

// InstanceCatalogItemType struct for InstanceCatalogItemType
type InstanceCatalogItemType struct {
	...
	Config        InstanceCatalogItemTypeConfig `json:"config"`
	...
	Form     *InstanceCatalogItemTypeForm `json:"form,omitempty"`
...
type _InstanceCatalogItemType InstanceCatalogItemType
...
func (o *InstanceCatalogItemType) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetCode() bool {
...
func (o *InstanceCatalogItemType) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *InstanceCatalogItemType) IsSetCategory() bool {
...
func (o *InstanceCatalogItemType) SetCategoryNil() {
	o.Category.Set(nil)
}
...
func (o *InstanceCatalogItemType) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetLayoutCode() bool {
...
func (o *InstanceCatalogItemType) SetLayoutCodeNil() {
...
func (o *InstanceCatalogItemType) IsSetIconPath() bool {
	if o != nil && !IsNil(o.IconPath) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetFeatured() bool {
	if o != nil && !IsNil(o.Featured) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetAllowQuantity() bool {
	if o != nil && !IsNil(o.AllowQuantity) {
		return true
	}
...
func (o *InstanceCatalogItemType) GetConfig() InstanceCatalogItemTypeConfig {
	if o == nil {
		var ret InstanceCatalogItemTypeConfig
		return ret
	}
...
func (o *InstanceCatalogItemType) IsSetInstanceSpec() bool {
	if o != nil && !IsNil(o.InstanceSpec) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetFormType() bool {
	if o != nil && !IsNil(o.FormType) {
		return true
	}
...
func (o *InstanceCatalogItemType) GetForm() InstanceCatalogItemTypeForm {
	if o == nil || IsNil(o.Form) {
		var ret InstanceCatalogItemTypeForm
		return ret
	}
	return *o.Form
}
...
func (o *InstanceCatalogItemType) IsSetForm() bool {
	if o != nil && !IsNil(o.Form) {
		return true
	}
...
// SetForm gets a reference to the given InstanceCatalogItemTypeForm and assigns it to the Form field.
...
func (o *InstanceCatalogItemType) IsSetOptionTypes() bool {
	if o != nil && !IsNil(o.OptionTypes) {
		return true
	}
...
func (o *InstanceCatalogItemType) IsSetContent() bool {
	if o != nil && !IsNil(o.Content) {
		return true
	}
...
func (o InstanceCatalogItemType) MarshalJSON() ([]byte, error) {
...
func (o InstanceCatalogItemType) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceCatalogItemType struct {
	value *InstanceCatalogItemType
	isSet bool
}

func (v NullableInstanceCatalogItemType) Get() *InstanceCatalogItemType {
	return v.value
}

func (v *NullableInstanceCatalogItemType) Set(val *InstanceCatalogItemType) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceCatalogItemType) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceCatalogItemType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceCatalogItemType(val *InstanceCatalogItemType) *NullableInstanceCatalogItemType {
	return &NullableInstanceCatalogItemType{value: val, isSet: true}
}

func (v NullableInstanceCatalogItemType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceCatalogItemType) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceCatalogItemType) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceCatalogItemType) UnmarshalJSON(data []byte) (err error) {
