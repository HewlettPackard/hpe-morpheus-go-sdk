...
// checks if the ClusterPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterPermissions{}
...
type _ClusterPermissions ClusterPermissions
...
func (o *ClusterPermissions) IsSetResourcePool() bool {
	if o != nil && !IsNil(o.ResourcePool) {
		return true
	}
...
func (o *ClusterPermissions) IsSetResourcePermissions() bool {
	if o != nil && !IsNil(o.ResourcePermissions) {
		return true
	}
...
func (o ClusterPermissions) ToMap() (map[string]interface{}, error) {
...
func (v NullableClusterPermissions) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ClusterPermissions) UnmarshalJSON(data []byte) (err error) {
