...
func (o *SocketConfig3) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SocketConfig3) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SocketConfig3) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SocketConfig3) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SocketConfig3) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
