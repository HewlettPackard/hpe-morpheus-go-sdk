...
// checks if the IntegrationTypeOptionTypeInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationTypeOptionTypeInner{}

// IntegrationTypeOptionTypeInner struct for IntegrationTypeOptionTypeInner
type IntegrationTypeOptionTypeInner struct {
...
type _IntegrationTypeOptionTypeInner IntegrationTypeOptionTypeInner
...
func NewIntegrationTypeOptionTypeInner() *IntegrationTypeOptionTypeInner {
	this := IntegrationTypeOptionTypeInner{}
	return &this
}
...
func (o IntegrationTypeOptionTypeInner) ToMap() (map[string]interface{}, error) {
...
type NullableIntegrationTypeOptionTypeInner struct {
	value *IntegrationTypeOptionTypeInner
	isSet bool
}

func (v NullableIntegrationTypeOptionTypeInner) Get() *IntegrationTypeOptionTypeInner {
	return v.value
}

func (v *NullableIntegrationTypeOptionTypeInner) Set(val *IntegrationTypeOptionTypeInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationTypeOptionTypeInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationTypeOptionTypeInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationTypeOptionTypeInner(val *IntegrationTypeOptionTypeInner) *NullableIntegrationTypeOptionTypeInner {
	return &NullableIntegrationTypeOptionTypeInner{value: val, isSet: true}
}

func (v NullableIntegrationTypeOptionTypeInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationTypeOptionTypeInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableIntegrationTypeOptionTypeInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *IntegrationTypeOptionTypeInner) UnmarshalJSON(data []byte) (err error) {
