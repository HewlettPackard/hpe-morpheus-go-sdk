...
// checks if the GetIdentitySources200ResponseUserSourceAnyOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIdentitySources200ResponseUserSourceAnyOf2{}

// GetIdentitySources200ResponseUserSourceAnyOf2 struct for GetIdentitySources200ResponseUserSourceAnyOf2
type GetIdentitySources200ResponseUserSourceAnyOf2 struct {
	...
	Account              *GetIdentitySources200ResponseUserSourceAnyOf2Account            `json:"account,omitempty"`
	DefaultAccountRole   *GetIdentitySources200ResponseUserSourceAnyOf2DefaultAccountRole `json:"defaultAccountRole,omitempty"`
	Config               *GetIdentitySources200ResponseUserSourceAnyOf2Config             `json:"config,omitempty"`
	RoleMappings         []GetIdentitySources200ResponseUserSourceAnyOf2RoleMappingsInner `json:"roleMappings,omitempty"`
...
type _GetIdentitySources200ResponseUserSourceAnyOf2 GetIdentitySources200ResponseUserSourceAnyOf2
...
func NewGetIdentitySources200ResponseUserSourceAnyOf2() *GetIdentitySources200ResponseUserSourceAnyOf2 {
	this := GetIdentitySources200ResponseUserSourceAnyOf2{}
	return &this
}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetDescription() bool {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) SetDescriptionNil() {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetDeleted() bool {
	if o != nil && !IsNil(o.Deleted) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetAutoSyncOnLogin() bool {
	if o != nil && !IsNil(o.AutoSyncOnLogin) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetExternalLogin() bool {
	if o != nil && !IsNil(o.ExternalLogin) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetAllowCustomMappings() bool {
	if o != nil && !IsNil(o.AllowCustomMappings) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetManualRoleAssignment() bool {
	if o != nil && !IsNil(o.ManualRoleAssignment) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) GetAccount() GetIdentitySources200ResponseUserSourceAnyOf2Account {
	if o == nil || IsNil(o.Account) {
		var ret GetIdentitySources200ResponseUserSourceAnyOf2Account
		return ret
	}
	return *o.Account
}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
// SetAccount gets a reference to the given GetIdentitySources200ResponseUserSourceAnyOf2Account and assigns it to the Account field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) GetDefaultAccountRole() GetIdentitySources200ResponseUserSourceAnyOf2DefaultAccountRole {
	if o == nil || IsNil(o.DefaultAccountRole) {
		var ret GetIdentitySources200ResponseUserSourceAnyOf2DefaultAccountRole
		return ret
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetDefaultAccountRole() bool {
	if o != nil && !IsNil(o.DefaultAccountRole) {
		return true
	}
...
// SetDefaultAccountRole gets a reference to the given GetIdentitySources200ResponseUserSourceAnyOf2DefaultAccountRole and assigns it to the DefaultAccountRole field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) GetConfig() GetIdentitySources200ResponseUserSourceAnyOf2Config {
	if o == nil || IsNil(o.Config) {
		var ret GetIdentitySources200ResponseUserSourceAnyOf2Config
		return ret
	}
	return *o.Config
}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given GetIdentitySources200ResponseUserSourceAnyOf2Config and assigns it to the Config field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) GetRoleMappings() []GetIdentitySources200ResponseUserSourceAnyOf2RoleMappingsInner {
	if o == nil || IsNil(o.RoleMappings) {
		var ret []GetIdentitySources200ResponseUserSourceAnyOf2RoleMappingsInner
		return ret
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetRoleMappings() bool {
	if o != nil && !IsNil(o.RoleMappings) {
		return true
	}
...
// SetRoleMappings gets a reference to the given []GetIdentitySources200ResponseUserSourceAnyOf2RoleMappingsInner and assigns it to the RoleMappings field.
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetSubdomain() bool {
	if o != nil && !IsNil(o.Subdomain) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetLoginURL() bool {
	if o != nil && !IsNil(o.LoginURL) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetProviderSettings() bool {
	if o != nil && !IsNil(o.ProviderSettings) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o GetIdentitySources200ResponseUserSourceAnyOf2) MarshalJSON() ([]byte, error) {
...
func (o GetIdentitySources200ResponseUserSourceAnyOf2) ToMap() (map[string]interface{}, error) {
...
type NullableGetIdentitySources200ResponseUserSourceAnyOf2 struct {
	value *GetIdentitySources200ResponseUserSourceAnyOf2
	isSet bool
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf2) Get() *GetIdentitySources200ResponseUserSourceAnyOf2 {
	return v.value
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf2) Set(val *GetIdentitySources200ResponseUserSourceAnyOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIdentitySources200ResponseUserSourceAnyOf2(val *GetIdentitySources200ResponseUserSourceAnyOf2) *NullableGetIdentitySources200ResponseUserSourceAnyOf2 {
	return &NullableGetIdentitySources200ResponseUserSourceAnyOf2{value: val, isSet: true}
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf2) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf2) UnmarshalJSON(data []byte) (err error) {
