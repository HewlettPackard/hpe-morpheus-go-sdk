...
// checks if the ShutdownPolicyTypeConfiguration10 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShutdownPolicyTypeConfiguration10{}

// ShutdownPolicyTypeConfiguration10 - Shutdown
type ShutdownPolicyTypeConfiguration10 struct {
...
type _ShutdownPolicyTypeConfiguration10 ShutdownPolicyTypeConfiguration10
...
func NewShutdownPolicyTypeConfiguration10(shutdownType string) *ShutdownPolicyTypeConfiguration10 {
	this := ShutdownPolicyTypeConfiguration10{}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration10) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration10) MarshalJSON() ([]byte, error) {
...
func (o ShutdownPolicyTypeConfiguration10) ToMap() (map[string]interface{}, error) {
...
type NullableShutdownPolicyTypeConfiguration10 struct {
	value *ShutdownPolicyTypeConfiguration10
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration10) Get() *ShutdownPolicyTypeConfiguration10 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration10) Set(val *ShutdownPolicyTypeConfiguration10) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration10) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration10) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration10(val *ShutdownPolicyTypeConfiguration10) *NullableShutdownPolicyTypeConfiguration10 {
	return &NullableShutdownPolicyTypeConfiguration10{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration10) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration10) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration10) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ShutdownPolicyTypeConfiguration10) UnmarshalJSON(data []byte) (err error) {
