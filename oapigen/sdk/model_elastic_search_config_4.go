...
func NewElasticSearchConfig4(esHost string, esPort string) *ElasticSearchConfig4 {
	this := ElasticSearchConfig4{}
	this.EsHost = esHost
	this.EsPort = esPort
	return &this
}

// NewElasticSearchConfig4WithDefaults instantiates a new ElasticSearchConfig4 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewElasticSearchConfig4WithDefaults() *ElasticSearchConfig4 {
	this := ElasticSearchConfig4{}
	return &this
}
...
func (o *ElasticSearchConfig4) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *ElasticSearchConfig4) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *ElasticSearchConfig4) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *ElasticSearchConfig4) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *ElasticSearchConfig4) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
