...
// checks if the ShutdownPolicyTypeConfiguration5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShutdownPolicyTypeConfiguration5{}

// ShutdownPolicyTypeConfiguration5 - Shutdown
type ShutdownPolicyTypeConfiguration5 struct {
...
type _ShutdownPolicyTypeConfiguration5 ShutdownPolicyTypeConfiguration5
...
func NewShutdownPolicyTypeConfiguration5(shutdownType string) *ShutdownPolicyTypeConfiguration5 {
	this := ShutdownPolicyTypeConfiguration5{}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration5) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration5) MarshalJSON() ([]byte, error) {
...
func (o ShutdownPolicyTypeConfiguration5) ToMap() (map[string]interface{}, error) {
...
type NullableShutdownPolicyTypeConfiguration5 struct {
	value *ShutdownPolicyTypeConfiguration5
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration5) Get() *ShutdownPolicyTypeConfiguration5 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration5) Set(val *ShutdownPolicyTypeConfiguration5) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration5) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration5(val *ShutdownPolicyTypeConfiguration5) *NullableShutdownPolicyTypeConfiguration5 {
	return &NullableShutdownPolicyTypeConfiguration5{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration5) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration5) UnmarshalMapstructure(data any) (any, error) {
