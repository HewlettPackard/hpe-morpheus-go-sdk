...
// checks if the IdentitySourcesAzureADConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentitySourcesAzureADConfig{}
...
func (o *IdentitySourcesAzureADConfig) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetDeleted() bool {
	if o != nil && !IsNil(o.Deleted) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetAutoSyncOnLogin() bool {
	if o != nil && !IsNil(o.AutoSyncOnLogin) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetExternalLogin() bool {
	if o != nil && !IsNil(o.ExternalLogin) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetAllowCustomMappings() bool {
	if o != nil && !IsNil(o.AllowCustomMappings) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetManualRoleAssignment() bool {
	if o != nil && !IsNil(o.ManualRoleAssignment) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetDefaultAccountRole() bool {
	if o != nil && !IsNil(o.DefaultAccountRole) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetRoleMappings() bool {
	if o != nil && !IsNil(o.RoleMappings) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetSubdomain() bool {
	if o != nil && !IsNil(o.Subdomain) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetLoginURL() bool {
	if o != nil && !IsNil(o.LoginURL) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetProviderSettings() bool {
	if o != nil && !IsNil(o.ProviderSettings) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *IdentitySourcesAzureADConfig) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o IdentitySourcesAzureADConfig) ToMap() (map[string]interface{}, error) {
...
func (v NullableIdentitySourcesAzureADConfig) UnmarshalMapstructure(data any) (any, error) {
