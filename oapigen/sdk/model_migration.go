...
func (o *Migration) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *Migration) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *Migration) IsSetStatusMessage() bool {
...
func (o *Migration) SetStatusMessageNil() {
...
func (o *Migration) IsSetSkippedPrechecks() bool {
	if o != nil && !IsNil(o.SkippedPrechecks) {
		return true
	}
...
func (o *Migration) IsSetInstallGuestTools() bool {
	if o != nil && !IsNil(o.InstallGuestTools) {
		return true
	}
...
func (o *Migration) IsSetReInitializeServerOnMigration() bool {
	if o != nil && !IsNil(o.ReInitializeServerOnMigration) {
		return true
	}
...
func (o *Migration) IsSetLinuxUsername() bool {
...
func (o *Migration) SetLinuxUsernameNil() {
...
func (o *Migration) IsSetLinuxPassword() bool {
...
func (o *Migration) SetLinuxPasswordNil() {
...
func (o *Migration) IsSetLinuxKeyPair() bool {
	if o != nil && !IsNil(o.LinuxKeyPair) {
		return true
	}
...
func (o *Migration) IsSetWindowsUsername() bool {
...
func (o *Migration) SetWindowsUsernameNil() {
...
func (o *Migration) IsSetWindowsPassword() bool {
...
func (o *Migration) SetWindowsPasswordNil() {
...
func (o *Migration) IsSetSourceCloud() bool {
	if o != nil && !IsNil(o.SourceCloud) {
		return true
	}
...
func (o *Migration) IsSetTargetCloud() bool {
	if o != nil && !IsNil(o.TargetCloud) {
		return true
	}
...
func (o *Migration) IsSetTargetGroup() bool {
	if o != nil && !IsNil(o.TargetGroup) {
		return true
	}
...
func (o *Migration) IsSetTargetPool() bool {
	if o != nil && !IsNil(o.TargetPool) {
		return true
	}
...
func (o *Migration) IsSetServers() bool {
	if o != nil && !IsNil(o.Servers) {
		return true
	}
