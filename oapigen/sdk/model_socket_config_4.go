...
// checks if the SocketConfig4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocketConfig4{}

// SocketConfig4 struct for SocketConfig4
type SocketConfig4 struct {
...
func (o *SocketConfig4) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SocketConfig4) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SocketConfig4) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SocketConfig4) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SocketConfig4) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o SocketConfig4) ToMap() (map[string]interface{}, error) {
...
type NullableSocketConfig4 struct {
	value *SocketConfig4
	isSet bool
}

func (v NullableSocketConfig4) Get() *SocketConfig4 {
	return v.value
}

func (v *NullableSocketConfig4) Set(val *SocketConfig4) {
	v.value = val
	v.isSet = true
}

func (v NullableSocketConfig4) IsSet() bool {
	return v.isSet
}

func (v *NullableSocketConfig4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocketConfig4(val *SocketConfig4) *NullableSocketConfig4 {
	return &NullableSocketConfig4{value: val, isSet: true}
}

func (v NullableSocketConfig4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocketConfig4) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSocketConfig4) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SocketConfig4) UnmarshalJSON(data []byte) (err error) {
