...
// checks if the AzureInstanceConfiguration8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureInstanceConfiguration8{}

// AzureInstanceConfiguration8 struct for AzureInstanceConfiguration8
type AzureInstanceConfiguration8 struct {
...
type _AzureInstanceConfiguration8 AzureInstanceConfiguration8

func (o AzureInstanceConfiguration8) MarshalJSON() ([]byte, error) {
...
func (o AzureInstanceConfiguration8) ToMap() (map[string]interface{}, error) {
...
type NullableAzureInstanceConfiguration8 struct {
	value *AzureInstanceConfiguration8
	isSet bool
}

func (v NullableAzureInstanceConfiguration8) Get() *AzureInstanceConfiguration8 {
	return v.value
}

func (v *NullableAzureInstanceConfiguration8) Set(val *AzureInstanceConfiguration8) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureInstanceConfiguration8) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureInstanceConfiguration8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureInstanceConfiguration8(val *AzureInstanceConfiguration8) *NullableAzureInstanceConfiguration8 {
	return &NullableAzureInstanceConfiguration8{value: val, isSet: true}
}

func (v NullableAzureInstanceConfiguration8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureInstanceConfiguration8) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAzureInstanceConfiguration8) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AzureInstanceConfiguration8) UnmarshalJSON(data []byte) (err error) {
