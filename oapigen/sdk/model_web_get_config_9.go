...
func (o *WebGetConfig9) IsSetIgnoreSSL() bool {
	if o != nil && !IsNil(o.IgnoreSSL) {
		return true
	}
...
func (o *WebGetConfig9) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *WebGetConfig9) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *WebGetConfig9) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *WebGetConfig9) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
