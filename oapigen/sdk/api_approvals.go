...
func (r ApiUpdateApprovalsItemRequest) Execute() (*UpdateApprovalsItem200Response, *http.Response, error) {
...
func (a *ApprovalsAPIService) UpdateApprovalsItemExecute(r ApiUpdateApprovalsItemRequest) (*UpdateApprovalsItem200Response, *http.Response, error) {
	var (
