...
func (r ApiRefreshIntegrationsRequest) Execute() (*RefreshIntegrations200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return RefreshIntegrations200Response
func (a *IntegrationsAPIService) RefreshIntegrationsExecute(r ApiRefreshIntegrationsRequest) (*RefreshIntegrations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RefreshIntegrations200Response
	)
...
func (r ApiRemoveIntegrationObjectsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *IntegrationsAPIService) RemoveIntegrationObjectsExecute(r ApiRemoveIntegrationObjectsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiRemoveIntegrationsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
//
//	@return RemoveExecuteSchedules200Response
func (a *IntegrationsAPIService) RemoveIntegrationsExecute(r ApiRemoveIntegrationsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateIntegrationsRequest) UpdateIntegrationsRequest(updateIntegrationsRequest UpdateIntegrationsRequest) ApiUpdateIntegrationsRequest {
	r.updateIntegrationsRequest = &updateIntegrationsRequest
	return r
}

func (r ApiUpdateIntegrationsRequest) Execute() (*UpdateIntegrations200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateIntegrations200Response
func (a *IntegrationsAPIService) UpdateIntegrationsExecute(r ApiUpdateIntegrationsRequest) (*UpdateIntegrations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateIntegrations200Response
	)
	...
	// body params
	localVarPostBody = r.updateIntegrationsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
