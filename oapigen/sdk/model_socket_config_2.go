...
// checks if the SocketConfig2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocketConfig2{}

// SocketConfig2 struct for SocketConfig2
type SocketConfig2 struct {
...
type _SocketConfig2 SocketConfig2
...
func (o *SocketConfig2) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SocketConfig2) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SocketConfig2) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SocketConfig2) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SocketConfig2) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o SocketConfig2) MarshalJSON() ([]byte, error) {
...
func (o SocketConfig2) ToMap() (map[string]interface{}, error) {
...
type NullableSocketConfig2 struct {
	value *SocketConfig2
	isSet bool
}

func (v NullableSocketConfig2) Get() *SocketConfig2 {
	return v.value
}

func (v *NullableSocketConfig2) Set(val *SocketConfig2) {
	v.value = val
	v.isSet = true
}

func (v NullableSocketConfig2) IsSet() bool {
	return v.isSet
}

func (v *NullableSocketConfig2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocketConfig2(val *SocketConfig2) *NullableSocketConfig2 {
	return &NullableSocketConfig2{value: val, isSet: true}
}

func (v NullableSocketConfig2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocketConfig2) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSocketConfig2) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SocketConfig2) UnmarshalJSON(data []byte) (err error) {
