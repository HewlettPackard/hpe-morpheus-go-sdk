...
// checks if the AddPoliciesCloud200ResponseAllOfPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddPoliciesCloud200ResponseAllOfPolicy{}

// AddPoliciesCloud200ResponseAllOfPolicy struct for AddPoliciesCloud200ResponseAllOfPolicy
type AddPoliciesCloud200ResponseAllOfPolicy struct {
	Id                   *int64                                                   `json:"id,omitempty"`
	Name                 *string                                                  `json:"name,omitempty"`
	Description          NullableString                                           `json:"description,omitempty"`
	PolicyType           *AddPoliciesCloud200ResponseAllOfPolicyPolicyType        `json:"policyType,omitempty"`
	Zone                 *AddPoliciesCloud200ResponseAllOfPolicyZone              `json:"zone,omitempty"`
	Site                 *AddPoliciesCloud200ResponseAllOfPolicySite              `json:"site,omitempty"`
	User                 *AddPoliciesCloud200ResponseAllOfPolicyUser              `json:"user,omitempty"`
	Role                 *AddPoliciesCloud200ResponseAllOfPolicyRole              `json:"role,omitempty"`
	...
	Config               *AddPoliciesCloud200ResponseAllOfPolicyConfig            `json:"config,omitempty"`
	Enabled              *bool                                                    `json:"enabled,omitempty"`
	Owner                NullableAddPoliciesCloud200ResponseAllOfPolicyOwner      `json:"owner,omitempty"`
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetDescription() bool {
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) SetDescriptionNil() {
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) GetPolicyType() AddPoliciesCloud200ResponseAllOfPolicyPolicyType {
	if o == nil || IsNil(o.PolicyType) {
		var ret AddPoliciesCloud200ResponseAllOfPolicyPolicyType
		return ret
	}
	return *o.PolicyType
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetPolicyType() bool {
	if o != nil && !IsNil(o.PolicyType) {
		return true
	}
...
// SetPolicyType gets a reference to the given AddPoliciesCloud200ResponseAllOfPolicyPolicyType and assigns it to the PolicyType field.
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) GetZone() AddPoliciesCloud200ResponseAllOfPolicyZone {
	if o == nil || IsNil(o.Zone) {
		var ret AddPoliciesCloud200ResponseAllOfPolicyZone
		return ret
	}
	return *o.Zone
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetZone() bool {
	if o != nil && !IsNil(o.Zone) {
		return true
	}
...
// SetZone gets a reference to the given AddPoliciesCloud200ResponseAllOfPolicyZone and assigns it to the Zone field.
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) GetSite() AddPoliciesCloud200ResponseAllOfPolicySite {
	if o == nil || IsNil(o.Site) {
		var ret AddPoliciesCloud200ResponseAllOfPolicySite
		return ret
	}
	return *o.Site
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetSite() bool {
	if o != nil && !IsNil(o.Site) {
		return true
	}
...
// SetSite gets a reference to the given AddPoliciesCloud200ResponseAllOfPolicySite and assigns it to the Site field.
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) GetUser() AddPoliciesCloud200ResponseAllOfPolicyUser {
	if o == nil || IsNil(o.User) {
		var ret AddPoliciesCloud200ResponseAllOfPolicyUser
		return ret
	}
	return *o.User
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetUser() bool {
	if o != nil && !IsNil(o.User) {
		return true
	}
...
// SetUser gets a reference to the given AddPoliciesCloud200ResponseAllOfPolicyUser and assigns it to the User field.
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) GetRole() AddPoliciesCloud200ResponseAllOfPolicyRole {
	if o == nil || IsNil(o.Role) {
		var ret AddPoliciesCloud200ResponseAllOfPolicyRole
		return ret
	}
	return *o.Role
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetRole() bool {
	if o != nil && !IsNil(o.Role) {
		return true
	}
...
// SetRole gets a reference to the given AddPoliciesCloud200ResponseAllOfPolicyRole and assigns it to the Role field.
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetRefType() bool {
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) SetRefTypeNil() {
	o.RefType.Set(nil)
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetRefId() bool {
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) SetRefIdNil() {
	o.RefId.Set(nil)
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetEachUser() bool {
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) SetEachUserNil() {
	o.EachUser.Set(nil)
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) GetConfig() AddPoliciesCloud200ResponseAllOfPolicyConfig {
	if o == nil || IsNil(o.Config) {
		var ret AddPoliciesCloud200ResponseAllOfPolicyConfig
		return ret
	}
	return *o.Config
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given AddPoliciesCloud200ResponseAllOfPolicyConfig and assigns it to the Config field.
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) GetOwner() AddPoliciesCloud200ResponseAllOfPolicyOwner {
	if o == nil || IsNil(o.Owner.Get()) {
		var ret AddPoliciesCloud200ResponseAllOfPolicyOwner
		return ret
	}
	return *o.Owner.Get()
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetOwner() bool {
...
// SetOwner gets a reference to the given NullableAddPoliciesCloud200ResponseAllOfPolicyOwner and assigns it to the Owner field.
func (o *AddPoliciesCloud200ResponseAllOfPolicy) SetOwner(v AddPoliciesCloud200ResponseAllOfPolicyOwner) {
	o.Owner.Set(&v)
}

// SetOwnerNil sets the value for Owner to be an explicit nil
func (o *AddPoliciesCloud200ResponseAllOfPolicy) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) IsSetAccounts() bool {
	if o != nil && !IsNil(o.Accounts) {
		return true
	}
...
func (o AddPoliciesCloud200ResponseAllOfPolicy) ToMap() (map[string]interface{}, error) {
...
type NullableAddPoliciesCloud200ResponseAllOfPolicy struct {
	value *AddPoliciesCloud200ResponseAllOfPolicy
	isSet bool
}

func (v NullableAddPoliciesCloud200ResponseAllOfPolicy) Get() *AddPoliciesCloud200ResponseAllOfPolicy {
	return v.value
}

func (v *NullableAddPoliciesCloud200ResponseAllOfPolicy) Set(val *AddPoliciesCloud200ResponseAllOfPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableAddPoliciesCloud200ResponseAllOfPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableAddPoliciesCloud200ResponseAllOfPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddPoliciesCloud200ResponseAllOfPolicy(val *AddPoliciesCloud200ResponseAllOfPolicy) *NullableAddPoliciesCloud200ResponseAllOfPolicy {
	return &NullableAddPoliciesCloud200ResponseAllOfPolicy{value: val, isSet: true}
}

func (v NullableAddPoliciesCloud200ResponseAllOfPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddPoliciesCloud200ResponseAllOfPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddPoliciesCloud200ResponseAllOfPolicy) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddPoliciesCloud200ResponseAllOfPolicy) UnmarshalJSON(data []byte) (err error) {
