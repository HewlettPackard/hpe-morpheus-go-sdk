...
// checks if the GetIntegrationTypes200ResponseIntegrationType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIntegrationTypes200ResponseIntegrationType{}

// GetIntegrationTypes200ResponseIntegrationType struct for GetIntegrationTypes200ResponseIntegrationType
type GetIntegrationTypes200ResponseIntegrationType struct {
...
type _GetIntegrationTypes200ResponseIntegrationType GetIntegrationTypes200ResponseIntegrationType
...
func NewGetIntegrationTypes200ResponseIntegrationType() *GetIntegrationTypes200ResponseIntegrationType {
	this := GetIntegrationTypes200ResponseIntegrationType{}
	return &this
}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetDescription() bool {
...
func (o *GetIntegrationTypes200ResponseIntegrationType) SetDescriptionNil() {
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetCreatable() bool {
	if o != nil && !IsNil(o.Creatable) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetHasCMDB() bool {
	if o != nil && !IsNil(o.HasCMDB) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetHasCMDBDiscovery() bool {
	if o != nil && !IsNil(o.HasCMDBDiscovery) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetHasCM() bool {
	if o != nil && !IsNil(o.HasCM) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetHasDNS() bool {
	if o != nil && !IsNil(o.HasDNS) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetHasApprovals() bool {
	if o != nil && !IsNil(o.HasApprovals) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetHasDeleteApprovals() bool {
	if o != nil && !IsNil(o.HasDeleteApprovals) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetHasReconfigureApprovals() bool {
	if o != nil && !IsNil(o.HasReconfigureApprovals) {
		return true
	}
...
func (o *GetIntegrationTypes200ResponseIntegrationType) IsSetIsPlugin() bool {
	if o != nil && !IsNil(o.IsPlugin) {
		return true
	}
...
func (o GetIntegrationTypes200ResponseIntegrationType) MarshalJSON() ([]byte, error) {
...
func (o GetIntegrationTypes200ResponseIntegrationType) ToMap() (map[string]interface{}, error) {
...
type NullableGetIntegrationTypes200ResponseIntegrationType struct {
	value *GetIntegrationTypes200ResponseIntegrationType
	isSet bool
}

func (v NullableGetIntegrationTypes200ResponseIntegrationType) Get() *GetIntegrationTypes200ResponseIntegrationType {
	return v.value
}

func (v *NullableGetIntegrationTypes200ResponseIntegrationType) Set(val *GetIntegrationTypes200ResponseIntegrationType) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIntegrationTypes200ResponseIntegrationType) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIntegrationTypes200ResponseIntegrationType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIntegrationTypes200ResponseIntegrationType(val *GetIntegrationTypes200ResponseIntegrationType) *NullableGetIntegrationTypes200ResponseIntegrationType {
	return &NullableGetIntegrationTypes200ResponseIntegrationType{value: val, isSet: true}
}

func (v NullableGetIntegrationTypes200ResponseIntegrationType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIntegrationTypes200ResponseIntegrationType) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetIntegrationTypes200ResponseIntegrationType) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetIntegrationTypes200ResponseIntegrationType) UnmarshalJSON(data []byte) (err error) {
