...
// checks if the AmazonInstanceConfiguration3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AmazonInstanceConfiguration3{}

// AmazonInstanceConfiguration3 struct for AmazonInstanceConfiguration3
...
type _AmazonInstanceConfiguration3 AmazonInstanceConfiguration3
...
func (o *AmazonInstanceConfiguration3) IsSetNoAgent() bool {
...
func (o *AmazonInstanceConfiguration3) SetNoAgentNil() {
	o.NoAgent.Set(nil)
}
...
func (o *AmazonInstanceConfiguration3) IsSetIsEC2() bool {
	if o != nil && !IsNil(o.IsEC2) {
		return true
	}
...
func (o *AmazonInstanceConfiguration3) IsSetAvailabilityId() bool {
	if o != nil && !IsNil(o.AvailabilityId) {
		return true
	}
...
func (o *AmazonInstanceConfiguration3) IsSetSecurityId() bool {
	if o != nil && !IsNil(o.SecurityId) {
		return true
	}
...
func (o *AmazonInstanceConfiguration3) IsSetPublicIpType() bool {
	if o != nil && !IsNil(o.PublicIpType) {
		return true
	}
...
func (o *AmazonInstanceConfiguration3) IsSetInstanceProfile() bool {
	if o != nil && !IsNil(o.InstanceProfile) {
		return true
	}
...
func (o *AmazonInstanceConfiguration3) IsSetKmsKeyId() bool {
	if o != nil && !IsNil(o.KmsKeyId) {
		return true
	}
...
func (o AmazonInstanceConfiguration3) ToMap() (map[string]interface{}, error) {
...
type NullableAmazonInstanceConfiguration3 struct {
	value *AmazonInstanceConfiguration3
	isSet bool
}

func (v NullableAmazonInstanceConfiguration3) Get() *AmazonInstanceConfiguration3 {
	return v.value
}

func (v *NullableAmazonInstanceConfiguration3) Set(val *AmazonInstanceConfiguration3) {
	v.value = val
	v.isSet = true
}

func (v NullableAmazonInstanceConfiguration3) IsSet() bool {
	return v.isSet
}

func (v *NullableAmazonInstanceConfiguration3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAmazonInstanceConfiguration3(val *AmazonInstanceConfiguration3) *NullableAmazonInstanceConfiguration3 {
	return &NullableAmazonInstanceConfiguration3{value: val, isSet: true}
}

func (v NullableAmazonInstanceConfiguration3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAmazonInstanceConfiguration3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAmazonInstanceConfiguration3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AmazonInstanceConfiguration3) UnmarshalJSON(data []byte) (err error) {
