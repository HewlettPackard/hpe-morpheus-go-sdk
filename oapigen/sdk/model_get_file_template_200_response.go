...
type GetFileTemplate200Response struct {
	ContainerTemplate    *GetFileTemplate200ResponseContainerTemplate `json:"containerTemplate,omitempty"`
...
func (v NullableGetFileTemplate200Response) UnmarshalMapstructure(data any) (any, error) {
