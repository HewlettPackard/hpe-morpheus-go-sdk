...
func (r ApiRemoveIdentitySourcesRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *IdentitySourcesAPIService) RemoveIdentitySourcesExecute(r ApiRemoveIdentitySourcesRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiUpdateIdentitySourcesRequest) UpdateIdentitySourcesRequest(updateIdentitySourcesRequest UpdateIdentitySourcesRequest) ApiUpdateIdentitySourcesRequest {
	r.updateIdentitySourcesRequest = &updateIdentitySourcesRequest
	return r
}

func (r ApiUpdateIdentitySourcesRequest) Execute() (*UpdateIdentitySources200Response, *http.Response, error) {
...
func (a *IdentitySourcesAPIService) UpdateIdentitySourcesExecute(r ApiUpdateIdentitySourcesRequest) (*UpdateIdentitySources200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
