...
func (o *GuidanceVmwareSizingPlanBeforeActionProvisionType) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GuidanceVmwareSizingPlanBeforeActionProvisionType) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GuidanceVmwareSizingPlanBeforeActionProvisionType) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GuidanceVmwareSizingPlanBeforeActionProvisionType) IsSetRootDiskCustomizable() bool {
	if o != nil && !IsNil(o.RootDiskCustomizable) {
		return true
	}
...
func (o *GuidanceVmwareSizingPlanBeforeActionProvisionType) IsSetAddVolumes() bool {
	if o != nil && !IsNil(o.AddVolumes) {
		return true
	}
...
func (o *GuidanceVmwareSizingPlanBeforeActionProvisionType) IsSetCustomizeVolume() bool {
	if o != nil && !IsNil(o.CustomizeVolume) {
		return true
	}
...
func (o *GuidanceVmwareSizingPlanBeforeActionProvisionType) IsSetHasConfigurableCpuSockets() bool {
	if o != nil && !IsNil(o.HasConfigurableCpuSockets) {
		return true
	}
