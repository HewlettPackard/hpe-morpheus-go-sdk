...
// checks if the AddClusterRequestClusterServerConfigAnyOfOneOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddClusterRequestClusterServerConfigAnyOfOneOf3{}

// AddClusterRequestClusterServerConfigAnyOfOneOf3 Configuration for Google Kuberenetes Engine cluster servers
type AddClusterRequestClusterServerConfigAnyOfOneOf3 struct {
	GoogleZoneId        *int64                                                 `json:"googleZoneId,omitempty"`
	Worker              *AddClusterRequestClusterServerConfigAnyOfOneOf3Worker `json:"worker,omitempty"`
...
type _AddClusterRequestClusterServerConfigAnyOfOneOf3 AddClusterRequestClusterServerConfigAnyOfOneOf3
...
func NewAddClusterRequestClusterServerConfigAnyOfOneOf3() *AddClusterRequestClusterServerConfigAnyOfOneOf3 {
	this := AddClusterRequestClusterServerConfigAnyOfOneOf3{}
	return &this
}
...
func (o *AddClusterRequestClusterServerConfigAnyOfOneOf3) GetWorker() AddClusterRequestClusterServerConfigAnyOfOneOf3Worker {
	if o == nil || IsNil(o.Worker) {
		var ret AddClusterRequestClusterServerConfigAnyOfOneOf3Worker
		return ret
	}
	return *o.Worker
}
...
func (o AddClusterRequestClusterServerConfigAnyOfOneOf3) MarshalJSON() ([]byte, error) {
...
func (o AddClusterRequestClusterServerConfigAnyOfOneOf3) ToMap() (map[string]interface{}, error) {
...
type NullableAddClusterRequestClusterServerConfigAnyOfOneOf3 struct {
	value *AddClusterRequestClusterServerConfigAnyOfOneOf3
	isSet bool
}

func (v NullableAddClusterRequestClusterServerConfigAnyOfOneOf3) Get() *AddClusterRequestClusterServerConfigAnyOfOneOf3 {
	return v.value
}

func (v *NullableAddClusterRequestClusterServerConfigAnyOfOneOf3) Set(val *AddClusterRequestClusterServerConfigAnyOfOneOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableAddClusterRequestClusterServerConfigAnyOfOneOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableAddClusterRequestClusterServerConfigAnyOfOneOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddClusterRequestClusterServerConfigAnyOfOneOf3(val *AddClusterRequestClusterServerConfigAnyOfOneOf3) *NullableAddClusterRequestClusterServerConfigAnyOfOneOf3 {
	return &NullableAddClusterRequestClusterServerConfigAnyOfOneOf3{value: val, isSet: true}
}

func (v NullableAddClusterRequestClusterServerConfigAnyOfOneOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddClusterRequestClusterServerConfigAnyOfOneOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddClusterRequestClusterServerConfigAnyOfOneOf3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddClusterRequestClusterServerConfigAnyOfOneOf3) UnmarshalJSON(data []byte) (err error) {
