...
// checks if the ClusterServerCreateConfigAnyOfOneOf5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterServerCreateConfigAnyOfOneOf5{}

// ClusterServerCreateConfigAnyOfOneOf5 Configuration for HKS cluster provisioning on a HVM cluster.
type ClusterServerCreateConfigAnyOfOneOf5 struct {
...
type _ClusterServerCreateConfigAnyOfOneOf5 ClusterServerCreateConfigAnyOfOneOf5
...
func NewClusterServerCreateConfigAnyOfOneOf5() *ClusterServerCreateConfigAnyOfOneOf5 {
	this := ClusterServerCreateConfigAnyOfOneOf5{}
	return &this
}
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) IsSetPodCidr() bool {
	if o != nil && !IsNil(o.PodCidr) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) IsSetServiceCidr() bool {
	if o != nil && !IsNil(o.ServiceCidr) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) IsSetNodeCount() bool {
	if o != nil && !IsNil(o.NodeCount) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) IsSetCreateUser() bool {
	if o != nil && !IsNil(o.CreateUser) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) IsSetDefaultRepoAccount() bool {
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) SetDefaultRepoAccountNil() {
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) IsSetImageServer() bool {
	if o != nil && !IsNil(o.ImageServer) {
		return true
	}
...
func (o ClusterServerCreateConfigAnyOfOneOf5) MarshalJSON() ([]byte, error) {
...
func (o ClusterServerCreateConfigAnyOfOneOf5) ToMap() (map[string]interface{}, error) {
...
type NullableClusterServerCreateConfigAnyOfOneOf5 struct {
	value *ClusterServerCreateConfigAnyOfOneOf5
	isSet bool
}

func (v NullableClusterServerCreateConfigAnyOfOneOf5) Get() *ClusterServerCreateConfigAnyOfOneOf5 {
	return v.value
}

func (v *NullableClusterServerCreateConfigAnyOfOneOf5) Set(val *ClusterServerCreateConfigAnyOfOneOf5) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterServerCreateConfigAnyOfOneOf5) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterServerCreateConfigAnyOfOneOf5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterServerCreateConfigAnyOfOneOf5(val *ClusterServerCreateConfigAnyOfOneOf5) *NullableClusterServerCreateConfigAnyOfOneOf5 {
	return &NullableClusterServerCreateConfigAnyOfOneOf5{value: val, isSet: true}
}

func (v NullableClusterServerCreateConfigAnyOfOneOf5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterServerCreateConfigAnyOfOneOf5) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableClusterServerCreateConfigAnyOfOneOf5) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ClusterServerCreateConfigAnyOfOneOf5) UnmarshalJSON(data []byte) (err error) {
