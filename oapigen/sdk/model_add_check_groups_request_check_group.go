...
var _ MappedNullable = &AddCheckGroupsRequestCheckGroup{}

// AddCheckGroupsRequestCheckGroup Payload for creating a new monitoring check group
type AddCheckGroupsRequestCheckGroup struct {
...
func NewAddCheckGroupsRequestCheckGroup(name string) *AddCheckGroupsRequestCheckGroup {
	this := AddCheckGroupsRequestCheckGroup{}
	this.Name = name
...
func (o *AddCheckGroupsRequestCheckGroup) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *AddCheckGroupsRequestCheckGroup) IsSetMinHappy() bool {
	if o != nil && !IsNil(o.MinHappy) {
		return true
	}
...
func (o *AddCheckGroupsRequestCheckGroup) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *AddCheckGroupsRequestCheckGroup) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *AddCheckGroupsRequestCheckGroup) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *AddCheckGroupsRequestCheckGroup) IsSetChecks() bool {
	if o != nil && !IsNil(o.Checks) {
		return true
	}
...
func (o AddCheckGroupsRequestCheckGroup) MarshalJSON() ([]byte, error) {
...
func (o AddCheckGroupsRequestCheckGroup) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddCheckGroupsRequestCheckGroup) UnmarshalMapstructure(data any) (any, error) {
