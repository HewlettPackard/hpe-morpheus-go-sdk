...
// checks if the ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3{}

// ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 struct for ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3
type ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 struct {
	Id                   *int64                                                                  `json:"id,omitempty"`
	Name                 *string                                                                 `json:"name,omitempty"`
	Enabled              *bool                                                                   `json:"enabled,omitempty"`
	Type                 *string                                                                 `json:"type,omitempty"`
	IntegrationType      *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3IntegrationType `json:"integrationType,omitempty"`
	...
	Credential           *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3Credential      `json:"credential,omitempty"`
	AdditionalProperties map[string]interface{}                                                  `json:",remain"`
}

type _ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3
...
func NewListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3() *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 {
	this := ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3{}
	return &this
}
...
func (o *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) GetIntegrationType() ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3IntegrationType {
	if o == nil || IsNil(o.IntegrationType) {
		var ret ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3IntegrationType
		return ret
	}
...
func (o *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) GetCredential() ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3Credential {
	if o == nil || IsNil(o.Credential) {
		var ret ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3Credential
		return ret
	}
	return *o.Credential
}
...
func (o ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) MarshalJSON() ([]byte, error) {
...
func (o ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) ToMap() (map[string]interface{}, error) {
...
type NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 struct {
	value *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3
	isSet bool
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) Get() *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 {
	return v.value
}

func (v *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) Set(val *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3(val *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3 {
	return &NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3{value: val, isSet: true}
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3) UnmarshalJSON(data []byte) (err error) {
