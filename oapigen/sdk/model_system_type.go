...
func (o *SystemType) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *SystemType) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *SystemType) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (v NullableSystemType) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SystemType) UnmarshalJSON(data []byte) (err error) {
