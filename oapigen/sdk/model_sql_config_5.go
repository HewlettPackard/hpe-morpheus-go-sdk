...
// checks if the SQLConfig5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SQLConfig5{}

// SQLConfig5 struct for SQLConfig5
type SQLConfig5 struct {
...
func (o *SQLConfig5) IsSetDbPasswordHash() bool {
	if o != nil && !IsNil(o.DbPasswordHash) {
		return true
	}
...
func (o *SQLConfig5) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SQLConfig5) IsSetCheckResult() bool {
	if o != nil && !IsNil(o.CheckResult) {
		return true
	}
...
func (o *SQLConfig5) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SQLConfig5) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SQLConfig5) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SQLConfig5) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SQLConfig5) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o SQLConfig5) MarshalJSON() ([]byte, error) {
...
func (o SQLConfig5) ToMap() (map[string]interface{}, error) {
...
type NullableSQLConfig5 struct {
	value *SQLConfig5
	isSet bool
}

func (v NullableSQLConfig5) Get() *SQLConfig5 {
	return v.value
}

func (v *NullableSQLConfig5) Set(val *SQLConfig5) {
	v.value = val
	v.isSet = true
}

func (v NullableSQLConfig5) IsSet() bool {
	return v.isSet
}

func (v *NullableSQLConfig5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSQLConfig5(val *SQLConfig5) *NullableSQLConfig5 {
	return &NullableSQLConfig5{value: val, isSet: true}
}

func (v NullableSQLConfig5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSQLConfig5) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSQLConfig5) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SQLConfig5) UnmarshalJSON(data []byte) (err error) {
