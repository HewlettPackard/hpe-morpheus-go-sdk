...
// checks if the IntegrationMicrosoftDNS type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationMicrosoftDNS{}
...
type _IntegrationMicrosoftDNS IntegrationMicrosoftDNS
...
func (o *IntegrationMicrosoftDNS) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetIntegrationType() bool {
	if o != nil && !IsNil(o.IntegrationType) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetServiceFlag() bool {
	if o != nil && !IsNil(o.ServiceFlag) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetIsPlugin() bool {
	if o != nil && !IsNil(o.IsPlugin) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetStatusDate() bool {
	if o != nil && !IsNil(o.StatusDate) {
		return true
	}
...
func (o *IntegrationMicrosoftDNS) IsSetStatusMessage() bool {
...
func (o *IntegrationMicrosoftDNS) IsSetLastSync() bool {
...
func (o *IntegrationMicrosoftDNS) IsSetLastSyncDuration() bool {
...
func (o *IntegrationMicrosoftDNS) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o IntegrationMicrosoftDNS) ToMap() (map[string]interface{}, error) {
...
func (v NullableIntegrationMicrosoftDNS) UnmarshalMapstructure(data any) (any, error) {
