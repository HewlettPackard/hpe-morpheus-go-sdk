...
func (o *SqlCheck1) IsSetDescription() bool {
...
func (o *SqlCheck1) SetDescriptionNil() {
...
func (o *SqlCheck1) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *SqlCheck1) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *SqlCheck1) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *SqlCheck1) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *SqlCheck1) GetCheckType() SqlCheck1AllOfCheckType {
	if o == nil || IsNil(o.CheckType) {
		var ret SqlCheck1AllOfCheckType
		return ret
	}
	return *o.CheckType
}
...
func (o *SqlCheck1) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
// SetCheckType gets a reference to the given SqlCheck1AllOfCheckType and assigns it to the CheckType field.
...
func (o *SqlCheck1) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given SqlCheck1AllOfConfig and assigns it to the Config field.
