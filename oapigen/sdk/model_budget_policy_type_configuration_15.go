...
func (o *BudgetPolicyTypeConfiguration15) IsSetMaxPrice() bool {
	if o != nil && !IsNil(o.MaxPrice) {
		return true
	}
...
func (o *BudgetPolicyTypeConfiguration15) IsSetMaxPriceCurrency() bool {
	if o != nil && !IsNil(o.MaxPriceCurrency) {
		return true
	}
...
func (o *BudgetPolicyTypeConfiguration15) IsSetMaxPriceUnit() bool {
	if o != nil && !IsNil(o.MaxPriceUnit) {
		return true
	}
