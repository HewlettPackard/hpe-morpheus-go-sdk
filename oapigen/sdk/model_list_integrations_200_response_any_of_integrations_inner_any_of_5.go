...
type ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5 struct {
	...
	IntegrationType      *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5IntegrationType `json:"integrationType,omitempty"`
	...
	Credential           *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5Credential      `json:"credential,omitempty"`
...
func (o *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) GetIntegrationType() ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5IntegrationType {
	if o == nil || IsNil(o.IntegrationType) {
		var ret ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5IntegrationType
		return ret
	}
...
// SetIntegrationType gets a reference to the given ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5IntegrationType and assigns it to the IntegrationType field.
...
func (o *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) GetCredential() ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5Credential {
	if o == nil || IsNil(o.Credential) {
		var ret ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5Credential
		return ret
	}
	return *o.Credential
}
...
// SetCredential gets a reference to the given ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5Credential and assigns it to the Credential field.
...
type NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5 struct {
	value *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5
	isSet bool
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) Get() *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5 {
	return v.value
}

func (v *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) Set(val *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) {
	v.value = val
	v.isSet = true
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) IsSet() bool {
	return v.isSet
}

func (v *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5(val *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5 {
	return &NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5{value: val, isSet: true}
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) UnmarshalMapstructure(data any) (any, error) {
