...
// checks if the InstanceContainerServer3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceContainerServer3{}

// InstanceContainerServer3 struct for InstanceContainerServer3
type InstanceContainerServer3 struct {
	...
	Account              *InstanceContainerServer3Account           `json:"account,omitempty"`
	Owner                *InstanceContainerServer3Owner             `json:"owner,omitempty"`
	Zone                 *InstanceContainerServer3Zone              `json:"zone,omitempty"`
	Plan                 *InstanceContainerServer3Plan              `json:"plan,omitempty"`
	ComputeServerType    *InstanceContainerServer3ComputeServerType `json:"computeServerType,omitempty"`
	...
	PowerState           *InstanceContainerServer3PowerState        `json:"powerState,omitempty"`
...
type _InstanceContainerServer3 InstanceContainerServer3
...
func (o *InstanceContainerServer3) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetExternalId() bool {
...
func (o *InstanceContainerServer3) SetExternalIdNil() {
...
func (o *InstanceContainerServer3) IsSetInternalId() bool {
...
func (o *InstanceContainerServer3) SetInternalIdNil() {
...
func (o *InstanceContainerServer3) IsSetHostName() bool {
	if o != nil && !IsNil(o.HostName) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *InstanceContainerServer3) GetAccount() InstanceContainerServer3Account {
	if o == nil || IsNil(o.Account) {
		var ret InstanceContainerServer3Account
		return ret
	}
	return *o.Account
}
...
func (o *InstanceContainerServer3) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
// SetAccount gets a reference to the given InstanceContainerServer3Account and assigns it to the Account field.
...
func (o *InstanceContainerServer3) GetOwner() InstanceContainerServer3Owner {
	if o == nil || IsNil(o.Owner) {
		var ret InstanceContainerServer3Owner
		return ret
	}
	return *o.Owner
}
...
func (o *InstanceContainerServer3) IsSetOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
// SetOwner gets a reference to the given InstanceContainerServer3Owner and assigns it to the Owner field.
...
func (o *InstanceContainerServer3) GetZone() InstanceContainerServer3Zone {
	if o == nil || IsNil(o.Zone) {
		var ret InstanceContainerServer3Zone
		return ret
	}
	return *o.Zone
}
...
func (o *InstanceContainerServer3) IsSetZone() bool {
	if o != nil && !IsNil(o.Zone) {
		return true
	}
...
// SetZone gets a reference to the given InstanceContainerServer3Zone and assigns it to the Zone field.
...
func (o *InstanceContainerServer3) GetPlan() InstanceContainerServer3Plan {
	if o == nil || IsNil(o.Plan) {
		var ret InstanceContainerServer3Plan
		return ret
	}
	return *o.Plan
}
...
func (o *InstanceContainerServer3) IsSetPlan() bool {
	if o != nil && !IsNil(o.Plan) {
		return true
	}
...
// SetPlan gets a reference to the given InstanceContainerServer3Plan and assigns it to the Plan field.
...
func (o *InstanceContainerServer3) GetComputeServerType() InstanceContainerServer3ComputeServerType {
	if o == nil || IsNil(o.ComputeServerType) {
		var ret InstanceContainerServer3ComputeServerType
		return ret
	}
...
func (o *InstanceContainerServer3) IsSetComputeServerType() bool {
	if o != nil && !IsNil(o.ComputeServerType) {
		return true
	}
...
// SetComputeServerType gets a reference to the given InstanceContainerServer3ComputeServerType and assigns it to the ComputeServerType field.
...
func (o *InstanceContainerServer3) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetDescription() bool {
...
func (o *InstanceContainerServer3) SetDescriptionNil() {
...
func (o *InstanceContainerServer3) IsSetZoneId() bool {
	if o != nil && !IsNil(o.ZoneId) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetSiteId() bool {
	if o != nil && !IsNil(o.SiteId) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetResourcePoolId() bool {
	if o != nil && !IsNil(o.ResourcePoolId) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetSshHost() bool {
...
func (o *InstanceContainerServer3) SetSshHostNil() {
	o.SshHost.Set(nil)
}
...
func (o *InstanceContainerServer3) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetExternalIp() bool {
...
func (o *InstanceContainerServer3) SetExternalIpNil() {
...
func (o *InstanceContainerServer3) IsSetInternalIp() bool {
...
func (o *InstanceContainerServer3) SetInternalIpNil() {
...
func (o *InstanceContainerServer3) IsSetPlatform() bool {
	if o != nil && !IsNil(o.Platform) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetStatusMessage() bool {
...
func (o *InstanceContainerServer3) SetStatusMessageNil() {
...
func (o *InstanceContainerServer3) IsSetErrorMessage() bool {
...
func (o *InstanceContainerServer3) SetErrorMessageNil() {
...
func (o *InstanceContainerServer3) IsSetStatusDate() bool {
	if o != nil && !IsNil(o.StatusDate) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetStatusPercent() bool {
...
func (o *InstanceContainerServer3) SetStatusPercentNil() {
...
func (o *InstanceContainerServer3) IsSetStatusEta() bool {
...
func (o *InstanceContainerServer3) SetStatusEtaNil() {
	o.StatusEta.Set(nil)
}
...
func (o *InstanceContainerServer3) GetPowerState() InstanceContainerServer3PowerState {
	if o == nil || IsNil(o.PowerState) {
		var ret InstanceContainerServer3PowerState
		return ret
	}
	return *o.PowerState
}
...
func (o *InstanceContainerServer3) IsSetPowerState() bool {
	if o != nil && !IsNil(o.PowerState) {
		return true
	}
...
// SetPowerState gets a reference to the given InstanceContainerServer3PowerState and assigns it to the PowerState field.
...
func (o *InstanceContainerServer3) IsSetAgentInstalled() bool {
	if o != nil && !IsNil(o.AgentInstalled) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetLastAgentUpdate() bool {
...
func (o *InstanceContainerServer3) SetLastAgentUpdateNil() {
...
func (o *InstanceContainerServer3) IsSetMaxCores() bool {
	if o != nil && !IsNil(o.MaxCores) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *InstanceContainerServer3) GetSourceImage() InstanceContainerServer3SourceImage {
	if o == nil || IsNil(o.SourceImage) {
		var ret InstanceContainerServer3SourceImage
		return ret
	}
...
func (o *InstanceContainerServer3) IsSetSourceImage() bool {
	if o != nil && !IsNil(o.SourceImage) {
		return true
	}
...
// SetSourceImage gets a reference to the given InstanceContainerServer3SourceImage and assigns it to the SourceImage field.
...
func (o *InstanceContainerServer3) GetServerOs() InstanceContainerServer3ServerOs {
	if o == nil || IsNil(o.ServerOs) {
		var ret InstanceContainerServer3ServerOs
		return ret
	}
	return *o.ServerOs
}
...
func (o *InstanceContainerServer3) IsSetServerOs() bool {
	if o != nil && !IsNil(o.ServerOs) {
		return true
	}
...
// SetServerOs gets a reference to the given InstanceContainerServer3ServerOs and assigns it to the ServerOs field.
...
func (o *InstanceContainerServer3) IsSetVolumes() bool {
	if o != nil && !IsNil(o.Volumes) {
		return true
	}
...
func (o *InstanceContainerServer3) IsSetInterfaces() bool {
	if o != nil && !IsNil(o.Interfaces) {
		return true
	}
...
func (o InstanceContainerServer3) MarshalJSON() ([]byte, error) {
...
func (o InstanceContainerServer3) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceContainerServer3 struct {
	value *InstanceContainerServer3
	isSet bool
}

func (v NullableInstanceContainerServer3) Get() *InstanceContainerServer3 {
	return v.value
}

func (v *NullableInstanceContainerServer3) Set(val *InstanceContainerServer3) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceContainerServer3) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceContainerServer3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceContainerServer3(val *InstanceContainerServer3) *NullableInstanceContainerServer3 {
	return &NullableInstanceContainerServer3{value: val, isSet: true}
}

func (v NullableInstanceContainerServer3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceContainerServer3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceContainerServer3) UnmarshalMapstructure(data any) (any, error) {
