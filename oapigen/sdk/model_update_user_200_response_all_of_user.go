...
// checks if the UpdateUser200ResponseAllOfUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUser200ResponseAllOfUser{}

// UpdateUser200ResponseAllOfUser struct for UpdateUser200ResponseAllOfUser
type UpdateUser200ResponseAllOfUser struct {
	...
	Roles                []UpdateUser200ResponseAllOfUserRolesInner    `json:"roles,omitempty"`
	Account              *UpdateUser200ResponseAllOfUserAccount        `json:"account,omitempty"`
	...
	DefaultPersona       *UpdateUser200ResponseAllOfUserDefaultPersona `json:"defaultPersona,omitempty"`
	DateCreated          *time.Time                                    `json:"dateCreated,omitempty"`
	LastUpdated          *time.Time                                    `json:"lastUpdated,omitempty"`
	Access               *UpdateUser200ResponseAllOfUserAccess         `json:"access,omitempty"`
	AdditionalProperties map[string]interface{}                        `json:",remain"`
}

type _UpdateUser200ResponseAllOfUser UpdateUser200ResponseAllOfUser
...
func NewUpdateUser200ResponseAllOfUser() *UpdateUser200ResponseAllOfUser {
	this := UpdateUser200ResponseAllOfUser{}
	return &this
}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetUsername() bool {
	if o != nil && !IsNil(o.Username) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetFirstName() bool {
	if o != nil && !IsNil(o.FirstName) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLastName() bool {
	if o != nil && !IsNil(o.LastName) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetReceiveNotifications() bool {
	if o != nil && !IsNil(o.ReceiveNotifications) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetIsUsing2FA() bool {
	if o != nil && !IsNil(o.IsUsing2FA) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetAccountExpired() bool {
	if o != nil && !IsNil(o.AccountExpired) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetAccountLocked() bool {
	if o != nil && !IsNil(o.AccountLocked) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetPasswordExpired() bool {
	if o != nil && !IsNil(o.PasswordExpired) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLoginCount() bool {
	if o != nil && !IsNil(o.LoginCount) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLoginAttempts() bool {
	if o != nil && !IsNil(o.LoginAttempts) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLastLoginDate() bool {
	if o != nil && !IsNil(o.LastLoginDate) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) GetRoles() []UpdateUser200ResponseAllOfUserRolesInner {
	if o == nil || IsNil(o.Roles) {
		var ret []UpdateUser200ResponseAllOfUserRolesInner
		return ret
	}
	return o.Roles
}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetRoles() bool {
	if o != nil && !IsNil(o.Roles) {
		return true
	}
...
// SetRoles gets a reference to the given []UpdateUser200ResponseAllOfUserRolesInner and assigns it to the Roles field.
...
func (o *UpdateUser200ResponseAllOfUser) GetAccount() UpdateUser200ResponseAllOfUserAccount {
	if o == nil || IsNil(o.Account) {
		var ret UpdateUser200ResponseAllOfUserAccount
		return ret
	}
	return *o.Account
}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
// SetAccount gets a reference to the given UpdateUser200ResponseAllOfUserAccount and assigns it to the Account field.
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLinuxUsername() bool {
...
func (o *UpdateUser200ResponseAllOfUser) SetLinuxUsernameNil() {
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLinuxPassword() bool {
...
func (o *UpdateUser200ResponseAllOfUser) SetLinuxPasswordNil() {
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLinuxKeyPairId() bool {
...
func (o *UpdateUser200ResponseAllOfUser) SetLinuxKeyPairIdNil() {
...
func (o *UpdateUser200ResponseAllOfUser) IsSetWindowsUsername() bool {
...
func (o *UpdateUser200ResponseAllOfUser) SetWindowsUsernameNil() {
...
func (o *UpdateUser200ResponseAllOfUser) IsSetWindowsPassword() bool {
...
func (o *UpdateUser200ResponseAllOfUser) SetWindowsPasswordNil() {
...
func (o *UpdateUser200ResponseAllOfUser) GetDefaultPersona() UpdateUser200ResponseAllOfUserDefaultPersona {
	if o == nil || IsNil(o.DefaultPersona) {
		var ret UpdateUser200ResponseAllOfUserDefaultPersona
		return ret
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetDefaultPersona() bool {
	if o != nil && !IsNil(o.DefaultPersona) {
		return true
	}
...
// SetDefaultPersona gets a reference to the given UpdateUser200ResponseAllOfUserDefaultPersona and assigns it to the DefaultPersona field.
...
func (o *UpdateUser200ResponseAllOfUser) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *UpdateUser200ResponseAllOfUser) GetAccess() UpdateUser200ResponseAllOfUserAccess {
	if o == nil || IsNil(o.Access) {
		var ret UpdateUser200ResponseAllOfUserAccess
		return ret
	}
	return *o.Access
}
...
func (o *UpdateUser200ResponseAllOfUser) IsSetAccess() bool {
	if o != nil && !IsNil(o.Access) {
		return true
	}
...
// SetAccess gets a reference to the given UpdateUser200ResponseAllOfUserAccess and assigns it to the Access field.
func (o *UpdateUser200ResponseAllOfUser) SetAccess(v UpdateUser200ResponseAllOfUserAccess) {
	o.Access = &v
}

func (o UpdateUser200ResponseAllOfUser) MarshalJSON() ([]byte, error) {
...
func (o UpdateUser200ResponseAllOfUser) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateUser200ResponseAllOfUser struct {
	value *UpdateUser200ResponseAllOfUser
	isSet bool
}

func (v NullableUpdateUser200ResponseAllOfUser) Get() *UpdateUser200ResponseAllOfUser {
	return v.value
}

func (v *NullableUpdateUser200ResponseAllOfUser) Set(val *UpdateUser200ResponseAllOfUser) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUser200ResponseAllOfUser) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUser200ResponseAllOfUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUser200ResponseAllOfUser(val *UpdateUser200ResponseAllOfUser) *NullableUpdateUser200ResponseAllOfUser {
	return &NullableUpdateUser200ResponseAllOfUser{value: val, isSet: true}
}

func (v NullableUpdateUser200ResponseAllOfUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUser200ResponseAllOfUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateUser200ResponseAllOfUser) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateUser200ResponseAllOfUser) UnmarshalJSON(data []byte) (err error) {
