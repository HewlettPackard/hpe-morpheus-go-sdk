...
// checks if the AzureInstanceConfiguration7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureInstanceConfiguration7{}

// AzureInstanceConfiguration7 struct for AzureInstanceConfiguration7
type AzureInstanceConfiguration7 struct {
...
type _AzureInstanceConfiguration7 AzureInstanceConfiguration7

func (o AzureInstanceConfiguration7) MarshalJSON() ([]byte, error) {
...
func (o AzureInstanceConfiguration7) ToMap() (map[string]interface{}, error) {
...
type NullableAzureInstanceConfiguration7 struct {
	value *AzureInstanceConfiguration7
	isSet bool
}

func (v NullableAzureInstanceConfiguration7) Get() *AzureInstanceConfiguration7 {
	return v.value
}

func (v *NullableAzureInstanceConfiguration7) Set(val *AzureInstanceConfiguration7) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureInstanceConfiguration7) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureInstanceConfiguration7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureInstanceConfiguration7(val *AzureInstanceConfiguration7) *NullableAzureInstanceConfiguration7 {
	return &NullableAzureInstanceConfiguration7{value: val, isSet: true}
}

func (v NullableAzureInstanceConfiguration7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureInstanceConfiguration7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAzureInstanceConfiguration7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AzureInstanceConfiguration7) UnmarshalJSON(data []byte) (err error) {
