...
type GetBackups200ResponseBackup struct {
	...
	Server      *GetBackups200ResponseBackupServer `json:"server,omitempty"`
	...
	BackupRepository   *GetBackups200ResponseBackupBackupRepository `json:"backupRepository,omitempty"`
	// Cron Expression
