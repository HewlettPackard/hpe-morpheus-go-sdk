...
// checks if the BlueprintARMCreateArmGit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintARMCreateArmGit{}
...
type _BlueprintARMCreateArmGit BlueprintARMCreateArmGit
...
func (o BlueprintARMCreateArmGit) ToMap() (map[string]interface{}, error) {
...
func (v NullableBlueprintARMCreateArmGit) UnmarshalMapstructure(data any) (any, error) {
...
func (o *BlueprintARMCreateArmGit) UnmarshalJSON(data []byte) (err error) {
