...
func (r ApiRemoveProvisioningLicenseRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *ProvisioningLicensesAPIService) RemoveProvisioningLicenseExecute(r ApiRemoveProvisioningLicenseRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiUpdateProvisioningLicenseRequest) Execute() (*UpdateProvisioningLicense200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateProvisioningLicense200Response
func (a *ProvisioningLicensesAPIService) UpdateProvisioningLicenseExecute(r ApiUpdateProvisioningLicenseRequest) (*UpdateProvisioningLicense200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateProvisioningLicense200Response
	)
