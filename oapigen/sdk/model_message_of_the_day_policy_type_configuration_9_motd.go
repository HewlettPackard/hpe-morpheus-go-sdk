...
func (o *MessageOfTheDayPolicyTypeConfiguration9Motd) IsSetTitle() bool {
	if o != nil && !IsNil(o.Title) {
		return true
	}
...
func (o *MessageOfTheDayPolicyTypeConfiguration9Motd) IsSetMessage() bool {
	if o != nil && !IsNil(o.Message) {
		return true
	}
...
func (o *MessageOfTheDayPolicyTypeConfiguration9Motd) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *MessageOfTheDayPolicyTypeConfiguration9Motd) IsSetFullPage() bool {
	if o != nil && !IsNil(o.FullPage) {
		return true
	}
