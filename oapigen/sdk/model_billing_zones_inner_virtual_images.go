...
func (o *BillingZonesInnerVirtualImages) IsSetPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *BillingZonesInnerVirtualImages) IsSetCost() bool {
	if o != nil && !IsNil(o.Cost) {
		return true
	}
...
func (o *BillingZonesInnerVirtualImages) IsSetVirtualImages() bool {
	if o != nil && !IsNil(o.VirtualImages) {
		return true
	}
...
func (o *BillingZonesInnerVirtualImages) IsSetCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
