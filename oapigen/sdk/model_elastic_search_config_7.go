...
// checks if the ElasticSearchConfig7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ElasticSearchConfig7{}

// ElasticSearchConfig7 struct for ElasticSearchConfig7
...
func (o *ElasticSearchConfig7) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *ElasticSearchConfig7) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *ElasticSearchConfig7) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *ElasticSearchConfig7) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *ElasticSearchConfig7) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o ElasticSearchConfig7) ToMap() (map[string]interface{}, error) {
...
type NullableElasticSearchConfig7 struct {
	value *ElasticSearchConfig7
	isSet bool
}

func (v NullableElasticSearchConfig7) Get() *ElasticSearchConfig7 {
	return v.value
}

func (v *NullableElasticSearchConfig7) Set(val *ElasticSearchConfig7) {
	v.value = val
	v.isSet = true
}

func (v NullableElasticSearchConfig7) IsSet() bool {
	return v.isSet
}

func (v *NullableElasticSearchConfig7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableElasticSearchConfig7(val *ElasticSearchConfig7) *NullableElasticSearchConfig7 {
	return &NullableElasticSearchConfig7{value: val, isSet: true}
}

func (v NullableElasticSearchConfig7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableElasticSearchConfig7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableElasticSearchConfig7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ElasticSearchConfig7) UnmarshalJSON(data []byte) (err error) {
