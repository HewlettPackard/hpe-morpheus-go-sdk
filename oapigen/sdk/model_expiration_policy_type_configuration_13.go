...
// checks if the ExpirationPolicyTypeConfiguration13 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration13{}

// ExpirationPolicyTypeConfiguration13 - Expiration
type ExpirationPolicyTypeConfiguration13 struct {
...
type _ExpirationPolicyTypeConfiguration13 ExpirationPolicyTypeConfiguration13
...
func NewExpirationPolicyTypeConfiguration13(lifecycleType string) *ExpirationPolicyTypeConfiguration13 {
	this := ExpirationPolicyTypeConfiguration13{}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration13) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration13) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration13) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration13 struct {
	value *ExpirationPolicyTypeConfiguration13
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration13) Get() *ExpirationPolicyTypeConfiguration13 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration13) Set(val *ExpirationPolicyTypeConfiguration13) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration13) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration13) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration13(val *ExpirationPolicyTypeConfiguration13) *NullableExpirationPolicyTypeConfiguration13 {
	return &NullableExpirationPolicyTypeConfiguration13{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration13) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration13) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration13) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration13) UnmarshalJSON(data []byte) (err error) {
