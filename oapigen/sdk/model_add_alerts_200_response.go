...
type AddAlerts200Response struct {
	Alert                *AddAlerts200ResponseAllOfAlert `json:"alert,omitempty"`
...
func (o *AddAlerts200Response) GetAlert() AddAlerts200ResponseAllOfAlert {
	if o == nil || IsNil(o.Alert) {
		var ret AddAlerts200ResponseAllOfAlert
		return ret
	}
	return *o.Alert
}
...
func (v NullableAddAlerts200Response) UnmarshalMapstructure(data any) (any, error) {
