...
func (o *BlueprintCFTCreateCloudFormation) IsSetJson() bool {
	if o != nil && !IsNil(o.Json) {
		return true
	}
...
func (o *BlueprintCFTCreateCloudFormation) IsSetYaml() bool {
	if o != nil && !IsNil(o.Yaml) {
		return true
	}
...
func (o *BlueprintCFTCreateCloudFormation) IsSetGit() bool {
	if o != nil && !IsNil(o.Git) {
		return true
	}
...
func (o *BlueprintCFTCreateCloudFormation) IsSetIAM() bool {
	if o != nil && !IsNil(o.IAM) {
		return true
	}
...
func (o *BlueprintCFTCreateCloudFormation) IsSetCAPABILITY_NAMED_IAM() bool {
	if o != nil && !IsNil(o.CAPABILITY_NAMED_IAM) {
		return true
	}
...
func (o *BlueprintCFTCreateCloudFormation) IsSetCAPABILITY_AUTO_EXPAND() bool {
	if o != nil && !IsNil(o.CAPABILITY_AUTO_EXPAND) {
		return true
	}
...
func (o *BlueprintCFTCreateCloudFormation) IsSetInstallAgent() bool {
	if o != nil && !IsNil(o.InstallAgent) {
		return true
	}
...
func (o *BlueprintCFTCreateCloudFormation) IsSetCloudInitEnabled() bool {
	if o != nil && !IsNil(o.CloudInitEnabled) {
		return true
	}
