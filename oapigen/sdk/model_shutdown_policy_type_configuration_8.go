...
type _ShutdownPolicyTypeConfiguration8 ShutdownPolicyTypeConfiguration8
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration8) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration8) MarshalJSON() ([]byte, error) {
...
type NullableShutdownPolicyTypeConfiguration8 struct {
	value *ShutdownPolicyTypeConfiguration8
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration8) Get() *ShutdownPolicyTypeConfiguration8 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration8) Set(val *ShutdownPolicyTypeConfiguration8) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration8) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration8(val *ShutdownPolicyTypeConfiguration8) *NullableShutdownPolicyTypeConfiguration8 {
	return &NullableShutdownPolicyTypeConfiguration8{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration8) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration8) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ShutdownPolicyTypeConfiguration8) UnmarshalJSON(data []byte) (err error) {
