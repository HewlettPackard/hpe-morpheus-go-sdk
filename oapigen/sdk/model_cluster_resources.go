...
func (o *ClusterResources) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ClusterResources) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ClusterResources) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ClusterResources) IsSetCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *ClusterResources) IsSetResourceType() bool {
	if o != nil && !IsNil(o.ResourceType) {
		return true
	}
...
func (o *ClusterResources) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *ClusterResources) IsSetOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
// SetOwner gets a reference to the given ClusterResourcesOwner and assigns it to the Owner field.
...
func (o *ClusterResources) IsSetStats() bool {
	if o != nil && !IsNil(o.Stats) {
		return true
	}
