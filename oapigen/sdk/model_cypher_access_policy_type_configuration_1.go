...
func (o *CypherAccessPolicyTypeConfiguration1) IsSetKeyPattern() bool {
	if o != nil && !IsNil(o.KeyPattern) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration1) IsSetRead() bool {
	if o != nil && !IsNil(o.Read) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration1) IsSetWrite() bool {
	if o != nil && !IsNil(o.Write) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration1) IsSetUpdate() bool {
	if o != nil && !IsNil(o.Update) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration1) IsSetDelete() bool {
	if o != nil && !IsNil(o.Delete) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration1) IsSetList() bool {
	if o != nil && !IsNil(o.List) {
		return true
	}
