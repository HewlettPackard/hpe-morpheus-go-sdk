...
// checks if the ElasticCheck1AllOfConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ElasticCheck1AllOfConfig{}

// ElasticCheck1AllOfConfig struct for ElasticCheck1AllOfConfig
type ElasticCheck1AllOfConfig struct {
...
func (o *ElasticCheck1AllOfConfig) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetTunnelOn() bool {
	if o != nil && !IsNil(o.TunnelOn) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetSshHost() bool {
	if o != nil && !IsNil(o.SshHost) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetSshUser() bool {
	if o != nil && !IsNil(o.SshUser) {
		return true
	}
...
func (o *ElasticCheck1AllOfConfig) IsSetSshPassword() bool {
	if o != nil && !IsNil(o.SshPassword) {
		return true
	}
...
func (o ElasticCheck1AllOfConfig) ToMap() (map[string]interface{}, error) {
...
type NullableElasticCheck1AllOfConfig struct {
	value *ElasticCheck1AllOfConfig
	isSet bool
}

func (v NullableElasticCheck1AllOfConfig) Get() *ElasticCheck1AllOfConfig {
	return v.value
}

func (v *NullableElasticCheck1AllOfConfig) Set(val *ElasticCheck1AllOfConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableElasticCheck1AllOfConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableElasticCheck1AllOfConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableElasticCheck1AllOfConfig(val *ElasticCheck1AllOfConfig) *NullableElasticCheck1AllOfConfig {
	return &NullableElasticCheck1AllOfConfig{value: val, isSet: true}
}

func (v NullableElasticCheck1AllOfConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableElasticCheck1AllOfConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableElasticCheck1AllOfConfig) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ElasticCheck1AllOfConfig) UnmarshalJSON(data []byte) (err error) {
