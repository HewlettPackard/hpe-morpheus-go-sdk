...
type ListJobs200ResponseAllOfJobsInnerAnyOf2 struct {
	...
	Type                 *ListJobs200ResponseAllOfJobsInnerAnyOf2Type          `json:"type,omitempty"`
	Workflow             *ListJobs200ResponseAllOfJobsInnerAnyOf2Workflow      `json:"workflow,omitempty"`
	JobSummary           NullableString                                        `json:"jobSummary,omitempty"`
	ScheduleMode         *ListJobs200ResponseAllOfJobsInnerAnyOf2ScheduleMode  `json:"scheduleMode,omitempty"`
	...
	CreatedBy            *ListJobs200ResponseAllOfJobsInnerAnyOf2CreatedBy     `json:"createdBy,omitempty"`
	TargetType           *string                                               `json:"targetType,omitempty"`
	Targets              []ListJobs200ResponseAllOfJobsInnerAnyOf2TargetsInner `json:"targets,omitempty"`
	CustomConfig         NullableString                                        `json:"customConfig,omitempty"`
	CustomOptions        *ListJobs200ResponseAllOfJobsInnerAnyOf2CustomOptions `json:"customOptions,omitempty"`
...
func (o *ListJobs200ResponseAllOfJobsInnerAnyOf2) GetType() ListJobs200ResponseAllOfJobsInnerAnyOf2Type {
	if o == nil || IsNil(o.Type) {
		var ret ListJobs200ResponseAllOfJobsInnerAnyOf2Type
		return ret
	}
	return *o.Type
}
...
// SetType gets a reference to the given ListJobs200ResponseAllOfJobsInnerAnyOf2Type and assigns it to the Type field.
...
func (o *ListJobs200ResponseAllOfJobsInnerAnyOf2) GetWorkflow() ListJobs200ResponseAllOfJobsInnerAnyOf2Workflow {
	if o == nil || IsNil(o.Workflow) {
		var ret ListJobs200ResponseAllOfJobsInnerAnyOf2Workflow
		return ret
	}
	return *o.Workflow
}
...
// SetWorkflow gets a reference to the given ListJobs200ResponseAllOfJobsInnerAnyOf2Workflow and assigns it to the Workflow field.
...
func (o *ListJobs200ResponseAllOfJobsInnerAnyOf2) GetScheduleMode() ListJobs200ResponseAllOfJobsInnerAnyOf2ScheduleMode {
	if o == nil || IsNil(o.ScheduleMode) {
		var ret ListJobs200ResponseAllOfJobsInnerAnyOf2ScheduleMode
		return ret
	}
...
// SetScheduleMode gets a reference to the given ListJobs200ResponseAllOfJobsInnerAnyOf2ScheduleMode and assigns it to the ScheduleMode field.
...
func (o *ListJobs200ResponseAllOfJobsInnerAnyOf2) GetCreatedBy() ListJobs200ResponseAllOfJobsInnerAnyOf2CreatedBy {
	if o == nil || IsNil(o.CreatedBy) {
		var ret ListJobs200ResponseAllOfJobsInnerAnyOf2CreatedBy
		return ret
	}
	return *o.CreatedBy
}
...
// SetCreatedBy gets a reference to the given ListJobs200ResponseAllOfJobsInnerAnyOf2CreatedBy and assigns it to the CreatedBy field.
...
func (o *ListJobs200ResponseAllOfJobsInnerAnyOf2) GetTargets() []ListJobs200ResponseAllOfJobsInnerAnyOf2TargetsInner {
	if o == nil {
		var ret []ListJobs200ResponseAllOfJobsInnerAnyOf2TargetsInner
		return ret
	}
	return o.Targets
}
...
// SetTargets gets a reference to the given []ListJobs200ResponseAllOfJobsInnerAnyOf2TargetsInner and assigns it to the Targets field.
...
func (o *ListJobs200ResponseAllOfJobsInnerAnyOf2) GetCustomOptions() ListJobs200ResponseAllOfJobsInnerAnyOf2CustomOptions {
	if o == nil || IsNil(o.CustomOptions) {
		var ret ListJobs200ResponseAllOfJobsInnerAnyOf2CustomOptions
		return ret
	}
...
// SetCustomOptions gets a reference to the given ListJobs200ResponseAllOfJobsInnerAnyOf2CustomOptions and assigns it to the CustomOptions field.
