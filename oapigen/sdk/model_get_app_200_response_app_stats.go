...
func (o *GetApp200ResponseAppStats) IsSetUsedMemory() bool {
	if o != nil && !IsNil(o.UsedMemory) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetUsedStorage() bool {
	if o != nil && !IsNil(o.UsedStorage) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetRunning() bool {
	if o != nil && !IsNil(o.Running) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetTotal() bool {
	if o != nil && !IsNil(o.Total) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetCpuUsage() bool {
	if o != nil && !IsNil(o.CpuUsage) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetInstanceCount() bool {
	if o != nil && !IsNil(o.InstanceCount) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetInstanceDayCount() bool {
	if o != nil && !IsNil(o.InstanceDayCount) {
		return true
	}
...
func (o *GetApp200ResponseAppStats) IsSetInstanceDayCountTotal() bool {
	if o != nil && !IsNil(o.InstanceDayCountTotal) {
		return true
	}
