...
// checks if the InstanceContainer3PortsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceContainer3PortsInner{}

// InstanceContainer3PortsInner struct for InstanceContainer3PortsInner
type InstanceContainer3PortsInner struct {
...
type _InstanceContainer3PortsInner InstanceContainer3PortsInner
...
func NewInstanceContainer3PortsInner() *InstanceContainer3PortsInner {
	this := InstanceContainer3PortsInner{}
	return &this
}
...
func (o *InstanceContainer3PortsInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetExternal() bool {
	if o != nil && !IsNil(o.External) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetInternal() bool {
	if o != nil && !IsNil(o.Internal) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetPrimaryPort() bool {
	if o != nil && !IsNil(o.PrimaryPort) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetExport() bool {
	if o != nil && !IsNil(o.Export) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetVisible() bool {
	if o != nil && !IsNil(o.Visible) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetExportName() bool {
	if o != nil && !IsNil(o.ExportName) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetLoadBalanceProtocol() bool {
...
func (o *InstanceContainer3PortsInner) SetLoadBalanceProtocolNil() {
...
func (o *InstanceContainer3PortsInner) IsSetLoadBalance() bool {
	if o != nil && !IsNil(o.LoadBalance) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetProtocol() bool {
...
func (o *InstanceContainer3PortsInner) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o *InstanceContainer3PortsInner) IsSetLink() bool {
	if o != nil && !IsNil(o.Link) {
		return true
	}
...
func (o *InstanceContainer3PortsInner) IsSetExternalIp() bool {
...
func (o *InstanceContainer3PortsInner) SetExternalIpNil() {
...
func (o *InstanceContainer3PortsInner) IsSetInternalIp() bool {
...
func (o *InstanceContainer3PortsInner) SetInternalIpNil() {
...
func (o InstanceContainer3PortsInner) MarshalJSON() ([]byte, error) {
...
func (o InstanceContainer3PortsInner) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceContainer3PortsInner struct {
	value *InstanceContainer3PortsInner
	isSet bool
}

func (v NullableInstanceContainer3PortsInner) Get() *InstanceContainer3PortsInner {
	return v.value
}

func (v *NullableInstanceContainer3PortsInner) Set(val *InstanceContainer3PortsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceContainer3PortsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceContainer3PortsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceContainer3PortsInner(val *InstanceContainer3PortsInner) *NullableInstanceContainer3PortsInner {
	return &NullableInstanceContainer3PortsInner{value: val, isSet: true}
}

func (v NullableInstanceContainer3PortsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceContainer3PortsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceContainer3PortsInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceContainer3PortsInner) UnmarshalJSON(data []byte) (err error) {
