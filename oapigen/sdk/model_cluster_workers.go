...
// checks if the ClusterWorkers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterWorkers{}
...
type _ClusterWorkers ClusterWorkers
...
func (o *ClusterWorkers) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ClusterWorkers) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ClusterWorkers) IsSetExternalId() bool {
	if o != nil && !IsNil(o.ExternalId) {
		return true
	}
...
func (o *ClusterWorkers) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ClusterWorkers) IsSetExternalName() bool {
	if o != nil && !IsNil(o.ExternalName) {
		return true
	}
...
func (o *ClusterWorkers) IsSetHostname() bool {
	if o != nil && !IsNil(o.Hostname) {
		return true
	}
...
func (o *ClusterWorkers) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ClusterWorkers) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
func (o *ClusterWorkers) IsSetOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
func (o *ClusterWorkers) IsSetZone() bool {
	if o != nil && !IsNil(o.Zone) {
		return true
	}
...
func (o *ClusterWorkers) IsSetPlan() bool {
	if o != nil && !IsNil(o.Plan) {
		return true
	}
...
func (o *ClusterWorkers) GetComputeServerType() ClusterMastersComputeServerType {
	if o == nil || IsNil(o.ComputeServerType) {
		var ret ClusterMastersComputeServerType
		return ret
	}
...
func (o *ClusterWorkers) IsSetComputeServerType() bool {
	if o != nil && !IsNil(o.ComputeServerType) {
		return true
	}
...
func (o *ClusterWorkers) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ClusterWorkers) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *ClusterWorkers) IsSetZoneId() bool {
	if o != nil && !IsNil(o.ZoneId) {
		return true
	}
...
func (o *ClusterWorkers) IsSetSiteId() bool {
	if o != nil && !IsNil(o.SiteId) {
		return true
	}
...
func (o *ClusterWorkers) IsSetResourcePoolId() bool {
	if o != nil && !IsNil(o.ResourcePoolId) {
		return true
	}
...
func (o *ClusterWorkers) IsSetSshHost() bool {
	if o != nil && !IsNil(o.SshHost) {
		return true
	}
...
func (o *ClusterWorkers) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *ClusterWorkers) IsSetExternalIp() bool {
	if o != nil && !IsNil(o.ExternalIp) {
		return true
	}
...
func (o *ClusterWorkers) IsSetInternalIp() bool {
	if o != nil && !IsNil(o.InternalIp) {
		return true
	}
...
func (o *ClusterWorkers) IsSetPlatform() bool {
	if o != nil && !IsNil(o.Platform) {
		return true
	}
...
func (o *ClusterWorkers) IsSetPlatformVersion() bool {
	if o != nil && !IsNil(o.PlatformVersion) {
		return true
	}
...
func (o *ClusterWorkers) IsSetSshUsername() bool {
	if o != nil && !IsNil(o.SshUsername) {
		return true
	}
...
func (o *ClusterWorkers) IsSetSshPassword() bool {
	if o != nil && !IsNil(o.SshPassword) {
		return true
	}
...
func (o *ClusterWorkers) IsSetSshPasswordHash() bool {
	if o != nil && !IsNil(o.SshPasswordHash) {
		return true
	}
...
func (o *ClusterWorkers) IsSetOsDevice() bool {
	if o != nil && !IsNil(o.OsDevice) {
		return true
	}
...
func (o *ClusterWorkers) IsSetOsType() bool {
	if o != nil && !IsNil(o.OsType) {
		return true
	}
...
func (o *ClusterWorkers) IsSetDataDevice() bool {
	if o != nil && !IsNil(o.DataDevice) {
		return true
	}
...
func (o *ClusterWorkers) IsSetLvmEnabled() bool {
	if o != nil && !IsNil(o.LvmEnabled) {
		return true
	}
...
func (o *ClusterWorkers) IsSetApiKey() bool {
	if o != nil && !IsNil(o.ApiKey) {
		return true
	}
...
func (o *ClusterWorkers) IsSetSoftwareRaid() bool {
	if o != nil && !IsNil(o.SoftwareRaid) {
		return true
	}
...
func (o *ClusterWorkers) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ClusterWorkers) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *ClusterWorkers) IsSetStats() bool {
	if o != nil && !IsNil(o.Stats) {
		return true
	}
...
func (o *ClusterWorkers) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *ClusterWorkers) IsSetPowerState() bool {
	if o != nil && !IsNil(o.PowerState) {
		return true
	}
...
func (o *ClusterWorkers) IsSetAgentInstalled() bool {
	if o != nil && !IsNil(o.AgentInstalled) {
		return true
	}
...
func (o *ClusterWorkers) IsSetLastAgentUpdate() bool {
	if o != nil && !IsNil(o.LastAgentUpdate) {
		return true
	}
...
func (o *ClusterWorkers) IsSetAgentVersion() bool {
	if o != nil && !IsNil(o.AgentVersion) {
		return true
	}
...
func (o *ClusterWorkers) IsSetMaxCores() bool {
	if o != nil && !IsNil(o.MaxCores) {
		return true
	}
...
func (o *ClusterWorkers) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *ClusterWorkers) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *ClusterWorkers) IsSetMaxCpu() bool {
	if o != nil && !IsNil(o.MaxCpu) {
		return true
	}
...
func (o *ClusterWorkers) IsSetHourlyPrice() bool {
	if o != nil && !IsNil(o.HourlyPrice) {
		return true
	}
...
func (o *ClusterWorkers) GetSourceImage() ClusterMastersSourceImage {
	if o == nil || IsNil(o.SourceImage) {
		var ret ClusterMastersSourceImage
		return ret
	}
...
func (o *ClusterWorkers) IsSetSourceImage() bool {
	if o != nil && !IsNil(o.SourceImage) {
		return true
	}
...
func (o *ClusterWorkers) GetVolumes() []ClusterMastersVolumesInner {
	if o == nil || IsNil(o.Volumes) {
		var ret []ClusterMastersVolumesInner
		return ret
	}
	return o.Volumes
}
...
func (o *ClusterWorkers) IsSetVolumes() bool {
	if o != nil && !IsNil(o.Volumes) {
		return true
	}
...
func (o *ClusterWorkers) IsSetControllers() bool {
	if o != nil && !IsNil(o.Controllers) {
		return true
	}
...
func (o *ClusterWorkers) GetInterfaces() []ClusterMastersInterfacesInner {
	if o == nil || IsNil(o.Interfaces) {
		var ret []ClusterMastersInterfacesInner
		return ret
	}
	return o.Interfaces
}
...
func (o *ClusterWorkers) IsSetInterfaces() bool {
	if o != nil && !IsNil(o.Interfaces) {
		return true
	}
...
func (o *ClusterWorkers) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ClusterWorkers) GetTags() []ClusterMastersTagsInner {
	if o == nil || IsNil(o.Tags) {
		var ret []ClusterMastersTagsInner
		return ret
	}
	return o.Tags
}
...
func (o *ClusterWorkers) IsSetTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *ClusterWorkers) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *ClusterWorkers) IsSetContainers() bool {
	if o != nil && !IsNil(o.Containers) {
		return true
	}
...
func (o *ClusterWorkers) IsSetGuestConsolePreferred() bool {
	if o != nil && !IsNil(o.GuestConsolePreferred) {
		return true
	}
...
func (o ClusterWorkers) ToMap() (map[string]interface{}, error) {
...
func (v NullableClusterWorkers) UnmarshalMapstructure(data any) (any, error) {
