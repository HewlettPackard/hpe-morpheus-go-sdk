...
func (r ApiRemoveCypherRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *CypherAPIService) RemoveCypherExecute(r ApiRemoveCypherRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
