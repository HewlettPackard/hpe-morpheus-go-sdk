...
func (o *AmazonInstanceConfiguration1) IsSetCreateUser() bool {
...
func (o *AmazonInstanceConfiguration1) SetCreateUserNil() {
...
func (o *AmazonInstanceConfiguration1) IsSetResourcePoolId() bool {
	if o != nil && !IsNil(o.ResourcePoolId) {
		return true
	}
