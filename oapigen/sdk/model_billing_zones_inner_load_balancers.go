...
type _BillingZonesInnerLoadBalancers BillingZonesInnerLoadBalancers
...
func (o *BillingZonesInnerLoadBalancers) IsSetPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *BillingZonesInnerLoadBalancers) IsSetCost() bool {
	if o != nil && !IsNil(o.Cost) {
		return true
	}
...
func (o *BillingZonesInnerLoadBalancers) IsSetLoadBalancers() bool {
	if o != nil && !IsNil(o.LoadBalancers) {
		return true
	}
...
func (o *BillingZonesInnerLoadBalancers) IsSetCount() bool {
	if o != nil && !IsNil(o.Count) {
		return true
	}
...
func (v NullableBillingZonesInnerLoadBalancers) UnmarshalMapstructure(data any) (any, error) {
...
func (o *BillingZonesInnerLoadBalancers) UnmarshalJSON(data []byte) (err error) {
