...
func (o *UpdateClusterPackageRequestClusterPackage) GetSpecTemplates() []UpdateClusterPackageRequestClusterPackageSpecTemplatesInner {
	if o == nil || IsNil(o.SpecTemplates) {
		var ret []UpdateClusterPackageRequestClusterPackageSpecTemplatesInner
		return ret
	}
...
// SetSpecTemplates gets a reference to the given []UpdateClusterPackageRequestClusterPackageSpecTemplatesInner and assigns it to the SpecTemplates field.
