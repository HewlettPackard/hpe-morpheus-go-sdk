...
// checks if the PolicyGroupCreatePolicyTypeConfigOneOf26 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyGroupCreatePolicyTypeConfigOneOf26{}

// PolicyGroupCreatePolicyTypeConfigOneOf26 - Shutdown
type PolicyGroupCreatePolicyTypeConfigOneOf26 struct {
...
type _PolicyGroupCreatePolicyTypeConfigOneOf26 PolicyGroupCreatePolicyTypeConfigOneOf26
...
func NewPolicyGroupCreatePolicyTypeConfigOneOf26() *PolicyGroupCreatePolicyTypeConfigOneOf26 {
	this := PolicyGroupCreatePolicyTypeConfigOneOf26{}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o PolicyGroupCreatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
...
func (o PolicyGroupCreatePolicyTypeConfigOneOf26) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyGroupCreatePolicyTypeConfigOneOf26 struct {
	value *PolicyGroupCreatePolicyTypeConfigOneOf26
	isSet bool
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf26) Get() *PolicyGroupCreatePolicyTypeConfigOneOf26 {
	return v.value
}

func (v *NullablePolicyGroupCreatePolicyTypeConfigOneOf26) Set(val *PolicyGroupCreatePolicyTypeConfigOneOf26) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf26) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyGroupCreatePolicyTypeConfigOneOf26) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyGroupCreatePolicyTypeConfigOneOf26(val *PolicyGroupCreatePolicyTypeConfigOneOf26) *NullablePolicyGroupCreatePolicyTypeConfigOneOf26 {
	return &NullablePolicyGroupCreatePolicyTypeConfigOneOf26{value: val, isSet: true}
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyGroupCreatePolicyTypeConfigOneOf26) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePolicyGroupCreatePolicyTypeConfigOneOf26) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyGroupCreatePolicyTypeConfigOneOf26) UnmarshalJSON(data []byte) (err error) {
