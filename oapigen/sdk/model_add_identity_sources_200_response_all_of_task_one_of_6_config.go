...
// checks if the AddIdentitySources200ResponseAllOfTaskOneOf6Config type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddIdentitySources200ResponseAllOfTaskOneOf6Config{}

// AddIdentitySources200ResponseAllOfTaskOneOf6Config struct for AddIdentitySources200ResponseAllOfTaskOneOf6Config
type AddIdentitySources200ResponseAllOfTaskOneOf6Config struct {
...
type _AddIdentitySources200ResponseAllOfTaskOneOf6Config AddIdentitySources200ResponseAllOfTaskOneOf6Config
...
func NewAddIdentitySources200ResponseAllOfTaskOneOf6Config() *AddIdentitySources200ResponseAllOfTaskOneOf6Config {
	this := AddIdentitySources200ResponseAllOfTaskOneOf6Config{}
	return &this
}
...
func (o AddIdentitySources200ResponseAllOfTaskOneOf6Config) ToMap() (map[string]interface{}, error) {
...
type NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config struct {
	value *AddIdentitySources200ResponseAllOfTaskOneOf6Config
	isSet bool
}

func (v NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config) Get() *AddIdentitySources200ResponseAllOfTaskOneOf6Config {
	return v.value
}

func (v *NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config) Set(val *AddIdentitySources200ResponseAllOfTaskOneOf6Config) {
	v.value = val
	v.isSet = true
}

func (v NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config) IsSet() bool {
	return v.isSet
}

func (v *NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddIdentitySources200ResponseAllOfTaskOneOf6Config(val *AddIdentitySources200ResponseAllOfTaskOneOf6Config) *NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config {
	return &NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config{value: val, isSet: true}
}

func (v NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddIdentitySources200ResponseAllOfTaskOneOf6Config) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddIdentitySources200ResponseAllOfTaskOneOf6Config) UnmarshalJSON(data []byte) (err error) {
