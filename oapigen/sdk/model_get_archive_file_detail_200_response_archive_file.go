...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetFilePath() bool {
	if o != nil && !IsNil(o.FilePath) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetArchiveBucket() bool {
	if o != nil && !IsNil(o.ArchiveBucket) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetCreatedBy() bool {
	if o != nil && !IsNil(o.CreatedBy) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetIsDirectory() bool {
	if o != nil && !IsNil(o.IsDirectory) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetRawSize() bool {
	if o != nil && !IsNil(o.RawSize) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetContentType() bool {
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) SetContentTypeNil() {
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetDownloadCount() bool {
	if o != nil && !IsNil(o.DownloadCount) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *GetArchiveFileDetail200ResponseArchiveFile) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
