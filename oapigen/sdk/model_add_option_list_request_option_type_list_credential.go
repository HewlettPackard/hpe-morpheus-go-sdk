...
// checks if the AddOptionListRequestOptionTypeListCredential type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddOptionListRequestOptionTypeListCredential{}
...
func NewAddOptionListRequestOptionTypeListCredential() *AddOptionListRequestOptionTypeListCredential {
	this := AddOptionListRequestOptionTypeListCredential{}
	return &this
}
...
func (o *AddOptionListRequestOptionTypeListCredential) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *AddOptionListRequestOptionTypeListCredential) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddOptionListRequestOptionTypeListCredential) MarshalJSON() ([]byte, error) {
...
func (o AddOptionListRequestOptionTypeListCredential) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddOptionListRequestOptionTypeListCredential) UnmarshalMapstructure(data any) (any, error) {
