...
// checks if the GetInstance200ResponseInstanceVolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetInstance200ResponseInstanceVolumesInner{}

// GetInstance200ResponseInstanceVolumesInner struct for GetInstance200ResponseInstanceVolumesInner
type GetInstance200ResponseInstanceVolumesInner struct {
...
type _GetInstance200ResponseInstanceVolumesInner GetInstance200ResponseInstanceVolumesInner
...
func NewGetInstance200ResponseInstanceVolumesInner() *GetInstance200ResponseInstanceVolumesInner {
	this := GetInstance200ResponseInstanceVolumesInner{}
	return &this
}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetControllerId() bool {
...
func (o *GetInstance200ResponseInstanceVolumesInner) SetControllerIdNil() {
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetDatastoreId() bool {
...
func (o *GetInstance200ResponseInstanceVolumesInner) SetDatastoreIdNil() {
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetDisplayOrder() bool {
	if o != nil && !IsNil(o.DisplayOrder) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetMaxIOPS() bool {
...
func (o *GetInstance200ResponseInstanceVolumesInner) SetMaxIOPSNil() {
	o.MaxIOPS.Set(nil)
}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetShortName() bool {
	if o != nil && !IsNil(o.ShortName) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetResizeable() bool {
	if o != nil && !IsNil(o.Resizeable) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetPlanResizable() bool {
	if o != nil && !IsNil(o.PlanResizable) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetRootVolume() bool {
	if o != nil && !IsNil(o.RootVolume) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetStorageType() bool {
	if o != nil && !IsNil(o.StorageType) {
		return true
	}
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetUnitNumber() bool {
...
func (o *GetInstance200ResponseInstanceVolumesInner) SetUnitNumberNil() {
...
func (o *GetInstance200ResponseInstanceVolumesInner) IsSetControllerMountPoint() bool {
...
func (o *GetInstance200ResponseInstanceVolumesInner) SetControllerMountPointNil() {
...
func (o GetInstance200ResponseInstanceVolumesInner) MarshalJSON() ([]byte, error) {
...
func (o GetInstance200ResponseInstanceVolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetInstance200ResponseInstanceVolumesInner struct {
	value *GetInstance200ResponseInstanceVolumesInner
	isSet bool
}

func (v NullableGetInstance200ResponseInstanceVolumesInner) Get() *GetInstance200ResponseInstanceVolumesInner {
	return v.value
}

func (v *NullableGetInstance200ResponseInstanceVolumesInner) Set(val *GetInstance200ResponseInstanceVolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetInstance200ResponseInstanceVolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetInstance200ResponseInstanceVolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetInstance200ResponseInstanceVolumesInner(val *GetInstance200ResponseInstanceVolumesInner) *NullableGetInstance200ResponseInstanceVolumesInner {
	return &NullableGetInstance200ResponseInstanceVolumesInner{value: val, isSet: true}
}

func (v NullableGetInstance200ResponseInstanceVolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetInstance200ResponseInstanceVolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetInstance200ResponseInstanceVolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetInstance200ResponseInstanceVolumesInner) UnmarshalJSON(data []byte) (err error) {
