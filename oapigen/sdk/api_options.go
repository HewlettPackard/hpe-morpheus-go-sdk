...
func (r ApiListOptionAnsibleTowerJobTemplateOptionsRequest) Execute() (*ListOptionAnsibleTowerJobTemplateOptions200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ListOptionAnsibleTowerJobTemplateOptions200Response
func (a *OptionsAPIService) ListOptionAnsibleTowerJobTemplateOptionsExecute(r ApiListOptionAnsibleTowerJobTemplateOptionsRequest) (*ListOptionAnsibleTowerJobTemplateOptions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListOptionAnsibleTowerJobTemplateOptions200Response
	)
...
func (r ApiListOptionChefServerOptionsRequest) Execute() (*ListOptionChefServerOptions200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ListOptionChefServerOptions200Response
func (a *OptionsAPIService) ListOptionChefServerOptionsExecute(r ApiListOptionChefServerOptionsRequest) (*ListOptionChefServerOptions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListOptionChefServerOptions200Response
	)
...
func (r ApiListOptionServiceNowWorkflowsOptionsRequest) Execute() (*ListOptionServiceNowWorkflowsOptions200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ListOptionServiceNowWorkflowsOptions200Response
func (a *OptionsAPIService) ListOptionServiceNowWorkflowsOptionsExecute(r ApiListOptionServiceNowWorkflowsOptionsRequest) (*ListOptionServiceNowWorkflowsOptions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListOptionServiceNowWorkflowsOptions200Response
	)
