...
func (o *AddIdentitySources200ResponseAllOfTaskOneOf5ProviderSettings) IsSetEntityId() bool {
	if o != nil && !IsNil(o.EntityId) {
		return true
	}
...
func (o *AddIdentitySources200ResponseAllOfTaskOneOf5ProviderSettings) IsSetAcsUrl() bool {
	if o != nil && !IsNil(o.AcsUrl) {
		return true
	}
...
func (o *AddIdentitySources200ResponseAllOfTaskOneOf5ProviderSettings) IsSetSpMetadata() bool {
	if o != nil && !IsNil(o.SpMetadata) {
		return true
	}
