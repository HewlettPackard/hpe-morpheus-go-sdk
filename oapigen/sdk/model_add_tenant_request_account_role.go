...
// checks if the AddTenantRequestAccountRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddTenantRequestAccountRole{}

// AddTenantRequestAccountRole Tenant Base Role. This restricts the access available to this tenant's roles and users. The Options API `/api/options/roles?roleType=account&tenantId=1` can be used to see which options are available.
...
func NewAddTenantRequestAccountRole() *AddTenantRequestAccountRole {
	this := AddTenantRequestAccountRole{}
	return &this
}
...
func (o *AddTenantRequestAccountRole) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddTenantRequestAccountRole) MarshalJSON() ([]byte, error) {
...
func (o AddTenantRequestAccountRole) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddTenantRequestAccountRole) UnmarshalMapstructure(data any) (any, error) {
