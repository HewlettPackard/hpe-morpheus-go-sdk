...
func NewInstancesNetworkInterfaces1NetworkInterfacesInner(network InstancesNetworkInterfaces1NetworkInterfacesInnerNetwork) *InstancesNetworkInterfaces1NetworkInterfacesInner {
	this := InstancesNetworkInterfaces1NetworkInterfacesInner{}
...
func (o *InstancesNetworkInterfaces1NetworkInterfacesInner) GetNetwork() InstancesNetworkInterfaces1NetworkInterfacesInnerNetwork {
	if o == nil {
		var ret InstancesNetworkInterfaces1NetworkInterfacesInnerNetwork
		return ret
	}
...
func (o *InstancesNetworkInterfaces1NetworkInterfacesInner) IsSetNetworkInterfaceTypeId() bool {
	if o != nil && !IsNil(o.NetworkInterfaceTypeId) {
		return true
	}
...
func (o *InstancesNetworkInterfaces1NetworkInterfacesInner) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *InstancesNetworkInterfaces1NetworkInterfacesInner) IsSetIpAddress() bool {
	if o != nil && !IsNil(o.IpAddress) {
		return true
	}
...
func (o *InstancesNetworkInterfaces1NetworkInterfacesInner) IsSetMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *InstancesNetworkInterfaces1NetworkInterfacesInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
