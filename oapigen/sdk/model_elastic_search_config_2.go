...
func (o *ElasticSearchConfig2) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *ElasticSearchConfig2) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *ElasticSearchConfig2) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *ElasticSearchConfig2) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *ElasticSearchConfig2) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
