...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetInternal() bool {
	if o != nil && !IsNil(o.Internal) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetCreatable() bool {
	if o != nil && !IsNil(o.Creatable) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetCreateType() bool {
	if o != nil && !IsNil(o.CreateType) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetOptionTypes() bool {
	if o != nil && !IsNil(o.OptionTypes) {
		return true
	}
...
func (o *GetLoadBalancerType200ResponseLoadBalancerType) IsSetVipOptionTypes() bool {
	if o != nil && !IsNil(o.VipOptionTypes) {
		return true
	}
