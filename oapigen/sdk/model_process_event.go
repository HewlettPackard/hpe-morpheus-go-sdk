...
// checks if the ProcessEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProcessEvent{}
...
func (o ProcessEvent) ToMap() (map[string]interface{}, error) {
...
func (v NullableProcessEvent) UnmarshalMapstructure(data any) (any, error) {
