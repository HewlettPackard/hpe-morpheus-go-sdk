...
// checks if the GFS2DatastoreConfiguration1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GFS2DatastoreConfiguration1{}

// GFS2DatastoreConfiguration1 GFS2 Cluster Datastore Configuration
type GFS2DatastoreConfiguration1 struct {
...
type _GFS2DatastoreConfiguration1 GFS2DatastoreConfiguration1
...
func NewGFS2DatastoreConfiguration1(blockDevice string) *GFS2DatastoreConfiguration1 {
	this := GFS2DatastoreConfiguration1{}
...
func (o *GFS2DatastoreConfiguration1) IsSetAllowReformat() bool {
	if o != nil && !IsNil(o.AllowReformat) {
		return true
	}
...
func (o GFS2DatastoreConfiguration1) MarshalJSON() ([]byte, error) {
...
func (o GFS2DatastoreConfiguration1) ToMap() (map[string]interface{}, error) {
...
type NullableGFS2DatastoreConfiguration1 struct {
	value *GFS2DatastoreConfiguration1
	isSet bool
}

func (v NullableGFS2DatastoreConfiguration1) Get() *GFS2DatastoreConfiguration1 {
	return v.value
}

func (v *NullableGFS2DatastoreConfiguration1) Set(val *GFS2DatastoreConfiguration1) {
	v.value = val
	v.isSet = true
}

func (v NullableGFS2DatastoreConfiguration1) IsSet() bool {
	return v.isSet
}

func (v *NullableGFS2DatastoreConfiguration1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGFS2DatastoreConfiguration1(val *GFS2DatastoreConfiguration1) *NullableGFS2DatastoreConfiguration1 {
	return &NullableGFS2DatastoreConfiguration1{value: val, isSet: true}
}

func (v NullableGFS2DatastoreConfiguration1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGFS2DatastoreConfiguration1) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGFS2DatastoreConfiguration1) UnmarshalMapstructure(data any) (any, error) {
