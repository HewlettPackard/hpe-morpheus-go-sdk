...
// checks if the PolicyCloudUpdatePolicyTypeConfigOneOf26 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyCloudUpdatePolicyTypeConfigOneOf26{}

// PolicyCloudUpdatePolicyTypeConfigOneOf26 - Shutdown
type PolicyCloudUpdatePolicyTypeConfigOneOf26 struct {
...
type _PolicyCloudUpdatePolicyTypeConfigOneOf26 PolicyCloudUpdatePolicyTypeConfigOneOf26
...
func NewPolicyCloudUpdatePolicyTypeConfigOneOf26() *PolicyCloudUpdatePolicyTypeConfigOneOf26 {
	this := PolicyCloudUpdatePolicyTypeConfigOneOf26{}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o PolicyCloudUpdatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
...
func (o PolicyCloudUpdatePolicyTypeConfigOneOf26) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyCloudUpdatePolicyTypeConfigOneOf26 struct {
	value *PolicyCloudUpdatePolicyTypeConfigOneOf26
	isSet bool
}

func (v NullablePolicyCloudUpdatePolicyTypeConfigOneOf26) Get() *PolicyCloudUpdatePolicyTypeConfigOneOf26 {
	return v.value
}

func (v *NullablePolicyCloudUpdatePolicyTypeConfigOneOf26) Set(val *PolicyCloudUpdatePolicyTypeConfigOneOf26) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyCloudUpdatePolicyTypeConfigOneOf26) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyCloudUpdatePolicyTypeConfigOneOf26) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyCloudUpdatePolicyTypeConfigOneOf26(val *PolicyCloudUpdatePolicyTypeConfigOneOf26) *NullablePolicyCloudUpdatePolicyTypeConfigOneOf26 {
	return &NullablePolicyCloudUpdatePolicyTypeConfigOneOf26{value: val, isSet: true}
}

func (v NullablePolicyCloudUpdatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyCloudUpdatePolicyTypeConfigOneOf26) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePolicyCloudUpdatePolicyTypeConfigOneOf26) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf26) UnmarshalJSON(data []byte) (err error) {
