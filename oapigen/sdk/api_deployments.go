...
func (r ApiAddDeploymentFileRequest) Execute() (*AddDeploymentFile200Response, *http.Response, error) {
...
//
//	@return AddDeploymentFile200Response
func (a *DeploymentsAPIService) AddDeploymentFileExecute(r ApiAddDeploymentFileRequest) (*AddDeploymentFile200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AddDeploymentFile200Response
	)
...
func (r ApiDeleteDeploymentRequest) Execute() (*DeleteDeployment200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteDeployment200Response
func (a *DeploymentsAPIService) DeleteDeploymentExecute(r ApiDeleteDeploymentRequest) (*DeleteDeployment200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteDeployment200Response
	)
...
func (r ApiDeleteDeploymentFileRequest) Execute() (*DeleteDeploymentFile200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteDeploymentFile200Response
func (a *DeploymentsAPIService) DeleteDeploymentFileExecute(r ApiDeleteDeploymentFileRequest) (*DeleteDeploymentFile200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteDeploymentFile200Response
	)
...
func (r ApiDeleteDeploymentVersionRequest) Execute() (*DeleteDeploymentVersion200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return DeleteDeploymentVersion200Response
func (a *DeploymentsAPIService) DeleteDeploymentVersionExecute(r ApiDeleteDeploymentVersionRequest) (*DeleteDeploymentVersion200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *DeleteDeploymentVersion200Response
	)
...
func (r ApiListDeploymentFilesRequest) Execute() (*ListDeploymentFiles200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ListDeploymentFiles200Response
func (a *DeploymentsAPIService) ListDeploymentFilesExecute(r ApiListDeploymentFilesRequest) (*ListDeploymentFiles200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListDeploymentFiles200Response
	)
...
func (r ApiUpdateDeploymentRequest) UpdateDeploymentRequest(updateDeploymentRequest UpdateDeploymentRequest) ApiUpdateDeploymentRequest {
...
type ApiUpdateDeploymentVersionRequest struct {
	...
	deploymentId                   int64
	id                             int64
	updateDeploymentVersionRequest *UpdateDeploymentVersionRequest
}

func (r ApiUpdateDeploymentVersionRequest) UpdateDeploymentVersionRequest(updateDeploymentVersionRequest UpdateDeploymentVersionRequest) ApiUpdateDeploymentVersionRequest {
	r.updateDeploymentVersionRequest = &updateDeploymentVersionRequest
	return r
}

func (r ApiUpdateDeploymentVersionRequest) Execute() (*UpdateDeploymentVersion200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateDeploymentVersion200Response
func (a *DeploymentsAPIService) UpdateDeploymentVersionExecute(r ApiUpdateDeploymentVersionRequest) (*UpdateDeploymentVersion200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateDeploymentVersion200Response
	)
	...
	// body params
	localVarPostBody = r.updateDeploymentVersionRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
