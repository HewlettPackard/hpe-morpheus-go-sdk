...
func NewPolicyCloudUpdatePolicyTypeConfigOneOf10() *PolicyCloudUpdatePolicyTypeConfigOneOf10 {
	this := PolicyCloudUpdatePolicyTypeConfigOneOf10{}
	return &this
}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf10) IsSetNamingType() bool {
	if o != nil && !IsNil(o.NamingType) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf10) IsSetNamingPattern() bool {
	if o != nil && !IsNil(o.NamingPattern) {
		return true
	}
...
func (o *PolicyCloudUpdatePolicyTypeConfigOneOf10) IsSetNamingConflict() bool {
	if o != nil && !IsNil(o.NamingConflict) {
		return true
	}
