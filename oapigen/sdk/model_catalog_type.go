...
// SetForm gets a reference to the given CatalogTypeForm and assigns it to the Form field.
...
func (o *CatalogType) GetOptionTypes() []CatalogTypeOptionTypesInner {
	if o == nil || IsNil(o.OptionTypes) {
		var ret []CatalogTypeOptionTypesInner
		return ret
	}
...
// SetOptionTypes gets a reference to the given []CatalogTypeOptionTypesInner and assigns it to the OptionTypes field.
