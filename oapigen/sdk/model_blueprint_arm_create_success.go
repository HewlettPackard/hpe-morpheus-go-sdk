...
type BlueprintARMCreateSuccess struct {
	...
	Arm  *BlueprintARMCreateSuccessArm `json:"arm,omitempty"`
...
func (o *BlueprintARMCreateSuccess) GetArm() BlueprintARMCreateSuccessArm {
	if o == nil || IsNil(o.Arm) {
		var ret BlueprintARMCreateSuccessArm
		return ret
	}
	return *o.Arm
}
...
// SetArm gets a reference to the given BlueprintARMCreateSuccessArm and assigns it to the Arm field.
...
func (v NullableBlueprintARMCreateSuccess) UnmarshalMapstructure(data any) (any, error) {
