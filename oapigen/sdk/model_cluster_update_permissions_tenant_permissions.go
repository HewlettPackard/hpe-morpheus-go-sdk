...
// checks if the ClusterUpdatePermissionsTenantPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterUpdatePermissionsTenantPermissions{}
...
type _ClusterUpdatePermissionsTenantPermissions ClusterUpdatePermissionsTenantPermissions
...
func (o *ClusterUpdatePermissionsTenantPermissions) IsSetAccounts() bool {
	if o != nil && !IsNil(o.Accounts) {
		return true
	}
...
func (o *ClusterUpdatePermissionsTenantPermissions) IsSetDefaultTarget() bool {
	if o != nil && !IsNil(o.DefaultTarget) {
		return true
	}
...
func (o *ClusterUpdatePermissionsTenantPermissions) IsSetDefaultStore() bool {
	if o != nil && !IsNil(o.DefaultStore) {
		return true
	}
...
func (o ClusterUpdatePermissionsTenantPermissions) ToMap() (map[string]interface{}, error) {
...
func (v NullableClusterUpdatePermissionsTenantPermissions) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ClusterUpdatePermissionsTenantPermissions) UnmarshalJSON(data []byte) (err error) {
