...
// checks if the UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7{}

// UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 - Expiration
type UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 struct {
...
type _UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7
...
func NewUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7() *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 {
	this := UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7{}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleType() bool {
	if o != nil && !IsNil(o.LifecycleType) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
...
func (o UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) ToMap() (map[string]interface{}, error) {
...
type NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 struct {
	value *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7
	isSet bool
}

func (v NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) Get() *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 {
	return v.value
}

func (v *NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) Set(val *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7(val *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) *NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7 {
	return &NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7{value: val, isSet: true}
}

func (v NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdatePoliciesCloudRequestPolicyPolicyTypeConfigOneOf7) UnmarshalJSON(data []byte) (err error) {
