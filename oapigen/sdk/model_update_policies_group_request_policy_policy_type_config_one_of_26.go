...
// checks if the UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26{}

// UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 - Shutdown
type UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 struct {
...
type _UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26
...
func NewUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26() *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 {
	this := UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26{}
...
// NewUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26WithDefaults instantiates a new UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26WithDefaults() *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 {
	this := UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26{}
	var shutdownAutoRenew string = "off"
	this.ShutdownAutoRenew = &shutdownAutoRenew
	var shutdownAllowExtend string = "off"
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
...
func (o UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) ToMap() (map[string]interface{}, error) {
...
type NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 struct {
	value *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26
	isSet bool
}

func (v NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) Get() *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 {
	return v.value
}

func (v *NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) Set(val *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26(val *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) *NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26 {
	return &NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26{value: val, isSet: true}
}

func (v NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdatePoliciesGroupRequestPolicyPolicyTypeConfigOneOf26) UnmarshalJSON(data []byte) (err error) {
