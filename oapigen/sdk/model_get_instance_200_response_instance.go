...
func (o *GetInstance200ResponseInstance) IsSetCurrentLoadBalancerInstances() bool {
	if o != nil && !IsNil(o.CurrentLoadBalancerInstances) {
		return true
	}
...
func (o *GetInstance200ResponseInstance) IsSetCurrentLoadBalancerContainersIn() bool {
	if o != nil && !IsNil(o.CurrentLoadBalancerContainersIn) {
		return true
	}
...
func (o *GetInstance200ResponseInstance) IsSetCurrentLoadBalancerContainersOut() bool {
	if o != nil && !IsNil(o.CurrentLoadBalancerContainersOut) {
		return true
	}
...
func (o *GetInstance200ResponseInstance) IsSetLastDeploy() bool {
	if o != nil && !IsNil(o.LastDeploy) {
		return true
	}
