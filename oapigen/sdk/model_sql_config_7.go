...
// checks if the SQLConfig7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SQLConfig7{}

// SQLConfig7 struct for SQLConfig7
type SQLConfig7 struct {
...
func (o *SQLConfig7) IsSetDbPasswordHash() bool {
	if o != nil && !IsNil(o.DbPasswordHash) {
		return true
	}
...
func (o *SQLConfig7) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SQLConfig7) IsSetCheckResult() bool {
	if o != nil && !IsNil(o.CheckResult) {
		return true
	}
...
func (o *SQLConfig7) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SQLConfig7) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SQLConfig7) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SQLConfig7) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SQLConfig7) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o SQLConfig7) MarshalJSON() ([]byte, error) {
...
func (o SQLConfig7) ToMap() (map[string]interface{}, error) {
...
type NullableSQLConfig7 struct {
	value *SQLConfig7
	isSet bool
}

func (v NullableSQLConfig7) Get() *SQLConfig7 {
	return v.value
}

func (v *NullableSQLConfig7) Set(val *SQLConfig7) {
	v.value = val
	v.isSet = true
}

func (v NullableSQLConfig7) IsSet() bool {
	return v.isSet
}

func (v *NullableSQLConfig7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSQLConfig7(val *SQLConfig7) *NullableSQLConfig7 {
	return &NullableSQLConfig7{value: val, isSet: true}
}

func (v NullableSQLConfig7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSQLConfig7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSQLConfig7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SQLConfig7) UnmarshalJSON(data []byte) (err error) {
