...
// checks if the InstanceResizeServicePlanOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceResizeServicePlanOptions{}

// InstanceResizeServicePlanOptions Map of custom options depending on selected service plan.
type InstanceResizeServicePlanOptions struct {
	// Core Count
...
type _InstanceResizeServicePlanOptions InstanceResizeServicePlanOptions
...
func NewInstanceResizeServicePlanOptions() *InstanceResizeServicePlanOptions {
	this := InstanceResizeServicePlanOptions{}
	return &this
}
...
func (o InstanceResizeServicePlanOptions) MarshalJSON() ([]byte, error) {
...
func (o InstanceResizeServicePlanOptions) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceResizeServicePlanOptions struct {
	value *InstanceResizeServicePlanOptions
	isSet bool
}

func (v NullableInstanceResizeServicePlanOptions) Get() *InstanceResizeServicePlanOptions {
	return v.value
}

func (v *NullableInstanceResizeServicePlanOptions) Set(val *InstanceResizeServicePlanOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceResizeServicePlanOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceResizeServicePlanOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceResizeServicePlanOptions(val *InstanceResizeServicePlanOptions) *NullableInstanceResizeServicePlanOptions {
	return &NullableInstanceResizeServicePlanOptions{value: val, isSet: true}
}

func (v NullableInstanceResizeServicePlanOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceResizeServicePlanOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceResizeServicePlanOptions) UnmarshalMapstructure(data any) (any, error) {
