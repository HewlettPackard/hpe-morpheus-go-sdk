...
func (o *NetworkPoolServerUpdateSolarWinds) GetConfig() NetworkPoolServerUpdateSolarWindsConfig {
	if o == nil || IsNil(o.Config) {
		var ret NetworkPoolServerUpdateSolarWindsConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given NetworkPoolServerUpdateSolarWindsConfig and assigns it to the Config field.
...
func (o *NetworkPoolServerUpdateSolarWinds) GetCredential() NetworkPoolServerUpdateSolarWindsCredential {
	if o == nil || IsNil(o.Credential) {
		var ret NetworkPoolServerUpdateSolarWindsCredential
		return ret
	}
	return *o.Credential
}
...
// SetCredential gets a reference to the given NetworkPoolServerUpdateSolarWindsCredential and assigns it to the Credential field.
