...
func (r ApiAddInstanceDeployRequest) Execute() (*AddInstanceDeploy200Response, *http.Response, error) {
...
//
//	@return AddInstanceDeploy200Response
func (a *DeploysAPIService) AddInstanceDeployExecute(r ApiAddInstanceDeployRequest) (*AddInstanceDeploy200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *AddInstanceDeploy200Response
	)
...
func (r ApiDeletedeployRequest) Execute() (*Deletedeploy200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return Deletedeploy200Response
func (a *DeploysAPIService) DeletedeployExecute(r ApiDeletedeployRequest) (*Deletedeploy200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *Deletedeploy200Response
	)
...
func (r ApiRunDeployRequest) RunDeployRequest(runDeployRequest RunDeployRequest) ApiRunDeployRequest {
	r.runDeployRequest = &runDeployRequest
	return r
}

func (r ApiRunDeployRequest) Execute() (*RunDeploy200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return RunDeploy200Response
func (a *DeploysAPIService) RunDeployExecute(r ApiRunDeployRequest) (*RunDeploy200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *RunDeploy200Response
	)
	...
	// body params
	localVarPostBody = r.runDeployRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
