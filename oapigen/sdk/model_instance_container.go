...
func (o *InstanceContainer) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceContainer) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *InstanceContainer) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceContainer) IsSetIp() bool {
	if o != nil && !IsNil(o.Ip) {
		return true
	}
...
func (o *InstanceContainer) IsSetInternalIp() bool {
	if o != nil && !IsNil(o.InternalIp) {
		return true
	}
...
func (o *InstanceContainer) IsSetInternalHostname() bool {
	if o != nil && !IsNil(o.InternalHostname) {
		return true
	}
...
func (o *InstanceContainer) IsSetExternalHostname() bool {
	if o != nil && !IsNil(o.ExternalHostname) {
		return true
	}
...
func (o *InstanceContainer) IsSetExternalDomain() bool {
	if o != nil && !IsNil(o.ExternalDomain) {
		return true
	}
...
func (o *InstanceContainer) IsSetExternalFqdn() bool {
	if o != nil && !IsNil(o.ExternalFqdn) {
		return true
	}
...
func (o *InstanceContainer) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *InstanceContainer) IsSetInstance() bool {
	if o != nil && !IsNil(o.Instance) {
		return true
	}
...
func (o *InstanceContainer) IsSetContainerType() bool {
	if o != nil && !IsNil(o.ContainerType) {
		return true
	}
...
func (o *InstanceContainer) IsSetContainerTypeSet() bool {
	if o != nil && !IsNil(o.ContainerTypeSet) {
		return true
	}
...
func (o *InstanceContainer) GetServer() InstanceContainerServer {
	if o == nil || IsNil(o.Server) {
		var ret InstanceContainerServer
		return ret
	}
	return *o.Server
}
...
func (o *InstanceContainer) IsSetServer() bool {
	if o != nil && !IsNil(o.Server) {
		return true
	}
...
// SetServer gets a reference to the given InstanceContainerServer and assigns it to the Server field.
...
func (o *InstanceContainer) IsSetCloud() bool {
	if o != nil && !IsNil(o.Cloud) {
		return true
	}
...
func (o *InstanceContainer) GetPorts() []InstanceContainerPortsInner {
	if o == nil || IsNil(o.Ports) {
		var ret []InstanceContainerPortsInner
		return ret
	}
	return o.Ports
}
...
func (o *InstanceContainer) IsSetPorts() bool {
	if o != nil && !IsNil(o.Ports) {
		return true
	}
...
// SetPorts gets a reference to the given []InstanceContainerPortsInner and assigns it to the Ports field.
...
func (o *InstanceContainer) IsSetPlan() bool {
	if o != nil && !IsNil(o.Plan) {
		return true
	}
...
func (o *InstanceContainer) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *InstanceContainer) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *InstanceContainer) IsSetHostname() bool {
	if o != nil && !IsNil(o.Hostname) {
		return true
	}
...
func (o *InstanceContainer) IsSetVolumeCreated() bool {
	if o != nil && !IsNil(o.VolumeCreated) {
		return true
	}
...
func (o *InstanceContainer) IsSetContainerCreated() bool {
	if o != nil && !IsNil(o.ContainerCreated) {
		return true
	}
