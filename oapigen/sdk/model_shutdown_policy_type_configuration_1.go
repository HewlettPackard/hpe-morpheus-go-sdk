...
// checks if the ShutdownPolicyTypeConfiguration1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShutdownPolicyTypeConfiguration1{}
...
func NewShutdownPolicyTypeConfiguration1() *ShutdownPolicyTypeConfiguration1 {
	this := ShutdownPolicyTypeConfiguration1{}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration1) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration1) MarshalJSON() ([]byte, error) {
...
func (o ShutdownPolicyTypeConfiguration1) ToMap() (map[string]interface{}, error) {
...
type NullableShutdownPolicyTypeConfiguration1 struct {
	value *ShutdownPolicyTypeConfiguration1
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration1) Get() *ShutdownPolicyTypeConfiguration1 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration1) Set(val *ShutdownPolicyTypeConfiguration1) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration1) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration1(val *ShutdownPolicyTypeConfiguration1) *NullableShutdownPolicyTypeConfiguration1 {
	return &NullableShutdownPolicyTypeConfiguration1{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration1) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration1) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ShutdownPolicyTypeConfiguration1) UnmarshalJSON(data []byte) (err error) {
