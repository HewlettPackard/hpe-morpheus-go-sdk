...
// checks if the GetLayout200ResponseInstanceTypeLayout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLayout200ResponseInstanceTypeLayout{}

// GetLayout200ResponseInstanceTypeLayout struct for GetLayout200ResponseInstanceTypeLayout
type GetLayout200ResponseInstanceTypeLayout struct {
	Id           *int64                                              `json:"id,omitempty"`
	InstanceType *GetLayout200ResponseInstanceTypeLayoutInstanceType `json:"instanceType,omitempty"`
	Account      *GetLayout200ResponseInstanceTypeLayoutAccount      `json:"account,omitempty"`
	...
	ProvisionType            *GetLayout200ResponseInstanceTypeLayoutProvisionType        `json:"provisionType,omitempty"`
	TaskSets                 []map[string]interface{}                                    `json:"taskSets,omitempty"`
	ContainerTypes           []GetLayout200ResponseInstanceTypeLayoutContainerTypesInner `json:"containerTypes,omitempty"`
	...
	Permissions              *GetLayout200ResponseInstanceTypeLayoutPermissions          `json:"permissions,omitempty"`
	AdditionalProperties     map[string]interface{}                                      `json:",remain"`
}

type _GetLayout200ResponseInstanceTypeLayout GetLayout200ResponseInstanceTypeLayout
...
func NewGetLayout200ResponseInstanceTypeLayout() *GetLayout200ResponseInstanceTypeLayout {
	this := GetLayout200ResponseInstanceTypeLayout{}
	return &this
}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) GetInstanceType() GetLayout200ResponseInstanceTypeLayoutInstanceType {
	if o == nil || IsNil(o.InstanceType) {
		var ret GetLayout200ResponseInstanceTypeLayoutInstanceType
		return ret
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetInstanceType() bool {
	if o != nil && !IsNil(o.InstanceType) {
		return true
	}
...
// SetInstanceType gets a reference to the given GetLayout200ResponseInstanceTypeLayoutInstanceType and assigns it to the InstanceType field.
...
func (o *GetLayout200ResponseInstanceTypeLayout) GetAccount() GetLayout200ResponseInstanceTypeLayoutAccount {
	if o == nil || IsNil(o.Account) {
		var ret GetLayout200ResponseInstanceTypeLayoutAccount
		return ret
	}
	return *o.Account
}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
// SetAccount gets a reference to the given GetLayout200ResponseInstanceTypeLayoutAccount and assigns it to the Account field.
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetInstanceVersion() bool {
	if o != nil && !IsNil(o.InstanceVersion) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetDescription() bool {
...
func (o *GetLayout200ResponseInstanceTypeLayout) SetDescriptionNil() {
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetCreatable() bool {
	if o != nil && !IsNil(o.Creatable) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetMemoryRequirement() bool {
...
func (o *GetLayout200ResponseInstanceTypeLayout) SetMemoryRequirementNil() {
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetSortOrder() bool {
	if o != nil && !IsNil(o.SortOrder) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetSupportsConvertToManaged() bool {
...
func (o *GetLayout200ResponseInstanceTypeLayout) SetSupportsConvertToManagedNil() {
...
func (o *GetLayout200ResponseInstanceTypeLayout) GetProvisionType() GetLayout200ResponseInstanceTypeLayoutProvisionType {
	if o == nil || IsNil(o.ProvisionType) {
		var ret GetLayout200ResponseInstanceTypeLayoutProvisionType
		return ret
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetProvisionType() bool {
	if o != nil && !IsNil(o.ProvisionType) {
		return true
	}
...
// SetProvisionType gets a reference to the given GetLayout200ResponseInstanceTypeLayoutProvisionType and assigns it to the ProvisionType field.
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetTaskSets() bool {
	if o != nil && !IsNil(o.TaskSets) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) GetContainerTypes() []GetLayout200ResponseInstanceTypeLayoutContainerTypesInner {
	if o == nil || IsNil(o.ContainerTypes) {
		var ret []GetLayout200ResponseInstanceTypeLayoutContainerTypesInner
		return ret
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetContainerTypes() bool {
	if o != nil && !IsNil(o.ContainerTypes) {
		return true
	}
...
// SetContainerTypes gets a reference to the given []GetLayout200ResponseInstanceTypeLayoutContainerTypesInner and assigns it to the ContainerTypes field.
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetMounts() bool {
	if o != nil && !IsNil(o.Mounts) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetPorts() bool {
	if o != nil && !IsNil(o.Ports) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetOptionTypes() bool {
	if o != nil && !IsNil(o.OptionTypes) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetEnvironmentVariables() bool {
	if o != nil && !IsNil(o.EnvironmentVariables) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetPriceSets() bool {
	if o != nil && !IsNil(o.PriceSets) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetSpecTemplates() bool {
	if o != nil && !IsNil(o.SpecTemplates) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetTfvarSecret() bool {
...
func (o *GetLayout200ResponseInstanceTypeLayout) SetTfvarSecretNil() {
...
func (o *GetLayout200ResponseInstanceTypeLayout) GetPermissions() GetLayout200ResponseInstanceTypeLayoutPermissions {
	if o == nil || IsNil(o.Permissions) {
		var ret GetLayout200ResponseInstanceTypeLayoutPermissions
		return ret
	}
...
func (o *GetLayout200ResponseInstanceTypeLayout) IsSetPermissions() bool {
	if o != nil && !IsNil(o.Permissions) {
		return true
	}
...
// SetPermissions gets a reference to the given GetLayout200ResponseInstanceTypeLayoutPermissions and assigns it to the Permissions field.
func (o *GetLayout200ResponseInstanceTypeLayout) SetPermissions(v GetLayout200ResponseInstanceTypeLayoutPermissions) {
	o.Permissions = &v
}

func (o GetLayout200ResponseInstanceTypeLayout) MarshalJSON() ([]byte, error) {
...
func (o GetLayout200ResponseInstanceTypeLayout) ToMap() (map[string]interface{}, error) {
...
type NullableGetLayout200ResponseInstanceTypeLayout struct {
	value *GetLayout200ResponseInstanceTypeLayout
	isSet bool
}

func (v NullableGetLayout200ResponseInstanceTypeLayout) Get() *GetLayout200ResponseInstanceTypeLayout {
	return v.value
}

func (v *NullableGetLayout200ResponseInstanceTypeLayout) Set(val *GetLayout200ResponseInstanceTypeLayout) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLayout200ResponseInstanceTypeLayout) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLayout200ResponseInstanceTypeLayout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLayout200ResponseInstanceTypeLayout(val *GetLayout200ResponseInstanceTypeLayout) *NullableGetLayout200ResponseInstanceTypeLayout {
	return &NullableGetLayout200ResponseInstanceTypeLayout{value: val, isSet: true}
}

func (v NullableGetLayout200ResponseInstanceTypeLayout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLayout200ResponseInstanceTypeLayout) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetLayout200ResponseInstanceTypeLayout) UnmarshalMapstructure(data any) (any, error) {
