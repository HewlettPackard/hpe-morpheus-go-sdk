...
type AddPolicies200ResponseAllOfPolicyConfig struct {
	...
	HostnamePolicyTypeConfiguration2                        *HostnamePolicyTypeConfiguration2
	InstanceNamePolicyTypeConfiguration2                    *InstanceNamePolicyTypeConfiguration2
	...
	RequiredNetworkPolicyTypeConfiguration2                 *RequiredNetworkPolicyTypeConfiguration2
...
// HostnamePolicyTypeConfiguration2AsAddPolicies200ResponseAllOfPolicyConfig is a convenience function that returns HostnamePolicyTypeConfiguration2 wrapped in AddPolicies200ResponseAllOfPolicyConfig
func HostnamePolicyTypeConfiguration2AsAddPolicies200ResponseAllOfPolicyConfig(v *HostnamePolicyTypeConfiguration2) AddPolicies200ResponseAllOfPolicyConfig {
	return AddPolicies200ResponseAllOfPolicyConfig{
		HostnamePolicyTypeConfiguration2: v,
	}
}

// InstanceNamePolicyTypeConfiguration2AsAddPolicies200ResponseAllOfPolicyConfig is a convenience function that returns InstanceNamePolicyTypeConfiguration2 wrapped in AddPolicies200ResponseAllOfPolicyConfig
func InstanceNamePolicyTypeConfiguration2AsAddPolicies200ResponseAllOfPolicyConfig(v *InstanceNamePolicyTypeConfiguration2) AddPolicies200ResponseAllOfPolicyConfig {
	return AddPolicies200ResponseAllOfPolicyConfig{
		InstanceNamePolicyTypeConfiguration2: v,
	}
}
...
// RequiredNetworkPolicyTypeConfiguration2AsAddPolicies200ResponseAllOfPolicyConfig is a convenience function that returns RequiredNetworkPolicyTypeConfiguration2 wrapped in AddPolicies200ResponseAllOfPolicyConfig
func RequiredNetworkPolicyTypeConfiguration2AsAddPolicies200ResponseAllOfPolicyConfig(v *RequiredNetworkPolicyTypeConfiguration2) AddPolicies200ResponseAllOfPolicyConfig {
	return AddPolicies200ResponseAllOfPolicyConfig{
		RequiredNetworkPolicyTypeConfiguration2: v,
	}
}
...
func (dst *AddPolicies200ResponseAllOfPolicyConfig) UnmarshalMapstructure(data any) (any, error) {
	...
	mapstructDecode(data, &dst.HostnamePolicyTypeConfiguration2)

	if IsEmpty(dst.HostnamePolicyTypeConfiguration2) {
		dst.HostnamePolicyTypeConfiguration2 = nil
	}

	mapstructDecode(data, &dst.InstanceNamePolicyTypeConfiguration2)

	if IsEmpty(dst.InstanceNamePolicyTypeConfiguration2) {
		dst.InstanceNamePolicyTypeConfiguration2 = nil
	}
	...
	mapstructDecode(data, &dst.RequiredNetworkPolicyTypeConfiguration2)

	if IsEmpty(dst.RequiredNetworkPolicyTypeConfiguration2) {
		dst.RequiredNetworkPolicyTypeConfiguration2 = nil
	}
...
func (dst *AddPolicies200ResponseAllOfPolicyConfig) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into HostnamePolicyTypeConfiguration2
	err = newStrictDecoder(data).Decode(&dst.HostnamePolicyTypeConfiguration2)
	if err == nil {
		jsonHostnamePolicyTypeConfiguration2, _ := json.Marshal(dst.HostnamePolicyTypeConfiguration2)
		if string(jsonHostnamePolicyTypeConfiguration2) == "{}" { // empty struct
			dst.HostnamePolicyTypeConfiguration2 = nil
		} else {
			if err = validator.Validate(dst.HostnamePolicyTypeConfiguration2); err != nil {
				dst.HostnamePolicyTypeConfiguration2 = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into InstanceNamePolicyTypeConfiguration2
	err = newStrictDecoder(data).Decode(&dst.InstanceNamePolicyTypeConfiguration2)
	if err == nil {
		jsonInstanceNamePolicyTypeConfiguration2, _ := json.Marshal(dst.InstanceNamePolicyTypeConfiguration2)
		if string(jsonInstanceNamePolicyTypeConfiguration2) == "{}" { // empty struct
			dst.InstanceNamePolicyTypeConfiguration2 = nil
		} else {
			if err = validator.Validate(dst.InstanceNamePolicyTypeConfiguration2); err != nil {
				dst.InstanceNamePolicyTypeConfiguration2 = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into RequiredNetworkPolicyTypeConfiguration2
	err = newStrictDecoder(data).Decode(&dst.RequiredNetworkPolicyTypeConfiguration2)
	if err == nil {
		jsonRequiredNetworkPolicyTypeConfiguration2, _ := json.Marshal(dst.RequiredNetworkPolicyTypeConfiguration2)
		if string(jsonRequiredNetworkPolicyTypeConfiguration2) == "{}" { // empty struct
			dst.RequiredNetworkPolicyTypeConfiguration2 = nil
		} else {
			if err = validator.Validate(dst.RequiredNetworkPolicyTypeConfiguration2); err != nil {
				dst.RequiredNetworkPolicyTypeConfiguration2 = nil
			} else {
				match++
			}
...
func (src AddPolicies200ResponseAllOfPolicyConfig) MarshalJSON() ([]byte, error) {
	...
	if src.HostnamePolicyTypeConfiguration2 != nil {
		return json.Marshal(&src.HostnamePolicyTypeConfiguration2)
	}

	if src.InstanceNamePolicyTypeConfiguration2 != nil {
		return json.Marshal(&src.InstanceNamePolicyTypeConfiguration2)
	}
	...
	if src.RequiredNetworkPolicyTypeConfiguration2 != nil {
		return json.Marshal(&src.RequiredNetworkPolicyTypeConfiguration2)
	}
...
func (obj *AddPolicies200ResponseAllOfPolicyConfig) GetActualInstance() interface{} {
	...
	if obj.HostnamePolicyTypeConfiguration2 != nil {
		return obj.HostnamePolicyTypeConfiguration2
	}

	if obj.InstanceNamePolicyTypeConfiguration2 != nil {
		return obj.InstanceNamePolicyTypeConfiguration2
	}
	...
	if obj.RequiredNetworkPolicyTypeConfiguration2 != nil {
		return obj.RequiredNetworkPolicyTypeConfiguration2
	}
