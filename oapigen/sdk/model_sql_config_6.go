...
// checks if the SQLConfig6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SQLConfig6{}

// SQLConfig6 struct for SQLConfig6
type SQLConfig6 struct {
...
func (o *SQLConfig6) IsSetDbPasswordHash() bool {
	if o != nil && !IsNil(o.DbPasswordHash) {
		return true
	}
...
func (o *SQLConfig6) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SQLConfig6) IsSetCheckResult() bool {
	if o != nil && !IsNil(o.CheckResult) {
		return true
	}
...
func (o *SQLConfig6) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SQLConfig6) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SQLConfig6) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SQLConfig6) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SQLConfig6) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o SQLConfig6) MarshalJSON() ([]byte, error) {
...
func (o SQLConfig6) ToMap() (map[string]interface{}, error) {
...
type NullableSQLConfig6 struct {
	value *SQLConfig6
	isSet bool
}

func (v NullableSQLConfig6) Get() *SQLConfig6 {
	return v.value
}

func (v *NullableSQLConfig6) Set(val *SQLConfig6) {
	v.value = val
	v.isSet = true
}

func (v NullableSQLConfig6) IsSet() bool {
	return v.isSet
}

func (v *NullableSQLConfig6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSQLConfig6(val *SQLConfig6) *NullableSQLConfig6 {
	return &NullableSQLConfig6{value: val, isSet: true}
}

func (v NullableSQLConfig6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSQLConfig6) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSQLConfig6) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SQLConfig6) UnmarshalJSON(data []byte) (err error) {
