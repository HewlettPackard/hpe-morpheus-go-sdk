...
type UpdateCloudFoldersRequestFolder struct {
	...
	ResourcePermissions  *UpdateCloudFoldersRequestFolderResourcePermissions `json:"resourcePermissions,omitempty"`
...
func (o *UpdateCloudFoldersRequestFolder) GetResourcePermissions() UpdateCloudFoldersRequestFolderResourcePermissions {
	if o == nil || IsNil(o.ResourcePermissions) {
		var ret UpdateCloudFoldersRequestFolderResourcePermissions
		return ret
	}
...
func (v NullableUpdateCloudFoldersRequestFolder) UnmarshalMapstructure(data any) (any, error) {
