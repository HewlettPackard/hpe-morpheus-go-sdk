...
// checks if the IdentitySourcesJumpCloudConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IdentitySourcesJumpCloudConfig{}
...
func NewIdentitySourcesJumpCloudConfig() *IdentitySourcesJumpCloudConfig {
	this := IdentitySourcesJumpCloudConfig{}
	return &this
}
...
func (o IdentitySourcesJumpCloudConfig) ToMap() (map[string]interface{}, error) {
...
func (v NullableIdentitySourcesJumpCloudConfig) UnmarshalMapstructure(data any) (any, error) {
