...
// checks if the InstanceConfigObject1VolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceConfigObject1VolumesInner{}

// InstanceConfigObject1VolumesInner struct for InstanceConfigObject1VolumesInner
type InstanceConfigObject1VolumesInner struct {
	...
	DatastoreId *InstanceConfigObject1VolumesInnerDatastoreId `json:"datastoreId,omitempty"`
...
type _InstanceConfigObject1VolumesInner InstanceConfigObject1VolumesInner
...
func NewInstanceConfigObject1VolumesInner() *InstanceConfigObject1VolumesInner {
	this := InstanceConfigObject1VolumesInner{}
	var id int64 = -1
	this.Id = &id
...
func (o *InstanceConfigObject1VolumesInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceConfigObject1VolumesInner) IsSetRootVolume() bool {
	if o != nil && !IsNil(o.RootVolume) {
		return true
	}
...
func (o *InstanceConfigObject1VolumesInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceConfigObject1VolumesInner) IsSetSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
...
func (o *InstanceConfigObject1VolumesInner) IsSetSizeId() bool {
...
func (o *InstanceConfigObject1VolumesInner) SetSizeIdNil() {
	o.SizeId.Set(nil)
}
...
func (o *InstanceConfigObject1VolumesInner) IsSetStorageType() bool {
...
func (o *InstanceConfigObject1VolumesInner) SetStorageTypeNil() {
...
func (o *InstanceConfigObject1VolumesInner) GetDatastoreId() InstanceConfigObject1VolumesInnerDatastoreId {
	if o == nil || IsNil(o.DatastoreId) {
		var ret InstanceConfigObject1VolumesInnerDatastoreId
		return ret
	}
...
func (o *InstanceConfigObject1VolumesInner) IsSetDatastoreId() bool {
	if o != nil && !IsNil(o.DatastoreId) {
		return true
	}
...
// SetDatastoreId gets a reference to the given InstanceConfigObject1VolumesInnerDatastoreId and assigns it to the DatastoreId field.
...
func (o *InstanceConfigObject1VolumesInner) IsSetControllerMountPoint() bool {
	if o != nil && !IsNil(o.ControllerMountPoint) {
		return true
	}
...
func (o *InstanceConfigObject1VolumesInner) IsSetStorageProfile() bool {
...
func (o *InstanceConfigObject1VolumesInner) SetStorageProfileNil() {
...
func (o *InstanceConfigObject1VolumesInner) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o InstanceConfigObject1VolumesInner) MarshalJSON() ([]byte, error) {
...
func (o InstanceConfigObject1VolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceConfigObject1VolumesInner struct {
	value *InstanceConfigObject1VolumesInner
	isSet bool
}

func (v NullableInstanceConfigObject1VolumesInner) Get() *InstanceConfigObject1VolumesInner {
	return v.value
}

func (v *NullableInstanceConfigObject1VolumesInner) Set(val *InstanceConfigObject1VolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceConfigObject1VolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceConfigObject1VolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceConfigObject1VolumesInner(val *InstanceConfigObject1VolumesInner) *NullableInstanceConfigObject1VolumesInner {
	return &NullableInstanceConfigObject1VolumesInner{value: val, isSet: true}
}

func (v NullableInstanceConfigObject1VolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceConfigObject1VolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceConfigObject1VolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceConfigObject1VolumesInner) UnmarshalJSON(data []byte) (err error) {
