...
// checks if the UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner{}

// UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner struct for UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner
type UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner struct {
...
func (o *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) IsSetValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) IsSetMasked() bool {
	if o != nil && !IsNil(o.Masked) {
		return true
	}
...
func (o *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) IsSetExport() bool {
	if o != nil && !IsNil(o.Export) {
		return true
	}
...
func (o UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner struct {
	value *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner
	isSet bool
}

func (v NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) Get() *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner {
	return v.value
}

func (v *NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) Set(val *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner(val *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) *NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner {
	return &NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner{value: val, isSet: true}
}

func (v NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateLayoutRequestInstanceTypeLayoutEnvironmentVariablesInner) UnmarshalJSON(data []byte) (err error) {
