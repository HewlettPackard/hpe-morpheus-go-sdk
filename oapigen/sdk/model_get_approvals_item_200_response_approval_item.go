...
type GetApprovalsItem200ResponseApprovalItem struct {
	...
	Approval     *GetApprovalsItem200ResponseApprovalItemApproval  `json:"approval,omitempty"`
	...
	Details              []GetApprovalsItem200ResponseApprovalItemDetailsInner `json:"details,omitempty"`
...
func (o *GetApprovalsItem200ResponseApprovalItem) GetApproval() GetApprovalsItem200ResponseApprovalItemApproval {
	if o == nil || IsNil(o.Approval) {
		var ret GetApprovalsItem200ResponseApprovalItemApproval
		return ret
	}
	return *o.Approval
}
...
// SetApproval gets a reference to the given GetApprovalsItem200ResponseApprovalItemApproval and assigns it to the Approval field.
...
func (o *GetApprovalsItem200ResponseApprovalItem) GetDetails() []GetApprovalsItem200ResponseApprovalItemDetailsInner {
	if o == nil {
		var ret []GetApprovalsItem200ResponseApprovalItemDetailsInner
		return ret
	}
	return o.Details
}
...
func (o *GetApprovalsItem200ResponseApprovalItem) IsSetDetails() bool {
	if o != nil && !IsNil(o.Details) {
		return true
	}
...
// SetDetails gets a reference to the given []GetApprovalsItem200ResponseApprovalItemDetailsInner and assigns it to the Details field.
