...
// checks if the Whoami200ResponseUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Whoami200ResponseUser{}

// Whoami200ResponseUser struct for Whoami200ResponseUser
type Whoami200ResponseUser struct {
...
type _Whoami200ResponseUser Whoami200ResponseUser
...
func (o *Whoami200ResponseUser) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetUsername() bool {
	if o != nil && !IsNil(o.Username) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetEmail() bool {
	if o != nil && !IsNil(o.Email) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetFirstName() bool {
	if o != nil && !IsNil(o.FirstName) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetLastName() bool {
	if o != nil && !IsNil(o.LastName) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetReceiveNotifications() bool {
	if o != nil && !IsNil(o.ReceiveNotifications) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetIsUsing2FA() bool {
	if o != nil && !IsNil(o.IsUsing2FA) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetAccountExpired() bool {
	if o != nil && !IsNil(o.AccountExpired) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetAccountLocked() bool {
	if o != nil && !IsNil(o.AccountLocked) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetPasswordExpired() bool {
	if o != nil && !IsNil(o.PasswordExpired) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetLoginCount() bool {
	if o != nil && !IsNil(o.LoginCount) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetLoginAttempts() bool {
	if o != nil && !IsNil(o.LoginAttempts) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetLastLoginDate() bool {
	if o != nil && !IsNil(o.LastLoginDate) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetRoles() bool {
	if o != nil && !IsNil(o.Roles) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetLinuxUsername() bool {
...
func (o *Whoami200ResponseUser) SetLinuxUsernameNil() {
...
func (o *Whoami200ResponseUser) IsSetLinuxPassword() bool {
...
func (o *Whoami200ResponseUser) SetLinuxPasswordNil() {
...
func (o *Whoami200ResponseUser) IsSetLinuxKeyPairId() bool {
...
func (o *Whoami200ResponseUser) SetLinuxKeyPairIdNil() {
...
func (o *Whoami200ResponseUser) IsSetWindowsUsername() bool {
...
func (o *Whoami200ResponseUser) SetWindowsUsernameNil() {
...
func (o *Whoami200ResponseUser) IsSetWindowsPassword() bool {
...
func (o *Whoami200ResponseUser) SetWindowsPasswordNil() {
...
func (o *Whoami200ResponseUser) IsSetDefaultPersona() bool {
	if o != nil && !IsNil(o.DefaultPersona) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *Whoami200ResponseUser) IsSetAccess() bool {
	if o != nil && !IsNil(o.Access) {
		return true
	}
...
func (o Whoami200ResponseUser) MarshalJSON() ([]byte, error) {
...
func (o Whoami200ResponseUser) ToMap() (map[string]interface{}, error) {
...
type NullableWhoami200ResponseUser struct {
	value *Whoami200ResponseUser
	isSet bool
}

func (v NullableWhoami200ResponseUser) Get() *Whoami200ResponseUser {
	return v.value
}

func (v *NullableWhoami200ResponseUser) Set(val *Whoami200ResponseUser) {
	v.value = val
	v.isSet = true
}

func (v NullableWhoami200ResponseUser) IsSet() bool {
	return v.isSet
}

func (v *NullableWhoami200ResponseUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWhoami200ResponseUser(val *Whoami200ResponseUser) *NullableWhoami200ResponseUser {
	return &NullableWhoami200ResponseUser{value: val, isSet: true}
}

func (v NullableWhoami200ResponseUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWhoami200ResponseUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableWhoami200ResponseUser) UnmarshalMapstructure(data any) (any, error) {
...
func (o *Whoami200ResponseUser) UnmarshalJSON(data []byte) (err error) {
