...
type WhitelabelSettings struct {
	...
	SupportMenuLinks          []WhitelabelSettingsSupportMenuLinksInner `json:"supportMenuLinks,omitempty"`
...
func (o *WhitelabelSettings) GetSupportMenuLinks() []WhitelabelSettingsSupportMenuLinksInner {
	if o == nil || IsNil(o.SupportMenuLinks) {
		var ret []WhitelabelSettingsSupportMenuLinksInner
		return ret
	}
...
// SetSupportMenuLinks gets a reference to the given []WhitelabelSettingsSupportMenuLinksInner and assigns it to the SupportMenuLinks field.
