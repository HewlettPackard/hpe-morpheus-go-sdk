...
func NewGetPriceSets200ResponsePriceSet() *GetPriceSets200ResponsePriceSet {
	this := GetPriceSets200ResponsePriceSet{}
	return &this
}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetPriceUnit() bool {
	if o != nil && !IsNil(o.PriceUnit) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetRegionCode() bool {
	if o != nil && !IsNil(o.RegionCode) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetSystemCreated() bool {
	if o != nil && !IsNil(o.SystemCreated) {
		return true
	}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetZone() bool {
...
func (o *GetPriceSets200ResponsePriceSet) SetZoneNil() {
	o.Zone.Set(nil)
}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetZonePool() bool {
...
func (o *GetPriceSets200ResponsePriceSet) SetZonePoolNil() {
	o.ZonePool.Set(nil)
}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetAccount() bool {
...
func (o *GetPriceSets200ResponsePriceSet) SetAccountNil() {
	o.Account.Set(nil)
}
...
func (o *GetPriceSets200ResponsePriceSet) IsSetPrices() bool {
	if o != nil && !IsNil(o.Prices) {
		return true
	}
