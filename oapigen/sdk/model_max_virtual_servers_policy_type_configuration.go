...
// MaxVirtualServersPolicyTypeConfiguration - Max Virtual Servers
...
func (v NullableMaxVirtualServersPolicyTypeConfiguration) UnmarshalMapstructure(data any) (any, error) {
