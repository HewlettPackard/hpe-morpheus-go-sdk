...
type GetCredentialType200Response struct {
	CredentialType       *GetCredentialType200ResponseCredentialType `json:"credentialType,omitempty"`
...
func (v NullableGetCredentialType200Response) UnmarshalMapstructure(data any) (any, error) {
