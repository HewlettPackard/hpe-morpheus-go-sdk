...
// checks if the SQLConfig2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SQLConfig2{}

// SQLConfig2 struct for SQLConfig2
type SQLConfig2 struct {
...
func (o *SQLConfig2) IsSetDbPasswordHash() bool {
	if o != nil && !IsNil(o.DbPasswordHash) {
		return true
	}
...
func (o *SQLConfig2) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SQLConfig2) IsSetCheckResult() bool {
	if o != nil && !IsNil(o.CheckResult) {
		return true
	}
...
func (o *SQLConfig2) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SQLConfig2) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SQLConfig2) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SQLConfig2) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SQLConfig2) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o SQLConfig2) MarshalJSON() ([]byte, error) {
...
func (o SQLConfig2) ToMap() (map[string]interface{}, error) {
...
type NullableSQLConfig2 struct {
	value *SQLConfig2
	isSet bool
}

func (v NullableSQLConfig2) Get() *SQLConfig2 {
	return v.value
}

func (v *NullableSQLConfig2) Set(val *SQLConfig2) {
	v.value = val
	v.isSet = true
}

func (v NullableSQLConfig2) IsSet() bool {
	return v.isSet
}

func (v *NullableSQLConfig2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSQLConfig2(val *SQLConfig2) *NullableSQLConfig2 {
	return &NullableSQLConfig2{value: val, isSet: true}
}

func (v NullableSQLConfig2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSQLConfig2) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSQLConfig2) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SQLConfig2) UnmarshalJSON(data []byte) (err error) {
