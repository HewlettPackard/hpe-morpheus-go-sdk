...
// checks if the PolicyCloudCreatePolicyTypeConfigOneOf26 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyCloudCreatePolicyTypeConfigOneOf26{}

// PolicyCloudCreatePolicyTypeConfigOneOf26 - Shutdown
type PolicyCloudCreatePolicyTypeConfigOneOf26 struct {
...
type _PolicyCloudCreatePolicyTypeConfigOneOf26 PolicyCloudCreatePolicyTypeConfigOneOf26
...
func NewPolicyCloudCreatePolicyTypeConfigOneOf26() *PolicyCloudCreatePolicyTypeConfigOneOf26 {
	this := PolicyCloudCreatePolicyTypeConfigOneOf26{}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o PolicyCloudCreatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
...
func (o PolicyCloudCreatePolicyTypeConfigOneOf26) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyCloudCreatePolicyTypeConfigOneOf26 struct {
	value *PolicyCloudCreatePolicyTypeConfigOneOf26
	isSet bool
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf26) Get() *PolicyCloudCreatePolicyTypeConfigOneOf26 {
	return v.value
}

func (v *NullablePolicyCloudCreatePolicyTypeConfigOneOf26) Set(val *PolicyCloudCreatePolicyTypeConfigOneOf26) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf26) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyCloudCreatePolicyTypeConfigOneOf26) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyCloudCreatePolicyTypeConfigOneOf26(val *PolicyCloudCreatePolicyTypeConfigOneOf26) *NullablePolicyCloudCreatePolicyTypeConfigOneOf26 {
	return &NullablePolicyCloudCreatePolicyTypeConfigOneOf26{value: val, isSet: true}
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf26) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyCloudCreatePolicyTypeConfigOneOf26) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePolicyCloudCreatePolicyTypeConfigOneOf26) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyCloudCreatePolicyTypeConfigOneOf26) UnmarshalJSON(data []byte) (err error) {
