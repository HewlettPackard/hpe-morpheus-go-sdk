...
// checks if the AddClusterRequestClusterLayout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddClusterRequestClusterLayout{}
...
func NewAddClusterRequestClusterLayout() *AddClusterRequestClusterLayout {
	this := AddClusterRequestClusterLayout{}
	return &this
}
...
func (o *AddClusterRequestClusterLayout) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddClusterRequestClusterLayout) MarshalJSON() ([]byte, error) {
...
func (o AddClusterRequestClusterLayout) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddClusterRequestClusterLayout) UnmarshalMapstructure(data any) (any, error) {
