...
func (r ApiAcknowledgeHealthAlarmRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *HealthAPIService) AcknowledgeHealthAlarmExecute(r ApiAcknowledgeHealthAlarmRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiAcknowledgeHealthAlarmsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
//
//	@return RemoveExecuteSchedules200Response
func (a *HealthAPIService) AcknowledgeHealthAlarmsExecute(r ApiAcknowledgeHealthAlarmsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
