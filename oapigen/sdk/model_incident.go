...
func (o *Incident) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
func (o *Incident) IsSetAutoClose() bool {
	if o != nil && !IsNil(o.AutoClose) {
		return true
	}
...
func (o *Incident) IsSetChannelId() bool {
	if o != nil && !IsNil(o.ChannelId) {
		return true
	}
...
func (o *Incident) IsSetCheckGroups() bool {
	if o != nil && !IsNil(o.CheckGroups) {
		return true
	}
...
func (o *Incident) IsSetChecks() bool {
	if o != nil && !IsNil(o.Checks) {
		return true
	}
...
func (o *Incident) IsSetDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (o *Incident) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *Incident) IsSetMuted() bool {
	if o != nil && !IsNil(o.Muted) {
		return true
	}
...
func (o *Incident) IsSetLastCheckTime() bool {
	if o != nil && !IsNil(o.LastCheckTime) {
		return true
	}
...
func (o *Incident) IsSetLastError() bool {
	if o != nil && !IsNil(o.LastError) {
		return true
	}
...
func (o *Incident) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *Incident) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *Incident) IsSetSeverityId() bool {
	if o != nil && !IsNil(o.SeverityId) {
		return true
	}
...
func (o *Incident) IsSetStartDate() bool {
	if o != nil && !IsNil(o.StartDate) {
		return true
	}
...
func (o *Incident) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *Incident) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
