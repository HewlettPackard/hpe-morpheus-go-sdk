...
// checks if the VMWareInstanceConfiguration4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VMWareInstanceConfiguration4{}

// VMWareInstanceConfiguration4 struct for VMWareInstanceConfiguration4
type VMWareInstanceConfiguration4 struct {
...
type _VMWareInstanceConfiguration4 VMWareInstanceConfiguration4
...
func NewVMWareInstanceConfiguration4() *VMWareInstanceConfiguration4 {
	this := VMWareInstanceConfiguration4{}
...
func (o *VMWareInstanceConfiguration4) IsSetNoAgent() bool {
...
func (o *VMWareInstanceConfiguration4) SetNoAgentNil() {
	o.NoAgent.Set(nil)
}
...
func (o *VMWareInstanceConfiguration4) IsSetResourcePoolId() bool {
	if o != nil && !IsNil(o.ResourcePoolId) {
		return true
	}
...
func (o *VMWareInstanceConfiguration4) IsSetHostId() bool {
	if o != nil && !IsNil(o.HostId) {
		return true
	}
...
func (o *VMWareInstanceConfiguration4) IsSetSmbiosAssetTag() bool {
	if o != nil && !IsNil(o.SmbiosAssetTag) {
		return true
	}
...
func (o *VMWareInstanceConfiguration4) IsSetNestedVirtualization() bool {
	if o != nil && !IsNil(o.NestedVirtualization) {
		return true
	}
...
func (o *VMWareInstanceConfiguration4) IsSetVmwareFolderId() bool {
	if o != nil && !IsNil(o.VmwareFolderId) {
		return true
	}
...
func (o *VMWareInstanceConfiguration4) IsSetCreateUser() bool {
...
func (o *VMWareInstanceConfiguration4) SetCreateUserNil() {
...
func (o *VMWareInstanceConfiguration4) IsSetTemplate() bool {
	if o != nil && !IsNil(o.Template) {
		return true
	}
...
func (o VMWareInstanceConfiguration4) MarshalJSON() ([]byte, error) {
...
func (o VMWareInstanceConfiguration4) ToMap() (map[string]interface{}, error) {
...
type NullableVMWareInstanceConfiguration4 struct {
	value *VMWareInstanceConfiguration4
	isSet bool
}

func (v NullableVMWareInstanceConfiguration4) Get() *VMWareInstanceConfiguration4 {
	return v.value
}

func (v *NullableVMWareInstanceConfiguration4) Set(val *VMWareInstanceConfiguration4) {
	v.value = val
	v.isSet = true
}

func (v NullableVMWareInstanceConfiguration4) IsSet() bool {
	return v.isSet
}

func (v *NullableVMWareInstanceConfiguration4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVMWareInstanceConfiguration4(val *VMWareInstanceConfiguration4) *NullableVMWareInstanceConfiguration4 {
	return &NullableVMWareInstanceConfiguration4{value: val, isSet: true}
}

func (v NullableVMWareInstanceConfiguration4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVMWareInstanceConfiguration4) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableVMWareInstanceConfiguration4) UnmarshalMapstructure(data any) (any, error) {
...
func (o *VMWareInstanceConfiguration4) UnmarshalJSON(data []byte) (err error) {
