...
// checks if the BlueprintCreateSuccessConfigOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintCreateSuccessConfigOneOf1{}

// BlueprintCreateSuccessConfigOneOf1 struct for BlueprintCreateSuccessConfigOneOf1
type BlueprintCreateSuccessConfigOneOf1 struct {
	...
	CloudFormation *BlueprintCreateSuccessConfigOneOf1CloudFormation `json:"cloudFormation,omitempty"`
...
type _BlueprintCreateSuccessConfigOneOf1 BlueprintCreateSuccessConfigOneOf1
...
func NewBlueprintCreateSuccessConfigOneOf1() *BlueprintCreateSuccessConfigOneOf1 {
	this := BlueprintCreateSuccessConfigOneOf1{}
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetImage() bool {
	if o != nil && !IsNil(o.Image) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1) GetCloudFormation() BlueprintCreateSuccessConfigOneOf1CloudFormation {
	if o == nil || IsNil(o.CloudFormation) {
		var ret BlueprintCreateSuccessConfigOneOf1CloudFormation
		return ret
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetCloudFormation() bool {
	if o != nil && !IsNil(o.CloudFormation) {
		return true
	}
...
// SetCloudFormation gets a reference to the given BlueprintCreateSuccessConfigOneOf1CloudFormation and assigns it to the CloudFormation field.
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetResourcePermission() bool {
	if o != nil && !IsNil(o.ResourcePermission) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1) IsSetTenant() bool {
	if o != nil && !IsNil(o.Tenant) {
		return true
	}
...
func (o BlueprintCreateSuccessConfigOneOf1) MarshalJSON() ([]byte, error) {
...
func (o BlueprintCreateSuccessConfigOneOf1) ToMap() (map[string]interface{}, error) {
...
type NullableBlueprintCreateSuccessConfigOneOf1 struct {
	value *BlueprintCreateSuccessConfigOneOf1
	isSet bool
}

func (v NullableBlueprintCreateSuccessConfigOneOf1) Get() *BlueprintCreateSuccessConfigOneOf1 {
	return v.value
}

func (v *NullableBlueprintCreateSuccessConfigOneOf1) Set(val *BlueprintCreateSuccessConfigOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintCreateSuccessConfigOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintCreateSuccessConfigOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintCreateSuccessConfigOneOf1(val *BlueprintCreateSuccessConfigOneOf1) *NullableBlueprintCreateSuccessConfigOneOf1 {
	return &NullableBlueprintCreateSuccessConfigOneOf1{value: val, isSet: true}
}

func (v NullableBlueprintCreateSuccessConfigOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintCreateSuccessConfigOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableBlueprintCreateSuccessConfigOneOf1) UnmarshalMapstructure(data any) (any, error) {
...
func (o *BlueprintCreateSuccessConfigOneOf1) UnmarshalJSON(data []byte) (err error) {
