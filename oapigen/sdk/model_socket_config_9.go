...
func (o *SocketConfig9) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SocketConfig9) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SocketConfig9) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SocketConfig9) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SocketConfig9) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
