...
type AddVDIApps200Response struct {
	...
	AddVDIApps200ResponseAnyOf1 *AddVDIApps200ResponseAnyOf1
}
...
func (dst *AddVDIApps200Response) UnmarshalMapstructure(data any) (any, error) {
	...
	mapstructDecode(data, &dst.AddVDIApps200ResponseAnyOf1)

	if IsEmpty(dst.AddVDIApps200ResponseAnyOf1) {
...
func (src AddVDIApps200Response) MarshalJSON() ([]byte, error) {
	...
	if src.AddVDIApps200ResponseAnyOf1 != nil {
