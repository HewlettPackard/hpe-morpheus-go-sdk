...
func NewBillingServersServersInnerUsagesInnerApplicablePricesInner() *BillingServersServersInnerUsagesInnerApplicablePricesInner {
	this := BillingServersServersInnerUsagesInnerApplicablePricesInner{}
	return &this
}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) IsSetStartDate() bool {
	if o != nil && !IsNil(o.StartDate) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) IsSetEndDate() bool {
	if o != nil && !IsNil(o.EndDate) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) IsSetNumUnits() bool {
	if o != nil && !IsNil(o.NumUnits) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) IsSetCost() bool {
	if o != nil && !IsNil(o.Cost) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) IsSetPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) IsSetCurrency() bool {
	if o != nil && !IsNil(o.Currency) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) GetPrices() []BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner {
	if o == nil || IsNil(o.Prices) {
		var ret []BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner
		return ret
	}
	return o.Prices
}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInner) IsSetPrices() bool {
	if o != nil && !IsNil(o.Prices) {
		return true
	}
...
// SetPrices gets a reference to the given []BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner and assigns it to the Prices field.
