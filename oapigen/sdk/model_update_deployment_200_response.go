...
type UpdateDeployment200Response struct {
	Deployment           *UpdateDeployment200ResponseAllOfDeployment `json:"deployment,omitempty"`
...
func (o *UpdateDeployment200Response) GetDeployment() UpdateDeployment200ResponseAllOfDeployment {
	if o == nil || IsNil(o.Deployment) {
		var ret UpdateDeployment200ResponseAllOfDeployment
		return ret
	}
	return *o.Deployment
}
...
func (v NullableUpdateDeployment200Response) UnmarshalMapstructure(data any) (any, error) {
