...
// checks if the InstanceTypeLayoutCreateEnvironmentVariablesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceTypeLayoutCreateEnvironmentVariablesInner{}

// InstanceTypeLayoutCreateEnvironmentVariablesInner struct for InstanceTypeLayoutCreateEnvironmentVariablesInner
type InstanceTypeLayoutCreateEnvironmentVariablesInner struct {
...
func NewInstanceTypeLayoutCreateEnvironmentVariablesInnerWithDefaults() *InstanceTypeLayoutCreateEnvironmentVariablesInner {
	this := InstanceTypeLayoutCreateEnvironmentVariablesInner{}
	var masked bool = false
	this.Masked = &masked
	var export bool = false
...
func (o *InstanceTypeLayoutCreateEnvironmentVariablesInner) IsSetValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *InstanceTypeLayoutCreateEnvironmentVariablesInner) IsSetMasked() bool {
	if o != nil && !IsNil(o.Masked) {
		return true
	}
...
func (o *InstanceTypeLayoutCreateEnvironmentVariablesInner) IsSetExport() bool {
	if o != nil && !IsNil(o.Export) {
		return true
	}
...
func (o InstanceTypeLayoutCreateEnvironmentVariablesInner) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceTypeLayoutCreateEnvironmentVariablesInner struct {
	value *InstanceTypeLayoutCreateEnvironmentVariablesInner
	isSet bool
}

func (v NullableInstanceTypeLayoutCreateEnvironmentVariablesInner) Get() *InstanceTypeLayoutCreateEnvironmentVariablesInner {
	return v.value
}

func (v *NullableInstanceTypeLayoutCreateEnvironmentVariablesInner) Set(val *InstanceTypeLayoutCreateEnvironmentVariablesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceTypeLayoutCreateEnvironmentVariablesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceTypeLayoutCreateEnvironmentVariablesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceTypeLayoutCreateEnvironmentVariablesInner(val *InstanceTypeLayoutCreateEnvironmentVariablesInner) *NullableInstanceTypeLayoutCreateEnvironmentVariablesInner {
	return &NullableInstanceTypeLayoutCreateEnvironmentVariablesInner{value: val, isSet: true}
}

func (v NullableInstanceTypeLayoutCreateEnvironmentVariablesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceTypeLayoutCreateEnvironmentVariablesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceTypeLayoutCreateEnvironmentVariablesInner) UnmarshalMapstructure(data any) (any, error) {
