...
// checks if the SaveClusterAffinityGroup200ResponseAllOfAffinityGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveClusterAffinityGroup200ResponseAllOfAffinityGroup{}

// SaveClusterAffinityGroup200ResponseAllOfAffinityGroup struct for SaveClusterAffinityGroup200ResponseAllOfAffinityGroup
type SaveClusterAffinityGroup200ResponseAllOfAffinityGroup struct {
...
type _SaveClusterAffinityGroup200ResponseAllOfAffinityGroup SaveClusterAffinityGroup200ResponseAllOfAffinityGroup
...
func NewSaveClusterAffinityGroup200ResponseAllOfAffinityGroup() *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup {
	this := SaveClusterAffinityGroup200ResponseAllOfAffinityGroup{}
	return &this
}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetAffinityType() bool {
	if o != nil && !IsNil(o.AffinityType) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetSource() bool {
	if o != nil && !IsNil(o.Source) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetRefType() bool {
	if o != nil && !IsNil(o.RefType) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetRefId() bool {
	if o != nil && !IsNil(o.RefId) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetPool() bool {
	if o != nil && !IsNil(o.Pool) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetServers() bool {
	if o != nil && !IsNil(o.Servers) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetTenants() bool {
	if o != nil && !IsNil(o.Tenants) {
		return true
	}
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSetResourcePermissions() bool {
	if o != nil && !IsNil(o.ResourcePermissions) {
		return true
	}
...
func (o SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) MarshalJSON() ([]byte, error) {
...
func (o SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) ToMap() (map[string]interface{}, error) {
...
type NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup struct {
	value *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup
	isSet bool
}

func (v NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup) Get() *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup {
	return v.value
}

func (v *NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup) Set(val *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup(val *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) *NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup {
	return &NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup{value: val, isSet: true}
}

func (v NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSaveClusterAffinityGroup200ResponseAllOfAffinityGroup) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SaveClusterAffinityGroup200ResponseAllOfAffinityGroup) UnmarshalJSON(data []byte) (err error) {
