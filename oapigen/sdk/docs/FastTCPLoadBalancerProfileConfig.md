# FastTCPLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag1**](LoadBalancerProfileTag1.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastTCPLoadBalancerProfileConfig{
    // Set fields directly
}
```
