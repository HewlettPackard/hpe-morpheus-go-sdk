# HTTPLoadBalancerProfileConfig5
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag40**](LoadBalancerProfileTag40.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &HTTPLoadBalancerProfileConfig5{
    // Set fields directly
}
```
