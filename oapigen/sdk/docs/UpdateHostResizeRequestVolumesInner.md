...
**DatastoreId** | Pointer to [**CloneInstanceRequestVolumesInnerDatastoreId**](CloneInstanceRequestVolumesInnerDatastoreId.md) |  | [optional] 
...
```go
obj := &UpdateHostResizeRequestVolumesInner{
    // Set fields directly
}
```
