# ExpirationPolicyTypeConfiguration8
...
### NewExpirationPolicyTypeConfiguration8

`func NewExpirationPolicyTypeConfiguration8(lifecycleType string, ) *ExpirationPolicyTypeConfiguration8`

NewExpirationPolicyTypeConfiguration8 instantiates a new ExpirationPolicyTypeConfiguration8 object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewExpirationPolicyTypeConfiguration8WithDefaults
...
`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleAge() string`

GetLifecycleAge returns the LifecycleAge field if non-nil, zero value otherwise.

### GetLifecycleAgeOk

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleAgeOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetLifecycleAge(v string)`

SetLifecycleAge sets LifecycleAge field to given value.

### HasLifecycleAge

`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleAge() bool`

HasLifecycleAge returns a boolean if a field has been set.

### GetLifecycleRenewal

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleRenewal() string`

GetLifecycleRenewal returns the LifecycleRenewal field if non-nil, zero value otherwise.

### GetLifecycleRenewalOk

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleRenewalOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetLifecycleRenewal(v string)`

SetLifecycleRenewal sets LifecycleRenewal field to given value.

### HasLifecycleRenewal

`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleRenewal() bool`

HasLifecycleRenewal returns a boolean if a field has been set.

### GetLifecycleNotify

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleNotify() string`

GetLifecycleNotify returns the LifecycleNotify field if non-nil, zero value otherwise.

### GetLifecycleNotifyOk

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleNotifyOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetLifecycleNotify(v string)`

SetLifecycleNotify sets LifecycleNotify field to given value.

### HasLifecycleNotify

`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleNotify() bool`

HasLifecycleNotify returns a boolean if a field has been set.

### GetLifecycleMessage

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleMessage() string`

GetLifecycleMessage returns the LifecycleMessage field if non-nil, zero value otherwise.

### GetLifecycleMessageOk

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleMessageOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetLifecycleMessage(v string)`

SetLifecycleMessage sets LifecycleMessage field to given value.

### HasLifecycleMessage

`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleMessage() bool`

HasLifecycleMessage returns a boolean if a field has been set.

### GetLifecycleAutoRenew

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleAutoRenew() string`

GetLifecycleAutoRenew returns the LifecycleAutoRenew field if non-nil, zero value otherwise.

### GetLifecycleAutoRenewOk

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleAutoRenewOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetLifecycleAllowExtend(v string)`

SetLifecycleAllowExtend sets LifecycleAllowExtend field to given value.

### HasLifecycleAllowExtend

`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleAllowExtend() bool`

HasLifecycleAllowExtend returns a boolean if a field has been set.

### GetLifecycleExtensionsBeforeApproval

`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleExtensionsBeforeApproval() string`
...
`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleExtensionsBeforeApprovalOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetLifecycleExtensionsBeforeApproval(v string)`
...
`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleExtensionsBeforeApproval() bool`

HasLifecycleExtensionsBeforeApproval returns a boolean if a field has been set.

### GetAccountIntegrationId

`func (o *ExpirationPolicyTypeConfiguration8) GetAccountIntegrationId() string`

GetAccountIntegrationId returns the AccountIntegrationId field if non-nil, zero value otherwise.

### GetAccountIntegrationIdOk

`func (o *ExpirationPolicyTypeConfiguration8) GetAccountIntegrationIdOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetAccountIntegrationId(v string)`

SetAccountIntegrationId sets AccountIntegrationId field to given value.

### HasAccountIntegrationId

`func (o *ExpirationPolicyTypeConfiguration8) HasAccountIntegrationId() bool`
...
`func (o *ExpirationPolicyTypeConfiguration8) GetLifecycleWorkflowIdOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetLifecycleWorkflowId(v string)`

SetLifecycleWorkflowId sets LifecycleWorkflowId field to given value.

### HasLifecycleWorkflowId

`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleWorkflowId() bool`

HasLifecycleWorkflowId returns a boolean if a field has been set.

### GetFlowId

`func (o *ExpirationPolicyTypeConfiguration8) GetFlowId() string`

GetFlowId returns the FlowId field if non-nil, zero value otherwise.

### GetFlowIdOk

`func (o *ExpirationPolicyTypeConfiguration8) GetFlowIdOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetFlowId(v string)`

SetFlowId sets FlowId field to given value.

### HasFlowId

`func (o *ExpirationPolicyTypeConfiguration8) HasFlowId() bool`

HasFlowId returns a boolean if a field has been set.

### GetWorkflowType

`func (o *ExpirationPolicyTypeConfiguration8) GetWorkflowType() string`

GetWorkflowType returns the WorkflowType field if non-nil, zero value otherwise.

### GetWorkflowTypeOk

`func (o *ExpirationPolicyTypeConfiguration8) GetWorkflowTypeOk() (*string, bool)`
...
`func (o *ExpirationPolicyTypeConfiguration8) SetWorkflowType(v string)`

SetWorkflowType sets WorkflowType field to given value.

### HasWorkflowType

`func (o *ExpirationPolicyTypeConfiguration8) HasWorkflowType() bool`
...
`func (o *ExpirationPolicyTypeConfiguration8) HasLifecycleHideFixed() bool`
