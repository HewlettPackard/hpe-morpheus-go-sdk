...
**NetworkServer** | Pointer to [**NetworkInterfaceUpdateSuccessServerZoneNetworkServer**](NetworkInterfaceUpdateSuccessServerZoneNetworkServer.md) |  | [optional] 
...
```go
obj := &NetworkInterfaceUpdateSuccessServerZone{
    // Set fields directly
}
```
