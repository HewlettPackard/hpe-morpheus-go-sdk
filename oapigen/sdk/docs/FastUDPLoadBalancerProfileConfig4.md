# FastUDPLoadBalancerProfileConfig4
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag34**](LoadBalancerProfileTag34.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastUDPLoadBalancerProfileConfig4{
    // Set fields directly
}
```
