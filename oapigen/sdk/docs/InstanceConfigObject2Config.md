...
`func (o *InstanceConfigObject2Config) GetAzureRegion() string`

GetAzureRegion returns the AzureRegion field if non-nil, zero value otherwise.

### GetAzureRegionOk

`func (o *InstanceConfigObject2Config) GetAzureRegionOk() (*string, bool)`
...
`func (o *InstanceConfigObject2Config) SetAzuresecurityGroupId(v string)`

SetAzuresecurityGroupId sets AzuresecurityGroupId field to given value.

### HasAzuresecurityGroupId

`func (o *InstanceConfigObject2Config) HasAzuresecurityGroupId() bool`
