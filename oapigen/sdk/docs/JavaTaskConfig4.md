...
Use the Nullable wrapper methods:
- `obj.JsScript.IsSet()` — check if set
- `obj.JsScript.Get()` — get the inner value (returns pointer)
- `obj.JsScript.Set(&val)` — set the value
- `obj.JsScript.Unset()` — clear the value
### Host (Nullable)
