# SourceIPPersistenceLoadBalancerProfileConfig1
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag12**](LoadBalancerProfileTag12.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &SourceIPPersistenceLoadBalancerProfileConfig1{
    // Set fields directly
}
```
