# GenericPersistenceLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag5**](LoadBalancerProfileTag5.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &GenericPersistenceLoadBalancerProfileConfig{
    // Set fields directly
}
```
