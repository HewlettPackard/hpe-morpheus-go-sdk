...
**Terraform** | Pointer to [**BlueprintTerraformCreateSuccessTerraform**](BlueprintTerraformCreateSuccessTerraform.md) |  | [optional] 
**Config** | Pointer to [**BlueprintTerraformCreateSuccessConfig**](BlueprintTerraformCreateSuccessConfig.md) |  | [optional] 
...
`func (o *BlueprintTerraformCreateSuccess) GetTerraform() BlueprintTerraformCreateSuccessTerraform`

GetTerraform returns the Terraform field if non-nil, zero value otherwise.

### GetTerraformOk

`func (o *BlueprintTerraformCreateSuccess) GetTerraformOk() (*BlueprintTerraformCreateSuccessTerraform, bool)`
...
`func (o *BlueprintTerraformCreateSuccess) SetTerraform(v BlueprintTerraformCreateSuccessTerraform)`
...
`func (o *BlueprintTerraformCreateSuccess) GetConfig() BlueprintTerraformCreateSuccessConfig`

GetConfig returns the Config field if non-nil, zero value otherwise.

### GetConfigOk

`func (o *BlueprintTerraformCreateSuccess) GetConfigOk() (*BlueprintTerraformCreateSuccessConfig, bool)`
...
`func (o *BlueprintTerraformCreateSuccess) SetConfig(v BlueprintTerraformCreateSuccessConfig)`
