# LoadBalancerProfileConfigSourceIpPersistence
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag52**](LoadBalancerProfileTag52.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &LoadBalancerProfileConfigSourceIpPersistence{
    // Set fields directly
}
```
