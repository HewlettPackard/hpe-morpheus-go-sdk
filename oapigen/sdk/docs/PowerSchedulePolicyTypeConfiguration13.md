# PowerSchedulePolicyTypeConfiguration13
...
### NewPowerSchedulePolicyTypeConfiguration13

`func NewPowerSchedulePolicyTypeConfiguration13(powerScheduleType string, ) *PowerSchedulePolicyTypeConfiguration13`

NewPowerSchedulePolicyTypeConfiguration13 instantiates a new PowerSchedulePolicyTypeConfiguration13 object
...
`func (o *PowerSchedulePolicyTypeConfiguration13) GetPowerScheduleType() string`

GetPowerScheduleType returns the PowerScheduleType field if non-nil, zero value otherwise.

### GetPowerScheduleTypeOk

`func (o *PowerSchedulePolicyTypeConfiguration13) GetPowerScheduleTypeOk() (*string, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration13) SetPowerScheduleType(v string)`
...
`func (o *PowerSchedulePolicyTypeConfiguration13) GetPowerSchedule() string`

GetPowerSchedule returns the PowerSchedule field if non-nil, zero value otherwise.

### GetPowerScheduleOk

`func (o *PowerSchedulePolicyTypeConfiguration13) GetPowerScheduleOk() (*string, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration13) SetPowerSchedule(v string)`

SetPowerSchedule sets PowerSchedule field to given value.

### HasPowerSchedule

`func (o *PowerSchedulePolicyTypeConfiguration13) HasPowerSchedule() bool`

HasPowerSchedule returns a boolean if a field has been set.

### GetPowerScheduleHideFixed

`func (o *PowerSchedulePolicyTypeConfiguration13) GetPowerScheduleHideFixed() bool`
...
`func (o *PowerSchedulePolicyTypeConfiguration13) GetPowerScheduleHideFixedOk() (*bool, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration13) SetPowerScheduleHideFixed(v bool)`

SetPowerScheduleHideFixed sets PowerScheduleHideFixed field to given value.

### HasPowerScheduleHideFixed

`func (o *PowerSchedulePolicyTypeConfiguration13) HasPowerScheduleHideFixed() bool`
