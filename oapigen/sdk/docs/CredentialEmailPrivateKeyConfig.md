...
`func NewCredentialEmailPrivateKeyConfig(type_ string, name string, username string, authKey UpdateCredentialsRequestCredentialOneOf2AuthKey, ) *CredentialEmailPrivateKeyConfig`
...
`func (o *CredentialEmailPrivateKeyConfig) GetIntegration() UpdateCredentialsRequestCredentialOneOf2Integration`

GetIntegration returns the Integration field if non-nil, zero value otherwise.

### GetIntegrationOk

`func (o *CredentialEmailPrivateKeyConfig) GetIntegrationOk() (*UpdateCredentialsRequestCredentialOneOf2Integration, bool)`
...
`func (o *CredentialEmailPrivateKeyConfig) SetIntegration(v UpdateCredentialsRequestCredentialOneOf2Integration)`
...
`func (o *CredentialEmailPrivateKeyConfig) GetAuthKey() UpdateCredentialsRequestCredentialOneOf2AuthKey`

GetAuthKey returns the AuthKey field if non-nil, zero value otherwise.

### GetAuthKeyOk

`func (o *CredentialEmailPrivateKeyConfig) GetAuthKeyOk() (*UpdateCredentialsRequestCredentialOneOf2AuthKey, bool)`
...
`func (o *CredentialEmailPrivateKeyConfig) SetAuthKey(v UpdateCredentialsRequestCredentialOneOf2AuthKey)`
