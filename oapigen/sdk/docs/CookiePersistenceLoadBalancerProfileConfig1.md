# CookiePersistenceLoadBalancerProfileConfig1
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag11**](LoadBalancerProfileTag11.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &CookiePersistenceLoadBalancerProfileConfig1{
    // Set fields directly
}
```
