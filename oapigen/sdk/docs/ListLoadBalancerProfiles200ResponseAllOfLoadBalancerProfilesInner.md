...
**Config** | Pointer to [**ListLoadBalancerProfiles200ResponseAllOfLoadBalancerProfilesInnerConfig**](ListLoadBalancerProfiles200ResponseAllOfLoadBalancerProfilesInnerConfig.md) |  | [optional] 
...
```go
obj := &ListLoadBalancerProfiles200ResponseAllOfLoadBalancerProfilesInner{
    // Set fields directly
}
```
