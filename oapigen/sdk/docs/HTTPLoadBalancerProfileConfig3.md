# HTTPLoadBalancerProfileConfig3
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag24**](LoadBalancerProfileTag24.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &HTTPLoadBalancerProfileConfig3{
    // Set fields directly
}
```
