# GenericPersistenceLoadBalancerProfileConfig1
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag13**](LoadBalancerProfileTag13.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &GenericPersistenceLoadBalancerProfileConfig1{
    // Set fields directly
}
```
