...
### NewUpdateClouds200ResponseAllOfZone

`func NewUpdateClouds200ResponseAllOfZone() *UpdateClouds200ResponseAllOfZone`

NewUpdateClouds200ResponseAllOfZone instantiates a new UpdateClouds200ResponseAllOfZone object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewUpdateClouds200ResponseAllOfZoneWithDefaults

`func NewUpdateClouds200ResponseAllOfZoneWithDefaults() *UpdateClouds200ResponseAllOfZone`

NewUpdateClouds200ResponseAllOfZoneWithDefaults instantiates a new UpdateClouds200ResponseAllOfZone object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetId

`func (o *UpdateClouds200ResponseAllOfZone) GetId() int64`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *UpdateClouds200ResponseAllOfZone) GetIdOk() (*int64, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetId(v int64)`

SetId sets Id field to given value.

### HasId

`func (o *UpdateClouds200ResponseAllOfZone) HasId() bool`

HasId returns a boolean if a field has been set.

### GetUuid

`func (o *UpdateClouds200ResponseAllOfZone) GetUuid() string`

GetUuid returns the Uuid field if non-nil, zero value otherwise.

### GetUuidOk

`func (o *UpdateClouds200ResponseAllOfZone) GetUuidOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetUuid(v string)`

SetUuid sets Uuid field to given value.

### HasUuid

`func (o *UpdateClouds200ResponseAllOfZone) HasUuid() bool`

HasUuid returns a boolean if a field has been set.

### GetExternalId

`func (o *UpdateClouds200ResponseAllOfZone) GetExternalId() string`

GetExternalId returns the ExternalId field if non-nil, zero value otherwise.

### GetExternalIdOk

`func (o *UpdateClouds200ResponseAllOfZone) GetExternalIdOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetExternalId(v string)`

SetExternalId sets ExternalId field to given value.

### HasExternalId

`func (o *UpdateClouds200ResponseAllOfZone) HasExternalId() bool`

HasExternalId returns a boolean if a field has been set.

### SetExternalIdNil

`func (o *UpdateClouds200ResponseAllOfZone) SetExternalIdNil(b bool)`

 SetExternalIdNil sets the value for ExternalId to be an explicit nil

### UnsetExternalId
`func (o *UpdateClouds200ResponseAllOfZone) UnsetExternalId()`

UnsetExternalId ensures that no value is present for ExternalId, not even an explicit nil
### GetName

`func (o *UpdateClouds200ResponseAllOfZone) GetName() string`

GetName returns the Name field if non-nil, zero value otherwise.

### GetNameOk

`func (o *UpdateClouds200ResponseAllOfZone) GetNameOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetName(v string)`

SetName sets Name field to given value.

### HasName

`func (o *UpdateClouds200ResponseAllOfZone) HasName() bool`

HasName returns a boolean if a field has been set.

### GetCode

`func (o *UpdateClouds200ResponseAllOfZone) GetCode() string`

GetCode returns the Code field if non-nil, zero value otherwise.

### GetCodeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetCodeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetCode(v string)`

SetCode sets Code field to given value.

### HasCode

`func (o *UpdateClouds200ResponseAllOfZone) HasCode() bool`

HasCode returns a boolean if a field has been set.

### GetLabels

`func (o *UpdateClouds200ResponseAllOfZone) GetLabels() []string`

GetLabels returns the Labels field if non-nil, zero value otherwise.

### GetLabelsOk

`func (o *UpdateClouds200ResponseAllOfZone) GetLabelsOk() (*[]string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetLabels(v []string)`

SetLabels sets Labels field to given value.

### HasLabels

`func (o *UpdateClouds200ResponseAllOfZone) HasLabels() bool`

HasLabels returns a boolean if a field has been set.

### GetLocation

`func (o *UpdateClouds200ResponseAllOfZone) GetLocation() string`

GetLocation returns the Location field if non-nil, zero value otherwise.

### GetLocationOk

`func (o *UpdateClouds200ResponseAllOfZone) GetLocationOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetLocation(v string)`

SetLocation sets Location field to given value.

### HasLocation

`func (o *UpdateClouds200ResponseAllOfZone) HasLocation() bool`

HasLocation returns a boolean if a field has been set.

### SetLocationNil

`func (o *UpdateClouds200ResponseAllOfZone) SetLocationNil(b bool)`

 SetLocationNil sets the value for Location to be an explicit nil

### UnsetLocation
`func (o *UpdateClouds200ResponseAllOfZone) UnsetLocation()`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasOwner() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetAccountIdOk() (*int64, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetAccountId(v int64)`

SetAccountId sets AccountId field to given value.

### HasAccountId

`func (o *UpdateClouds200ResponseAllOfZone) HasAccountId() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasAccount() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetVisibilityOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetVisibility(v string)`

SetVisibility sets Visibility field to given value.

### HasVisibility

`func (o *UpdateClouds200ResponseAllOfZone) HasVisibility() bool`

HasVisibility returns a boolean if a field has been set.

### GetEnabled

`func (o *UpdateClouds200ResponseAllOfZone) GetEnabled() bool`

GetEnabled returns the Enabled field if non-nil, zero value otherwise.

### GetEnabledOk

`func (o *UpdateClouds200ResponseAllOfZone) GetEnabledOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetEnabled(v bool)`

SetEnabled sets Enabled field to given value.

### HasEnabled

`func (o *UpdateClouds200ResponseAllOfZone) HasEnabled() bool`

HasEnabled returns a boolean if a field has been set.

### GetStatus

`func (o *UpdateClouds200ResponseAllOfZone) GetStatus() string`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *UpdateClouds200ResponseAllOfZone) GetStatusOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetStatus(v string)`

SetStatus sets Status field to given value.

### HasStatus

`func (o *UpdateClouds200ResponseAllOfZone) HasStatus() bool`

HasStatus returns a boolean if a field has been set.

### GetStatusMessage

`func (o *UpdateClouds200ResponseAllOfZone) GetStatusMessage() string`

GetStatusMessage returns the StatusMessage field if non-nil, zero value otherwise.

### GetStatusMessageOk

`func (o *UpdateClouds200ResponseAllOfZone) GetStatusMessageOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetStatusMessage(v string)`

SetStatusMessage sets StatusMessage field to given value.

### HasStatusMessage

`func (o *UpdateClouds200ResponseAllOfZone) HasStatusMessage() bool`

HasStatusMessage returns a boolean if a field has been set.

### SetStatusMessageNil

`func (o *UpdateClouds200ResponseAllOfZone) SetStatusMessageNil(b bool)`

 SetStatusMessageNil sets the value for StatusMessage to be an explicit nil

### UnsetStatusMessage
`func (o *UpdateClouds200ResponseAllOfZone) UnsetStatusMessage()`

UnsetStatusMessage ensures that no value is present for StatusMessage, not even an explicit nil
### GetStatusDate

`func (o *UpdateClouds200ResponseAllOfZone) GetStatusDate() time.Time`

GetStatusDate returns the StatusDate field if non-nil, zero value otherwise.

### GetStatusDateOk

`func (o *UpdateClouds200ResponseAllOfZone) GetStatusDateOk() (*time.Time, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetStatusDate(v time.Time)`

SetStatusDate sets StatusDate field to given value.

### HasStatusDate

`func (o *UpdateClouds200ResponseAllOfZone) HasStatusDate() bool`

HasStatusDate returns a boolean if a field has been set.

### SetStatusDateNil

`func (o *UpdateClouds200ResponseAllOfZone) SetStatusDateNil(b bool)`

 SetStatusDateNil sets the value for StatusDate to be an explicit nil

### UnsetStatusDate
`func (o *UpdateClouds200ResponseAllOfZone) UnsetStatusDate()`

UnsetStatusDate ensures that no value is present for StatusDate, not even an explicit nil
### GetCostStatus

`func (o *UpdateClouds200ResponseAllOfZone) GetCostStatus() string`

GetCostStatus returns the CostStatus field if non-nil, zero value otherwise.

### GetCostStatusOk

`func (o *UpdateClouds200ResponseAllOfZone) GetCostStatusOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetCostLastSync(v time.Time)`

SetCostLastSync sets CostLastSync field to given value.

### HasCostLastSync

`func (o *UpdateClouds200ResponseAllOfZone) HasCostLastSync() bool`

HasCostLastSync returns a boolean if a field has been set.

### SetCostLastSyncNil

`func (o *UpdateClouds200ResponseAllOfZone) SetCostLastSyncNil(b bool)`

 SetCostLastSyncNil sets the value for CostLastSync to be an explicit nil

### UnsetCostLastSync
`func (o *UpdateClouds200ResponseAllOfZone) UnsetCostLastSync()`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasZoneType() bool`

HasZoneType returns a boolean if a field has been set.

### GetZoneTypeId

`func (o *UpdateClouds200ResponseAllOfZone) GetZoneTypeId() int64`

GetZoneTypeId returns the ZoneTypeId field if non-nil, zero value otherwise.

### GetZoneTypeIdOk

`func (o *UpdateClouds200ResponseAllOfZone) GetZoneTypeIdOk() (*int64, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetZoneTypeId(v int64)`

SetZoneTypeId sets ZoneTypeId field to given value.

### HasZoneTypeId

`func (o *UpdateClouds200ResponseAllOfZone) HasZoneTypeId() bool`

HasZoneTypeId returns a boolean if a field has been set.

### GetGuidanceMode

`func (o *UpdateClouds200ResponseAllOfZone) GetGuidanceMode() string`

GetGuidanceMode returns the GuidanceMode field if non-nil, zero value otherwise.

### GetGuidanceModeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetGuidanceModeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetGuidanceMode(v string)`

SetGuidanceMode sets GuidanceMode field to given value.

### HasGuidanceMode

`func (o *UpdateClouds200ResponseAllOfZone) HasGuidanceMode() bool`

HasGuidanceMode returns a boolean if a field has been set.

### SetGuidanceModeNil

`func (o *UpdateClouds200ResponseAllOfZone) SetGuidanceModeNil(b bool)`

 SetGuidanceModeNil sets the value for GuidanceMode to be an explicit nil

### UnsetGuidanceMode
`func (o *UpdateClouds200ResponseAllOfZone) UnsetGuidanceMode()`

UnsetGuidanceMode ensures that no value is present for GuidanceMode, not even an explicit nil
### GetStorageMode

`func (o *UpdateClouds200ResponseAllOfZone) GetStorageMode() string`

GetStorageMode returns the StorageMode field if non-nil, zero value otherwise.

### GetStorageModeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetStorageModeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetStorageMode(v string)`

SetStorageMode sets StorageMode field to given value.

### HasStorageMode

`func (o *UpdateClouds200ResponseAllOfZone) HasStorageMode() bool`

HasStorageMode returns a boolean if a field has been set.

### GetAgentMode

`func (o *UpdateClouds200ResponseAllOfZone) GetAgentMode() string`

GetAgentMode returns the AgentMode field if non-nil, zero value otherwise.

### GetAgentModeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetAgentModeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetAgentMode(v string)`

SetAgentMode sets AgentMode field to given value.

### HasAgentMode

`func (o *UpdateClouds200ResponseAllOfZone) HasAgentMode() bool`

HasAgentMode returns a boolean if a field has been set.

### GetUserDataLinux

`func (o *UpdateClouds200ResponseAllOfZone) GetUserDataLinux() string`

GetUserDataLinux returns the UserDataLinux field if non-nil, zero value otherwise.

### GetUserDataLinuxOk

`func (o *UpdateClouds200ResponseAllOfZone) GetUserDataLinuxOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetUserDataLinux(v string)`

SetUserDataLinux sets UserDataLinux field to given value.

### HasUserDataLinux

`func (o *UpdateClouds200ResponseAllOfZone) HasUserDataLinux() bool`

HasUserDataLinux returns a boolean if a field has been set.

### SetUserDataLinuxNil

`func (o *UpdateClouds200ResponseAllOfZone) SetUserDataLinuxNil(b bool)`

 SetUserDataLinuxNil sets the value for UserDataLinux to be an explicit nil

### UnsetUserDataLinux
`func (o *UpdateClouds200ResponseAllOfZone) UnsetUserDataLinux()`

UnsetUserDataLinux ensures that no value is present for UserDataLinux, not even an explicit nil
### GetUserDataWindows

`func (o *UpdateClouds200ResponseAllOfZone) GetUserDataWindows() string`

GetUserDataWindows returns the UserDataWindows field if non-nil, zero value otherwise.

### GetUserDataWindowsOk

`func (o *UpdateClouds200ResponseAllOfZone) GetUserDataWindowsOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetConsoleKeymap(v string)`

SetConsoleKeymap sets ConsoleKeymap field to given value.

### HasConsoleKeymap

`func (o *UpdateClouds200ResponseAllOfZone) HasConsoleKeymap() bool`

HasConsoleKeymap returns a boolean if a field has been set.

### SetConsoleKeymapNil

`func (o *UpdateClouds200ResponseAllOfZone) SetConsoleKeymapNil(b bool)`

 SetConsoleKeymapNil sets the value for ConsoleKeymap to be an explicit nil

### UnsetConsoleKeymap
`func (o *UpdateClouds200ResponseAllOfZone) UnsetConsoleKeymap()`

UnsetConsoleKeymap ensures that no value is present for ConsoleKeymap, not even an explicit nil
### GetContainerMode

`func (o *UpdateClouds200ResponseAllOfZone) GetContainerMode() string`

GetContainerMode returns the ContainerMode field if non-nil, zero value otherwise.

### GetContainerModeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetContainerModeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetContainerMode(v string)`

SetContainerMode sets ContainerMode field to given value.

### HasContainerMode

`func (o *UpdateClouds200ResponseAllOfZone) HasContainerMode() bool`

HasContainerMode returns a boolean if a field has been set.

### GetCostingMode

`func (o *UpdateClouds200ResponseAllOfZone) GetCostingMode() string`

GetCostingMode returns the CostingMode field if non-nil, zero value otherwise.

### GetCostingModeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetCostingModeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetCostingMode(v string)`

SetCostingMode sets CostingMode field to given value.

### HasCostingMode

`func (o *UpdateClouds200ResponseAllOfZone) HasCostingMode() bool`

HasCostingMode returns a boolean if a field has been set.

### SetCostingModeNil

`func (o *UpdateClouds200ResponseAllOfZone) SetCostingModeNil(b bool)`

 SetCostingModeNil sets the value for CostingMode to be an explicit nil

### UnsetCostingMode
`func (o *UpdateClouds200ResponseAllOfZone) UnsetCostingMode()`

UnsetCostingMode ensures that no value is present for CostingMode, not even an explicit nil
### GetServiceVersion

`func (o *UpdateClouds200ResponseAllOfZone) GetServiceVersion() string`

GetServiceVersion returns the ServiceVersion field if non-nil, zero value otherwise.

### GetServiceVersionOk

`func (o *UpdateClouds200ResponseAllOfZone) GetServiceVersionOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetServiceVersion(v string)`

SetServiceVersion sets ServiceVersion field to given value.

### HasServiceVersion

`func (o *UpdateClouds200ResponseAllOfZone) HasServiceVersion() bool`

HasServiceVersion returns a boolean if a field has been set.

### SetServiceVersionNil

`func (o *UpdateClouds200ResponseAllOfZone) SetServiceVersionNil(b bool)`

 SetServiceVersionNil sets the value for ServiceVersion to be an explicit nil

### UnsetServiceVersion
`func (o *UpdateClouds200ResponseAllOfZone) UnsetServiceVersion()`

UnsetServiceVersion ensures that no value is present for ServiceVersion, not even an explicit nil
### GetSecurityMode

`func (o *UpdateClouds200ResponseAllOfZone) GetSecurityMode() string`

GetSecurityMode returns the SecurityMode field if non-nil, zero value otherwise.

### GetSecurityModeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetSecurityModeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetSecurityMode(v string)`

SetSecurityMode sets SecurityMode field to given value.

### HasSecurityMode

`func (o *UpdateClouds200ResponseAllOfZone) HasSecurityMode() bool`

HasSecurityMode returns a boolean if a field has been set.

### GetInventoryLevel

`func (o *UpdateClouds200ResponseAllOfZone) GetInventoryLevel() string`

GetInventoryLevel returns the InventoryLevel field if non-nil, zero value otherwise.

### GetInventoryLevelOk

`func (o *UpdateClouds200ResponseAllOfZone) GetInventoryLevelOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetInventoryLevel(v string)`

SetInventoryLevel sets InventoryLevel field to given value.

### HasInventoryLevel

`func (o *UpdateClouds200ResponseAllOfZone) HasInventoryLevel() bool`

HasInventoryLevel returns a boolean if a field has been set.

### GetTimezone

`func (o *UpdateClouds200ResponseAllOfZone) GetTimezone() string`

GetTimezone returns the Timezone field if non-nil, zero value otherwise.

### GetTimezoneOk

`func (o *UpdateClouds200ResponseAllOfZone) GetTimezoneOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetTimezone(v string)`

SetTimezone sets Timezone field to given value.

### HasTimezone

`func (o *UpdateClouds200ResponseAllOfZone) HasTimezone() bool`

HasTimezone returns a boolean if a field has been set.

### SetTimezoneNil

`func (o *UpdateClouds200ResponseAllOfZone) SetTimezoneNil(b bool)`

 SetTimezoneNil sets the value for Timezone to be an explicit nil

### UnsetTimezone
`func (o *UpdateClouds200ResponseAllOfZone) UnsetTimezone()`

UnsetTimezone ensures that no value is present for Timezone, not even an explicit nil
### GetApiProxy

`func (o *UpdateClouds200ResponseAllOfZone) GetApiProxy() string`

GetApiProxy returns the ApiProxy field if non-nil, zero value otherwise.

### GetApiProxyOk

`func (o *UpdateClouds200ResponseAllOfZone) GetApiProxyOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasNetworkDomain() bool`

HasNetworkDomain returns a boolean if a field has been set.

### GetDomainName

`func (o *UpdateClouds200ResponseAllOfZone) GetDomainName() string`

GetDomainName returns the DomainName field if non-nil, zero value otherwise.

### GetDomainNameOk

`func (o *UpdateClouds200ResponseAllOfZone) GetDomainNameOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDomainName(v string)`

SetDomainName sets DomainName field to given value.

### HasDomainName

`func (o *UpdateClouds200ResponseAllOfZone) HasDomainName() bool`

HasDomainName returns a boolean if a field has been set.

### GetRegionCode

`func (o *UpdateClouds200ResponseAllOfZone) GetRegionCode() string`

GetRegionCode returns the RegionCode field if non-nil, zero value otherwise.

### GetRegionCodeOk

`func (o *UpdateClouds200ResponseAllOfZone) GetRegionCodeOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetRegionCode(v string)`

SetRegionCode sets RegionCode field to given value.

### HasRegionCode

`func (o *UpdateClouds200ResponseAllOfZone) HasRegionCode() bool`

HasRegionCode returns a boolean if a field has been set.

### SetRegionCodeNil

`func (o *UpdateClouds200ResponseAllOfZone) SetRegionCodeNil(b bool)`

 SetRegionCodeNil sets the value for RegionCode to be an explicit nil

### UnsetRegionCode
`func (o *UpdateClouds200ResponseAllOfZone) UnsetRegionCode()`

UnsetRegionCode ensures that no value is present for RegionCode, not even an explicit nil
### GetAutoRecoverPowerState

`func (o *UpdateClouds200ResponseAllOfZone) GetAutoRecoverPowerState() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetAutoRecoverPowerStateOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetAutoRecoverPowerState(v bool)`

SetAutoRecoverPowerState sets AutoRecoverPowerState field to given value.

### HasAutoRecoverPowerState

`func (o *UpdateClouds200ResponseAllOfZone) HasAutoRecoverPowerState() bool`

HasAutoRecoverPowerState returns a boolean if a field has been set.

### GetScalePriority

`func (o *UpdateClouds200ResponseAllOfZone) GetScalePriority() int64`

GetScalePriority returns the ScalePriority field if non-nil, zero value otherwise.

### GetScalePriorityOk

`func (o *UpdateClouds200ResponseAllOfZone) GetScalePriorityOk() (*int64, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetScalePriority(v int64)`

SetScalePriority sets ScalePriority field to given value.

### HasScalePriority

`func (o *UpdateClouds200ResponseAllOfZone) HasScalePriority() bool`

HasScalePriority returns a boolean if a field has been set.

### GetDefaultDatastoreSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultDatastoreSyncActive() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultDatastoreSyncActiveOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDefaultDatastoreSyncActive(v bool)`

SetDefaultDatastoreSyncActive sets DefaultDatastoreSyncActive field to given value.

### HasDefaultDatastoreSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) HasDefaultDatastoreSyncActive() bool`

HasDefaultDatastoreSyncActive returns a boolean if a field has been set.

### GetDefaultNetworkSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultNetworkSyncActive() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultNetworkSyncActiveOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDefaultNetworkSyncActive(v bool)`

SetDefaultNetworkSyncActive sets DefaultNetworkSyncActive field to given value.

### HasDefaultNetworkSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) HasDefaultNetworkSyncActive() bool`

HasDefaultNetworkSyncActive returns a boolean if a field has been set.

### GetDefaultFolderSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultFolderSyncActive() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultFolderSyncActiveOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDefaultFolderSyncActive(v bool)`

SetDefaultFolderSyncActive sets DefaultFolderSyncActive field to given value.

### HasDefaultFolderSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) HasDefaultFolderSyncActive() bool`

HasDefaultFolderSyncActive returns a boolean if a field has been set.

### GetDefaultSecurityGroupSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultSecurityGroupSyncActive() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultSecurityGroupSyncActiveOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDefaultSecurityGroupSyncActive(v bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasDefaultSecurityGroupSyncActive() bool`

HasDefaultSecurityGroupSyncActive returns a boolean if a field has been set.

### GetDefaultPoolSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultPoolSyncActive() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultPoolSyncActiveOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDefaultPoolSyncActive(v bool)`

SetDefaultPoolSyncActive sets DefaultPoolSyncActive field to given value.

### HasDefaultPoolSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) HasDefaultPoolSyncActive() bool`

HasDefaultPoolSyncActive returns a boolean if a field has been set.

### GetDefaultPlanSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultPlanSyncActive() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) GetDefaultPlanSyncActiveOk() (*bool, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDefaultPlanSyncActive(v bool)`

SetDefaultPlanSyncActive sets DefaultPlanSyncActive field to given value.

### HasDefaultPlanSyncActive

`func (o *UpdateClouds200ResponseAllOfZone) HasDefaultPlanSyncActive() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasConfig() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasCredential() bool`

HasCredential returns a boolean if a field has been set.

### GetImagePath

`func (o *UpdateClouds200ResponseAllOfZone) GetImagePath() string`

GetImagePath returns the ImagePath field if non-nil, zero value otherwise.

### GetImagePathOk

`func (o *UpdateClouds200ResponseAllOfZone) GetImagePathOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetImagePath(v string)`

SetImagePath sets ImagePath field to given value.

### HasImagePath

`func (o *UpdateClouds200ResponseAllOfZone) HasImagePath() bool`

HasImagePath returns a boolean if a field has been set.

### SetImagePathNil

`func (o *UpdateClouds200ResponseAllOfZone) SetImagePathNil(b bool)`

 SetImagePathNil sets the value for ImagePath to be an explicit nil

### UnsetImagePath
`func (o *UpdateClouds200ResponseAllOfZone) UnsetImagePath()`

UnsetImagePath ensures that no value is present for ImagePath, not even an explicit nil
### GetDarkImagePath

`func (o *UpdateClouds200ResponseAllOfZone) GetDarkImagePath() string`

GetDarkImagePath returns the DarkImagePath field if non-nil, zero value otherwise.

### GetDarkImagePathOk

`func (o *UpdateClouds200ResponseAllOfZone) GetDarkImagePathOk() (*string, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDarkImagePath(v string)`

SetDarkImagePath sets DarkImagePath field to given value.

### HasDarkImagePath

`func (o *UpdateClouds200ResponseAllOfZone) HasDarkImagePath() bool`

HasDarkImagePath returns a boolean if a field has been set.

### SetDarkImagePathNil

`func (o *UpdateClouds200ResponseAllOfZone) SetDarkImagePathNil(b bool)`

 SetDarkImagePathNil sets the value for DarkImagePath to be an explicit nil

### UnsetDarkImagePath
`func (o *UpdateClouds200ResponseAllOfZone) UnsetDarkImagePath()`

UnsetDarkImagePath ensures that no value is present for DarkImagePath, not even an explicit nil
### GetDateCreated

`func (o *UpdateClouds200ResponseAllOfZone) GetDateCreated() time.Time`

GetDateCreated returns the DateCreated field if non-nil, zero value otherwise.

### GetDateCreatedOk

`func (o *UpdateClouds200ResponseAllOfZone) GetDateCreatedOk() (*time.Time, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetDateCreated(v time.Time)`

SetDateCreated sets DateCreated field to given value.

### HasDateCreated

`func (o *UpdateClouds200ResponseAllOfZone) HasDateCreated() bool`

HasDateCreated returns a boolean if a field has been set.

### GetLastUpdated

`func (o *UpdateClouds200ResponseAllOfZone) GetLastUpdated() time.Time`

GetLastUpdated returns the LastUpdated field if non-nil, zero value otherwise.

### GetLastUpdatedOk

`func (o *UpdateClouds200ResponseAllOfZone) GetLastUpdatedOk() (*time.Time, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetLastUpdated(v time.Time)`

SetLastUpdated sets LastUpdated field to given value.

### HasLastUpdated

`func (o *UpdateClouds200ResponseAllOfZone) HasLastUpdated() bool`

HasLastUpdated returns a boolean if a field has been set.

### GetLastSync

`func (o *UpdateClouds200ResponseAllOfZone) GetLastSync() time.Time`

GetLastSync returns the LastSync field if non-nil, zero value otherwise.

### GetLastSyncOk

`func (o *UpdateClouds200ResponseAllOfZone) GetLastSyncOk() (*time.Time, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetLastSync(v time.Time)`

SetLastSync sets LastSync field to given value.

### HasLastSync

`func (o *UpdateClouds200ResponseAllOfZone) HasLastSync() bool`

HasLastSync returns a boolean if a field has been set.

### SetLastSyncNil

`func (o *UpdateClouds200ResponseAllOfZone) SetLastSyncNil(b bool)`

 SetLastSyncNil sets the value for LastSync to be an explicit nil

### UnsetLastSync
`func (o *UpdateClouds200ResponseAllOfZone) UnsetLastSync()`

UnsetLastSync ensures that no value is present for LastSync, not even an explicit nil
### GetLastSyncDuration

`func (o *UpdateClouds200ResponseAllOfZone) GetLastSyncDuration() int64`

GetLastSyncDuration returns the LastSyncDuration field if non-nil, zero value otherwise.

### GetLastSyncDurationOk

`func (o *UpdateClouds200ResponseAllOfZone) GetLastSyncDurationOk() (*int64, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetLastSyncDuration(v int64)`

SetLastSyncDuration sets LastSyncDuration field to given value.

### HasLastSyncDuration

`func (o *UpdateClouds200ResponseAllOfZone) HasLastSyncDuration() bool`

HasLastSyncDuration returns a boolean if a field has been set.

### SetLastSyncDurationNil

`func (o *UpdateClouds200ResponseAllOfZone) SetLastSyncDurationNil(b bool)`

 SetLastSyncDurationNil sets the value for LastSyncDuration to be an explicit nil

### UnsetLastSyncDuration
`func (o *UpdateClouds200ResponseAllOfZone) UnsetLastSyncDuration()`

UnsetLastSyncDuration ensures that no value is present for LastSyncDuration, not even an explicit nil
### GetNextRunDate

`func (o *UpdateClouds200ResponseAllOfZone) GetNextRunDate() time.Time`

GetNextRunDate returns the NextRunDate field if non-nil, zero value otherwise.

### GetNextRunDateOk

`func (o *UpdateClouds200ResponseAllOfZone) GetNextRunDateOk() (*time.Time, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetNextRunDate(v time.Time)`

SetNextRunDate sets NextRunDate field to given value.

### HasNextRunDate

`func (o *UpdateClouds200ResponseAllOfZone) HasNextRunDate() bool`

HasNextRunDate returns a boolean if a field has been set.

### SetNextRunDateNil

`func (o *UpdateClouds200ResponseAllOfZone) SetNextRunDateNil(b bool)`

 SetNextRunDateNil sets the value for NextRunDate to be an explicit nil

### UnsetNextRunDate
`func (o *UpdateClouds200ResponseAllOfZone) UnsetNextRunDate()`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasGroups() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasSecurityServer() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasNetworkServer() bool`
...
`func (o *UpdateClouds200ResponseAllOfZone) HasStats() bool`

HasStats returns a boolean if a field has been set.

### GetServerCount

`func (o *UpdateClouds200ResponseAllOfZone) GetServerCount() int64`

GetServerCount returns the ServerCount field if non-nil, zero value otherwise.

### GetServerCountOk

`func (o *UpdateClouds200ResponseAllOfZone) GetServerCountOk() (*int64, bool)`
...
`func (o *UpdateClouds200ResponseAllOfZone) SetServerCount(v int64)`

SetServerCount sets ServerCount field to given value.

### HasServerCount

`func (o *UpdateClouds200ResponseAllOfZone) HasServerCount() bool`
