# LoadBalancerProfileConfigServerSsl
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag55**](LoadBalancerProfileTag55.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &LoadBalancerProfileConfigServerSsl{
    // Set fields directly
}
```
