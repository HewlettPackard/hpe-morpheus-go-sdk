...
### GetDashboardsToDisplay

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetDashboardsToDisplay() string`

GetDashboardsToDisplay returns the DashboardsToDisplay field if non-nil, zero value otherwise.

### GetDashboardsToDisplayOk

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetDashboardsToDisplayOk() (*string, bool)`

GetDashboardsToDisplayOk returns a tuple with the DashboardsToDisplay field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetDashboardsToDisplay sets DashboardsToDisplay field to given value.

### HasDashboardsToDisplay

`func (o *ListApplianceSettings200ResponseApplianceSettings) HasDashboardsToDisplay() bool`

HasDashboardsToDisplay returns a boolean if a field has been set.

### SetDashboardsToDisplayNil

`func (o *ListApplianceSettings200ResponseApplianceSettings) SetDashboardsToDisplayNil(b bool)`

 SetDashboardsToDisplayNil sets the value for DashboardsToDisplay to be an explicit nil

### UnsetDashboardsToDisplay
`func (o *ListApplianceSettings200ResponseApplianceSettings) UnsetDashboardsToDisplay()`

UnsetDashboardsToDisplay ensures that no value is present for DashboardsToDisplay, not even an explicit nil
### GetVmeAppliance

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetVmeAppliance() bool`

GetVmeAppliance returns the VmeAppliance field if non-nil, zero value otherwise.

### GetVmeApplianceOk

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetVmeApplianceOk() (*bool, bool)`

GetVmeApplianceOk returns a tuple with the VmeAppliance field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetVmeAppliance sets VmeAppliance field to given value.

### HasVmeAppliance

`func (o *ListApplianceSettings200ResponseApplianceSettings) HasVmeAppliance() bool`

HasVmeAppliance returns a boolean if a field has been set.

### GetLatestWindowsAgentVersion

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetLatestWindowsAgentVersion() string`

GetLatestWindowsAgentVersion returns the LatestWindowsAgentVersion field if non-nil, zero value otherwise.

### GetLatestWindowsAgentVersionOk

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetLatestWindowsAgentVersionOk() (*string, bool)`

GetLatestWindowsAgentVersionOk returns a tuple with the LatestWindowsAgentVersion field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetLatestWindowsAgentVersion

`func (o *ListApplianceSettings200ResponseApplianceSettings) SetLatestWindowsAgentVersion(v string)`

SetLatestWindowsAgentVersion sets LatestWindowsAgentVersion field to given value.

### HasLatestWindowsAgentVersion

`func (o *ListApplianceSettings200ResponseApplianceSettings) HasLatestWindowsAgentVersion() bool`

HasLatestWindowsAgentVersion returns a boolean if a field has been set.

### GetLatestLinuxAgentVersion

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetLatestLinuxAgentVersion() string`

GetLatestLinuxAgentVersion returns the LatestLinuxAgentVersion field if non-nil, zero value otherwise.

### GetLatestLinuxAgentVersionOk

`func (o *ListApplianceSettings200ResponseApplianceSettings) GetLatestLinuxAgentVersionOk() (*string, bool)`

GetLatestLinuxAgentVersionOk returns a tuple with the LatestLinuxAgentVersion field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetLatestLinuxAgentVersion

`func (o *ListApplianceSettings200ResponseApplianceSettings) SetLatestLinuxAgentVersion(v string)`

SetLatestLinuxAgentVersion sets LatestLinuxAgentVersion field to given value.

### HasLatestLinuxAgentVersion

`func (o *ListApplianceSettings200ResponseApplianceSettings) HasLatestLinuxAgentVersion() bool`

HasLatestLinuxAgentVersion returns a boolean if a field has been set.
