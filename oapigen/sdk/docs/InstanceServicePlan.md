...
**StorageTypes** | Pointer to [**[]InstanceServicePlanStorageTypesInner**](InstanceServicePlanStorageTypesInner.md) |  | [optional] 
**RootStorageTypes** | Pointer to [**[]InstanceServicePlanRootStorageTypesInner**](InstanceServicePlanRootStorageTypesInner.md) |  | [optional] 
...
**Datastores** | Pointer to [**InstanceServicePlanDatastores**](InstanceServicePlanDatastores.md) |  | [optional] 
**SupportsAutoDatastore** | Pointer to **bool** |  | [optional] 
**AutoOptions** | Pointer to [**[]InstanceServicePlanAutoOptionsInner**](InstanceServicePlanAutoOptionsInner.md) |  | [optional] 
...
`func (o *InstanceServicePlan) GetStorageTypes() []InstanceServicePlanStorageTypesInner`

GetStorageTypes returns the StorageTypes field if non-nil, zero value otherwise.

### GetStorageTypesOk

`func (o *InstanceServicePlan) GetStorageTypesOk() (*[]InstanceServicePlanStorageTypesInner, bool)`
...
`func (o *InstanceServicePlan) SetStorageTypes(v []InstanceServicePlanStorageTypesInner)`
...
`func (o *InstanceServicePlan) GetRootStorageTypes() []InstanceServicePlanRootStorageTypesInner`

GetRootStorageTypes returns the RootStorageTypes field if non-nil, zero value otherwise.

### GetRootStorageTypesOk

`func (o *InstanceServicePlan) GetRootStorageTypesOk() (*[]InstanceServicePlanRootStorageTypesInner, bool)`
...
`func (o *InstanceServicePlan) SetRootStorageTypes(v []InstanceServicePlanRootStorageTypesInner)`
...
`func (o *InstanceServicePlan) GetAutoOptions() []InstanceServicePlanAutoOptionsInner`

GetAutoOptions returns the AutoOptions field if non-nil, zero value otherwise.

### GetAutoOptionsOk

`func (o *InstanceServicePlan) GetAutoOptionsOk() (*[]InstanceServicePlanAutoOptionsInner, bool)`
...
`func (o *InstanceServicePlan) SetAutoOptions(v []InstanceServicePlanAutoOptionsInner)`
