...
`func NewAddStorageVolumesRequestStorageVolume(name string, type_ string, storageServer AddStorageVolumesRequestStorageVolumeStorageServer, ) *AddStorageVolumesRequestStorageVolume`
...
`func (o *AddStorageVolumesRequestStorageVolume) GetStorageServer() AddStorageVolumesRequestStorageVolumeStorageServer`

GetStorageServer returns the StorageServer field if non-nil, zero value otherwise.

### GetStorageServerOk

`func (o *AddStorageVolumesRequestStorageVolume) GetStorageServerOk() (*AddStorageVolumesRequestStorageVolumeStorageServer, bool)`
...
`func (o *AddStorageVolumesRequestStorageVolume) SetStorageServer(v AddStorageVolumesRequestStorageVolumeStorageServer)`
...
`func (o *AddStorageVolumesRequestStorageVolume) GetStorageGroup() AddStorageVolumesRequestStorageVolumeStorageGroup`

GetStorageGroup returns the StorageGroup field if non-nil, zero value otherwise.

### GetStorageGroupOk

`func (o *AddStorageVolumesRequestStorageVolume) GetStorageGroupOk() (*AddStorageVolumesRequestStorageVolumeStorageGroup, bool)`
...
`func (o *AddStorageVolumesRequestStorageVolume) SetStorageGroup(v AddStorageVolumesRequestStorageVolumeStorageGroup)`
