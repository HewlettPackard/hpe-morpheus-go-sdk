# ListLoadBalancerProfiles200ResponseAllOfLoadBalancerProfilesInnerConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag7**](LoadBalancerProfileTag7.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &ListLoadBalancerProfiles200ResponseAllOfLoadBalancerProfilesInnerConfig{
    // Set fields directly
}
```
