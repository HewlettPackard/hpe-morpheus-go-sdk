# LoadBalancerProfileConfigGenericPersistence
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag53**](LoadBalancerProfileTag53.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &LoadBalancerProfileConfigGenericPersistence{
    // Set fields directly
}
```
