# HTTPLoadBalancerProfileConfig4
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag32**](LoadBalancerProfileTag32.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &HTTPLoadBalancerProfileConfig4{
    // Set fields directly
}
```
