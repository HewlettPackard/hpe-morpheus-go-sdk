...
**CreatedBy** | Pointer to [**ClusterCreatedBy**](ClusterCreatedBy.md) |  | [optional] 
**UserGroup** | Pointer to **NullableString** |  | [optional] 
**Layout** | Pointer to [**ClusterLayout**](ClusterLayout.md) |  | [optional] 
**Owner** | Pointer to [**ClusterOwner**](ClusterOwner.md) |  | [optional] 
**Servers** | Pointer to [**[]ClusterServersInner**](ClusterServersInner.md) |  | [optional] 
**Accounts** | Pointer to **[]map[string]interface{}** |  | [optional] 
**Integrations** | Pointer to **[]map[string]interface{}** |  | [optional] 
**Site** | Pointer to [**ClusterSite**](ClusterSite.md) |  | [optional] 
**Type** | Pointer to [**ClusterType**](ClusterType.md) |  | [optional] 
**Zone** | Pointer to [**ClusterZone**](ClusterZone.md) |  | [optional] 
**WorkerStats** | Pointer to [**ClusterWorkerStats**](ClusterWorkerStats.md) |  | [optional] 
...
**Permissions** | Pointer to [**ClusterPermissions**](ClusterPermissions.md) |  | [optional] 
...
`func (o *Cluster) SetUseAgentNil(b bool)`

 SetUseAgentNil sets the value for UseAgent to be an explicit nil

### UnsetUseAgent
`func (o *Cluster) UnsetUseAgent()`
...
`func (o *Cluster) GetCreatedBy() ClusterCreatedBy`

GetCreatedBy returns the CreatedBy field if non-nil, zero value otherwise.

### GetCreatedByOk

`func (o *Cluster) GetCreatedByOk() (*ClusterCreatedBy, bool)`
...
`func (o *Cluster) SetCreatedBy(v ClusterCreatedBy)`
...
`func (o *Cluster) GetLayout() ClusterLayout`

GetLayout returns the Layout field if non-nil, zero value otherwise.

### GetLayoutOk

`func (o *Cluster) GetLayoutOk() (*ClusterLayout, bool)`
...
`func (o *Cluster) SetLayout(v ClusterLayout)`
...
`func (o *Cluster) GetOwner() ClusterOwner`

GetOwner returns the Owner field if non-nil, zero value otherwise.

### GetOwnerOk

`func (o *Cluster) GetOwnerOk() (*ClusterOwner, bool)`
...
`func (o *Cluster) SetOwner(v ClusterOwner)`
...
`func (o *Cluster) GetServers() []ClusterServersInner`

GetServers returns the Servers field if non-nil, zero value otherwise.

### GetServersOk

`func (o *Cluster) GetServersOk() (*[]ClusterServersInner, bool)`
...
`func (o *Cluster) SetServers(v []ClusterServersInner)`
...
`func (o *Cluster) GetSite() ClusterSite`

GetSite returns the Site field if non-nil, zero value otherwise.

### GetSiteOk

`func (o *Cluster) GetSiteOk() (*ClusterSite, bool)`
...
`func (o *Cluster) SetSite(v ClusterSite)`
...
`func (o *Cluster) GetType() ClusterType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *Cluster) GetTypeOk() (*ClusterType, bool)`
...
`func (o *Cluster) SetType(v ClusterType)`
...
`func (o *Cluster) GetZone() ClusterZone`

GetZone returns the Zone field if non-nil, zero value otherwise.

### GetZoneOk

`func (o *Cluster) GetZoneOk() (*ClusterZone, bool)`
...
`func (o *Cluster) SetZone(v ClusterZone)`
...
`func (o *Cluster) GetWorkerStats() ClusterWorkerStats`

GetWorkerStats returns the WorkerStats field if non-nil, zero value otherwise.

### GetWorkerStatsOk

`func (o *Cluster) GetWorkerStatsOk() (*ClusterWorkerStats, bool)`
...
`func (o *Cluster) SetWorkerStats(v ClusterWorkerStats)`
