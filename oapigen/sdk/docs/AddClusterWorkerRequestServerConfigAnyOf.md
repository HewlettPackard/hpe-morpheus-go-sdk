...
`func (o *AddClusterWorkerRequestServerConfigAnyOf) GetDefaultRepoAccount() int64`

GetDefaultRepoAccount returns the DefaultRepoAccount field if non-nil, zero value otherwise.

### GetDefaultRepoAccountOk

`func (o *AddClusterWorkerRequestServerConfigAnyOf) GetDefaultRepoAccountOk() (*int64, bool)`
...
`func (o *AddClusterWorkerRequestServerConfigAnyOf) SetDefaultRepoAccount(v int64)`
...
`func (o *AddClusterWorkerRequestServerConfigAnyOf) GetResourcePoolId() int64`

GetResourcePoolId returns the ResourcePoolId field if non-nil, zero value otherwise.

### GetResourcePoolIdOk

`func (o *AddClusterWorkerRequestServerConfigAnyOf) GetResourcePoolIdOk() (*int64, bool)`
...
`func (o *AddClusterWorkerRequestServerConfigAnyOf) SetResourcePoolId(v int64)`

SetResourcePoolId sets ResourcePoolId field to given value.

### HasResourcePoolId

`func (o *AddClusterWorkerRequestServerConfigAnyOf) HasResourcePoolId() bool`
...
`func (o *AddClusterWorkerRequestServerConfigAnyOf) GetVcpuPlacementMode() string`

GetVcpuPlacementMode returns the VcpuPlacementMode field if non-nil, zero value otherwise.

### GetVcpuPlacementModeOk

`func (o *AddClusterWorkerRequestServerConfigAnyOf) GetVcpuPlacementModeOk() (*string, bool)`
...
`func (o *AddClusterWorkerRequestServerConfigAnyOf) SetVcpuPlacementMode(v string)`

SetVcpuPlacementMode sets VcpuPlacementMode field to given value.

### HasVcpuPlacementMode

`func (o *AddClusterWorkerRequestServerConfigAnyOf) HasVcpuPlacementMode() bool`
