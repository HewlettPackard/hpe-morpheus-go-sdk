# SourceIPPersistenceLoadBalancerProfileConfig2
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag20**](LoadBalancerProfileTag20.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &SourceIPPersistenceLoadBalancerProfileConfig2{
    // Set fields directly
}
```
