...
**NetworkInterfaces** | Pointer to [**[]InstancesNetworkInterfaces9**](InstancesNetworkInterfaces9.md) | Key for network configuration. Include id to update an existing interface. The existing interfaces and their id can be retrieved with the hosts API. | [optional] 
