# GenericPersistenceLoadBalancerProfileConfig3
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag29**](LoadBalancerProfileTag29.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &GenericPersistenceLoadBalancerProfileConfig3{
    // Set fields directly
}
```
