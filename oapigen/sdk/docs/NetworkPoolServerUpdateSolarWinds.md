...
**Config** | Pointer to [**NetworkPoolServerUpdateSolarWindsConfig**](NetworkPoolServerUpdateSolarWindsConfig.md) |  | [optional] 
**Credential** | Pointer to [**NetworkPoolServerUpdateSolarWindsCredential**](NetworkPoolServerUpdateSolarWindsCredential.md) |  | [optional] 
...
`func (o *NetworkPoolServerUpdateSolarWinds) GetConfig() NetworkPoolServerUpdateSolarWindsConfig`

GetConfig returns the Config field if non-nil, zero value otherwise.

### GetConfigOk

`func (o *NetworkPoolServerUpdateSolarWinds) GetConfigOk() (*NetworkPoolServerUpdateSolarWindsConfig, bool)`
...
`func (o *NetworkPoolServerUpdateSolarWinds) SetConfig(v NetworkPoolServerUpdateSolarWindsConfig)`
...
`func (o *NetworkPoolServerUpdateSolarWinds) GetCredential() NetworkPoolServerUpdateSolarWindsCredential`

GetCredential returns the Credential field if non-nil, zero value otherwise.

### GetCredentialOk

`func (o *NetworkPoolServerUpdateSolarWinds) GetCredentialOk() (*NetworkPoolServerUpdateSolarWindsCredential, bool)`
...
`func (o *NetworkPoolServerUpdateSolarWinds) SetCredential(v NetworkPoolServerUpdateSolarWindsCredential)`
