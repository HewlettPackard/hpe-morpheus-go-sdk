...
**CreatedBy** | Pointer to [**UpdateLoadBalancerPool200ResponseAllOfLoadBalancerPoolCreatedBy**](UpdateLoadBalancerPool200ResponseAllOfLoadBalancerPoolCreatedBy.md) |  | [optional] 
...
```go
obj := &UpdateLoadBalancerPool200ResponseAllOfLoadBalancerPool{
    // Set fields directly
}
```
