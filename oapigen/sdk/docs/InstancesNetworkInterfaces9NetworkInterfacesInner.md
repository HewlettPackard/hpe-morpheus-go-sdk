# InstancesNetworkInterfaces9NetworkInterfacesInner

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Network** | [**InstancesNetworkInterfaces9NetworkInterfacesInnerNetwork**](InstancesNetworkInterfaces9NetworkInterfacesInnerNetwork.md) |  | 
...
```go
obj := &InstancesNetworkInterfaces9NetworkInterfacesInner{
    // Set fields directly
}
```
