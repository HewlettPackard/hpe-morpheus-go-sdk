# SourceIPPersistenceLoadBalancerProfileConfig4
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag36**](LoadBalancerProfileTag36.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &SourceIPPersistenceLoadBalancerProfileConfig4{
    // Set fields directly
}
```
