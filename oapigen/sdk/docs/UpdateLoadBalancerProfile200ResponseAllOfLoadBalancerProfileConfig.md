# UpdateLoadBalancerProfile200ResponseAllOfLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag47**](LoadBalancerProfileTag47.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &UpdateLoadBalancerProfile200ResponseAllOfLoadBalancerProfileConfig{
    // Set fields directly
}
```
