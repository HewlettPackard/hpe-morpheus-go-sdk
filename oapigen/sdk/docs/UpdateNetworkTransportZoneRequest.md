...
------------ | ------------- | ------------- | -------------
**NetworkScope** | Pointer to [**UpdateNetworkTransportZoneRequestNetworkScope**](UpdateNetworkTransportZoneRequestNetworkScope.md) |  | [optional] 
...
`func (o *UpdateNetworkTransportZoneRequest) GetNetworkScope() UpdateNetworkTransportZoneRequestNetworkScope`

GetNetworkScope returns the NetworkScope field if non-nil, zero value otherwise.

### GetNetworkScopeOk

`func (o *UpdateNetworkTransportZoneRequest) GetNetworkScopeOk() (*UpdateNetworkTransportZoneRequestNetworkScope, bool)`
