# GenericPersistenceLoadBalancerProfileConfig2
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag21**](LoadBalancerProfileTag21.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &GenericPersistenceLoadBalancerProfileConfig2{
    // Set fields directly
}
```
