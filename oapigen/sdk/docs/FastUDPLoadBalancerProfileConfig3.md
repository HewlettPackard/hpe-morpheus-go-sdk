# FastUDPLoadBalancerProfileConfig3
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag26**](LoadBalancerProfileTag26.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastUDPLoadBalancerProfileConfig3{
    // Set fields directly
}
```
