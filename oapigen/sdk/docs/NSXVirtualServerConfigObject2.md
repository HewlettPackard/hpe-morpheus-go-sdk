...
`func (o *NSXVirtualServerConfigObject2) GetPersistenceProfile() string`

GetPersistenceProfile returns the PersistenceProfile field if non-nil, zero value otherwise.

### GetPersistenceProfileOk

`func (o *NSXVirtualServerConfigObject2) GetPersistenceProfileOk() (*string, bool)`
...
`func (o *NSXVirtualServerConfigObject2) SetPersistenceProfile(v string)`
...
`func (o *NSXVirtualServerConfigObject2) GetSslClientProfile() string`

GetSslClientProfile returns the SslClientProfile field if non-nil, zero value otherwise.

### GetSslClientProfileOk

`func (o *NSXVirtualServerConfigObject2) GetSslClientProfileOk() (*string, bool)`
...
`func (o *NSXVirtualServerConfigObject2) SetSslClientProfile(v string)`
...
`func (o *NSXVirtualServerConfigObject2) GetSslServerProfile() string`

GetSslServerProfile returns the SslServerProfile field if non-nil, zero value otherwise.

### GetSslServerProfileOk

`func (o *NSXVirtualServerConfigObject2) GetSslServerProfileOk() (*string, bool)`
...
`func (o *NSXVirtualServerConfigObject2) SetSslServerProfile(v string)`
