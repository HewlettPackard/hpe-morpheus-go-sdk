# ClientSSLLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag6**](LoadBalancerProfileTag6.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &ClientSSLLoadBalancerProfileConfig{
    // Set fields directly
}
```
