# FastUDPLoadBalancerProfileConfig2
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag18**](LoadBalancerProfileTag18.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastUDPLoadBalancerProfileConfig2{
    // Set fields directly
}
```
