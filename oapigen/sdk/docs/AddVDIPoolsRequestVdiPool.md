...
`func NewAddVDIPoolsRequestVdiPool(name string, maxPoolSize float32, instanceConfig string, config AddVDIPoolsRequestVdiPoolOneOf1Config, ) *AddVDIPoolsRequestVdiPool`
...
`func (o *AddVDIPoolsRequestVdiPool) GetConfig() AddVDIPoolsRequestVdiPoolOneOf1Config`

GetConfig returns the Config field if non-nil, zero value otherwise.

### GetConfigOk

`func (o *AddVDIPoolsRequestVdiPool) GetConfigOk() (*AddVDIPoolsRequestVdiPoolOneOf1Config, bool)`
...
`func (o *AddVDIPoolsRequestVdiPool) SetConfig(v AddVDIPoolsRequestVdiPoolOneOf1Config)`
