...
```go
obj := &UpdateHostCloud200Response{
    // Set fields directly
}
```
...
Use the Nullable wrapper methods:
- `obj.Data.IsSet()` — check if set
- `obj.Data.Get()` — get the inner value (returns pointer)
- `obj.Data.Set(&val)` — set the value
- `obj.Data.Unset()` — clear the value
