...
`func (o *AddClusterRequestClusterServerConfig) GetDefaultRepoAccount() int64`

GetDefaultRepoAccount returns the DefaultRepoAccount field if non-nil, zero value otherwise.

### GetDefaultRepoAccountOk

`func (o *AddClusterRequestClusterServerConfig) GetDefaultRepoAccountOk() (*int64, bool)`
...
`func (o *AddClusterRequestClusterServerConfig) SetDefaultRepoAccount(v int64)`
...
`func (o *AddClusterRequestClusterServerConfig) GetResourcePoolId() int64`

GetResourcePoolId returns the ResourcePoolId field if non-nil, zero value otherwise.

### GetResourcePoolIdOk

`func (o *AddClusterRequestClusterServerConfig) GetResourcePoolIdOk() (*int64, bool)`
...
`func (o *AddClusterRequestClusterServerConfig) SetResourcePoolId(v int64)`

SetResourcePoolId sets ResourcePoolId field to given value.

### HasResourcePoolId

`func (o *AddClusterRequestClusterServerConfig) HasResourcePoolId() bool`
...
`func (o *AddClusterRequestClusterServerConfig) GetVcpuPlacementMode() string`

GetVcpuPlacementMode returns the VcpuPlacementMode field if non-nil, zero value otherwise.

### GetVcpuPlacementModeOk

`func (o *AddClusterRequestClusterServerConfig) GetVcpuPlacementModeOk() (*string, bool)`
...
`func (o *AddClusterRequestClusterServerConfig) SetVcpuPlacementMode(v string)`

SetVcpuPlacementMode sets VcpuPlacementMode field to given value.

### HasVcpuPlacementMode

`func (o *AddClusterRequestClusterServerConfig) HasVcpuPlacementMode() bool`
