...
`func (o *AddCluster200ResponseAllOfCluster) HasCpuPlacementMode() bool`

HasCpuPlacementMode returns a boolean if a field has been set.

### SetCpuPlacementModeNil

`func (o *AddCluster200ResponseAllOfCluster) SetCpuPlacementModeNil(b bool)`

 SetCpuPlacementModeNil sets the value for CpuPlacementMode to be an explicit nil

### UnsetCpuPlacementMode
`func (o *AddCluster200ResponseAllOfCluster) UnsetCpuPlacementMode()`
