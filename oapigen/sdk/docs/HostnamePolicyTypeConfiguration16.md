# HostnamePolicyTypeConfiguration16
...
### NewHostnamePolicyTypeConfiguration16

`func NewHostnamePolicyTypeConfiguration16() *HostnamePolicyTypeConfiguration16`

NewHostnamePolicyTypeConfiguration16 instantiates a new HostnamePolicyTypeConfiguration16 object
...
`func (o *HostnamePolicyTypeConfiguration16) GetHostNamingTypeOk() (*string, bool)`
...
`func (o *HostnamePolicyTypeConfiguration16) SetHostNamingType(v string)`

SetHostNamingType sets HostNamingType field to given value.

### HasHostNamingType

`func (o *HostnamePolicyTypeConfiguration16) HasHostNamingType() bool`

HasHostNamingType returns a boolean if a field has been set.

### GetHostNamingPattern

`func (o *HostnamePolicyTypeConfiguration16) GetHostNamingPattern() string`

GetHostNamingPattern returns the HostNamingPattern field if non-nil, zero value otherwise.

### GetHostNamingPatternOk

`func (o *HostnamePolicyTypeConfiguration16) GetHostNamingPatternOk() (*string, bool)`
...
`func (o *HostnamePolicyTypeConfiguration16) SetHostNamingPattern(v string)`

SetHostNamingPattern sets HostNamingPattern field to given value.

### HasHostNamingPattern

`func (o *HostnamePolicyTypeConfiguration16) HasHostNamingPattern() bool`
