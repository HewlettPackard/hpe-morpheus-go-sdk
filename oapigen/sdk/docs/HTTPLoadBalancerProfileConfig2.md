# HTTPLoadBalancerProfileConfig2
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag16**](LoadBalancerProfileTag16.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &HTTPLoadBalancerProfileConfig2{
    // Set fields directly
}
```
