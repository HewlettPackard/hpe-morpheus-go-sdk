# CreateLoadBalancerProfileRequestLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag15**](LoadBalancerProfileTag15.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &CreateLoadBalancerProfileRequestLoadBalancerProfileConfig{
    // Set fields directly
}
```
