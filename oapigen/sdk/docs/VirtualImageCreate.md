...
**IsCloudInit** | Pointer to **bool** | Cloud Init Enabled? | [optional] [default to true]
**UserData** | Pointer to **NullableString** | Cloud-Init User Data, a bash script | [optional] 
**InstallAgent** | Pointer to **bool** | Install Agent? | [optional] [default to true]
...
`func (o *VirtualImageCreate) HasUefi() bool`
...
`func (o *VirtualImageCreate) HasFipsEnabled() bool`
...
`func (o *VirtualImageCreate) SetOsTypeNil(b bool)`
