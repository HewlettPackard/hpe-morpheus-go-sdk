# ValidateBackupCreateRequestBackup
...
**BackupJob** | Pointer to [**BackupInstance1BackupJob**](BackupInstance1BackupJob.md) |  | [optional] 
...
```go
obj := &ValidateBackupCreateRequestBackup{
    // Set fields directly
}
```
