# CookiePersistenceLoadBalancerProfileConfig3
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag27**](LoadBalancerProfileTag27.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &CookiePersistenceLoadBalancerProfileConfig3{
    // Set fields directly
}
```
