...
### AnsibleTowerGitRef (Nullable)

Use the Nullable wrapper methods:
- `obj.AnsibleTowerGitRef.IsSet()` — check if set
- `obj.AnsibleTowerGitRef.Get()` — get the inner value (returns pointer)
- `obj.AnsibleTowerGitRef.Set(&val)` — set the value
- `obj.AnsibleTowerGitRef.Unset()` — clear the value
...
### AnsibleGroup (Nullable)

Use the Nullable wrapper methods:
- `obj.AnsibleGroup.IsSet()` — check if set
- `obj.AnsibleGroup.Get()` — get the inner value (returns pointer)
- `obj.AnsibleGroup.Set(&val)` — set the value
- `obj.AnsibleGroup.Unset()` — clear the value
