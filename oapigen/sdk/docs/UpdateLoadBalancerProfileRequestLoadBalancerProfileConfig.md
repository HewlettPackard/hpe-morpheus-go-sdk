# UpdateLoadBalancerProfileRequestLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag39**](LoadBalancerProfileTag39.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &UpdateLoadBalancerProfileRequestLoadBalancerProfileConfig{
    // Set fields directly
}
```
