# ClientSSLLoadBalancerProfileConfig4
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag38**](LoadBalancerProfileTag38.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &ClientSSLLoadBalancerProfileConfig4{
    // Set fields directly
}
```
