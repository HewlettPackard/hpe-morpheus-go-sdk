...
`func (o *ClusterCreateServerConfig) GetDefaultRepoAccount() int64`

GetDefaultRepoAccount returns the DefaultRepoAccount field if non-nil, zero value otherwise.

### GetDefaultRepoAccountOk

`func (o *ClusterCreateServerConfig) GetDefaultRepoAccountOk() (*int64, bool)`
...
`func (o *ClusterCreateServerConfig) SetDefaultRepoAccount(v int64)`
...
`func (o *ClusterCreateServerConfig) GetResourcePoolId() int64`

GetResourcePoolId returns the ResourcePoolId field if non-nil, zero value otherwise.

### GetResourcePoolIdOk

`func (o *ClusterCreateServerConfig) GetResourcePoolIdOk() (*int64, bool)`
...
`func (o *ClusterCreateServerConfig) SetResourcePoolId(v int64)`

SetResourcePoolId sets ResourcePoolId field to given value.

### HasResourcePoolId

`func (o *ClusterCreateServerConfig) HasResourcePoolId() bool`
...
`func (o *ClusterCreateServerConfig) GetVcpuPlacementMode() string`

GetVcpuPlacementMode returns the VcpuPlacementMode field if non-nil, zero value otherwise.

### GetVcpuPlacementModeOk

`func (o *ClusterCreateServerConfig) GetVcpuPlacementModeOk() (*string, bool)`
...
`func (o *ClusterCreateServerConfig) SetVcpuPlacementMode(v string)`

SetVcpuPlacementMode sets VcpuPlacementMode field to given value.

### HasVcpuPlacementMode

`func (o *ClusterCreateServerConfig) HasVcpuPlacementMode() bool`
