# ClusterResourceNamePolicyTypeConfiguration4
...
### NewClusterResourceNamePolicyTypeConfiguration4

`func NewClusterResourceNamePolicyTypeConfiguration4() *ClusterResourceNamePolicyTypeConfiguration4`

NewClusterResourceNamePolicyTypeConfiguration4 instantiates a new ClusterResourceNamePolicyTypeConfiguration4 object
...
`func (o *ClusterResourceNamePolicyTypeConfiguration4) GetServerNamingType() string`

GetServerNamingType returns the ServerNamingType field if non-nil, zero value otherwise.

### GetServerNamingTypeOk

`func (o *ClusterResourceNamePolicyTypeConfiguration4) GetServerNamingTypeOk() (*string, bool)`
...
`func (o *ClusterResourceNamePolicyTypeConfiguration4) SetServerNamingType(v string)`

SetServerNamingType sets ServerNamingType field to given value.

### HasServerNamingType

`func (o *ClusterResourceNamePolicyTypeConfiguration4) HasServerNamingType() bool`

HasServerNamingType returns a boolean if a field has been set.

### GetServerNamingPattern

`func (o *ClusterResourceNamePolicyTypeConfiguration4) GetServerNamingPattern() string`

GetServerNamingPattern returns the ServerNamingPattern field if non-nil, zero value otherwise.

### GetServerNamingPatternOk

`func (o *ClusterResourceNamePolicyTypeConfiguration4) GetServerNamingPatternOk() (*string, bool)`
...
`func (o *ClusterResourceNamePolicyTypeConfiguration4) SetServerNamingPattern(v string)`

SetServerNamingPattern sets ServerNamingPattern field to given value.

### HasServerNamingPattern

`func (o *ClusterResourceNamePolicyTypeConfiguration4) HasServerNamingPattern() bool`

HasServerNamingPattern returns a boolean if a field has been set.

### GetServerNamingConflict

`func (o *ClusterResourceNamePolicyTypeConfiguration4) GetServerNamingConflict() bool`

GetServerNamingConflict returns the ServerNamingConflict field if non-nil, zero value otherwise.

### GetServerNamingConflictOk

`func (o *ClusterResourceNamePolicyTypeConfiguration4) GetServerNamingConflictOk() (*bool, bool)`
...
`func (o *ClusterResourceNamePolicyTypeConfiguration4) SetServerNamingConflict(v bool)`

SetServerNamingConflict sets ServerNamingConflict field to given value.

### HasServerNamingConflict

`func (o *ClusterResourceNamePolicyTypeConfiguration4) HasServerNamingConflict() bool`
