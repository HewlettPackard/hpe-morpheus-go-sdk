# LoadBalancerProfileConfigFastUdp
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag50**](LoadBalancerProfileTag50.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &LoadBalancerProfileConfigFastUdp{
    // Set fields directly
}
```
