...
**Tags** | Pointer to [**[]LoadBalancerProfileTag48**](LoadBalancerProfileTag48.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &LoadBalancerProfileConfigHttp{
    // Set fields directly
}
```
