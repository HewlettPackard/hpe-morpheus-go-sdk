...
### PuppetEnvironment (Nullable)

Use the Nullable wrapper methods:
- `obj.PuppetEnvironment.IsSet()` — check if set
- `obj.PuppetEnvironment.Get()` — get the inner value (returns pointer)
- `obj.PuppetEnvironment.Set(&val)` — set the value
- `obj.PuppetEnvironment.Unset()` — clear the value
### PuppetNodeName (Nullable)

Use the Nullable wrapper methods:
- `obj.PuppetNodeName.IsSet()` — check if set
- `obj.PuppetNodeName.Get()` — get the inner value (returns pointer)
- `obj.PuppetNodeName.Set(&val)` — set the value
- `obj.PuppetNodeName.Unset()` — clear the value
### SshKey (Nullable)
