# ClientSSLLoadBalancerProfileConfig3
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag30**](LoadBalancerProfileTag30.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &ClientSSLLoadBalancerProfileConfig3{
    // Set fields directly
}
```
