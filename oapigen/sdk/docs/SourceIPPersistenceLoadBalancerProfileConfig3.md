# SourceIPPersistenceLoadBalancerProfileConfig3
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag28**](LoadBalancerProfileTag28.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &SourceIPPersistenceLoadBalancerProfileConfig3{
    // Set fields directly
}
```
