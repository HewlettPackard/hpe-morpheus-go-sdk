...
**Config** | Pointer to [**UpdateLoadBalancerVirtualServerRequestLoadBalancerInstanceConfig**](UpdateLoadBalancerVirtualServerRequestLoadBalancerInstanceConfig.md) |  | [optional] 
...
`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) GetVipPool() int64`

GetVipPool returns the VipPool field if non-nil, zero value otherwise.

### GetVipPoolOk

`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) GetVipPoolOk() (*int64, bool)`
...
`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) SetVipPool(v int64)`

SetVipPool sets VipPool field to given value.

### HasVipPool

`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) HasVipPool() bool`

HasVipPool returns a boolean if a field has been set.

### SetVipPoolNil

`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) SetVipPoolNil(b bool)`

 SetVipPoolNil sets the value for VipPool to be an explicit nil

### UnsetVipPool
`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) UnsetVipPool()`
...
`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) GetConfig() UpdateLoadBalancerVirtualServerRequestLoadBalancerInstanceConfig`

GetConfig returns the Config field if non-nil, zero value otherwise.

### GetConfigOk

`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) GetConfigOk() (*UpdateLoadBalancerVirtualServerRequestLoadBalancerInstanceConfig, bool)`
...
`func (o *UpdateLoadBalancerVirtualServerRequestLoadBalancerInstance) SetConfig(v UpdateLoadBalancerVirtualServerRequestLoadBalancerInstanceConfig)`
