# SourceIPPersistenceLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag4**](LoadBalancerProfileTag4.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &SourceIPPersistenceLoadBalancerProfileConfig{
    // Set fields directly
}
```
