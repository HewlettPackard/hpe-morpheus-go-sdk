# ClientSSLLoadBalancerProfileConfig5
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag46**](LoadBalancerProfileTag46.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &ClientSSLLoadBalancerProfileConfig5{
    // Set fields directly
}
```
