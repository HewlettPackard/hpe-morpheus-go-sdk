# GoogleCloudInstanceConfiguration3
...
### NewGoogleCloudInstanceConfiguration3

`func NewGoogleCloudInstanceConfiguration3() *GoogleCloudInstanceConfiguration3`

NewGoogleCloudInstanceConfiguration3 instantiates a new GoogleCloudInstanceConfiguration3 object
...
`func (o *GoogleCloudInstanceConfiguration3) GetNoAgent() bool`

GetNoAgent returns the NoAgent field if non-nil, zero value otherwise.

### GetNoAgentOk

`func (o *GoogleCloudInstanceConfiguration3) GetNoAgentOk() (*bool, bool)`
...
`func (o *GoogleCloudInstanceConfiguration3) HasNoAgent() bool`

HasNoAgent returns a boolean if a field has been set.

### SetNoAgentNil

`func (o *GoogleCloudInstanceConfiguration3) SetNoAgentNil(b bool)`
...
`func (o *GoogleCloudInstanceConfiguration3) GetGoogleZoneId() int64`

GetGoogleZoneId returns the GoogleZoneId field if non-nil, zero value otherwise.

### GetGoogleZoneIdOk

`func (o *GoogleCloudInstanceConfiguration3) GetGoogleZoneIdOk() (*int64, bool)`
...
`func (o *GoogleCloudInstanceConfiguration3) SetGoogleZoneId(v int64)`

SetGoogleZoneId sets GoogleZoneId field to given value.

### HasGoogleZoneId

`func (o *GoogleCloudInstanceConfiguration3) HasGoogleZoneId() bool`

HasGoogleZoneId returns a boolean if a field has been set.

### GetExternalIpType

`func (o *GoogleCloudInstanceConfiguration3) GetExternalIpType() int64`

GetExternalIpType returns the ExternalIpType field if non-nil, zero value otherwise.

### GetExternalIpTypeOk

`func (o *GoogleCloudInstanceConfiguration3) GetExternalIpTypeOk() (*int64, bool)`
...
`func (o *GoogleCloudInstanceConfiguration3) HasExternalIpType() bool`

HasExternalIpType returns a boolean if a field has been set.

### GetNetworkTags

`func (o *GoogleCloudInstanceConfiguration3) GetNetworkTags() string`

GetNetworkTags returns the NetworkTags field if non-nil, zero value otherwise.

### GetNetworkTagsOk

`func (o *GoogleCloudInstanceConfiguration3) GetNetworkTagsOk() (*string, bool)`
...
`func (o *GoogleCloudInstanceConfiguration3) SetNetworkTags(v string)`

SetNetworkTags sets NetworkTags field to given value.

### HasNetworkTags

`func (o *GoogleCloudInstanceConfiguration3) HasNetworkTags() bool`

HasNetworkTags returns a boolean if a field has been set.

### GetServiceAccount

`func (o *GoogleCloudInstanceConfiguration3) GetServiceAccount() string`

GetServiceAccount returns the ServiceAccount field if non-nil, zero value otherwise.

### GetServiceAccountOk

`func (o *GoogleCloudInstanceConfiguration3) GetServiceAccountOk() (*string, bool)`
...
`func (o *GoogleCloudInstanceConfiguration3) HasServiceAccount() bool`

HasServiceAccount returns a boolean if a field has been set.

### GetAccessScope

`func (o *GoogleCloudInstanceConfiguration3) GetAccessScope() string`

GetAccessScope returns the AccessScope field if non-nil, zero value otherwise.

### GetAccessScopeOk

`func (o *GoogleCloudInstanceConfiguration3) GetAccessScopeOk() (*string, bool)`
...
`func (o *GoogleCloudInstanceConfiguration3) SetAccessScope(v string)`

SetAccessScope sets AccessScope field to given value.

### HasAccessScope

`func (o *GoogleCloudInstanceConfiguration3) HasAccessScope() bool`
