# LoadBalancerProfileConfigClientSsl
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag54**](LoadBalancerProfileTag54.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &LoadBalancerProfileConfigClientSsl{
    // Set fields directly
}
```
