# FastTCPLoadBalancerProfileConfig5
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag41**](LoadBalancerProfileTag41.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastTCPLoadBalancerProfileConfig5{
    // Set fields directly
}
```
