# CookiePersistenceLoadBalancerProfileConfig4
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag35**](LoadBalancerProfileTag35.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &CookiePersistenceLoadBalancerProfileConfig4{
    // Set fields directly
}
```
