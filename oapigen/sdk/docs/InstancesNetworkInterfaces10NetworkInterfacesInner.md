# InstancesNetworkInterfaces10NetworkInterfacesInner

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Network** | [**InstancesNetworkInterfaces10NetworkInterfacesInnerNetwork**](InstancesNetworkInterfaces10NetworkInterfacesInnerNetwork.md) |  | 
...
```go
obj := &InstancesNetworkInterfaces10NetworkInterfacesInner{
    // Set fields directly
}
```
