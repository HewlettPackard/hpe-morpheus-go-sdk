# FastUDPLoadBalancerProfileConfig1
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag10**](LoadBalancerProfileTag10.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastUDPLoadBalancerProfileConfig1{
    // Set fields directly
}
```
