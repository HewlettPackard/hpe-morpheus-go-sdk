...
**Config** | Pointer to [**IntegrationSaltMasterConfigIntegrationConfig**](IntegrationSaltMasterConfigIntegrationConfig.md) |  | [optional] 
...
```go
obj := &IntegrationSaltMasterConfigIntegration{
    // Set fields directly
}
```
