# PolicyCloudCreatePolicyTypeConfigOneOf23
...
### NewPolicyCloudCreatePolicyTypeConfigOneOf23

`func NewPolicyCloudCreatePolicyTypeConfigOneOf23() *PolicyCloudCreatePolicyTypeConfigOneOf23`

NewPolicyCloudCreatePolicyTypeConfigOneOf23 instantiates a new PolicyCloudCreatePolicyTypeConfigOneOf23 object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewPolicyCloudCreatePolicyTypeConfigOneOf23WithDefaults
...
`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) GetPowerScheduleType() string`

GetPowerScheduleType returns the PowerScheduleType field if non-nil, zero value otherwise.

### GetPowerScheduleTypeOk

`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) GetPowerScheduleTypeOk() (*string, bool)`
...
`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) SetPowerScheduleType(v string)`

SetPowerScheduleType sets PowerScheduleType field to given value.

### HasPowerScheduleType

`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) HasPowerScheduleType() bool`

HasPowerScheduleType returns a boolean if a field has been set.

### GetPowerSchedule

`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) GetPowerSchedule() string`

GetPowerSchedule returns the PowerSchedule field if non-nil, zero value otherwise.

### GetPowerScheduleOk

`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) GetPowerScheduleOk() (*string, bool)`
...
`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) SetPowerSchedule(v string)`

SetPowerSchedule sets PowerSchedule field to given value.

### HasPowerSchedule

`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) HasPowerSchedule() bool`

HasPowerSchedule returns a boolean if a field has been set.

### GetPowerScheduleHideFixed

`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) GetPowerScheduleHideFixed() bool`
...
`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) GetPowerScheduleHideFixedOk() (*bool, bool)`
...
`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) SetPowerScheduleHideFixed(v bool)`

SetPowerScheduleHideFixed sets PowerScheduleHideFixed field to given value.

### HasPowerScheduleHideFixed

`func (o *PolicyCloudCreatePolicyTypeConfigOneOf23) HasPowerScheduleHideFixed() bool`
