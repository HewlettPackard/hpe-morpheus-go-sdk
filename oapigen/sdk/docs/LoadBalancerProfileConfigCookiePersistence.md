# LoadBalancerProfileConfigCookiePersistence
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag51**](LoadBalancerProfileTag51.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &LoadBalancerProfileConfigCookiePersistence{
    // Set fields directly
}
```
