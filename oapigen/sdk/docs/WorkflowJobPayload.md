...
`func NewWorkflowJobPayload(name string, workflow WorkflowJobPayloadWorkflow, targetType string, scheduleMode WorkflowJobPayloadScheduleMode, ) *WorkflowJobPayload`
...
`func (o *WorkflowJobPayload) GetWorkflow() WorkflowJobPayloadWorkflow`

GetWorkflow returns the Workflow field if non-nil, zero value otherwise.

### GetWorkflowOk

`func (o *WorkflowJobPayload) GetWorkflowOk() (*WorkflowJobPayloadWorkflow, bool)`
...
`func (o *WorkflowJobPayload) SetWorkflow(v WorkflowJobPayloadWorkflow)`
