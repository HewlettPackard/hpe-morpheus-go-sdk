# GenericPersistenceLoadBalancerProfileConfig5
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag45**](LoadBalancerProfileTag45.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &GenericPersistenceLoadBalancerProfileConfig5{
    // Set fields directly
}
```
