...
```go
obj := &GetCloudTypes200ResponseZoneTypeOptionTypesInner{
    // Set fields directly
}
```
...
Use the Nullable wrapper methods:
- `obj.FieldName.IsSet()` — check if set
- `obj.FieldName.Get()` — get the inner value (returns pointer)
- `obj.FieldName.Set(&val)` — set the value
- `obj.FieldName.Unset()` — clear the value
### FieldLabel (Nullable)

Use the Nullable wrapper methods:
- `obj.FieldLabel.IsSet()` — check if set
- `obj.FieldLabel.Get()` — get the inner value (returns pointer)
- `obj.FieldLabel.Set(&val)` — set the value
- `obj.FieldLabel.Unset()` — clear the value
### FieldContext (Nullable)

Use the Nullable wrapper methods:
- `obj.FieldContext.IsSet()` — check if set
- `obj.FieldContext.Get()` — get the inner value (returns pointer)
- `obj.FieldContext.Set(&val)` — set the value
- `obj.FieldContext.Unset()` — clear the value
### FieldGroup (Nullable)
...
Use the Nullable wrapper methods:
- `obj.OptionList.IsSet()` — check if set
- `obj.OptionList.Get()` — get the inner value (returns pointer)
- `obj.OptionList.Set(&val)` — set the value
- `obj.OptionList.Unset()` — clear the value
