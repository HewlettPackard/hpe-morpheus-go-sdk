...
**Tags** | Pointer to [**[]LoadBalancerProfileTag**](LoadBalancerProfileTag.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &HTTPLoadBalancerProfileConfig{
    // Set fields directly
}
```
