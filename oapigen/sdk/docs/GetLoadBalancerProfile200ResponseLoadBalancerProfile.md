...
**Config** | Pointer to [**GetLoadBalancerProfile200ResponseLoadBalancerProfileConfig**](GetLoadBalancerProfile200ResponseLoadBalancerProfileConfig.md) |  | [optional] 
...
```go
obj := &GetLoadBalancerProfile200ResponseLoadBalancerProfile{
    // Set fields directly
}
```
