...
------------ | ------------- | ------------- | -------------
**ResourcePermissions** | Pointer to [**ClusterNamespaceUpdatePermissionsResourcePermissions**](ClusterNamespaceUpdatePermissionsResourcePermissions.md) |  | [optional] 
...
`func (o *ClusterNamespaceUpdatePermissions) GetResourcePermissions() ClusterNamespaceUpdatePermissionsResourcePermissions`

GetResourcePermissions returns the ResourcePermissions field if non-nil, zero value otherwise.

### GetResourcePermissionsOk

`func (o *ClusterNamespaceUpdatePermissions) GetResourcePermissionsOk() (*ClusterNamespaceUpdatePermissionsResourcePermissions, bool)`
...
`func (o *ClusterNamespaceUpdatePermissions) SetResourcePermissions(v ClusterNamespaceUpdatePermissionsResourcePermissions)`
