# FastTCPLoadBalancerProfileConfig4
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag33**](LoadBalancerProfileTag33.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastTCPLoadBalancerProfileConfig4{
    // Set fields directly
}
```
