...
**Config** | Pointer to [**NetworkPoolServerCreateBluecatConfig**](NetworkPoolServerCreateBluecatConfig.md) |  | [optional] 
**Credential** | Pointer to [**NetworkPoolServerCreateBluecatCredential**](NetworkPoolServerCreateBluecatCredential.md) |  | [optional] 
...
```go
obj := &NetworkPoolServerCreateBluecat{
    // Set fields directly
}
```
