...
`func (o *AddInstanceRequestConfig) GetAzureRegion() string`

GetAzureRegion returns the AzureRegion field if non-nil, zero value otherwise.

### GetAzureRegionOk

`func (o *AddInstanceRequestConfig) GetAzureRegionOk() (*string, bool)`
...
`func (o *AddInstanceRequestConfig) SetAzuresecurityGroupId(v string)`

SetAzuresecurityGroupId sets AzuresecurityGroupId field to given value.

### HasAzuresecurityGroupId

`func (o *AddInstanceRequestConfig) HasAzuresecurityGroupId() bool`
...
`func (o *AddInstanceRequestConfig) GetProvisionPoweredOff() bool`

GetProvisionPoweredOff returns the ProvisionPoweredOff field if non-nil, zero value otherwise.

### GetProvisionPoweredOffOk

`func (o *AddInstanceRequestConfig) GetProvisionPoweredOffOk() (*bool, bool)`
...
`func (o *AddInstanceRequestConfig) SetProvisionPoweredOff(v bool)`

SetProvisionPoweredOff sets ProvisionPoweredOff field to given value.

### HasProvisionPoweredOff

`func (o *AddInstanceRequestConfig) HasProvisionPoweredOff() bool`
