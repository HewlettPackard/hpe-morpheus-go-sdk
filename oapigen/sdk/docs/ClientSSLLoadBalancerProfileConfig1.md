# ClientSSLLoadBalancerProfileConfig1
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag14**](LoadBalancerProfileTag14.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &ClientSSLLoadBalancerProfileConfig1{
    // Set fields directly
}
```
