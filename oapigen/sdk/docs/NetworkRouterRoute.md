...
`func (o *NetworkRouterRoute) GetNetworkMtu() float32`

GetNetworkMtu returns the NetworkMtu field if non-nil, zero value otherwise.

### GetNetworkMtuOk

`func (o *NetworkRouterRoute) GetNetworkMtuOk() (*float32, bool)`
...
`func (o *NetworkRouterRoute) SetNetworkMtu(v float32)`
