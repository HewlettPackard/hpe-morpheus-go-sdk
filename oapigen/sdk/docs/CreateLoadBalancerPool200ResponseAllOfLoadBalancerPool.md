...
**CreatedBy** | Pointer to [**CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolCreatedBy**](CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolCreatedBy.md) |  | [optional] 
...
```go
obj := &CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool{
    // Set fields directly
}
```
