...
**Config** | Pointer to [**NetworkPoolServerCreateSolarWindsConfig**](NetworkPoolServerCreateSolarWindsConfig.md) |  | [optional] 
**Credential** | Pointer to [**NetworkPoolServerCreateSolarWindsCredential**](NetworkPoolServerCreateSolarWindsCredential.md) |  | [optional] 
...
`func (o *NetworkPoolServerCreateSolarWinds) GetConfig() NetworkPoolServerCreateSolarWindsConfig`

GetConfig returns the Config field if non-nil, zero value otherwise.

### GetConfigOk

`func (o *NetworkPoolServerCreateSolarWinds) GetConfigOk() (*NetworkPoolServerCreateSolarWindsConfig, bool)`
...
`func (o *NetworkPoolServerCreateSolarWinds) SetConfig(v NetworkPoolServerCreateSolarWindsConfig)`
...
`func (o *NetworkPoolServerCreateSolarWinds) GetCredential() NetworkPoolServerCreateSolarWindsCredential`

GetCredential returns the Credential field if non-nil, zero value otherwise.

### GetCredentialOk

`func (o *NetworkPoolServerCreateSolarWinds) GetCredentialOk() (*NetworkPoolServerCreateSolarWindsCredential, bool)`
...
`func (o *NetworkPoolServerCreateSolarWinds) SetCredential(v NetworkPoolServerCreateSolarWindsCredential)`
