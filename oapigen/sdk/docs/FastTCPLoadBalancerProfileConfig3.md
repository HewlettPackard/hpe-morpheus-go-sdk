# FastTCPLoadBalancerProfileConfig3
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag25**](LoadBalancerProfileTag25.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastTCPLoadBalancerProfileConfig3{
    // Set fields directly
}
```
