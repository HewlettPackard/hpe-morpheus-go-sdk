# FastTCPLoadBalancerProfileConfig2
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag17**](LoadBalancerProfileTag17.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastTCPLoadBalancerProfileConfig2{
    // Set fields directly
}
```
