# PowerSchedulePolicyTypeConfiguration11
...
### NewPowerSchedulePolicyTypeConfiguration11

`func NewPowerSchedulePolicyTypeConfiguration11(powerScheduleType string, ) *PowerSchedulePolicyTypeConfiguration11`

NewPowerSchedulePolicyTypeConfiguration11 instantiates a new PowerSchedulePolicyTypeConfiguration11 object
...
`func (o *PowerSchedulePolicyTypeConfiguration11) GetPowerScheduleType() string`

GetPowerScheduleType returns the PowerScheduleType field if non-nil, zero value otherwise.

### GetPowerScheduleTypeOk

`func (o *PowerSchedulePolicyTypeConfiguration11) GetPowerScheduleTypeOk() (*string, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration11) SetPowerScheduleType(v string)`
...
`func (o *PowerSchedulePolicyTypeConfiguration11) GetPowerSchedule() string`

GetPowerSchedule returns the PowerSchedule field if non-nil, zero value otherwise.

### GetPowerScheduleOk

`func (o *PowerSchedulePolicyTypeConfiguration11) GetPowerScheduleOk() (*string, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration11) SetPowerSchedule(v string)`

SetPowerSchedule sets PowerSchedule field to given value.

### HasPowerSchedule

`func (o *PowerSchedulePolicyTypeConfiguration11) HasPowerSchedule() bool`

HasPowerSchedule returns a boolean if a field has been set.

### GetPowerScheduleHideFixed

`func (o *PowerSchedulePolicyTypeConfiguration11) GetPowerScheduleHideFixed() bool`
...
`func (o *PowerSchedulePolicyTypeConfiguration11) GetPowerScheduleHideFixedOk() (*bool, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration11) SetPowerScheduleHideFixed(v bool)`

SetPowerScheduleHideFixed sets PowerScheduleHideFixed field to given value.

### HasPowerScheduleHideFixed

`func (o *PowerSchedulePolicyTypeConfiguration11) HasPowerScheduleHideFixed() bool`
