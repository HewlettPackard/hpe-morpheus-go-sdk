# CookiePersistenceLoadBalancerProfileConfig5
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag43**](LoadBalancerProfileTag43.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &CookiePersistenceLoadBalancerProfileConfig5{
    // Set fields directly
}
```
