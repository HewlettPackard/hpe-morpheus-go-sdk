# CookiePersistenceLoadBalancerProfileConfig
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag3**](LoadBalancerProfileTag3.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &CookiePersistenceLoadBalancerProfileConfig{
    // Set fields directly
}
```
