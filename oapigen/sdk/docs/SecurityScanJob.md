...
`func NewSecurityScanJob(name string, securityPackage SecurityScanJobSecurityPackage, targetType string, targets []SecurityScanJobTargetsInner, scheduleMode SecurityScanJobScheduleMode, ) *SecurityScanJob`
...
`func (o *SecurityScanJob) GetSecurityPackage() SecurityScanJobSecurityPackage`

GetSecurityPackage returns the SecurityPackage field if non-nil, zero value otherwise.

### GetSecurityPackageOk

`func (o *SecurityScanJob) GetSecurityPackageOk() (*SecurityScanJobSecurityPackage, bool)`
...
`func (o *SecurityScanJob) SetSecurityPackage(v SecurityScanJobSecurityPackage)`
...
`func (o *SecurityScanJob) GetTargets() []SecurityScanJobTargetsInner`

GetTargets returns the Targets field if non-nil, zero value otherwise.

### GetTargetsOk

`func (o *SecurityScanJob) GetTargetsOk() (*[]SecurityScanJobTargetsInner, bool)`
...
`func (o *SecurityScanJob) SetTargets(v []SecurityScanJobTargetsInner)`
...
`func (o *SecurityScanJob) GetScheduleMode() SecurityScanJobScheduleMode`

GetScheduleMode returns the ScheduleMode field if non-nil, zero value otherwise.

### GetScheduleModeOk

`func (o *SecurityScanJob) GetScheduleModeOk() (*SecurityScanJobScheduleMode, bool)`
...
`func (o *SecurityScanJob) SetScheduleMode(v SecurityScanJobScheduleMode)`
