...
### ContainerScriptId (Nullable)

Use the Nullable wrapper methods:
- `obj.ContainerScriptId.IsSet()` — check if set
- `obj.ContainerScriptId.Get()` — get the inner value (returns pointer)
- `obj.ContainerScriptId.Set(&val)` — set the value
- `obj.ContainerScriptId.Unset()` — clear the value
### SshKey (Nullable)
...
### ContainerScript (Nullable)

Use the Nullable wrapper methods:
- `obj.ContainerScript.IsSet()` — check if set
- `obj.ContainerScript.Get()` — get the inner value (returns pointer)
- `obj.ContainerScript.Set(&val)` — set the value
- `obj.ContainerScript.Unset()` — clear the value
### Port (Nullable)
