...
**Approval** | Pointer to [**GetApprovalsItem200ResponseApprovalItemApproval**](GetApprovalsItem200ResponseApprovalItemApproval.md) |  | [optional] 
...
**Details** | Pointer to [**[]GetApprovalsItem200ResponseApprovalItemDetailsInner**](GetApprovalsItem200ResponseApprovalItemDetailsInner.md) | List of request change details associated with the approval item. Only present when the approval is for a reconfigure request.  | [optional] 
...
`func (o *GetApprovalsItem200ResponseApprovalItem) GetApproval() GetApprovalsItem200ResponseApprovalItemApproval`

GetApproval returns the Approval field if non-nil, zero value otherwise.

### GetApprovalOk

`func (o *GetApprovalsItem200ResponseApprovalItem) GetApprovalOk() (*GetApprovalsItem200ResponseApprovalItemApproval, bool)`
...
`func (o *GetApprovalsItem200ResponseApprovalItem) SetApproval(v GetApprovalsItem200ResponseApprovalItemApproval)`
...
`func (o *GetApprovalsItem200ResponseApprovalItem) GetDetails() []GetApprovalsItem200ResponseApprovalItemDetailsInner`

GetDetails returns the Details field if non-nil, zero value otherwise.

### GetDetailsOk

`func (o *GetApprovalsItem200ResponseApprovalItem) GetDetailsOk() (*[]GetApprovalsItem200ResponseApprovalItemDetailsInner, bool)`
...
`func (o *GetApprovalsItem200ResponseApprovalItem) SetDetails(v []GetApprovalsItem200ResponseApprovalItemDetailsInner)`

SetDetails sets Details field to given value.

### HasDetails

`func (o *GetApprovalsItem200ResponseApprovalItem) HasDetails() bool`

HasDetails returns a boolean if a field has been set.

### SetDetailsNil

`func (o *GetApprovalsItem200ResponseApprovalItem) SetDetailsNil(b bool)`

 SetDetailsNil sets the value for Details to be an explicit nil

### UnsetDetails
`func (o *GetApprovalsItem200ResponseApprovalItem) UnsetDetails()`
