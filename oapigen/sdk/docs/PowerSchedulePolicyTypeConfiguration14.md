# PowerSchedulePolicyTypeConfiguration14
...
### NewPowerSchedulePolicyTypeConfiguration14

`func NewPowerSchedulePolicyTypeConfiguration14(powerScheduleType string, ) *PowerSchedulePolicyTypeConfiguration14`

NewPowerSchedulePolicyTypeConfiguration14 instantiates a new PowerSchedulePolicyTypeConfiguration14 object
...
`func (o *PowerSchedulePolicyTypeConfiguration14) GetPowerScheduleType() string`

GetPowerScheduleType returns the PowerScheduleType field if non-nil, zero value otherwise.

### GetPowerScheduleTypeOk

`func (o *PowerSchedulePolicyTypeConfiguration14) GetPowerScheduleTypeOk() (*string, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration14) SetPowerScheduleType(v string)`
...
`func (o *PowerSchedulePolicyTypeConfiguration14) GetPowerSchedule() string`

GetPowerSchedule returns the PowerSchedule field if non-nil, zero value otherwise.

### GetPowerScheduleOk

`func (o *PowerSchedulePolicyTypeConfiguration14) GetPowerScheduleOk() (*string, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration14) SetPowerSchedule(v string)`

SetPowerSchedule sets PowerSchedule field to given value.

### HasPowerSchedule

`func (o *PowerSchedulePolicyTypeConfiguration14) HasPowerSchedule() bool`

HasPowerSchedule returns a boolean if a field has been set.

### GetPowerScheduleHideFixed

`func (o *PowerSchedulePolicyTypeConfiguration14) GetPowerScheduleHideFixed() bool`
...
`func (o *PowerSchedulePolicyTypeConfiguration14) GetPowerScheduleHideFixedOk() (*bool, bool)`
...
`func (o *PowerSchedulePolicyTypeConfiguration14) SetPowerScheduleHideFixed(v bool)`

SetPowerScheduleHideFixed sets PowerScheduleHideFixed field to given value.

### HasPowerScheduleHideFixed

`func (o *PowerSchedulePolicyTypeConfiguration14) HasPowerScheduleHideFixed() bool`
