...
GetMovePoweredOff returns the MovePoweredOff field if non-nil, zero value otherwise.

### GetMovePoweredOffOk

`func (o *EnableMaintenanceModeRequestServer) GetMovePoweredOffOk() (*bool, bool)`

GetMovePoweredOffOk returns a tuple with the MovePoweredOff field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetMovePoweredOff sets MovePoweredOff field to given value.

### HasMovePoweredOff

`func (o *EnableMaintenanceModeRequestServer) HasMovePoweredOff() bool`

HasMovePoweredOff returns a boolean if a field has been set.
