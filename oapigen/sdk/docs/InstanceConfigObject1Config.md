...
`func (o *InstanceConfigObject1Config) GetAzureRegion() string`

GetAzureRegion returns the AzureRegion field if non-nil, zero value otherwise.

### GetAzureRegionOk

`func (o *InstanceConfigObject1Config) GetAzureRegionOk() (*string, bool)`
...
`func (o *InstanceConfigObject1Config) SetAzuresecurityGroupId(v string)`

SetAzuresecurityGroupId sets AzuresecurityGroupId field to given value.

### HasAzuresecurityGroupId

`func (o *InstanceConfigObject1Config) HasAzuresecurityGroupId() bool`
