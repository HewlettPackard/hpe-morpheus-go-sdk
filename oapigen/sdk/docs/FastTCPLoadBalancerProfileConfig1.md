# FastTCPLoadBalancerProfileConfig1
...
**Tags** | Pointer to [**[]LoadBalancerProfileTag9**](LoadBalancerProfileTag9.md) | NSX-T tags applied to the profile. | [optional] 
...
```go
obj := &FastTCPLoadBalancerProfileConfig1{
    // Set fields directly
}
```
