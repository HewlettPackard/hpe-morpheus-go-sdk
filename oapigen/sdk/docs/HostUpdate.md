...
**SshKeyPair** | Pointer to [**HostUpdateSshKeyPair**](HostUpdateSshKeyPair.md) |  | [optional] 
**PowerScheduleType** | Pointer to **int64** | Power schedule ID. | [optional] 
**Labels** | Pointer to **[]string** |  | [optional] 
**ServerOs** | Pointer to [**HostUpdateServerOs**](HostUpdateServerOs.md) |  | [optional] 
**Tags** | Pointer to [**[]HostUpdateTagsInner**](HostUpdateTagsInner.md) | Metadata tags, Array of objects having a name and value. | [optional] 
**AddTags** | Pointer to [**[]HostUpdateAddTagsInner**](HostUpdateAddTagsInner.md) | Add or update value of Metadata tags, Array of objects having a name and value. | [optional] 
**RemoveTags** | Pointer to [**[]HostUpdateRemoveTagsInner**](HostUpdateRemoveTagsInner.md) | Remove Metadata tags, Array of objects having a name and an optional value. If value is passed, it must match to be removed. | [optional] 
...
**Config** | Pointer to [**HostUpdateConfig**](HostUpdateConfig.md) |  | [optional] 
...
`func (o *HostUpdate) SetSshPasswordNil(b bool)`
...
`func (o *HostUpdate) GetSshKeyPair() HostUpdateSshKeyPair`

GetSshKeyPair returns the SshKeyPair field if non-nil, zero value otherwise.

### GetSshKeyPairOk

`func (o *HostUpdate) GetSshKeyPairOk() (*HostUpdateSshKeyPair, bool)`
...
`func (o *HostUpdate) SetSshKeyPair(v HostUpdateSshKeyPair)`
...
`func (o *HostUpdate) GetServerOs() HostUpdateServerOs`

GetServerOs returns the ServerOs field if non-nil, zero value otherwise.

### GetServerOsOk

`func (o *HostUpdate) GetServerOsOk() (*HostUpdateServerOs, bool)`
...
`func (o *HostUpdate) GetTags() []HostUpdateTagsInner`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *HostUpdate) GetTagsOk() (*[]HostUpdateTagsInner, bool)`
...
`func (o *HostUpdate) SetTags(v []HostUpdateTagsInner)`
...
`func (o *HostUpdate) GetAddTags() []HostUpdateAddTagsInner`

GetAddTags returns the AddTags field if non-nil, zero value otherwise.

### GetAddTagsOk

`func (o *HostUpdate) GetAddTagsOk() (*[]HostUpdateAddTagsInner, bool)`
...
`func (o *HostUpdate) GetRemoveTags() []HostUpdateRemoveTagsInner`

GetRemoveTags returns the RemoveTags field if non-nil, zero value otherwise.

### GetRemoveTagsOk

`func (o *HostUpdate) GetRemoveTagsOk() (*[]HostUpdateRemoveTagsInner, bool)`
...
`func (o *HostUpdate) SetRemoveTags(v []HostUpdateRemoveTagsInner)`
...
`func (o *HostUpdate) HasConfig() bool`
