...
func (o *BlueprintCreateSuccessConfigOneOf3KubernetesGit) IsSetRepoId() bool {
	if o != nil && !IsNil(o.RepoId) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3KubernetesGit) IsSetPath() bool {
	if o != nil && !IsNil(o.Path) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3KubernetesGit) IsSetIntegrationId() bool {
	if o != nil && !IsNil(o.IntegrationId) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3KubernetesGit) IsSetBranch() bool {
	if o != nil && !IsNil(o.Branch) {
		return true
	}
