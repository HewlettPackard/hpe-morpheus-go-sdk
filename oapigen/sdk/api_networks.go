...
func (r ApiDeleteNetworkRequest) Execute() (*DeleteLayout200Response, *http.Response, error) {
...
func (a *NetworksAPIService) DeleteNetworkExecute(r ApiDeleteNetworkRequest) (*DeleteLayout200Response, *http.Response, error) {
	var (
