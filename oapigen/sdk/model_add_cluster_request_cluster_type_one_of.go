...
// checks if the AddClusterRequestClusterTypeOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddClusterRequestClusterTypeOneOf{}
...
func NewAddClusterRequestClusterTypeOneOf() *AddClusterRequestClusterTypeOneOf {
	this := AddClusterRequestClusterTypeOneOf{}
	return &this
}
...
func (o *AddClusterRequestClusterTypeOneOf) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddClusterRequestClusterTypeOneOf) MarshalJSON() ([]byte, error) {
...
func (o AddClusterRequestClusterTypeOneOf) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddClusterRequestClusterTypeOneOf) UnmarshalMapstructure(data any) (any, error) {
