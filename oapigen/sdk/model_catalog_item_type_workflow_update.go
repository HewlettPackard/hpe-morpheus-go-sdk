...
// checks if the CatalogItemTypeWorkflowUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogItemTypeWorkflowUpdate{}
...
type CatalogItemTypeWorkflowUpdate struct {
	...
	Workflow      *CatalogItemTypeWorkflowUpdateWorkflow `json:"workflow,omitempty"`
	...
	Form     *CatalogItemTypeWorkflowUpdateForm `json:"form,omitempty"`
...
func (o *CatalogItemTypeWorkflowUpdate) GetWorkflow() CatalogItemTypeWorkflowUpdateWorkflow {
	if o == nil || IsNil(o.Workflow) {
		var ret CatalogItemTypeWorkflowUpdateWorkflow
		return ret
	}
	return *o.Workflow
}
...
func (o *CatalogItemTypeWorkflowUpdate) GetForm() CatalogItemTypeWorkflowUpdateForm {
	if o == nil || IsNil(o.Form) {
		var ret CatalogItemTypeWorkflowUpdateForm
		return ret
	}
	return *o.Form
}
...
func (o CatalogItemTypeWorkflowUpdate) ToMap() (map[string]interface{}, error) {
