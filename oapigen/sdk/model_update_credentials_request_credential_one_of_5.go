...
func NewUpdateCredentialsRequestCredentialOneOf5(type_ string, name string, username string, authKey UpdateCredentialsRequestCredentialOneOf5AuthKey) *UpdateCredentialsRequestCredentialOneOf5 {
	this := UpdateCredentialsRequestCredentialOneOf5{}
	this.Type = type_
	this.Name = name
...
func (o *UpdateCredentialsRequestCredentialOneOf5) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *UpdateCredentialsRequestCredentialOneOf5) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *UpdateCredentialsRequestCredentialOneOf5) IsSetIntegration() bool {
	if o != nil && !IsNil(o.Integration) {
		return true
	}
