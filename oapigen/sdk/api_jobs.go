...
func (r ApiExecuteJobsRequest) Execute() (*ExecuteJobs200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ExecuteJobs200Response
func (a *JobsAPIService) ExecuteJobsExecute(r ApiExecuteJobsRequest) (*ExecuteJobs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ExecuteJobs200Response
	)
...
func (r ApiRemoveJobsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *JobsAPIService) RemoveJobsExecute(r ApiRemoveJobsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiUpdateJobsRequest) Execute() (*UpdateJobs200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateJobs200Response
func (a *JobsAPIService) UpdateJobsExecute(r ApiUpdateJobsRequest) (*UpdateJobs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateJobs200Response
	)
