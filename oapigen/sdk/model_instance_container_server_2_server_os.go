...
func (o *InstanceContainerServer2ServerOs) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetDescription() bool {
...
func (o *InstanceContainerServer2ServerOs) SetDescriptionNil() {
...
func (o *InstanceContainerServer2ServerOs) IsSetVendor() bool {
	if o != nil && !IsNil(o.Vendor) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetOsFamily() bool {
	if o != nil && !IsNil(o.OsFamily) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetOsVersion() bool {
	if o != nil && !IsNil(o.OsVersion) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetBitCount() bool {
	if o != nil && !IsNil(o.BitCount) {
		return true
	}
...
func (o *InstanceContainerServer2ServerOs) IsSetPlatform() bool {
	if o != nil && !IsNil(o.Platform) {
		return true
	}
