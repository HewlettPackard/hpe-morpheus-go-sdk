...
// checks if the BlueprintCreateSuccessConfigOneOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlueprintCreateSuccessConfigOneOf3{}

// BlueprintCreateSuccessConfigOneOf3 struct for BlueprintCreateSuccessConfigOneOf3
type BlueprintCreateSuccessConfigOneOf3 struct {
	...
	Kubernetes *BlueprintCreateSuccessConfigOneOf3Kubernetes `json:"kubernetes,omitempty"`
	Config     *BlueprintCreateSuccessConfigOneOf3Config     `json:"config,omitempty"`
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetImage() bool {
	if o != nil && !IsNil(o.Image) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3) GetKubernetes() BlueprintCreateSuccessConfigOneOf3Kubernetes {
	if o == nil || IsNil(o.Kubernetes) {
		var ret BlueprintCreateSuccessConfigOneOf3Kubernetes
		return ret
	}
	return *o.Kubernetes
}
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetKubernetes() bool {
	if o != nil && !IsNil(o.Kubernetes) {
		return true
	}
...
// SetKubernetes gets a reference to the given BlueprintCreateSuccessConfigOneOf3Kubernetes and assigns it to the Kubernetes field.
...
func (o *BlueprintCreateSuccessConfigOneOf3) GetConfig() BlueprintCreateSuccessConfigOneOf3Config {
	if o == nil || IsNil(o.Config) {
		var ret BlueprintCreateSuccessConfigOneOf3Config
		return ret
	}
	return *o.Config
}
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given BlueprintCreateSuccessConfigOneOf3Config and assigns it to the Config field.
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetResourcePermission() bool {
	if o != nil && !IsNil(o.ResourcePermission) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf3) IsSetTenant() bool {
	if o != nil && !IsNil(o.Tenant) {
		return true
	}
...
func (o BlueprintCreateSuccessConfigOneOf3) ToMap() (map[string]interface{}, error) {
...
type NullableBlueprintCreateSuccessConfigOneOf3 struct {
	value *BlueprintCreateSuccessConfigOneOf3
	isSet bool
}

func (v NullableBlueprintCreateSuccessConfigOneOf3) Get() *BlueprintCreateSuccessConfigOneOf3 {
	return v.value
}

func (v *NullableBlueprintCreateSuccessConfigOneOf3) Set(val *BlueprintCreateSuccessConfigOneOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableBlueprintCreateSuccessConfigOneOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableBlueprintCreateSuccessConfigOneOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlueprintCreateSuccessConfigOneOf3(val *BlueprintCreateSuccessConfigOneOf3) *NullableBlueprintCreateSuccessConfigOneOf3 {
	return &NullableBlueprintCreateSuccessConfigOneOf3{value: val, isSet: true}
}

func (v NullableBlueprintCreateSuccessConfigOneOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlueprintCreateSuccessConfigOneOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableBlueprintCreateSuccessConfigOneOf3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *BlueprintCreateSuccessConfigOneOf3) UnmarshalJSON(data []byte) (err error) {
