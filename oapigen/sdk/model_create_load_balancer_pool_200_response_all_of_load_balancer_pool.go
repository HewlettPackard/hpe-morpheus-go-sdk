...
// checks if the CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool{}

// CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool struct for CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool
type CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool struct {
	Id                   *int64                                                                `json:"id,omitempty"`
	LoadBalancer         *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolLoadBalancer   `json:"loadBalancer,omitempty"`
	...
	Nodes                []CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolNodesInner    `json:"nodes,omitempty"`
	Monitors             []CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolMonitorsInner `json:"monitors,omitempty"`
...
type _CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool
...
func NewCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool() *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool {
	this := CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool{}
	return &this
}
...
func (o *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) GetLoadBalancer() CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolLoadBalancer {
	if o == nil || IsNil(o.LoadBalancer) {
		var ret CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolLoadBalancer
		return ret
	}
...
func (o *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) GetNodes() []CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolNodesInner {
	if o == nil || IsNil(o.Nodes) {
		var ret []CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolNodesInner
		return ret
	}
	return o.Nodes
}
...
func (o *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) GetMonitors() []CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolMonitorsInner {
	if o == nil || IsNil(o.Monitors) {
		var ret []CreateLoadBalancerPool200ResponseAllOfLoadBalancerPoolMonitorsInner
		return ret
	}
	return o.Monitors
}
...
func (o CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) MarshalJSON() ([]byte, error) {
...
func (o CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) ToMap() (map[string]interface{}, error) {
...
type NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool struct {
	value *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool
	isSet bool
}

func (v NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) Get() *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool {
	return v.value
}

func (v *NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) Set(val *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool(val *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) *NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool {
	return &NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool{value: val, isSet: true}
}

func (v NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableCreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) UnmarshalMapstructure(data any) (any, error) {
...
func (o *CreateLoadBalancerPool200ResponseAllOfLoadBalancerPool) UnmarshalJSON(data []byte) (err error) {
