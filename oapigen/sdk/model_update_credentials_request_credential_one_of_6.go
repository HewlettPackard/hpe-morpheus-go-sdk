...
func (o *UpdateCredentialsRequestCredentialOneOf6) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *UpdateCredentialsRequestCredentialOneOf6) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *UpdateCredentialsRequestCredentialOneOf6) IsSetIntegration() bool {
	if o != nil && !IsNil(o.Integration) {
		return true
	}
