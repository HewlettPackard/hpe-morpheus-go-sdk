...
func (r ApiGetBillingAccountRequest) IncludeMs(includeMs bool) ApiGetBillingAccountRequest {
	r.includeMs = &includeMs
	return r
}
...
func (a *BillingAPIService) GetBillingAccountExecute(r ApiGetBillingAccountRequest) (*GetBillingAccount200Response, *http.Response, error) {
	var (
	...
	if r.includeUsages != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeUsages", r.includeUsages, "form", "")
	} else {
		var defaultValue bool = true
		r.includeUsages = &defaultValue
	}
	if r.maxUsages != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "maxUsages", r.maxUsages, "form", "")
	}
	if r.offsetUsages != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "offsetUsages", r.offsetUsages, "form", "")
	}
	if r.includeComputeServers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeComputeServers", r.includeComputeServers, "form", "")
	} else {
		var defaultValue bool = true
		r.includeComputeServers = &defaultValue
	}
	if r.includeInstances != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeInstances", r.includeInstances, "form", "")
	} else {
		var defaultValue bool = true
		r.includeInstances = &defaultValue
	}
	if r.includeDiscoveredServers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeDiscoveredServers", r.includeDiscoveredServers, "form", "")
	} else {
		var defaultValue bool = true
		r.includeDiscoveredServers = &defaultValue
	}
	if r.includeLoadBalancers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeLoadBalancers", r.includeLoadBalancers, "form", "")
	} else {
		var defaultValue bool = true
		r.includeLoadBalancers = &defaultValue
	}
	if r.includeVirtualImages != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeVirtualImages", r.includeVirtualImages, "form", "")
	} else {
		var defaultValue bool = true
		r.includeVirtualImages = &defaultValue
	}
	if r.includeSnapshots != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeSnapshots", r.includeSnapshots, "form", "")
	} else {
		var defaultValue bool = true
		r.includeSnapshots = &defaultValue
	}
	if r.includeMs != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeMs", r.includeMs, "form", "")
	} else {
		var defaultValue bool = false
		r.includeMs = &defaultValue
	}
...
// Optional ability to include milliseconds
func (r ApiGetBillingInstancesIdentifierRequest) IncludeMs(includeMs bool) ApiGetBillingInstancesIdentifierRequest {
	r.includeMs = &includeMs
	return r
}
...
// Optional ability to include milliseconds
func (r ApiGetBillingServersIdentifierRequest) IncludeMs(includeMs bool) ApiGetBillingServersIdentifierRequest {
	r.includeMs = &includeMs
	return r
}
...
// Optional ability to include milliseconds
func (r ApiGetBillingZoneIdentifierRequest) IncludeMs(includeMs bool) ApiGetBillingZoneIdentifierRequest {
	r.includeMs = &includeMs
	return r
}
...
// Optional ability to include milliseconds
func (r ApiListBillingAccountRequest) IncludeMs(includeMs bool) ApiListBillingAccountRequest {
	r.includeMs = &includeMs
	return r
}
...
// Optional ability to include milliseconds
func (r ApiListBillingInstancesRequest) IncludeMs(includeMs bool) ApiListBillingInstancesRequest {
	r.includeMs = &includeMs
	return r
}
...
// Optional ability to include milliseconds
func (r ApiListBillingServersRequest) IncludeMs(includeMs bool) ApiListBillingServersRequest {
	r.includeMs = &includeMs
	return r
}
...
// Optional ability to include milliseconds
func (r ApiListBillingZoneRequest) IncludeMs(includeMs bool) ApiListBillingZoneRequest {
	r.includeMs = &includeMs
	return r
}
