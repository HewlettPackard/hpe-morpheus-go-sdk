...
func (dst *BlueprintARMCreateArmInstallAgent) UnmarshalMapstructure(data any) (any, error) {
	if dst == nil {
		dst = &BlueprintARMCreateArmInstallAgent{}
	}
...
func (dst *BlueprintARMCreateArmInstallAgent) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return NewResponseValidationError("data matches more than one schema in oneOf(BlueprintARMCreateArmInstallAgent)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return NewResponseValidationError("data failed to match schemas in oneOf(BlueprintARMCreateArmInstallAgent)")
	}
}
...
func (obj BlueprintARMCreateArmInstallAgent) GetActualInstanceValue() interface{} {
	if obj.Bool != nil {
		return *obj.Bool
	}
...
func (v NullableBlueprintARMCreateArmInstallAgent) UnmarshalMapstructure(data any) (any, error) {
