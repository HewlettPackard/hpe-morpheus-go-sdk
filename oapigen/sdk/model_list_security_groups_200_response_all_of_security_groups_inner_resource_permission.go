...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetDefaultStore() bool {
	if o != nil && !IsNil(o.DefaultStore) {
		return true
	}
...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetDefaultTarget() bool {
	if o != nil && !IsNil(o.DefaultTarget) {
		return true
	}
...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetCanManage() bool {
	if o != nil && !IsNil(o.CanManage) {
		return true
	}
...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetAll() bool {
	if o != nil && !IsNil(o.All) {
		return true
	}
...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetSites() bool {
	if o != nil && !IsNil(o.Sites) {
		return true
	}
...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetAllPlans() bool {
	if o != nil && !IsNil(o.AllPlans) {
		return true
	}
...
func (o *ListSecurityGroups200ResponseAllOfSecurityGroupsInnerResourcePermission) IsSetPlans() bool {
	if o != nil && !IsNil(o.Plans) {
		return true
	}
