...
type GetScaleThresholds200Response struct {
	ScaleThreshold       *GetScaleThresholds200ResponseAllOfScaleThreshold `json:"scaleThreshold,omitempty"`
...
func (v NullableGetScaleThresholds200Response) UnmarshalMapstructure(data any) (any, error) {
