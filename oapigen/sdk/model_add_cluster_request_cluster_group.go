...
// checks if the AddClusterRequestClusterGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddClusterRequestClusterGroup{}
...
func (o *AddClusterRequestClusterGroup) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddClusterRequestClusterGroup) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddClusterRequestClusterGroup) UnmarshalMapstructure(data any) (any, error) {
