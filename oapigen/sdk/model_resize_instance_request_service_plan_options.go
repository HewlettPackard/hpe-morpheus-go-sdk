...
// checks if the ResizeInstanceRequestServicePlanOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResizeInstanceRequestServicePlanOptions{}

// ResizeInstanceRequestServicePlanOptions Map of custom options depending on selected service plan.
type ResizeInstanceRequestServicePlanOptions struct {
	// Core Count
...
type _ResizeInstanceRequestServicePlanOptions ResizeInstanceRequestServicePlanOptions
...
func NewResizeInstanceRequestServicePlanOptions() *ResizeInstanceRequestServicePlanOptions {
	this := ResizeInstanceRequestServicePlanOptions{}
	return &this
}
...
func (o *ResizeInstanceRequestServicePlanOptions) IsSetMaxCores() bool {
	if o != nil && !IsNil(o.MaxCores) {
		return true
	}
...
func (o *ResizeInstanceRequestServicePlanOptions) IsSetCoresPerSocket() bool {
	if o != nil && !IsNil(o.CoresPerSocket) {
		return true
	}
...
func (o *ResizeInstanceRequestServicePlanOptions) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o ResizeInstanceRequestServicePlanOptions) MarshalJSON() ([]byte, error) {
...
func (o ResizeInstanceRequestServicePlanOptions) ToMap() (map[string]interface{}, error) {
...
type NullableResizeInstanceRequestServicePlanOptions struct {
	value *ResizeInstanceRequestServicePlanOptions
	isSet bool
}

func (v NullableResizeInstanceRequestServicePlanOptions) Get() *ResizeInstanceRequestServicePlanOptions {
	return v.value
}

func (v *NullableResizeInstanceRequestServicePlanOptions) Set(val *ResizeInstanceRequestServicePlanOptions) {
	v.value = val
	v.isSet = true
}

func (v NullableResizeInstanceRequestServicePlanOptions) IsSet() bool {
	return v.isSet
}

func (v *NullableResizeInstanceRequestServicePlanOptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResizeInstanceRequestServicePlanOptions(val *ResizeInstanceRequestServicePlanOptions) *NullableResizeInstanceRequestServicePlanOptions {
	return &NullableResizeInstanceRequestServicePlanOptions{value: val, isSet: true}
}

func (v NullableResizeInstanceRequestServicePlanOptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResizeInstanceRequestServicePlanOptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableResizeInstanceRequestServicePlanOptions) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ResizeInstanceRequestServicePlanOptions) UnmarshalJSON(data []byte) (err error) {
