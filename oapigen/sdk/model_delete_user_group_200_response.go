...
type _DeleteUserGroup200Response DeleteUserGroup200Response
...
func (o *DeleteUserGroup200Response) IsSetSuccess() bool {
	if o != nil && !IsNil(o.Success) {
		return true
	}
...
func (v NullableDeleteUserGroup200Response) UnmarshalMapstructure(data any) (any, error) {
...
func (o *DeleteUserGroup200Response) UnmarshalJSON(data []byte) (err error) {
