...
func (o *AzureInstanceConfiguration) IsSetAzureRegion() bool {
	if o != nil && !IsNil(o.AzureRegion) {
		return true
	}
...
func (o *AzureInstanceConfiguration) IsSetAzuresecurityGroupId() bool {
	if o != nil && !IsNil(o.AzuresecurityGroupId) {
		return true
	}
...
func (v NullableAzureInstanceConfiguration) UnmarshalMapstructure(data any) (any, error) {
