...
// checks if the InstanceInterfacesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceInterfacesInner{}

// InstanceInterfacesInner struct for InstanceInterfacesInner
type InstanceInterfacesInner struct {
...
type _InstanceInterfacesInner InstanceInterfacesInner
...
func (o *InstanceInterfacesInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceInterfacesInner) IsSetNetwork() bool {
	if o != nil && !IsNil(o.Network) {
		return true
	}
...
func (o *InstanceInterfacesInner) IsSetIpAddress() bool {
...
func (o *InstanceInterfacesInner) SetIpAddressNil() {
	o.IpAddress.Set(nil)
}
...
func (o *InstanceInterfacesInner) IsSetNetworkInterfaceTypeId() bool {
...
func (o *InstanceInterfacesInner) SetNetworkInterfaceTypeIdNil() {
...
func (o *InstanceInterfacesInner) IsSetIpMode() bool {
...
func (o *InstanceInterfacesInner) SetIpModeNil() {
	o.IpMode.Set(nil)
}
...
func (o *InstanceInterfacesInner) IsSetNetworkInterfaces() bool {
	if o != nil && !IsNil(o.NetworkInterfaces) {
		return true
	}
...
func (o InstanceInterfacesInner) MarshalJSON() ([]byte, error) {
...
func (o InstanceInterfacesInner) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceInterfacesInner struct {
	value *InstanceInterfacesInner
	isSet bool
}

func (v NullableInstanceInterfacesInner) Get() *InstanceInterfacesInner {
	return v.value
}

func (v *NullableInstanceInterfacesInner) Set(val *InstanceInterfacesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceInterfacesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceInterfacesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceInterfacesInner(val *InstanceInterfacesInner) *NullableInstanceInterfacesInner {
	return &NullableInstanceInterfacesInner{value: val, isSet: true}
}

func (v NullableInstanceInterfacesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceInterfacesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceInterfacesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceInterfacesInner) UnmarshalJSON(data []byte) (err error) {
