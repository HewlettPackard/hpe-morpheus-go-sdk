...
// checks if the ExpirationPolicyTypeConfiguration10 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration10{}

// ExpirationPolicyTypeConfiguration10 - Expiration
type ExpirationPolicyTypeConfiguration10 struct {
...
type _ExpirationPolicyTypeConfiguration10 ExpirationPolicyTypeConfiguration10
...
func NewExpirationPolicyTypeConfiguration10(lifecycleType string) *ExpirationPolicyTypeConfiguration10 {
	this := ExpirationPolicyTypeConfiguration10{}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration10) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration10) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration10) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration10 struct {
	value *ExpirationPolicyTypeConfiguration10
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration10) Get() *ExpirationPolicyTypeConfiguration10 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration10) Set(val *ExpirationPolicyTypeConfiguration10) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration10) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration10) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration10(val *ExpirationPolicyTypeConfiguration10) *NullableExpirationPolicyTypeConfiguration10 {
	return &NullableExpirationPolicyTypeConfiguration10{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration10) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration10) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration10) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration10) UnmarshalJSON(data []byte) (err error) {
