...
func (o *SQLConfig1) IsSetTunnelOn() bool {
	if o != nil && !IsNil(o.TunnelOn) {
		return true
	}
...
func (o *SQLConfig1) IsSetSshHost() bool {
	if o != nil && !IsNil(o.SshHost) {
		return true
	}
...
func (o *SQLConfig1) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *SQLConfig1) IsSetSshUser() bool {
	if o != nil && !IsNil(o.SshUser) {
		return true
	}
...
func (o *SQLConfig1) IsSetSshPassword() bool {
	if o != nil && !IsNil(o.SshPassword) {
		return true
	}
