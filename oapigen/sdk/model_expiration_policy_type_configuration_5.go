...
// checks if the ExpirationPolicyTypeConfiguration5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpirationPolicyTypeConfiguration5{}

// ExpirationPolicyTypeConfiguration5 - Expiration
type ExpirationPolicyTypeConfiguration5 struct {
...
type _ExpirationPolicyTypeConfiguration5 ExpirationPolicyTypeConfiguration5
...
func NewExpirationPolicyTypeConfiguration5(lifecycleType string) *ExpirationPolicyTypeConfiguration5 {
	this := ExpirationPolicyTypeConfiguration5{}
...
// NewExpirationPolicyTypeConfiguration5WithDefaults instantiates a new ExpirationPolicyTypeConfiguration5 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewExpirationPolicyTypeConfiguration5WithDefaults() *ExpirationPolicyTypeConfiguration5 {
	this := ExpirationPolicyTypeConfiguration5{}
	var lifecycleAutoRenew string = "off"
	this.LifecycleAutoRenew = &lifecycleAutoRenew
	var lifecycleAllowExtend string = "off"
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleAge() bool {
	if o != nil && !IsNil(o.LifecycleAge) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleRenewal() bool {
	if o != nil && !IsNil(o.LifecycleRenewal) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleNotify() bool {
	if o != nil && !IsNil(o.LifecycleNotify) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleMessage() bool {
	if o != nil && !IsNil(o.LifecycleMessage) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleAutoRenew() bool {
	if o != nil && !IsNil(o.LifecycleAutoRenew) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleAllowExtend() bool {
	if o != nil && !IsNil(o.LifecycleAllowExtend) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.LifecycleExtensionsBeforeApproval) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleWorkflowId() bool {
	if o != nil && !IsNil(o.LifecycleWorkflowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o *ExpirationPolicyTypeConfiguration5) IsSetLifecycleHideFixed() bool {
	if o != nil && !IsNil(o.LifecycleHideFixed) {
		return true
	}
...
func (o ExpirationPolicyTypeConfiguration5) MarshalJSON() ([]byte, error) {
...
func (o ExpirationPolicyTypeConfiguration5) ToMap() (map[string]interface{}, error) {
...
type NullableExpirationPolicyTypeConfiguration5 struct {
	value *ExpirationPolicyTypeConfiguration5
	isSet bool
}

func (v NullableExpirationPolicyTypeConfiguration5) Get() *ExpirationPolicyTypeConfiguration5 {
	return v.value
}

func (v *NullableExpirationPolicyTypeConfiguration5) Set(val *ExpirationPolicyTypeConfiguration5) {
	v.value = val
	v.isSet = true
}

func (v NullableExpirationPolicyTypeConfiguration5) IsSet() bool {
	return v.isSet
}

func (v *NullableExpirationPolicyTypeConfiguration5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpirationPolicyTypeConfiguration5(val *ExpirationPolicyTypeConfiguration5) *NullableExpirationPolicyTypeConfiguration5 {
	return &NullableExpirationPolicyTypeConfiguration5{value: val, isSet: true}
}

func (v NullableExpirationPolicyTypeConfiguration5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpirationPolicyTypeConfiguration5) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableExpirationPolicyTypeConfiguration5) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ExpirationPolicyTypeConfiguration5) UnmarshalJSON(data []byte) (err error) {
