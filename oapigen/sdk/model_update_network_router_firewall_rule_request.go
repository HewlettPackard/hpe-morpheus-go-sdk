...
type UpdateNetworkRouterFirewallRuleRequest struct {
	Rule                 *UpdateNetworkRouterFirewallRuleRequestRule `json:"rule,omitempty"`
...
func (v NullableUpdateNetworkRouterFirewallRuleRequest) UnmarshalMapstructure(data any) (any, error) {
