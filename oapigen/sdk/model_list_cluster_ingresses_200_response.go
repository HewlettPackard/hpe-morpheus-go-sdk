...
type ListClusterIngresses200Response struct {
	Ingresses            []ListClusterIngresses200ResponseAllOfIngressesInner `json:"ingresses,omitempty"`
...
func (v NullableListClusterIngresses200Response) UnmarshalMapstructure(data any) (any, error) {
