...
// checks if the ListDeploymentFiles200ResponseAllOfMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDeploymentFiles200ResponseAllOfMeta{}

// ListDeploymentFiles200ResponseAllOfMeta struct for ListDeploymentFiles200ResponseAllOfMeta
type ListDeploymentFiles200ResponseAllOfMeta struct {
...
func (o *ListDeploymentFiles200ResponseAllOfMeta) IsSetOffset() bool {
	if o != nil && !IsNil(o.Offset) {
		return true
	}
...
func (o *ListDeploymentFiles200ResponseAllOfMeta) IsSetMax() bool {
	if o != nil && !IsNil(o.Max) {
		return true
	}
...
func (o *ListDeploymentFiles200ResponseAllOfMeta) IsSetSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
...
func (o *ListDeploymentFiles200ResponseAllOfMeta) IsSetTotal() bool {
	if o != nil && !IsNil(o.Total) {
		return true
	}
...
func (o ListDeploymentFiles200ResponseAllOfMeta) ToMap() (map[string]interface{}, error) {
...
type NullableListDeploymentFiles200ResponseAllOfMeta struct {
	value *ListDeploymentFiles200ResponseAllOfMeta
	isSet bool
}

func (v NullableListDeploymentFiles200ResponseAllOfMeta) Get() *ListDeploymentFiles200ResponseAllOfMeta {
	return v.value
}

func (v *NullableListDeploymentFiles200ResponseAllOfMeta) Set(val *ListDeploymentFiles200ResponseAllOfMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableListDeploymentFiles200ResponseAllOfMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableListDeploymentFiles200ResponseAllOfMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDeploymentFiles200ResponseAllOfMeta(val *ListDeploymentFiles200ResponseAllOfMeta) *NullableListDeploymentFiles200ResponseAllOfMeta {
	return &NullableListDeploymentFiles200ResponseAllOfMeta{value: val, isSet: true}
}

func (v NullableListDeploymentFiles200ResponseAllOfMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDeploymentFiles200ResponseAllOfMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListDeploymentFiles200ResponseAllOfMeta) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListDeploymentFiles200ResponseAllOfMeta) UnmarshalJSON(data []byte) (err error) {
