...
// checks if the UpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair{}
...
func NewUpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair() *UpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair {
	this := UpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair{}
	return &this
}
...
func (o *UpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o UpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair) MarshalJSON() ([]byte, error) {
...
func (o UpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair) ToMap() (map[string]interface{}, error) {
...
func (v NullableUpdateProvisioningSettingsRequestProvisioningSettingsCloudInitKeyPair) UnmarshalMapstructure(data any) (any, error) {
