...
// checks if the ClusterMastersVolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterMastersVolumesInner{}

// ClusterMastersVolumesInner struct for ClusterMastersVolumesInner
type ClusterMastersVolumesInner struct {
...
type _ClusterMastersVolumesInner ClusterMastersVolumesInner
...
func NewClusterMastersVolumesInner() *ClusterMastersVolumesInner {
	this := ClusterMastersVolumesInner{}
	return &this
}
...
func (o *ClusterMastersVolumesInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetControllerId() bool {
...
func (o *ClusterMastersVolumesInner) SetControllerIdNil() {
...
func (o *ClusterMastersVolumesInner) IsSetControllerMountPoint() bool {
...
func (o *ClusterMastersVolumesInner) SetControllerMountPointNil() {
...
func (o *ClusterMastersVolumesInner) IsSetResizeable() bool {
	if o != nil && !IsNil(o.Resizeable) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetPlanResizable() bool {
	if o != nil && !IsNil(o.PlanResizable) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetRootVolume() bool {
	if o != nil && !IsNil(o.RootVolume) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetUnitNumber() bool {
...
func (o *ClusterMastersVolumesInner) SetUnitNumberNil() {
...
func (o *ClusterMastersVolumesInner) IsSetTypeId() bool {
	if o != nil && !IsNil(o.TypeId) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetConfigurableIOPS() bool {
	if o != nil && !IsNil(o.ConfigurableIOPS) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetDatastoreId() bool {
...
func (o *ClusterMastersVolumesInner) SetDatastoreIdNil() {
...
func (o *ClusterMastersVolumesInner) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetDisplayOrder() bool {
	if o != nil && !IsNil(o.DisplayOrder) {
		return true
	}
...
func (o *ClusterMastersVolumesInner) IsSetMaxIOPS() bool {
...
func (o *ClusterMastersVolumesInner) SetMaxIOPSNil() {
	o.MaxIOPS.Set(nil)
}
...
func (o *ClusterMastersVolumesInner) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o ClusterMastersVolumesInner) MarshalJSON() ([]byte, error) {
...
func (o ClusterMastersVolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableClusterMastersVolumesInner struct {
	value *ClusterMastersVolumesInner
	isSet bool
}

func (v NullableClusterMastersVolumesInner) Get() *ClusterMastersVolumesInner {
	return v.value
}

func (v *NullableClusterMastersVolumesInner) Set(val *ClusterMastersVolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterMastersVolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterMastersVolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterMastersVolumesInner(val *ClusterMastersVolumesInner) *NullableClusterMastersVolumesInner {
	return &NullableClusterMastersVolumesInner{value: val, isSet: true}
}

func (v NullableClusterMastersVolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterMastersVolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableClusterMastersVolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ClusterMastersVolumesInner) UnmarshalJSON(data []byte) (err error) {
