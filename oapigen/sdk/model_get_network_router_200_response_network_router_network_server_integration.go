...
func (o *GetNetworkRouter200ResponseNetworkRouterNetworkServerIntegration) GetIntegrationType() GetNetworkRouter200ResponseNetworkRouterNetworkServerIntegrationIntegrationType {
	if o == nil || IsNil(o.IntegrationType) {
		var ret GetNetworkRouter200ResponseNetworkRouterNetworkServerIntegrationIntegrationType
		return ret
	}
...
// SetIntegrationType gets a reference to the given GetNetworkRouter200ResponseNetworkRouterNetworkServerIntegrationIntegrationType and assigns it to the IntegrationType field.
