...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner) IsSetPricePerUnit() bool {
	if o != nil && !IsNil(o.PricePerUnit) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner) IsSetCostPerUnit() bool {
	if o != nil && !IsNil(o.CostPerUnit) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner) IsSetCost() bool {
	if o != nil && !IsNil(o.Cost) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner) IsSetPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *BillingServersServersInnerUsagesInnerApplicablePricesInnerPricesInner) IsSetQuantity() bool {
	if o != nil && !IsNil(o.Quantity) {
		return true
	}
