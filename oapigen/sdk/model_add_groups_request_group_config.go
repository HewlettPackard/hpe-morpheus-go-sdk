...
func NewAddGroupsRequestGroupConfig() *AddGroupsRequestGroupConfig {
	this := AddGroupsRequestGroupConfig{}
	return &this
}
...
func (o *AddGroupsRequestGroupConfig) IsSetDnsIntegrationId() bool {
	if o != nil && !IsNil(o.DnsIntegrationId) {
		return true
	}
...
func (o *AddGroupsRequestGroupConfig) IsSetConfigCmdbId() bool {
	if o != nil && !IsNil(o.ConfigCmdbId) {
		return true
	}
...
func (o *AddGroupsRequestGroupConfig) IsSetConfigCmId() bool {
	if o != nil && !IsNil(o.ConfigCmId) {
		return true
	}
...
func (o *AddGroupsRequestGroupConfig) IsSetServiceRegistryId() bool {
	if o != nil && !IsNil(o.ServiceRegistryId) {
		return true
	}
...
func (o *AddGroupsRequestGroupConfig) IsSetConfigManagementId() bool {
	if o != nil && !IsNil(o.ConfigManagementId) {
		return true
	}
...
func (o *AddGroupsRequestGroupConfig) IsSetConfigCmdbDiscovery() bool {
	if o != nil && !IsNil(o.ConfigCmdbDiscovery) {
		return true
	}
