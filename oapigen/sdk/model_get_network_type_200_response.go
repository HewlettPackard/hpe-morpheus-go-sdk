...
type GetNetworkType200Response struct {
	NetworkType          *GetNetworkType200ResponseNetworkType `json:"networkType,omitempty"`
...
func (v NullableGetNetworkType200Response) UnmarshalMapstructure(data any) (any, error) {
