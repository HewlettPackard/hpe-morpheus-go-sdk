...
// checks if the ClusterServerCreateConfigAnyOfOneOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterServerCreateConfigAnyOfOneOf7{}

// ClusterServerCreateConfigAnyOfOneOf7 Configuration for VMware cluster servers
type ClusterServerCreateConfigAnyOfOneOf7 struct {
...
type _ClusterServerCreateConfigAnyOfOneOf7 ClusterServerCreateConfigAnyOfOneOf7
...
func NewClusterServerCreateConfigAnyOfOneOf7() *ClusterServerCreateConfigAnyOfOneOf7 {
	this := ClusterServerCreateConfigAnyOfOneOf7{}
	return &this
}
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) IsSetNodeCount() bool {
	if o != nil && !IsNil(o.NodeCount) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) IsSetPodCidr() bool {
	if o != nil && !IsNil(o.PodCidr) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) IsSetVmwareFolderId() bool {
	if o != nil && !IsNil(o.VmwareFolderId) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) IsSetServiceCidr() bool {
	if o != nil && !IsNil(o.ServiceCidr) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) IsSetCreateUser() bool {
	if o != nil && !IsNil(o.CreateUser) {
		return true
	}
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) IsSetDefaultRepoAccount() bool {
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) SetDefaultRepoAccountNil() {
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) IsSetImageServer() bool {
	if o != nil && !IsNil(o.ImageServer) {
		return true
	}
...
func (o ClusterServerCreateConfigAnyOfOneOf7) MarshalJSON() ([]byte, error) {
...
func (o ClusterServerCreateConfigAnyOfOneOf7) ToMap() (map[string]interface{}, error) {
...
type NullableClusterServerCreateConfigAnyOfOneOf7 struct {
	value *ClusterServerCreateConfigAnyOfOneOf7
	isSet bool
}

func (v NullableClusterServerCreateConfigAnyOfOneOf7) Get() *ClusterServerCreateConfigAnyOfOneOf7 {
	return v.value
}

func (v *NullableClusterServerCreateConfigAnyOfOneOf7) Set(val *ClusterServerCreateConfigAnyOfOneOf7) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterServerCreateConfigAnyOfOneOf7) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterServerCreateConfigAnyOfOneOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterServerCreateConfigAnyOfOneOf7(val *ClusterServerCreateConfigAnyOfOneOf7) *NullableClusterServerCreateConfigAnyOfOneOf7 {
	return &NullableClusterServerCreateConfigAnyOfOneOf7{value: val, isSet: true}
}

func (v NullableClusterServerCreateConfigAnyOfOneOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterServerCreateConfigAnyOfOneOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableClusterServerCreateConfigAnyOfOneOf7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ClusterServerCreateConfigAnyOfOneOf7) UnmarshalJSON(data []byte) (err error) {
