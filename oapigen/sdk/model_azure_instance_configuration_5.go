...
// checks if the AzureInstanceConfiguration5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureInstanceConfiguration5{}

// AzureInstanceConfiguration5 struct for AzureInstanceConfiguration5
type AzureInstanceConfiguration5 struct {
...
type _AzureInstanceConfiguration5 AzureInstanceConfiguration5

func (o AzureInstanceConfiguration5) MarshalJSON() ([]byte, error) {
...
func (o AzureInstanceConfiguration5) ToMap() (map[string]interface{}, error) {
...
type NullableAzureInstanceConfiguration5 struct {
	value *AzureInstanceConfiguration5
	isSet bool
}

func (v NullableAzureInstanceConfiguration5) Get() *AzureInstanceConfiguration5 {
	return v.value
}

func (v *NullableAzureInstanceConfiguration5) Set(val *AzureInstanceConfiguration5) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureInstanceConfiguration5) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureInstanceConfiguration5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureInstanceConfiguration5(val *AzureInstanceConfiguration5) *NullableAzureInstanceConfiguration5 {
	return &NullableAzureInstanceConfiguration5{value: val, isSet: true}
}

func (v NullableAzureInstanceConfiguration5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureInstanceConfiguration5) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAzureInstanceConfiguration5) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AzureInstanceConfiguration5) UnmarshalJSON(data []byte) (err error) {
