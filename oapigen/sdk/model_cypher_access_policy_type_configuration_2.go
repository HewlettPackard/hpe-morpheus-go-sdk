...
func (o *CypherAccessPolicyTypeConfiguration2) IsSetRead() bool {
	if o != nil && !IsNil(o.Read) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration2) IsSetWrite() bool {
	if o != nil && !IsNil(o.Write) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration2) IsSetUpdate() bool {
	if o != nil && !IsNil(o.Update) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration2) IsSetDelete() bool {
	if o != nil && !IsNil(o.Delete) {
		return true
	}
...
func (o *CypherAccessPolicyTypeConfiguration2) IsSetList() bool {
	if o != nil && !IsNil(o.List) {
		return true
	}
