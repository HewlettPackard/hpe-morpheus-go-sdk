...
func (o *BillingZonesInner) IsSetZoneName() bool {
	if o != nil && !IsNil(o.ZoneName) {
		return true
	}
...
func (o *BillingZonesInner) IsSetZoneId() bool {
	if o != nil && !IsNil(o.ZoneId) {
		return true
	}
...
func (o *BillingZonesInner) IsSetZoneUUID() bool {
	if o != nil && !IsNil(o.ZoneUUID) {
		return true
	}
...
func (o *BillingZonesInner) IsSetZoneCode() bool {
...
func (o *BillingZonesInner) IsSetStartDate() bool {
	if o != nil && !IsNil(o.StartDate) {
		return true
	}
...
func (o *BillingZonesInner) IsSetEndDate() bool {
	if o != nil && !IsNil(o.EndDate) {
		return true
	}
...
func (o *BillingZonesInner) IsSetPriceUnit() bool {
	if o != nil && !IsNil(o.PriceUnit) {
		return true
	}
...
func (o *BillingZonesInner) IsSetComputeServers() bool {
	if o != nil && !IsNil(o.ComputeServers) {
		return true
	}
...
func (o *BillingZonesInner) IsSetInstances() bool {
	if o != nil && !IsNil(o.Instances) {
		return true
	}
...
func (o *BillingZonesInner) GetDiscoveredServers() BillingZonesInnerDiscoveredServers {
	if o == nil || IsNil(o.DiscoveredServers) {
		var ret BillingZonesInnerDiscoveredServers
		return ret
	}
...
func (o *BillingZonesInner) IsSetDiscoveredServers() bool {
	if o != nil && !IsNil(o.DiscoveredServers) {
		return true
	}
...
// SetDiscoveredServers gets a reference to the given BillingZonesInnerDiscoveredServers and assigns it to the DiscoveredServers field.
...
func (o *BillingZonesInner) IsSetLoadBalancers() bool {
	if o != nil && !IsNil(o.LoadBalancers) {
		return true
	}
...
func (o *BillingZonesInner) IsSetVirtualImages() bool {
	if o != nil && !IsNil(o.VirtualImages) {
		return true
	}
...
func (o *BillingZonesInner) IsSetSnapshots() bool {
	if o != nil && !IsNil(o.Snapshots) {
		return true
	}
...
func (o *BillingZonesInner) IsSetPrice() bool {
	if o != nil && !IsNil(o.Price) {
		return true
	}
...
func (o *BillingZonesInner) IsSetCost() bool {
	if o != nil && !IsNil(o.Cost) {
		return true
	}
