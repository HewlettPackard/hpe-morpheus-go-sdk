...
type InstanceCreateVolumesInner struct {
	...
	DatastoreId *InstanceCreateVolumesInnerDatastoreId `json:"datastoreId,omitempty"`
...
func (o *InstanceCreateVolumesInner) GetDatastoreId() InstanceCreateVolumesInnerDatastoreId {
	if o == nil || IsNil(o.DatastoreId) {
		var ret InstanceCreateVolumesInnerDatastoreId
		return ret
	}
...
// SetDatastoreId gets a reference to the given InstanceCreateVolumesInnerDatastoreId and assigns it to the DatastoreId field.
