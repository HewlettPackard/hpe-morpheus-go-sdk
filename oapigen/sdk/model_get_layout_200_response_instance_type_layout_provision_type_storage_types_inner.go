...
// checks if the GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner{}

// GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner struct for GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner
type GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner struct {
...
type _GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner
...
func NewGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner() *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner {
	this := GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner{}
	return &this
}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetDisplayOrder() bool {
	if o != nil && !IsNil(o.DisplayOrder) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetDefaultType() bool {
	if o != nil && !IsNil(o.DefaultType) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetCustomLabel() bool {
	if o != nil && !IsNil(o.CustomLabel) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetCustomSize() bool {
	if o != nil && !IsNil(o.CustomSize) {
		return true
	}
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSetCustomSizeOptions() bool {
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) SetCustomSizeOptionsNil() {
...
func (o GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) MarshalJSON() ([]byte, error) {
...
func (o GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner struct {
	value *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner
	isSet bool
}

func (v NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) Get() *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner {
	return v.value
}

func (v *NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) Set(val *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner(val *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) *NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner {
	return &NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner{value: val, isSet: true}
}

func (v NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetLayout200ResponseInstanceTypeLayoutProvisionTypeStorageTypesInner) UnmarshalJSON(data []byte) (err error) {
