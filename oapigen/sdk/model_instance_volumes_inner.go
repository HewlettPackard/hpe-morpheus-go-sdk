...
// checks if the InstanceVolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceVolumesInner{}

// InstanceVolumesInner struct for InstanceVolumesInner
type InstanceVolumesInner struct {
...
type _InstanceVolumesInner InstanceVolumesInner
...
func (o *InstanceVolumesInner) IsSetControllerId() bool {
...
func (o *InstanceVolumesInner) SetControllerIdNil() {
...
func (o *InstanceVolumesInner) IsSetDatastoreId() bool {
...
func (o *InstanceVolumesInner) SetDatastoreIdNil() {
...
func (o *InstanceVolumesInner) IsSetDisplayOrder() bool {
	if o != nil && !IsNil(o.DisplayOrder) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetMaxIOPS() bool {
...
func (o *InstanceVolumesInner) SetMaxIOPSNil() {
	o.MaxIOPS.Set(nil)
}
...
func (o *InstanceVolumesInner) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetShortName() bool {
	if o != nil && !IsNil(o.ShortName) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetResizeable() bool {
	if o != nil && !IsNil(o.Resizeable) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetPlanResizable() bool {
	if o != nil && !IsNil(o.PlanResizable) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetRootVolume() bool {
	if o != nil && !IsNil(o.RootVolume) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetStorageType() bool {
	if o != nil && !IsNil(o.StorageType) {
		return true
	}
...
func (o *InstanceVolumesInner) IsSetUnitNumber() bool {
...
func (o *InstanceVolumesInner) SetUnitNumberNil() {
...
func (o *InstanceVolumesInner) IsSetControllerMountPoint() bool {
...
func (o *InstanceVolumesInner) SetControllerMountPointNil() {
...
func (o InstanceVolumesInner) MarshalJSON() ([]byte, error) {
...
func (o InstanceVolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceVolumesInner struct {
	value *InstanceVolumesInner
	isSet bool
}

func (v NullableInstanceVolumesInner) Get() *InstanceVolumesInner {
	return v.value
}

func (v *NullableInstanceVolumesInner) Set(val *InstanceVolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceVolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceVolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceVolumesInner(val *InstanceVolumesInner) *NullableInstanceVolumesInner {
	return &NullableInstanceVolumesInner{value: val, isSet: true}
}

func (v NullableInstanceVolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceVolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceVolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceVolumesInner) UnmarshalJSON(data []byte) (err error) {
