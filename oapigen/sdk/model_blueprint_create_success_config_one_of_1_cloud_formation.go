...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetJson() bool {
	if o != nil && !IsNil(o.Json) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetYaml() bool {
	if o != nil && !IsNil(o.Yaml) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetGit() bool {
	if o != nil && !IsNil(o.Git) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetIAM() bool {
	if o != nil && !IsNil(o.IAM) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetCAPABILITY_NAMED_IAM() bool {
	if o != nil && !IsNil(o.CAPABILITY_NAMED_IAM) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetCAPABILITY_AUTO_EXPAND() bool {
	if o != nil && !IsNil(o.CAPABILITY_AUTO_EXPAND) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetInstallAgent() bool {
	if o != nil && !IsNil(o.InstallAgent) {
		return true
	}
...
func (o *BlueprintCreateSuccessConfigOneOf1CloudFormation) IsSetCloudInitEnabled() bool {
	if o != nil && !IsNil(o.CloudInitEnabled) {
		return true
	}
