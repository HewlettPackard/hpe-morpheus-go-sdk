...
// checks if the UpdateDatastoresRequestDatastoreTenantPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDatastoresRequestDatastoreTenantPermissions{}

// UpdateDatastoresRequestDatastoreTenantPermissions struct for UpdateDatastoresRequestDatastoreTenantPermissions
type UpdateDatastoresRequestDatastoreTenantPermissions struct {
...
type _UpdateDatastoresRequestDatastoreTenantPermissions UpdateDatastoresRequestDatastoreTenantPermissions
...
func NewUpdateDatastoresRequestDatastoreTenantPermissions() *UpdateDatastoresRequestDatastoreTenantPermissions {
	this := UpdateDatastoresRequestDatastoreTenantPermissions{}
	return &this
}
...
func (o *UpdateDatastoresRequestDatastoreTenantPermissions) IsSetAccounts() bool {
	if o != nil && !IsNil(o.Accounts) {
		return true
	}
...
func (o *UpdateDatastoresRequestDatastoreTenantPermissions) IsSetDefaultTarget() bool {
	if o != nil && !IsNil(o.DefaultTarget) {
		return true
	}
...
func (o *UpdateDatastoresRequestDatastoreTenantPermissions) IsSetDefaultStore() bool {
	if o != nil && !IsNil(o.DefaultStore) {
		return true
	}
...
func (o UpdateDatastoresRequestDatastoreTenantPermissions) MarshalJSON() ([]byte, error) {
...
func (o UpdateDatastoresRequestDatastoreTenantPermissions) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateDatastoresRequestDatastoreTenantPermissions struct {
	value *UpdateDatastoresRequestDatastoreTenantPermissions
	isSet bool
}

func (v NullableUpdateDatastoresRequestDatastoreTenantPermissions) Get() *UpdateDatastoresRequestDatastoreTenantPermissions {
	return v.value
}

func (v *NullableUpdateDatastoresRequestDatastoreTenantPermissions) Set(val *UpdateDatastoresRequestDatastoreTenantPermissions) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDatastoresRequestDatastoreTenantPermissions) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDatastoresRequestDatastoreTenantPermissions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDatastoresRequestDatastoreTenantPermissions(val *UpdateDatastoresRequestDatastoreTenantPermissions) *NullableUpdateDatastoresRequestDatastoreTenantPermissions {
	return &NullableUpdateDatastoresRequestDatastoreTenantPermissions{value: val, isSet: true}
}

func (v NullableUpdateDatastoresRequestDatastoreTenantPermissions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDatastoresRequestDatastoreTenantPermissions) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateDatastoresRequestDatastoreTenantPermissions) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateDatastoresRequestDatastoreTenantPermissions) UnmarshalJSON(data []byte) (err error) {
