...
type GetBillingAccount200Response struct {
	BillingInfo          *GetBillingAccount200ResponseAllOfBillingInfo `json:"billingInfo,omitempty"`
...
func (o *GetBillingAccount200Response) IsSetBillingInfo() bool {
	if o != nil && !IsNil(o.BillingInfo) {
		return true
	}
...
func (o *GetBillingAccount200Response) IsSetSuccess() bool {
	if o != nil && !IsNil(o.Success) {
		return true
	}
...
func (v NullableGetBillingAccount200Response) UnmarshalMapstructure(data any) (any, error) {
