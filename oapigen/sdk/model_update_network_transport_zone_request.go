...
type UpdateNetworkTransportZoneRequest struct {
	NetworkScope         *UpdateNetworkTransportZoneRequestNetworkScope `json:"networkScope,omitempty"`
...
func (o *UpdateNetworkTransportZoneRequest) GetNetworkScope() UpdateNetworkTransportZoneRequestNetworkScope {
	if o == nil || IsNil(o.NetworkScope) {
		var ret UpdateNetworkTransportZoneRequestNetworkScope
		return ret
	}
...
func (v NullableUpdateNetworkTransportZoneRequest) UnmarshalMapstructure(data any) (any, error) {
