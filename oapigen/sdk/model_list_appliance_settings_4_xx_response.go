...
// checks if the ListApplianceSettings4XXResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListApplianceSettings4XXResponse{}

// ListApplianceSettings4XXResponse The standard response object that is returned when a request fails to complete successfully
type ListApplianceSettings4XXResponse struct {
...
type _ListApplianceSettings4XXResponse ListApplianceSettings4XXResponse
...
func NewListApplianceSettings4XXResponse() *ListApplianceSettings4XXResponse {
	this := ListApplianceSettings4XXResponse{}
...
func (o *ListApplianceSettings4XXResponse) IsSetSuccess() bool {
	if o != nil && !IsNil(o.Success) {
		return true
	}
...
func (o *ListApplianceSettings4XXResponse) IsSetMsg() bool {
...
func (o *ListApplianceSettings4XXResponse) SetMsgNil() {
	o.Msg.Set(nil)
}
...
func (o *ListApplianceSettings4XXResponse) IsSetErrors() bool {
	if o != nil && !IsNil(o.Errors) {
		return true
	}
...
func (o ListApplianceSettings4XXResponse) MarshalJSON() ([]byte, error) {
...
func (o ListApplianceSettings4XXResponse) ToMap() (map[string]interface{}, error) {
...
type NullableListApplianceSettings4XXResponse struct {
	value *ListApplianceSettings4XXResponse
	isSet bool
}

func (v NullableListApplianceSettings4XXResponse) Get() *ListApplianceSettings4XXResponse {
	return v.value
}

func (v *NullableListApplianceSettings4XXResponse) Set(val *ListApplianceSettings4XXResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListApplianceSettings4XXResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListApplianceSettings4XXResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListApplianceSettings4XXResponse(val *ListApplianceSettings4XXResponse) *NullableListApplianceSettings4XXResponse {
	return &NullableListApplianceSettings4XXResponse{value: val, isSet: true}
}

func (v NullableListApplianceSettings4XXResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListApplianceSettings4XXResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListApplianceSettings4XXResponse) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListApplianceSettings4XXResponse) UnmarshalJSON(data []byte) (err error) {
