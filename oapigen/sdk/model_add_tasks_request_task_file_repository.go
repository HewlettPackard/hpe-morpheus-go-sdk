...
// checks if the AddTasksRequestTaskFileRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddTasksRequestTaskFileRepository{}

// AddTasksRequestTaskFileRepository struct for AddTasksRequestTaskFileRepository
...
func NewAddTasksRequestTaskFileRepository() *AddTasksRequestTaskFileRepository {
	this := AddTasksRequestTaskFileRepository{}
	return &this
}
...
func (o *AddTasksRequestTaskFileRepository) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddTasksRequestTaskFileRepository) MarshalJSON() ([]byte, error) {
...
func (o AddTasksRequestTaskFileRepository) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddTasksRequestTaskFileRepository) UnmarshalMapstructure(data any) (any, error) {
