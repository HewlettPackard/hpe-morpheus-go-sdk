...
func (o *UpdateNodeTypeRequestContainerTypeEnvironmentVariablesInner) IsSetValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *UpdateNodeTypeRequestContainerTypeEnvironmentVariablesInner) IsSetMasked() bool {
	if o != nil && !IsNil(o.Masked) {
		return true
	}
...
func (o *UpdateNodeTypeRequestContainerTypeEnvironmentVariablesInner) IsSetExport() bool {
	if o != nil && !IsNil(o.Export) {
		return true
	}
