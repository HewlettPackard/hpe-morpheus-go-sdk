...
type _ApprovalItemApprovalItemReference ApprovalItemApprovalItemReference
...
func (o *ApprovalItemApprovalItemReference) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ApprovalItemApprovalItemReference) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *ApprovalItemApprovalItemReference) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ApprovalItemApprovalItemReference) IsSetDisplayName() bool {
	if o != nil && !IsNil(o.DisplayName) {
		return true
	}
...
func (v NullableApprovalItemApprovalItemReference) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ApprovalItemApprovalItemReference) UnmarshalJSON(data []byte) (err error) {
