...
// checks if the InstanceContainerServerInterfacesInner3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceContainerServerInterfacesInner3{}

// InstanceContainerServerInterfacesInner3 struct for InstanceContainerServerInterfacesInner3
type InstanceContainerServerInterfacesInner3 struct {
...
type _InstanceContainerServerInterfacesInner3 InstanceContainerServerInterfacesInner3
...
func NewInstanceContainerServerInterfacesInner3() *InstanceContainerServerInterfacesInner3 {
	this := InstanceContainerServerInterfacesInner3{}
	return &this
}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetUniqueId() bool {
	if o != nil && !IsNil(o.UniqueId) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetPublicIpAddress() bool {
	if o != nil && !IsNil(o.PublicIpAddress) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetIpAddress() bool {
	if o != nil && !IsNil(o.IpAddress) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetDhcp() bool {
	if o != nil && !IsNil(o.Dhcp) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetPoolAssigned() bool {
	if o != nil && !IsNil(o.PoolAssigned) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetPrimaryInterface() bool {
	if o != nil && !IsNil(o.PrimaryInterface) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetNetwork() bool {
	if o != nil && !IsNil(o.Network) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetNetworkGroup() bool {
	if o != nil && !IsNil(o.NetworkGroup) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetNetworkPool() bool {
	if o != nil && !IsNil(o.NetworkPool) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner3) IsSetInterfaces() bool {
	if o != nil && !IsNil(o.Interfaces) {
		return true
	}
...
func (o InstanceContainerServerInterfacesInner3) MarshalJSON() ([]byte, error) {
...
func (o InstanceContainerServerInterfacesInner3) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceContainerServerInterfacesInner3 struct {
	value *InstanceContainerServerInterfacesInner3
	isSet bool
}

func (v NullableInstanceContainerServerInterfacesInner3) Get() *InstanceContainerServerInterfacesInner3 {
	return v.value
}

func (v *NullableInstanceContainerServerInterfacesInner3) Set(val *InstanceContainerServerInterfacesInner3) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceContainerServerInterfacesInner3) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceContainerServerInterfacesInner3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceContainerServerInterfacesInner3(val *InstanceContainerServerInterfacesInner3) *NullableInstanceContainerServerInterfacesInner3 {
	return &NullableInstanceContainerServerInterfacesInner3{value: val, isSet: true}
}

func (v NullableInstanceContainerServerInterfacesInner3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceContainerServerInterfacesInner3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceContainerServerInterfacesInner3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceContainerServerInterfacesInner3) UnmarshalJSON(data []byte) (err error) {
