...
// checks if the ElasticSearchConfig8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ElasticSearchConfig8{}

// ElasticSearchConfig8 struct for ElasticSearchConfig8
type ElasticSearchConfig8 struct {
...
func (o *ElasticSearchConfig8) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *ElasticSearchConfig8) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *ElasticSearchConfig8) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *ElasticSearchConfig8) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *ElasticSearchConfig8) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o ElasticSearchConfig8) ToMap() (map[string]interface{}, error) {
...
type NullableElasticSearchConfig8 struct {
	value *ElasticSearchConfig8
	isSet bool
}

func (v NullableElasticSearchConfig8) Get() *ElasticSearchConfig8 {
	return v.value
}

func (v *NullableElasticSearchConfig8) Set(val *ElasticSearchConfig8) {
	v.value = val
	v.isSet = true
}

func (v NullableElasticSearchConfig8) IsSet() bool {
	return v.isSet
}

func (v *NullableElasticSearchConfig8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableElasticSearchConfig8(val *ElasticSearchConfig8) *NullableElasticSearchConfig8 {
	return &NullableElasticSearchConfig8{value: val, isSet: true}
}

func (v NullableElasticSearchConfig8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableElasticSearchConfig8) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableElasticSearchConfig8) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ElasticSearchConfig8) UnmarshalJSON(data []byte) (err error) {
