...
type OptionTypeListUpdate struct {
	...
	Credential *OptionTypeListUpdateCredential `json:"credential,omitempty"`
	...
	Config               *OptionTypeListUpdateConfig `json:"config,omitempty"`
...
func (o *OptionTypeListUpdate) GetCredential() OptionTypeListUpdateCredential {
	if o == nil || IsNil(o.Credential) {
		var ret OptionTypeListUpdateCredential
		return ret
	}
	return *o.Credential
}
...
// SetCredential gets a reference to the given OptionTypeListUpdateCredential and assigns it to the Credential field.
...
func (o *OptionTypeListUpdate) GetConfig() OptionTypeListUpdateConfig {
	if o == nil || IsNil(o.Config) {
		var ret OptionTypeListUpdateConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given OptionTypeListUpdateConfig and assigns it to the Config field.
...
func (v NullableOptionTypeListUpdate) UnmarshalMapstructure(data any) (any, error) {
