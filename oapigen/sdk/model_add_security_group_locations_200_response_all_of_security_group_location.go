...
type AddSecurityGroupLocations200ResponseAllOfSecurityGroupLocation struct {
	...
	Zone                 NullableAddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZone     `json:"zone,omitempty"`
	ZonePool             NullableAddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZonePool `json:"zonePool,omitempty"`
...
func (o *AddSecurityGroupLocations200ResponseAllOfSecurityGroupLocation) GetZone() AddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZone {
	if o == nil || IsNil(o.Zone.Get()) {
		var ret AddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZone
		return ret
	}
	return *o.Zone.Get()
}
...
// SetZone gets a reference to the given NullableAddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZone and assigns it to the Zone field.
...
func (o *AddSecurityGroupLocations200ResponseAllOfSecurityGroupLocation) GetZonePool() AddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZonePool {
	if o == nil || IsNil(o.ZonePool.Get()) {
		var ret AddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZonePool
		return ret
	}
...
// SetZonePool gets a reference to the given NullableAddSecurityGroupLocations200ResponseAllOfSecurityGroupLocationZonePool and assigns it to the ZonePool field.
