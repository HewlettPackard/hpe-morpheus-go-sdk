...
func (o *RunDeploy200ResponseAppDeployDeployment) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *RunDeploy200ResponseAppDeployDeployment) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *RunDeploy200ResponseAppDeployDeployment) IsSetDeployType() bool {
	if o != nil && !IsNil(o.DeployType) {
		return true
	}
