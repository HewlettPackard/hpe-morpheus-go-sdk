...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetAutoUp() bool {
	if o != nil && !IsNil(o.AutoUp) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetAutoDown() bool {
	if o != nil && !IsNil(o.AutoDown) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMinCount() bool {
	if o != nil && !IsNil(o.MinCount) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMaxCount() bool {
	if o != nil && !IsNil(o.MaxCount) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetScaleIncrement() bool {
	if o != nil && !IsNil(o.ScaleIncrement) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetCpuEnabled() bool {
	if o != nil && !IsNil(o.CpuEnabled) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMinCpu() bool {
	if o != nil && !IsNil(o.MinCpu) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMaxCpu() bool {
	if o != nil && !IsNil(o.MaxCpu) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMemoryEnabled() bool {
	if o != nil && !IsNil(o.MemoryEnabled) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMinMemory() bool {
	if o != nil && !IsNil(o.MinMemory) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetDiskEnabled() bool {
	if o != nil && !IsNil(o.DiskEnabled) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMinDisk() bool {
	if o != nil && !IsNil(o.MinDisk) {
		return true
	}
...
func (o *GetInstanceSchedule200ResponseInstanceScheduleThreshold) IsSetMaxDisk() bool {
	if o != nil && !IsNil(o.MaxDisk) {
		return true
	}
