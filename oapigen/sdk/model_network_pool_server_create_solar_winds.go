...
type NetworkPoolServerCreateSolarWinds struct {
	...
	Config               *NetworkPoolServerCreateSolarWindsConfig     `json:"config,omitempty"`
	Credential           *NetworkPoolServerCreateSolarWindsCredential `json:"credential,omitempty"`
...
func (o *NetworkPoolServerCreateSolarWinds) GetConfig() NetworkPoolServerCreateSolarWindsConfig {
	if o == nil || IsNil(o.Config) {
		var ret NetworkPoolServerCreateSolarWindsConfig
		return ret
	}
	return *o.Config
}
...
// SetConfig gets a reference to the given NetworkPoolServerCreateSolarWindsConfig and assigns it to the Config field.
...
func (o *NetworkPoolServerCreateSolarWinds) GetCredential() NetworkPoolServerCreateSolarWindsCredential {
	if o == nil || IsNil(o.Credential) {
		var ret NetworkPoolServerCreateSolarWindsCredential
		return ret
	}
	return *o.Credential
}
...
// SetCredential gets a reference to the given NetworkPoolServerCreateSolarWindsCredential and assigns it to the Credential field.
...
func (v NullableNetworkPoolServerCreateSolarWinds) UnmarshalMapstructure(data any) (any, error) {
