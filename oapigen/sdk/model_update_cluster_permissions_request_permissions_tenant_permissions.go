...
// checks if the UpdateClusterPermissionsRequestPermissionsTenantPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateClusterPermissionsRequestPermissionsTenantPermissions{}

// UpdateClusterPermissionsRequestPermissionsTenantPermissions struct for UpdateClusterPermissionsRequestPermissionsTenantPermissions
type UpdateClusterPermissionsRequestPermissionsTenantPermissions struct {
...
func (o UpdateClusterPermissionsRequestPermissionsTenantPermissions) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions struct {
	value *UpdateClusterPermissionsRequestPermissionsTenantPermissions
	isSet bool
}

func (v NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions) Get() *UpdateClusterPermissionsRequestPermissionsTenantPermissions {
	return v.value
}

func (v *NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions) Set(val *UpdateClusterPermissionsRequestPermissionsTenantPermissions) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateClusterPermissionsRequestPermissionsTenantPermissions(val *UpdateClusterPermissionsRequestPermissionsTenantPermissions) *NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions {
	return &NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions{value: val, isSet: true}
}

func (v NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateClusterPermissionsRequestPermissionsTenantPermissions) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateClusterPermissionsRequestPermissionsTenantPermissions) UnmarshalJSON(data []byte) (err error) {
