...
func (o *ListStorageBuckets200ResponseAllOfStorageBucketsInner) GetStorageServer() ListStorageBuckets200ResponseAllOfStorageBucketsInnerStorageServer {
	if o == nil || IsNil(o.StorageServer) {
		var ret ListStorageBuckets200ResponseAllOfStorageBucketsInnerStorageServer
		return ret
	}
...
func (o *ListStorageBuckets200ResponseAllOfStorageBucketsInner) IsSetStorageServer() bool {
	if o != nil && !IsNil(o.StorageServer) {
		return true
	}
...
// SetStorageServer gets a reference to the given ListStorageBuckets200ResponseAllOfStorageBucketsInnerStorageServer and assigns it to the StorageServer field.
