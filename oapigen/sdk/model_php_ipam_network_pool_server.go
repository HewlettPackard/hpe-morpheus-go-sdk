...
type PhpIPAMNetworkPoolServer struct {
	...
	Credential           *PhpIPAMNetworkPoolServerCredential `json:"credential,omitempty"`
...
func (o *PhpIPAMNetworkPoolServer) GetCredential() PhpIPAMNetworkPoolServerCredential {
	if o == nil || IsNil(o.Credential) {
		var ret PhpIPAMNetworkPoolServerCredential
		return ret
	}
	return *o.Credential
}
...
func (v NullablePhpIPAMNetworkPoolServer) UnmarshalMapstructure(data any) (any, error) {
