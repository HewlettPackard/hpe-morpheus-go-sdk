...
func (o *UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1) GetBlueprint() UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1Blueprint {
	if o == nil || IsNil(o.Blueprint) {
		var ret UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1Blueprint
		return ret
	}
	return *o.Blueprint
}
...
// SetBlueprint gets a reference to the given UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1Blueprint and assigns it to the Blueprint field.
...
func (o *UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1) GetForm() UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1Form {
	if o == nil || IsNil(o.Form) {
		var ret UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1Form
		return ret
	}
	return *o.Form
}
...
// SetForm gets a reference to the given UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf1Form and assigns it to the Form field.
