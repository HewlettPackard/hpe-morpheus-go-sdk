...
func (o *InstanceCreateVolume) GetStorageProfile() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InstanceCreateVolume) GetStorageProfileOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InstanceCreateVolume) IsSetStorageProfile() bool {
...
// and a boolean to check if the value has been set.
func (o *InstanceCreateVolume) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *InstanceCreateVolume) IsSetUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *InstanceCreateVolume) SetUuid(v string) {
	o.Uuid = &v
}
...
func (v NullableInstanceCreateVolume) UnmarshalMapstructure(data any) (any, error) {
