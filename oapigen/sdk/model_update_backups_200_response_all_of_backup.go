...
type UpdateBackups200ResponseAllOfBackup struct {
	...
	Server      *UpdateBackups200ResponseAllOfBackupServer `json:"server,omitempty"`
	...
	BackupRepository   *UpdateBackups200ResponseAllOfBackupBackupRepository `json:"backupRepository,omitempty"`
	// Cron Expression
