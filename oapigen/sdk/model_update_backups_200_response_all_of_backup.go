...
// checks if the UpdateBackups200ResponseAllOfBackup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateBackups200ResponseAllOfBackup{}

// UpdateBackups200ResponseAllOfBackup struct for UpdateBackups200ResponseAllOfBackup
type UpdateBackups200ResponseAllOfBackup struct {
	// Backup ID
	...
	Instance          *UpdateBackups200ResponseAllOfBackupInstance          `json:"instance,omitempty"`
	ContainerId       NullableInt64                                         `json:"containerId,omitempty"`
	Job               *UpdateBackups200ResponseAllOfBackupJob               `json:"job,omitempty"`
	Schedule          *UpdateBackups200ResponseAllOfBackupSchedule          `json:"schedule,omitempty"`
	RetentionCount    NullableInt64                                         `json:"retentionCount,omitempty"`
	BackupType        *UpdateBackups200ResponseAllOfBackupBackupType        `json:"backupType,omitempty"`
	StorageProvider   *UpdateBackups200ResponseAllOfBackupStorageProvider   `json:"storageProvider,omitempty"`
	BackupProvider    *UpdateBackups200ResponseAllOfBackupBackupProvider    `json:"backupProvider,omitempty"`
	BackupRespository *UpdateBackups200ResponseAllOfBackupBackupRespository `json:"backupRespository,omitempty"`
	// Cron Expression
	...
	LastResult *UpdateBackups200ResponseAllOfBackupLastResult `json:"lastResult,omitempty"`
	Stats      *UpdateBackups200ResponseAllOfBackupStats      `json:"stats,omitempty"`
	// Enabled
...
type _UpdateBackups200ResponseAllOfBackup UpdateBackups200ResponseAllOfBackup
...
func NewUpdateBackups200ResponseAllOfBackup() *UpdateBackups200ResponseAllOfBackup {
	this := UpdateBackups200ResponseAllOfBackup{}
	return &this
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetLocationType() bool {
	if o != nil && !IsNil(o.LocationType) {
		return true
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) GetInstance() UpdateBackups200ResponseAllOfBackupInstance {
	if o == nil || IsNil(o.Instance) {
		var ret UpdateBackups200ResponseAllOfBackupInstance
		return ret
	}
	return *o.Instance
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetInstance() bool {
	if o != nil && !IsNil(o.Instance) {
		return true
	}
...
// SetInstance gets a reference to the given UpdateBackups200ResponseAllOfBackupInstance and assigns it to the Instance field.
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetContainerId() bool {
...
func (o *UpdateBackups200ResponseAllOfBackup) SetContainerIdNil() {
...
func (o *UpdateBackups200ResponseAllOfBackup) GetJob() UpdateBackups200ResponseAllOfBackupJob {
	if o == nil || IsNil(o.Job) {
		var ret UpdateBackups200ResponseAllOfBackupJob
		return ret
	}
	return *o.Job
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetJob() bool {
	if o != nil && !IsNil(o.Job) {
		return true
	}
...
// SetJob gets a reference to the given UpdateBackups200ResponseAllOfBackupJob and assigns it to the Job field.
...
func (o *UpdateBackups200ResponseAllOfBackup) GetSchedule() UpdateBackups200ResponseAllOfBackupSchedule {
	if o == nil || IsNil(o.Schedule) {
		var ret UpdateBackups200ResponseAllOfBackupSchedule
		return ret
	}
	return *o.Schedule
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetSchedule() bool {
	if o != nil && !IsNil(o.Schedule) {
		return true
	}
...
// SetSchedule gets a reference to the given UpdateBackups200ResponseAllOfBackupSchedule and assigns it to the Schedule field.
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetRetentionCount() bool {
...
func (o *UpdateBackups200ResponseAllOfBackup) SetRetentionCountNil() {
...
func (o *UpdateBackups200ResponseAllOfBackup) GetBackupType() UpdateBackups200ResponseAllOfBackupBackupType {
	if o == nil || IsNil(o.BackupType) {
		var ret UpdateBackups200ResponseAllOfBackupBackupType
		return ret
	}
	return *o.BackupType
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetBackupType() bool {
	if o != nil && !IsNil(o.BackupType) {
		return true
	}
...
// SetBackupType gets a reference to the given UpdateBackups200ResponseAllOfBackupBackupType and assigns it to the BackupType field.
...
func (o *UpdateBackups200ResponseAllOfBackup) GetStorageProvider() UpdateBackups200ResponseAllOfBackupStorageProvider {
	if o == nil || IsNil(o.StorageProvider) {
		var ret UpdateBackups200ResponseAllOfBackupStorageProvider
		return ret
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetStorageProvider() bool {
	if o != nil && !IsNil(o.StorageProvider) {
		return true
	}
...
// SetStorageProvider gets a reference to the given UpdateBackups200ResponseAllOfBackupStorageProvider and assigns it to the StorageProvider field.
...
func (o *UpdateBackups200ResponseAllOfBackup) GetBackupProvider() UpdateBackups200ResponseAllOfBackupBackupProvider {
	if o == nil || IsNil(o.BackupProvider) {
		var ret UpdateBackups200ResponseAllOfBackupBackupProvider
		return ret
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetBackupProvider() bool {
	if o != nil && !IsNil(o.BackupProvider) {
		return true
	}
...
// SetBackupProvider gets a reference to the given UpdateBackups200ResponseAllOfBackupBackupProvider and assigns it to the BackupProvider field.
...
func (o *UpdateBackups200ResponseAllOfBackup) GetBackupRespository() UpdateBackups200ResponseAllOfBackupBackupRespository {
	if o == nil || IsNil(o.BackupRespository) {
		var ret UpdateBackups200ResponseAllOfBackupBackupRespository
		return ret
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetBackupRespository() bool {
	if o != nil && !IsNil(o.BackupRespository) {
		return true
	}
...
// SetBackupRespository gets a reference to the given UpdateBackups200ResponseAllOfBackupBackupRespository and assigns it to the BackupRespository field.
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetCronExpression() bool {
...
func (o *UpdateBackups200ResponseAllOfBackup) SetCronExpressionNil() {
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetNextFire() bool {
...
func (o *UpdateBackups200ResponseAllOfBackup) SetNextFireNil() {
	o.NextFire.Set(nil)
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetLastStatus() bool {
...
func (o *UpdateBackups200ResponseAllOfBackup) SetLastStatusNil() {
...
func (o *UpdateBackups200ResponseAllOfBackup) GetLastResult() UpdateBackups200ResponseAllOfBackupLastResult {
	if o == nil || IsNil(o.LastResult) {
		var ret UpdateBackups200ResponseAllOfBackupLastResult
		return ret
	}
	return *o.LastResult
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetLastResult() bool {
	if o != nil && !IsNil(o.LastResult) {
		return true
	}
...
// SetLastResult gets a reference to the given UpdateBackups200ResponseAllOfBackupLastResult and assigns it to the LastResult field.
...
func (o *UpdateBackups200ResponseAllOfBackup) GetStats() UpdateBackups200ResponseAllOfBackupStats {
	if o == nil || IsNil(o.Stats) {
		var ret UpdateBackups200ResponseAllOfBackupStats
		return ret
	}
	return *o.Stats
}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetStats() bool {
	if o != nil && !IsNil(o.Stats) {
		return true
	}
...
// SetStats gets a reference to the given UpdateBackups200ResponseAllOfBackupStats and assigns it to the Stats field.
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *UpdateBackups200ResponseAllOfBackup) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o UpdateBackups200ResponseAllOfBackup) MarshalJSON() ([]byte, error) {
...
func (o UpdateBackups200ResponseAllOfBackup) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateBackups200ResponseAllOfBackup struct {
	value *UpdateBackups200ResponseAllOfBackup
	isSet bool
}

func (v NullableUpdateBackups200ResponseAllOfBackup) Get() *UpdateBackups200ResponseAllOfBackup {
	return v.value
}

func (v *NullableUpdateBackups200ResponseAllOfBackup) Set(val *UpdateBackups200ResponseAllOfBackup) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateBackups200ResponseAllOfBackup) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateBackups200ResponseAllOfBackup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateBackups200ResponseAllOfBackup(val *UpdateBackups200ResponseAllOfBackup) *NullableUpdateBackups200ResponseAllOfBackup {
	return &NullableUpdateBackups200ResponseAllOfBackup{value: val, isSet: true}
}

func (v NullableUpdateBackups200ResponseAllOfBackup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateBackups200ResponseAllOfBackup) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateBackups200ResponseAllOfBackup) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateBackups200ResponseAllOfBackup) UnmarshalJSON(data []byte) (err error) {
