...
func (o *ListLoadBalancerVirtualServers200ResponseAllOfLoadBalancerInstancesInnerLoadBalancer) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListLoadBalancerVirtualServers200ResponseAllOfLoadBalancerInstancesInnerLoadBalancer) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *ListLoadBalancerVirtualServers200ResponseAllOfLoadBalancerInstancesInnerLoadBalancer) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListLoadBalancerVirtualServers200ResponseAllOfLoadBalancerInstancesInnerLoadBalancer) IsSetIp() bool {
	if o != nil && !IsNil(o.Ip) {
		return true
	}
