...
// checks if the ShutdownPolicyTypeConfiguration16 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShutdownPolicyTypeConfiguration16{}

// ShutdownPolicyTypeConfiguration16 Configuration settings for the following policy types: - Shutdown
type ShutdownPolicyTypeConfiguration16 struct {
...
type _ShutdownPolicyTypeConfiguration16 ShutdownPolicyTypeConfiguration16
...
func NewShutdownPolicyTypeConfiguration16() *ShutdownPolicyTypeConfiguration16 {
	this := ShutdownPolicyTypeConfiguration16{}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownType() bool {
	if o != nil && !IsNil(o.ShutdownType) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownAge() bool {
	if o != nil && !IsNil(o.ShutdownAge) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownRenewal() bool {
	if o != nil && !IsNil(o.ShutdownRenewal) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownNotify() bool {
	if o != nil && !IsNil(o.ShutdownNotify) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownMessage() bool {
	if o != nil && !IsNil(o.ShutdownMessage) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownAutoRenew() bool {
	if o != nil && !IsNil(o.ShutdownAutoRenew) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownAllowExtend() bool {
	if o != nil && !IsNil(o.ShutdownAllowExtend) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownExtensionsBeforeApproval() bool {
	if o != nil && !IsNil(o.ShutdownExtensionsBeforeApproval) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetAccountIntegrationId() bool {
	if o != nil && !IsNil(o.AccountIntegrationId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownHideFixed() bool {
	if o != nil && !IsNil(o.ShutdownHideFixed) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetShutdownWorkflowId() bool {
	if o != nil && !IsNil(o.ShutdownWorkflowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetFlowId() bool {
	if o != nil && !IsNil(o.FlowId) {
		return true
	}
...
func (o *ShutdownPolicyTypeConfiguration16) IsSetWorkflowType() bool {
	if o != nil && !IsNil(o.WorkflowType) {
		return true
	}
...
func (o ShutdownPolicyTypeConfiguration16) MarshalJSON() ([]byte, error) {
...
func (o ShutdownPolicyTypeConfiguration16) ToMap() (map[string]interface{}, error) {
...
type NullableShutdownPolicyTypeConfiguration16 struct {
	value *ShutdownPolicyTypeConfiguration16
	isSet bool
}

func (v NullableShutdownPolicyTypeConfiguration16) Get() *ShutdownPolicyTypeConfiguration16 {
	return v.value
}

func (v *NullableShutdownPolicyTypeConfiguration16) Set(val *ShutdownPolicyTypeConfiguration16) {
	v.value = val
	v.isSet = true
}

func (v NullableShutdownPolicyTypeConfiguration16) IsSet() bool {
	return v.isSet
}

func (v *NullableShutdownPolicyTypeConfiguration16) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShutdownPolicyTypeConfiguration16(val *ShutdownPolicyTypeConfiguration16) *NullableShutdownPolicyTypeConfiguration16 {
	return &NullableShutdownPolicyTypeConfiguration16{value: val, isSet: true}
}

func (v NullableShutdownPolicyTypeConfiguration16) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShutdownPolicyTypeConfiguration16) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableShutdownPolicyTypeConfiguration16) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ShutdownPolicyTypeConfiguration16) UnmarshalJSON(data []byte) (err error) {
