...
// checks if the SNMPConfig7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SNMPConfig7{}

// SNMPConfig7 struct for SNMPConfig7
type SNMPConfig7 struct {
...
func (o *SNMPConfig7) IsSetOid() bool {
	if o != nil && !IsNil(o.Oid) {
		return true
	}
...
func (o *SNMPConfig7) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SNMPConfig7) IsSetCheckResponse() bool {
	if o != nil && !IsNil(o.CheckResponse) {
		return true
	}
...
func (o *SNMPConfig7) IsSetVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *SNMPConfig7) IsSetCommunity() bool {
	if o != nil && !IsNil(o.Community) {
		return true
	}
...
func (o *SNMPConfig7) IsSetUsername() bool {
	if o != nil && !IsNil(o.Username) {
		return true
	}
...
func (o *SNMPConfig7) IsSetSecurityLevel() bool {
	if o != nil && !IsNil(o.SecurityLevel) {
		return true
	}
...
func (o *SNMPConfig7) IsSetAuth() bool {
	if o != nil && !IsNil(o.Auth) {
		return true
	}
...
func (o *SNMPConfig7) IsSetAuthpassword() bool {
	if o != nil && !IsNil(o.Authpassword) {
		return true
	}
...
func (o *SNMPConfig7) IsSetPriv() bool {
	if o != nil && !IsNil(o.Priv) {
		return true
	}
...
func (o *SNMPConfig7) IsSetPrivpassword() bool {
	if o != nil && !IsNil(o.Privpassword) {
		return true
	}
...
func (o SNMPConfig7) MarshalJSON() ([]byte, error) {
...
func (o SNMPConfig7) ToMap() (map[string]interface{}, error) {
...
type NullableSNMPConfig7 struct {
	value *SNMPConfig7
	isSet bool
}

func (v NullableSNMPConfig7) Get() *SNMPConfig7 {
	return v.value
}

func (v *NullableSNMPConfig7) Set(val *SNMPConfig7) {
	v.value = val
	v.isSet = true
}

func (v NullableSNMPConfig7) IsSet() bool {
	return v.isSet
}

func (v *NullableSNMPConfig7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSNMPConfig7(val *SNMPConfig7) *NullableSNMPConfig7 {
	return &NullableSNMPConfig7{value: val, isSet: true}
}

func (v NullableSNMPConfig7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSNMPConfig7) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSNMPConfig7) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SNMPConfig7) UnmarshalJSON(data []byte) (err error) {
