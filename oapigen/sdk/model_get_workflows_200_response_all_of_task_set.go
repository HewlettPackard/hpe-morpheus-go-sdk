...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetDescription() bool {
...
func (o *GetWorkflows200ResponseAllOfTaskSet) SetDescriptionNil() {
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetPlatform() bool {
...
func (o *GetWorkflows200ResponseAllOfTaskSet) SetPlatformNil() {
	o.Platform.Set(nil)
}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetTasks() bool {
	if o != nil && !IsNil(o.Tasks) {
		return true
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) GetOptionTypes() []GetWorkflows200ResponseAllOfTaskSetOptionTypesInner {
	if o == nil {
		var ret []GetWorkflows200ResponseAllOfTaskSetOptionTypesInner
		return ret
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetOptionTypes() bool {
	if o != nil && !IsNil(o.OptionTypes) {
		return true
	}
...
// SetOptionTypes gets a reference to the given []GetWorkflows200ResponseAllOfTaskSetOptionTypesInner and assigns it to the OptionTypes field.
...
func (o *GetWorkflows200ResponseAllOfTaskSet) GetTaskSetTasks() []GetWorkflows200ResponseAllOfTaskSetTaskSetTasksInner {
	if o == nil || IsNil(o.TaskSetTasks) {
		var ret []GetWorkflows200ResponseAllOfTaskSetTaskSetTasksInner
		return ret
	}
...
func (o *GetWorkflows200ResponseAllOfTaskSet) IsSetTaskSetTasks() bool {
	if o != nil && !IsNil(o.TaskSetTasks) {
		return true
	}
...
// SetTaskSetTasks gets a reference to the given []GetWorkflows200ResponseAllOfTaskSetTaskSetTasksInner and assigns it to the TaskSetTasks field.
