...
func (o *AmazonInstanceConfiguration) IsSetCreateUser() bool {
...
func (o *AmazonInstanceConfiguration) SetCreateUserNil() {
...
func (o *AmazonInstanceConfiguration) IsSetResourcePoolId() bool {
	if o != nil && !IsNil(o.ResourcePoolId) {
		return true
	}
