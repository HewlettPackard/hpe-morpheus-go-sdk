...
func (r ApiInstallLicenseRequest) Execute() (*InstallLicense200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return InstallLicense200Response
func (a *LicenseAPIService) InstallLicenseExecute(r ApiInstallLicenseRequest) (*InstallLicense200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *InstallLicense200Response
	)
...
type ApiTestLicenseRequest struct {
	ctx                context.Context
	ApiService         *LicenseAPIService
	testLicenseRequest *TestLicenseRequest
}

func (r ApiTestLicenseRequest) TestLicenseRequest(testLicenseRequest TestLicenseRequest) ApiTestLicenseRequest {
	r.testLicenseRequest = &testLicenseRequest
	return r
}

func (r ApiTestLicenseRequest) Execute() (*TestLicense200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return TestLicense200Response
func (a *LicenseAPIService) TestLicenseExecute(r ApiTestLicenseRequest) (*TestLicense200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TestLicense200Response
	)
	...
	// body params
	localVarPostBody = r.testLicenseRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiUninstallLicenseRequest) Execute() (*UpdateApprovalsItem200Response, *http.Response, error) {
...
func (a *LicenseAPIService) UninstallLicenseExecute(r ApiUninstallLicenseRequest) (*UpdateApprovalsItem200Response, *http.Response, error) {
	var (
