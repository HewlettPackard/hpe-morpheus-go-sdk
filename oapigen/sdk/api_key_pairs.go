...
func (r ApiRemoveKeyPairsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *KeyPairsAPIService) RemoveKeyPairsExecute(r ApiRemoveKeyPairsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
