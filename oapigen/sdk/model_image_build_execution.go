...
// checks if the ImageBuildExecution type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageBuildExecution{}

// ImageBuildExecution struct for ImageBuildExecution
type ImageBuildExecution struct {
	Id                   *int64                         `json:"id,omitempty"`
	ImageBuild           *ImageBuildExecutionImageBuild `json:"imageBuild,omitempty"`
	...
	CreatedBy            *ImageBuildExecutionCreatedBy  `json:"createdBy,omitempty"`
...
func (o *ImageBuildExecution) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ImageBuildExecution) GetImageBuild() ImageBuildExecutionImageBuild {
	if o == nil || IsNil(o.ImageBuild) {
		var ret ImageBuildExecutionImageBuild
		return ret
	}
	return *o.ImageBuild
}
...
func (o *ImageBuildExecution) IsSetImageBuild() bool {
	if o != nil && !IsNil(o.ImageBuild) {
		return true
	}
...
// SetImageBuild gets a reference to the given ImageBuildExecutionImageBuild and assigns it to the ImageBuild field.
...
func (o *ImageBuildExecution) IsSetBuildNumber() bool {
	if o != nil && !IsNil(o.BuildNumber) {
		return true
	}
...
func (o *ImageBuildExecution) IsSetStartDate() bool {
	if o != nil && !IsNil(o.StartDate) {
		return true
	}
...
func (o *ImageBuildExecution) IsSetEndDate() bool {
...
func (o *ImageBuildExecution) IsSetStatusMessage() bool {
...
func (o *ImageBuildExecution) IsSetStatusPercent() bool {
	if o != nil && !IsNil(o.StatusPercent) {
		return true
	}
...
func (o *ImageBuildExecution) IsSetStatusEta() bool {
...
func (o *ImageBuildExecution) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *ImageBuildExecution) IsSetErrorMessage() bool {
...
func (o *ImageBuildExecution) GetCreatedBy() ImageBuildExecutionCreatedBy {
	if o == nil || IsNil(o.CreatedBy) {
		var ret ImageBuildExecutionCreatedBy
		return ret
	}
	return *o.CreatedBy
}
...
func (o *ImageBuildExecution) IsSetCreatedBy() bool {
	if o != nil && !IsNil(o.CreatedBy) {
		return true
	}
...
// SetCreatedBy gets a reference to the given ImageBuildExecutionCreatedBy and assigns it to the CreatedBy field.
...
func (o *ImageBuildExecution) IsSetTempInstance() bool {
...
func (o *ImageBuildExecution) IsSetVirtualImages() bool {
	if o != nil && !IsNil(o.VirtualImages) {
		return true
	}
...
func (o ImageBuildExecution) ToMap() (map[string]interface{}, error) {
...
func (v NullableImageBuildExecution) UnmarshalMapstructure(data any) (any, error) {
