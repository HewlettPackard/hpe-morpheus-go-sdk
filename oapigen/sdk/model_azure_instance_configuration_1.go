...
func (o *AzureInstanceConfiguration1) IsSetResourcePoolId() bool {
	if o != nil && !IsNil(o.ResourcePoolId) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetAvailabilityOptions() bool {
	if o != nil && !IsNil(o.AvailabilityOptions) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetAvailabilitySet() bool {
	if o != nil && !IsNil(o.AvailabilitySet) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetAvailabilityZone() bool {
	if o != nil && !IsNil(o.AvailabilityZone) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetAzurefloatingIp() bool {
	if o != nil && !IsNil(o.AzurefloatingIp) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetBootDiagnostics() bool {
	if o != nil && !IsNil(o.BootDiagnostics) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetOsGuestDiagnostics() bool {
	if o != nil && !IsNil(o.OsGuestDiagnostics) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetDiagnosticsStorageAccount() bool {
	if o != nil && !IsNil(o.DiagnosticsStorageAccount) {
		return true
	}
...
func (o *AzureInstanceConfiguration1) IsSetCreateUser() bool {
	if o != nil && !IsNil(o.CreateUser) {
		return true
	}
