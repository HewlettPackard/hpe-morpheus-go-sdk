...
type ContainerTypeUpdate struct {
	...
	ContainerPorts []ContainerTypeUpdateContainerPortsInner `json:"containerPorts,omitempty"`
	// The environmentVariables parameter is array of env objects.
	EnvironmentVariables []ContainerTypeUpdateEnvironmentVariablesInner `json:"environmentVariables,omitempty"`
...
func (o *ContainerTypeUpdate) GetContainerPorts() []ContainerTypeUpdateContainerPortsInner {
	if o == nil || IsNil(o.ContainerPorts) {
		var ret []ContainerTypeUpdateContainerPortsInner
		return ret
	}
...
func (o *ContainerTypeUpdate) GetEnvironmentVariables() []ContainerTypeUpdateEnvironmentVariablesInner {
	if o == nil || IsNil(o.EnvironmentVariables) {
		var ret []ContainerTypeUpdateEnvironmentVariablesInner
		return ret
	}
