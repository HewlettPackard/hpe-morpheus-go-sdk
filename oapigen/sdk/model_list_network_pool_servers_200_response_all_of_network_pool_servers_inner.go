...
type ListNetworkPoolServers200ResponseAllOfNetworkPoolServersInner struct {
	...
	Pools                []ListNetworkPoolServers200ResponseAllOfNetworkPoolServersInnerPoolsInner `json:"pools,omitempty"`
...
func (o *ListNetworkPoolServers200ResponseAllOfNetworkPoolServersInner) GetPools() []ListNetworkPoolServers200ResponseAllOfNetworkPoolServersInnerPoolsInner {
	if o == nil || IsNil(o.Pools) {
		var ret []ListNetworkPoolServers200ResponseAllOfNetworkPoolServersInnerPoolsInner
		return ret
	}
	return o.Pools
}
...
// SetPools gets a reference to the given []ListNetworkPoolServers200ResponseAllOfNetworkPoolServersInnerPoolsInner and assigns it to the Pools field.
