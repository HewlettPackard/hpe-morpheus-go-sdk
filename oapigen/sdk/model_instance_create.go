...
type InstanceCreate struct {
	...
	ServicePlanOptions *InstanceCreateServicePlanOptions `json:"servicePlanOptions,omitempty"`
	...
	SecurityGroups []InstanceCreateSecurityGroupsInner `json:"securityGroups,omitempty"`
...
func (o *InstanceCreate) GetServicePlanOptions() InstanceCreateServicePlanOptions {
	if o == nil || IsNil(o.ServicePlanOptions) {
		var ret InstanceCreateServicePlanOptions
		return ret
	}
...
// SetServicePlanOptions gets a reference to the given InstanceCreateServicePlanOptions and assigns it to the ServicePlanOptions field.
...
func (o *InstanceCreate) GetSecurityGroups() []InstanceCreateSecurityGroupsInner {
	if o == nil {
		var ret []InstanceCreateSecurityGroupsInner
		return ret
	}
...
// SetSecurityGroups gets a reference to the given []InstanceCreateSecurityGroupsInner and assigns it to the SecurityGroups field.
