...
// checks if the AddInstanceRequestVolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddInstanceRequestVolumesInner{}

// AddInstanceRequestVolumesInner struct for AddInstanceRequestVolumesInner
type AddInstanceRequestVolumesInner struct {
...
type _AddInstanceRequestVolumesInner AddInstanceRequestVolumesInner
...
func NewAddInstanceRequestVolumesInner() *AddInstanceRequestVolumesInner {
	this := AddInstanceRequestVolumesInner{}
	var id int64 = -1
	this.Id = &id
...
func (o *AddInstanceRequestVolumesInner) GetStorageProfile() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AddInstanceRequestVolumesInner) GetStorageProfileOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddInstanceRequestVolumesInner) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *AddInstanceRequestVolumesInner) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *AddInstanceRequestVolumesInner) SetUuid(v string) {
	o.Uuid = &v
}

func (o AddInstanceRequestVolumesInner) MarshalJSON() ([]byte, error) {
...
func (o AddInstanceRequestVolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableAddInstanceRequestVolumesInner struct {
	value *AddInstanceRequestVolumesInner
	isSet bool
}

func (v NullableAddInstanceRequestVolumesInner) Get() *AddInstanceRequestVolumesInner {
	return v.value
}

func (v *NullableAddInstanceRequestVolumesInner) Set(val *AddInstanceRequestVolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAddInstanceRequestVolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAddInstanceRequestVolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddInstanceRequestVolumesInner(val *AddInstanceRequestVolumesInner) *NullableAddInstanceRequestVolumesInner {
	return &NullableAddInstanceRequestVolumesInner{value: val, isSet: true}
}

func (v NullableAddInstanceRequestVolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddInstanceRequestVolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddInstanceRequestVolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddInstanceRequestVolumesInner) UnmarshalJSON(data []byte) (err error) {
