...
// checks if the SQLConfig9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SQLConfig9{}

// SQLConfig9 struct for SQLConfig9
type SQLConfig9 struct {
...
func (o *SQLConfig9) IsSetDbPasswordHash() bool {
	if o != nil && !IsNil(o.DbPasswordHash) {
		return true
	}
...
func (o *SQLConfig9) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SQLConfig9) IsSetCheckResult() bool {
	if o != nil && !IsNil(o.CheckResult) {
		return true
	}
...
func (o *SQLConfig9) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *SQLConfig9) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *SQLConfig9) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *SQLConfig9) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *SQLConfig9) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o SQLConfig9) ToMap() (map[string]interface{}, error) {
...
type NullableSQLConfig9 struct {
	value *SQLConfig9
	isSet bool
}

func (v NullableSQLConfig9) Get() *SQLConfig9 {
	return v.value
}

func (v *NullableSQLConfig9) Set(val *SQLConfig9) {
	v.value = val
	v.isSet = true
}

func (v NullableSQLConfig9) IsSet() bool {
	return v.isSet
}

func (v *NullableSQLConfig9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSQLConfig9(val *SQLConfig9) *NullableSQLConfig9 {
	return &NullableSQLConfig9{value: val, isSet: true}
}

func (v NullableSQLConfig9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSQLConfig9) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSQLConfig9) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SQLConfig9) UnmarshalJSON(data []byte) (err error) {
