...
type InstanceContainer4 struct {
	...
	Ports                []InstanceContainer4PortsInner      `json:"ports,omitempty"`
...
func (o *InstanceContainer4) GetInstance() InstanceContainer4Instance {
	if o == nil || IsNil(o.Instance) {
		var ret InstanceContainer4Instance
		return ret
	}
	return *o.Instance
}
...
func (o *InstanceContainer4) GetContainerType() InstanceContainer4ContainerType {
	if o == nil || IsNil(o.ContainerType) {
		var ret InstanceContainer4ContainerType
		return ret
	}
...
func (o *InstanceContainer4) GetContainerTypeSet() InstanceContainer4ContainerTypeSet {
	if o == nil || IsNil(o.ContainerTypeSet) {
		var ret InstanceContainer4ContainerTypeSet
		return ret
	}
...
func (o *InstanceContainer4) GetServer() InstanceContainerServer4 {
	if o == nil || IsNil(o.Server) {
		var ret InstanceContainerServer4
		return ret
	}
	return *o.Server
}
...
func (o *InstanceContainer4) GetCloud() InstanceContainer4Cloud {
	if o == nil || IsNil(o.Cloud) {
		var ret InstanceContainer4Cloud
		return ret
	}
	return *o.Cloud
}
...
func (o *InstanceContainer4) GetPorts() []InstanceContainer4PortsInner {
	if o == nil || IsNil(o.Ports) {
		var ret []InstanceContainer4PortsInner
		return ret
	}
	return o.Ports
}
...
// SetPorts gets a reference to the given []InstanceContainer4PortsInner and assigns it to the Ports field.
...
func (o *InstanceContainer4) GetPlan() InstanceContainer4Plan {
	if o == nil || IsNil(o.Plan) {
		var ret InstanceContainer4Plan
		return ret
	}
	return *o.Plan
}
