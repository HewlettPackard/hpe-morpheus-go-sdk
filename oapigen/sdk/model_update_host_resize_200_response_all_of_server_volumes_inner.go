...
// checks if the UpdateHostResize200ResponseAllOfServerVolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateHostResize200ResponseAllOfServerVolumesInner{}

// UpdateHostResize200ResponseAllOfServerVolumesInner struct for UpdateHostResize200ResponseAllOfServerVolumesInner
type UpdateHostResize200ResponseAllOfServerVolumesInner struct {
	Id                   *int64                                                        `json:"id,omitempty"`
	Name                 *string                                                       `json:"name,omitempty"`
	Description          NullableString                                                `json:"description,omitempty"`
	Controller           *UpdateHostResize200ResponseAllOfServerVolumesInnerController `json:"controller,omitempty"`
	...
	Type                 *UpdateHostResize200ResponseAllOfServerVolumesInnerType       `json:"type,omitempty"`
	...
	Zone                 *UpdateHostResize200ResponseAllOfServerVolumesInnerZone       `json:"zone,omitempty"`
	ZoneId               *int64                                                        `json:"zoneId,omitempty"`
	Datastore            *UpdateHostResize200ResponseAllOfServerVolumesInnerDatastore  `json:"datastore,omitempty"`
	...
	Account              *UpdateHostResize200ResponseAllOfServerVolumesInnerAccount `json:"account,omitempty"`
	Owner                *UpdateHostResize200ResponseAllOfServerVolumesInnerOwner   `json:"owner,omitempty"`
	AdditionalProperties map[string]interface{}                                     `json:",remain"`
}

type _UpdateHostResize200ResponseAllOfServerVolumesInner UpdateHostResize200ResponseAllOfServerVolumesInner
...
func NewUpdateHostResize200ResponseAllOfServerVolumesInner() *UpdateHostResize200ResponseAllOfServerVolumesInner {
	this := UpdateHostResize200ResponseAllOfServerVolumesInner{}
	return &this
}
...
func (o *UpdateHostResize200ResponseAllOfServerVolumesInner) GetController() UpdateHostResize200ResponseAllOfServerVolumesInnerController {
	if o == nil || IsNil(o.Controller) {
		var ret UpdateHostResize200ResponseAllOfServerVolumesInnerController
		return ret
	}
	return *o.Controller
}
...
func (o *UpdateHostResize200ResponseAllOfServerVolumesInner) GetType() UpdateHostResize200ResponseAllOfServerVolumesInnerType {
	if o == nil || IsNil(o.Type) {
		var ret UpdateHostResize200ResponseAllOfServerVolumesInnerType
		return ret
	}
	return *o.Type
}
...
func (o *UpdateHostResize200ResponseAllOfServerVolumesInner) GetZone() UpdateHostResize200ResponseAllOfServerVolumesInnerZone {
	if o == nil || IsNil(o.Zone) {
		var ret UpdateHostResize200ResponseAllOfServerVolumesInnerZone
		return ret
	}
	return *o.Zone
}
...
func (o *UpdateHostResize200ResponseAllOfServerVolumesInner) GetDatastore() UpdateHostResize200ResponseAllOfServerVolumesInnerDatastore {
	if o == nil || IsNil(o.Datastore) {
		var ret UpdateHostResize200ResponseAllOfServerVolumesInnerDatastore
		return ret
	}
	return *o.Datastore
}
...
func (o *UpdateHostResize200ResponseAllOfServerVolumesInner) GetAccount() UpdateHostResize200ResponseAllOfServerVolumesInnerAccount {
	if o == nil || IsNil(o.Account) {
		var ret UpdateHostResize200ResponseAllOfServerVolumesInnerAccount
		return ret
	}
	return *o.Account
}
...
func (o *UpdateHostResize200ResponseAllOfServerVolumesInner) GetOwner() UpdateHostResize200ResponseAllOfServerVolumesInnerOwner {
	if o == nil || IsNil(o.Owner) {
		var ret UpdateHostResize200ResponseAllOfServerVolumesInnerOwner
		return ret
	}
	return *o.Owner
}
...
func (o UpdateHostResize200ResponseAllOfServerVolumesInner) MarshalJSON() ([]byte, error) {
...
func (o UpdateHostResize200ResponseAllOfServerVolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateHostResize200ResponseAllOfServerVolumesInner struct {
	value *UpdateHostResize200ResponseAllOfServerVolumesInner
	isSet bool
}

func (v NullableUpdateHostResize200ResponseAllOfServerVolumesInner) Get() *UpdateHostResize200ResponseAllOfServerVolumesInner {
	return v.value
}

func (v *NullableUpdateHostResize200ResponseAllOfServerVolumesInner) Set(val *UpdateHostResize200ResponseAllOfServerVolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateHostResize200ResponseAllOfServerVolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateHostResize200ResponseAllOfServerVolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateHostResize200ResponseAllOfServerVolumesInner(val *UpdateHostResize200ResponseAllOfServerVolumesInner) *NullableUpdateHostResize200ResponseAllOfServerVolumesInner {
	return &NullableUpdateHostResize200ResponseAllOfServerVolumesInner{value: val, isSet: true}
}

func (v NullableUpdateHostResize200ResponseAllOfServerVolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateHostResize200ResponseAllOfServerVolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateHostResize200ResponseAllOfServerVolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateHostResize200ResponseAllOfServerVolumesInner) UnmarshalJSON(data []byte) (err error) {
