...
// checks if the ElasticCheck1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ElasticCheck1{}

// ElasticCheck1 Elasticsearch check is capable of connecting to your Elasticsearch, cluster or node, verifying its health. In addition, Morpheus will also pull statistical information such as: document size, capacity, and cpu usage.
type ElasticCheck1 struct {
...
type _ElasticCheck1 ElasticCheck1
...
func (o *ElasticCheck1) IsSetDescription() bool {
...
func (o *ElasticCheck1) SetDescriptionNil() {
...
func (o *ElasticCheck1) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *ElasticCheck1) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *ElasticCheck1) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *ElasticCheck1) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *ElasticCheck1) GetCheckType() ElasticCheck1AllOfCheckType {
	if o == nil || IsNil(o.CheckType) {
		var ret ElasticCheck1AllOfCheckType
		return ret
	}
	return *o.CheckType
}
...
func (o *ElasticCheck1) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
// SetCheckType gets a reference to the given ElasticCheck1AllOfCheckType and assigns it to the CheckType field.
...
func (o *ElasticCheck1) GetConfig() ElasticCheck1AllOfConfig {
	if o == nil || IsNil(o.Config) {
		var ret ElasticCheck1AllOfConfig
		return ret
	}
	return *o.Config
}
...
func (o *ElasticCheck1) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given ElasticCheck1AllOfConfig and assigns it to the Config field.
func (o *ElasticCheck1) SetConfig(v ElasticCheck1AllOfConfig) {
	o.Config = &v
}

func (o ElasticCheck1) MarshalJSON() ([]byte, error) {
...
func (o ElasticCheck1) ToMap() (map[string]interface{}, error) {
...
type NullableElasticCheck1 struct {
	value *ElasticCheck1
	isSet bool
}

func (v NullableElasticCheck1) Get() *ElasticCheck1 {
	return v.value
}

func (v *NullableElasticCheck1) Set(val *ElasticCheck1) {
	v.value = val
	v.isSet = true
}

func (v NullableElasticCheck1) IsSet() bool {
	return v.isSet
}

func (v *NullableElasticCheck1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableElasticCheck1(val *ElasticCheck1) *NullableElasticCheck1 {
	return &NullableElasticCheck1{value: val, isSet: true}
}

func (v NullableElasticCheck1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableElasticCheck1) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableElasticCheck1) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ElasticCheck1) UnmarshalJSON(data []byte) (err error) {
