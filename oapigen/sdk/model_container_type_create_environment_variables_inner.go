...
// checks if the ContainerTypeCreateEnvironmentVariablesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContainerTypeCreateEnvironmentVariablesInner{}

// ContainerTypeCreateEnvironmentVariablesInner struct for ContainerTypeCreateEnvironmentVariablesInner
type ContainerTypeCreateEnvironmentVariablesInner struct {
...
type _ContainerTypeCreateEnvironmentVariablesInner ContainerTypeCreateEnvironmentVariablesInner
...
func NewContainerTypeCreateEnvironmentVariablesInner(name string) *ContainerTypeCreateEnvironmentVariablesInner {
	this := ContainerTypeCreateEnvironmentVariablesInner{}
	this.Name = name
...
func (o *ContainerTypeCreateEnvironmentVariablesInner) IsSetValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o *ContainerTypeCreateEnvironmentVariablesInner) IsSetMasked() bool {
	if o != nil && !IsNil(o.Masked) {
		return true
	}
...
func (o *ContainerTypeCreateEnvironmentVariablesInner) IsSetExport() bool {
	if o != nil && !IsNil(o.Export) {
		return true
	}
...
func (o ContainerTypeCreateEnvironmentVariablesInner) MarshalJSON() ([]byte, error) {
...
func (o ContainerTypeCreateEnvironmentVariablesInner) ToMap() (map[string]interface{}, error) {
...
type NullableContainerTypeCreateEnvironmentVariablesInner struct {
	value *ContainerTypeCreateEnvironmentVariablesInner
	isSet bool
}

func (v NullableContainerTypeCreateEnvironmentVariablesInner) Get() *ContainerTypeCreateEnvironmentVariablesInner {
	return v.value
}

func (v *NullableContainerTypeCreateEnvironmentVariablesInner) Set(val *ContainerTypeCreateEnvironmentVariablesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableContainerTypeCreateEnvironmentVariablesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableContainerTypeCreateEnvironmentVariablesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContainerTypeCreateEnvironmentVariablesInner(val *ContainerTypeCreateEnvironmentVariablesInner) *NullableContainerTypeCreateEnvironmentVariablesInner {
	return &NullableContainerTypeCreateEnvironmentVariablesInner{value: val, isSet: true}
}

func (v NullableContainerTypeCreateEnvironmentVariablesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContainerTypeCreateEnvironmentVariablesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableContainerTypeCreateEnvironmentVariablesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ContainerTypeCreateEnvironmentVariablesInner) UnmarshalJSON(data []byte) (err error) {
