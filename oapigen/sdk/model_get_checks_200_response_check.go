...
// checks if the GetChecks200ResponseCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetChecks200ResponseCheck{}

// GetChecks200ResponseCheck struct for GetChecks200ResponseCheck
type GetChecks200ResponseCheck struct {
	Id                   *int64                              `json:"id,omitempty"`
	Account              *GetChecks200ResponseCheckAccount   `json:"account,omitempty"`
	...
	CheckType            *GetChecks200ResponseCheckCheckType `json:"checkType,omitempty"`
	Config               *GetChecks200ResponseCheckConfig    `json:"config,omitempty"`
	Container            *GetChecks200ResponseCheckContainer `json:"container,omitempty"`
	CreateIncident       *bool                               `json:"createIncident,omitempty"`
	Muted                *bool                               `json:"muted,omitempty"`
	CreatedBy            *GetChecks200ResponseCheckCreatedBy `json:"createdBy,omitempty"`
...
type _GetChecks200ResponseCheck GetChecks200ResponseCheck
...
func NewGetChecks200ResponseCheck() *GetChecks200ResponseCheck {
	this := GetChecks200ResponseCheck{}
	return &this
}
...
func (o *GetChecks200ResponseCheck) GetAccount() GetChecks200ResponseCheckAccount {
	if o == nil || IsNil(o.Account) {
		var ret GetChecks200ResponseCheckAccount
		return ret
	}
	return *o.Account
}
...
func (o *GetChecks200ResponseCheck) GetCheckType() GetChecks200ResponseCheckCheckType {
	if o == nil || IsNil(o.CheckType) {
		var ret GetChecks200ResponseCheckCheckType
		return ret
	}
	return *o.CheckType
}
...
func (o *GetChecks200ResponseCheck) GetConfig() GetChecks200ResponseCheckConfig {
	if o == nil || IsNil(o.Config) {
		var ret GetChecks200ResponseCheckConfig
		return ret
	}
	return *o.Config
}
...
func (o *GetChecks200ResponseCheck) GetContainer() GetChecks200ResponseCheckContainer {
	if o == nil || IsNil(o.Container) {
		var ret GetChecks200ResponseCheckContainer
		return ret
	}
	return *o.Container
}
...
func (o *GetChecks200ResponseCheck) GetCreatedBy() GetChecks200ResponseCheckCreatedBy {
	if o == nil || IsNil(o.CreatedBy) {
		var ret GetChecks200ResponseCheckCreatedBy
		return ret
	}
	return *o.CreatedBy
}
...
func (o GetChecks200ResponseCheck) MarshalJSON() ([]byte, error) {
...
func (o GetChecks200ResponseCheck) ToMap() (map[string]interface{}, error) {
...
type NullableGetChecks200ResponseCheck struct {
	value *GetChecks200ResponseCheck
	isSet bool
}

func (v NullableGetChecks200ResponseCheck) Get() *GetChecks200ResponseCheck {
	return v.value
}

func (v *NullableGetChecks200ResponseCheck) Set(val *GetChecks200ResponseCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableGetChecks200ResponseCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableGetChecks200ResponseCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetChecks200ResponseCheck(val *GetChecks200ResponseCheck) *NullableGetChecks200ResponseCheck {
	return &NullableGetChecks200ResponseCheck{value: val, isSet: true}
}

func (v NullableGetChecks200ResponseCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetChecks200ResponseCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetChecks200ResponseCheck) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetChecks200ResponseCheck) UnmarshalJSON(data []byte) (err error) {
