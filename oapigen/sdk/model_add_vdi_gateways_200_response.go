...
type AddVDIGateways200Response struct {
	...
	AddVDIGateways200ResponseAnyOf1 *AddVDIGateways200ResponseAnyOf1
}
...
func (dst *AddVDIGateways200Response) UnmarshalMapstructure(data any) (any, error) {
	...
	mapstructDecode(data, &dst.AddVDIGateways200ResponseAnyOf1)

	if IsEmpty(dst.AddVDIGateways200ResponseAnyOf1) {
...
func (src AddVDIGateways200Response) MarshalJSON() ([]byte, error) {
	...
	if src.AddVDIGateways200ResponseAnyOf1 != nil {
