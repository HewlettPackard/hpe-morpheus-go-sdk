...
// checks if the PostgresCheckAllOfConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostgresCheckAllOfConfig{}

// PostgresCheckAllOfConfig struct for PostgresCheckAllOfConfig
type PostgresCheckAllOfConfig struct {
...
type _PostgresCheckAllOfConfig PostgresCheckAllOfConfig
...
func (o *PostgresCheckAllOfConfig) IsSetDbPasswordHash() bool {
	if o != nil && !IsNil(o.DbPasswordHash) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetCheckResult() bool {
	if o != nil && !IsNil(o.CheckResult) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetTunnelOn() bool {
	if o != nil && !IsNil(o.TunnelOn) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetSshHost() bool {
	if o != nil && !IsNil(o.SshHost) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetSshUser() bool {
	if o != nil && !IsNil(o.SshUser) {
		return true
	}
...
func (o *PostgresCheckAllOfConfig) IsSetSshPassword() bool {
	if o != nil && !IsNil(o.SshPassword) {
		return true
	}
...
func (o PostgresCheckAllOfConfig) MarshalJSON() ([]byte, error) {
...
func (o PostgresCheckAllOfConfig) ToMap() (map[string]interface{}, error) {
...
type NullablePostgresCheckAllOfConfig struct {
	value *PostgresCheckAllOfConfig
	isSet bool
}

func (v NullablePostgresCheckAllOfConfig) Get() *PostgresCheckAllOfConfig {
	return v.value
}

func (v *NullablePostgresCheckAllOfConfig) Set(val *PostgresCheckAllOfConfig) {
	v.value = val
	v.isSet = true
}

func (v NullablePostgresCheckAllOfConfig) IsSet() bool {
	return v.isSet
}

func (v *NullablePostgresCheckAllOfConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostgresCheckAllOfConfig(val *PostgresCheckAllOfConfig) *NullablePostgresCheckAllOfConfig {
	return &NullablePostgresCheckAllOfConfig{value: val, isSet: true}
}

func (v NullablePostgresCheckAllOfConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostgresCheckAllOfConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullablePostgresCheckAllOfConfig) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PostgresCheckAllOfConfig) UnmarshalJSON(data []byte) (err error) {
