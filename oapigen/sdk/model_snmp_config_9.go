...
// checks if the SNMPConfig9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SNMPConfig9{}

// SNMPConfig9 struct for SNMPConfig9
type SNMPConfig9 struct {
...
func (o *SNMPConfig9) IsSetOid() bool {
	if o != nil && !IsNil(o.Oid) {
		return true
	}
...
func (o *SNMPConfig9) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SNMPConfig9) IsSetCheckResponse() bool {
	if o != nil && !IsNil(o.CheckResponse) {
		return true
	}
...
func (o *SNMPConfig9) IsSetVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *SNMPConfig9) IsSetCommunity() bool {
	if o != nil && !IsNil(o.Community) {
		return true
	}
...
func (o *SNMPConfig9) IsSetUsername() bool {
	if o != nil && !IsNil(o.Username) {
		return true
	}
...
func (o *SNMPConfig9) IsSetSecurityLevel() bool {
	if o != nil && !IsNil(o.SecurityLevel) {
		return true
	}
...
func (o *SNMPConfig9) IsSetAuth() bool {
	if o != nil && !IsNil(o.Auth) {
		return true
	}
...
func (o *SNMPConfig9) IsSetAuthpassword() bool {
	if o != nil && !IsNil(o.Authpassword) {
		return true
	}
...
func (o *SNMPConfig9) IsSetPriv() bool {
	if o != nil && !IsNil(o.Priv) {
		return true
	}
...
func (o *SNMPConfig9) IsSetPrivpassword() bool {
	if o != nil && !IsNil(o.Privpassword) {
		return true
	}
...
func (o SNMPConfig9) MarshalJSON() ([]byte, error) {
...
func (o SNMPConfig9) ToMap() (map[string]interface{}, error) {
...
type NullableSNMPConfig9 struct {
	value *SNMPConfig9
	isSet bool
}

func (v NullableSNMPConfig9) Get() *SNMPConfig9 {
	return v.value
}

func (v *NullableSNMPConfig9) Set(val *SNMPConfig9) {
	v.value = val
	v.isSet = true
}

func (v NullableSNMPConfig9) IsSet() bool {
	return v.isSet
}

func (v *NullableSNMPConfig9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSNMPConfig9(val *SNMPConfig9) *NullableSNMPConfig9 {
	return &NullableSNMPConfig9{value: val, isSet: true}
}

func (v NullableSNMPConfig9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSNMPConfig9) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSNMPConfig9) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SNMPConfig9) UnmarshalJSON(data []byte) (err error) {
