...
// checks if the GetIntegrations200ResponseAllOfIntegrationOneOf11 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIntegrations200ResponseAllOfIntegrationOneOf11{}

// GetIntegrations200ResponseAllOfIntegrationOneOf11 struct for GetIntegrations200ResponseAllOfIntegrationOneOf11
type GetIntegrations200ResponseAllOfIntegrationOneOf11 struct {
	Id                   *int64                                                            `json:"id,omitempty"`
	Name                 *string                                                           `json:"name,omitempty"`
	Enabled              *bool                                                             `json:"enabled,omitempty"`
	Type                 *string                                                           `json:"type,omitempty"`
	IntegrationType      *GetIntegrations200ResponseAllOfIntegrationOneOf11IntegrationType `json:"integrationType,omitempty"`
	IsPlugin             *bool                                                             `json:"isPlugin,omitempty"`
	Config               *GetIntegrations200ResponseAllOfIntegrationOneOf11Config          `json:"config,omitempty"`
	...
	Credential           *GetIntegrations200ResponseAllOfIntegrationOneOf11Credential      `json:"credential,omitempty"`
	AdditionalProperties map[string]interface{}                                            `json:",remain"`
}

type _GetIntegrations200ResponseAllOfIntegrationOneOf11 GetIntegrations200ResponseAllOfIntegrationOneOf11
...
func NewGetIntegrations200ResponseAllOfIntegrationOneOf11() *GetIntegrations200ResponseAllOfIntegrationOneOf11 {
	this := GetIntegrations200ResponseAllOfIntegrationOneOf11{}
	return &this
}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) GetIntegrationType() GetIntegrations200ResponseAllOfIntegrationOneOf11IntegrationType {
	if o == nil || IsNil(o.IntegrationType) {
		var ret GetIntegrations200ResponseAllOfIntegrationOneOf11IntegrationType
		return ret
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetIntegrationType() bool {
	if o != nil && !IsNil(o.IntegrationType) {
		return true
	}
...
// SetIntegrationType gets a reference to the given GetIntegrations200ResponseAllOfIntegrationOneOf11IntegrationType and assigns it to the IntegrationType field.
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetIsPlugin() bool {
	if o != nil && !IsNil(o.IsPlugin) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) GetConfig() GetIntegrations200ResponseAllOfIntegrationOneOf11Config {
	if o == nil || IsNil(o.Config) {
		var ret GetIntegrations200ResponseAllOfIntegrationOneOf11Config
		return ret
	}
	return *o.Config
}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given GetIntegrations200ResponseAllOfIntegrationOneOf11Config and assigns it to the Config field.
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetStatusDate() bool {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) SetStatusDateNil() {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetStatusMessage() bool {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) SetStatusMessageNil() {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetLastSync() bool {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) SetLastSyncNil() {
	o.LastSync.Set(nil)
}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetLastSyncDuration() bool {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) SetLastSyncDurationNil() {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) GetCredential() GetIntegrations200ResponseAllOfIntegrationOneOf11Credential {
	if o == nil || IsNil(o.Credential) {
		var ret GetIntegrations200ResponseAllOfIntegrationOneOf11Credential
		return ret
	}
	return *o.Credential
}
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
// SetCredential gets a reference to the given GetIntegrations200ResponseAllOfIntegrationOneOf11Credential and assigns it to the Credential field.
...
func (o GetIntegrations200ResponseAllOfIntegrationOneOf11) MarshalJSON() ([]byte, error) {
...
func (o GetIntegrations200ResponseAllOfIntegrationOneOf11) ToMap() (map[string]interface{}, error) {
...
type NullableGetIntegrations200ResponseAllOfIntegrationOneOf11 struct {
	value *GetIntegrations200ResponseAllOfIntegrationOneOf11
	isSet bool
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf11) Get() *GetIntegrations200ResponseAllOfIntegrationOneOf11 {
	return v.value
}

func (v *NullableGetIntegrations200ResponseAllOfIntegrationOneOf11) Set(val *GetIntegrations200ResponseAllOfIntegrationOneOf11) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf11) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIntegrations200ResponseAllOfIntegrationOneOf11) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIntegrations200ResponseAllOfIntegrationOneOf11(val *GetIntegrations200ResponseAllOfIntegrationOneOf11) *NullableGetIntegrations200ResponseAllOfIntegrationOneOf11 {
	return &NullableGetIntegrations200ResponseAllOfIntegrationOneOf11{value: val, isSet: true}
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf11) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIntegrations200ResponseAllOfIntegrationOneOf11) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetIntegrations200ResponseAllOfIntegrationOneOf11) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetIntegrations200ResponseAllOfIntegrationOneOf11) UnmarshalJSON(data []byte) (err error) {
