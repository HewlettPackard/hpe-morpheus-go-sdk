...
func (o *ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfPlanAfterActionPriceSetsInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfPlanAfterActionPriceSetsInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfPlanAfterActionPriceSetsInner) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListGuidances200ResponseAllOfDiscoveriesInnerAnyOfPlanAfterActionPriceSetsInner) IsSetPriceUnit() bool {
	if o != nil && !IsNil(o.PriceUnit) {
		return true
	}
