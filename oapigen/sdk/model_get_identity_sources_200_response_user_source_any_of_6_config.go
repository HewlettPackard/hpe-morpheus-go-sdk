...
// checks if the GetIdentitySources200ResponseUserSourceAnyOf6Config type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIdentitySources200ResponseUserSourceAnyOf6Config{}

// GetIdentitySources200ResponseUserSourceAnyOf6Config struct for GetIdentitySources200ResponseUserSourceAnyOf6Config
type GetIdentitySources200ResponseUserSourceAnyOf6Config struct {
...
type _GetIdentitySources200ResponseUserSourceAnyOf6Config GetIdentitySources200ResponseUserSourceAnyOf6Config
...
func NewGetIdentitySources200ResponseUserSourceAnyOf6Config() *GetIdentitySources200ResponseUserSourceAnyOf6Config {
	this := GetIdentitySources200ResponseUserSourceAnyOf6Config{}
	return &this
}

// NewGetIdentitySources200ResponseUserSourceAnyOf6ConfigWithDefaults instantiates a new GetIdentitySources200ResponseUserSourceAnyOf6Config object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetIdentitySources200ResponseUserSourceAnyOf6ConfigWithDefaults() *GetIdentitySources200ResponseUserSourceAnyOf6Config {
	this := GetIdentitySources200ResponseUserSourceAnyOf6Config{}
	return &this
}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetLogoutUrl() bool {
	if o != nil && !IsNil(o.LogoutUrl) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetDoNotIncludeSAMLRequest() bool {
	if o != nil && !IsNil(o.DoNotIncludeSAMLRequest) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetSAMLSignatureMode() bool {
	if o != nil && !IsNil(o.SAMLSignatureMode) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetDoNotValidateSignature() bool {
	if o != nil && !IsNil(o.DoNotValidateSignature) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetDoNotValidateStatusCode() bool {
	if o != nil && !IsNil(o.DoNotValidateStatusCode) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetDoNotValidateDestination() bool {
	if o != nil && !IsNil(o.DoNotValidateDestination) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetDoNotValidateIssueInstants() bool {
	if o != nil && !IsNil(o.DoNotValidateIssueInstants) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetDoNotValidateAssertions() bool {
	if o != nil && !IsNil(o.DoNotValidateAssertions) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetGivenNameAttribute() bool {
	if o != nil && !IsNil(o.GivenNameAttribute) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetSurnameAttribute() bool {
	if o != nil && !IsNil(o.SurnameAttribute) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetEmailAttribute() bool {
	if o != nil && !IsNil(o.EmailAttribute) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetRequiredAttributeValue() bool {
	if o != nil && !IsNil(o.RequiredAttributeValue) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetRoleAttributeName() bool {
	if o != nil && !IsNil(o.RoleAttributeName) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetAzureTenantId() bool {
	if o != nil && !IsNil(o.AzureTenantId) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetAzureAppId() bool {
	if o != nil && !IsNil(o.AzureAppId) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetAzureAppSecret() bool {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) SetAzureAppSecretNil() {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetRoleLinkAttributeName() bool {
	if o != nil && !IsNil(o.RoleLinkAttributeName) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetPublicKey() bool {
	if o != nil && !IsNil(o.PublicKey) {
		return true
	}
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) IsSetAzureAppSecretHash() bool {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) SetAzureAppSecretHashNil() {
...
func (o GetIdentitySources200ResponseUserSourceAnyOf6Config) MarshalJSON() ([]byte, error) {
...
func (o GetIdentitySources200ResponseUserSourceAnyOf6Config) ToMap() (map[string]interface{}, error) {
...
type NullableGetIdentitySources200ResponseUserSourceAnyOf6Config struct {
	value *GetIdentitySources200ResponseUserSourceAnyOf6Config
	isSet bool
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf6Config) Get() *GetIdentitySources200ResponseUserSourceAnyOf6Config {
	return v.value
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf6Config) Set(val *GetIdentitySources200ResponseUserSourceAnyOf6Config) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf6Config) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf6Config) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIdentitySources200ResponseUserSourceAnyOf6Config(val *GetIdentitySources200ResponseUserSourceAnyOf6Config) *NullableGetIdentitySources200ResponseUserSourceAnyOf6Config {
	return &NullableGetIdentitySources200ResponseUserSourceAnyOf6Config{value: val, isSet: true}
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf6Config) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIdentitySources200ResponseUserSourceAnyOf6Config) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableGetIdentitySources200ResponseUserSourceAnyOf6Config) UnmarshalMapstructure(data any) (any, error) {
...
func (o *GetIdentitySources200ResponseUserSourceAnyOf6Config) UnmarshalJSON(data []byte) (err error) {
