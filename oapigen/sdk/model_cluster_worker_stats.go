...
func (o *ClusterWorkerStats) IsSetUsedStorage() bool {
	if o != nil && !IsNil(o.UsedStorage) {
		return true
	}
...
func (o *ClusterWorkerStats) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *ClusterWorkerStats) IsSetUsedMemory() bool {
	if o != nil && !IsNil(o.UsedMemory) {
		return true
	}
...
func (o *ClusterWorkerStats) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *ClusterWorkerStats) IsSetUsedCpu() bool {
	if o != nil && !IsNil(o.UsedCpu) {
		return true
	}
...
func (o *ClusterWorkerStats) IsSetCpuUsage() bool {
	if o != nil && !IsNil(o.CpuUsage) {
		return true
	}
...
func (o *ClusterWorkerStats) IsSetCpuUsagePeak() bool {
	if o != nil && !IsNil(o.CpuUsagePeak) {
		return true
	}
...
func (o *ClusterWorkerStats) IsSetCpuUsageAvg() bool {
	if o != nil && !IsNil(o.CpuUsageAvg) {
		return true
	}
