...
func NewBlueprintTerraformCreateSuccessTerraform(configType string) *BlueprintTerraformCreateSuccessTerraform {
	this := BlueprintTerraformCreateSuccessTerraform{}
...
func (o *BlueprintTerraformCreateSuccessTerraform) IsSetJson() bool {
	if o != nil && !IsNil(o.Json) {
		return true
	}
...
func (o *BlueprintTerraformCreateSuccessTerraform) IsSetTf() bool {
	if o != nil && !IsNil(o.Tf) {
		return true
	}
...
func (o *BlueprintTerraformCreateSuccessTerraform) GetGit() BlueprintTerraformCreateSuccessTerraformGit {
	if o == nil || IsNil(o.Git) {
		var ret BlueprintTerraformCreateSuccessTerraformGit
		return ret
	}
	return *o.Git
}
...
func (o *BlueprintTerraformCreateSuccessTerraform) IsSetGit() bool {
	if o != nil && !IsNil(o.Git) {
		return true
	}
...
// SetGit gets a reference to the given BlueprintTerraformCreateSuccessTerraformGit and assigns it to the Git field.
...
func (o *BlueprintTerraformCreateSuccessTerraform) IsSetTfvarSecret() bool {
	if o != nil && !IsNil(o.TfvarSecret) {
		return true
	}
