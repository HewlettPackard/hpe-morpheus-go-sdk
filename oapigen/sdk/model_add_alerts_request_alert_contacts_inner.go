...
type _AddAlertsRequestAlertContactsInner AddAlertsRequestAlertContactsInner
...
func (o *AddAlertsRequestAlertContactsInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AddAlertsRequestAlertContactsInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AddAlertsRequestAlertContactsInner) IsSetMethod() bool {
	if o != nil && !IsNil(o.Method) {
		return true
	}
...
func (o *AddAlertsRequestAlertContactsInner) IsSetNotify() bool {
	if o != nil && !IsNil(o.Notify) {
		return true
	}
...
func (o *AddAlertsRequestAlertContactsInner) IsSetClose() bool {
	if o != nil && !IsNil(o.Close) {
		return true
	}
...
func (v NullableAddAlertsRequestAlertContactsInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddAlertsRequestAlertContactsInner) UnmarshalJSON(data []byte) (err error) {
