...
func (o *PolicyOwner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PolicyOwner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (v NullablePolicyOwner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *PolicyOwner) UnmarshalJSON(data []byte) (err error) {
