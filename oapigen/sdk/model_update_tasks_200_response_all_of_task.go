...
// checks if the UpdateTasks200ResponseAllOfTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTasks200ResponseAllOfTask{}

// UpdateTasks200ResponseAllOfTask struct for UpdateTasks200ResponseAllOfTask
type UpdateTasks200ResponseAllOfTask struct {
	Id                   *int64                                      `json:"id,omitempty"`
	AccountId            *int64                                      `json:"accountId,omitempty"`
	Name                 *string                                     `json:"name,omitempty"`
	Code                 NullableString                              `json:"code,omitempty"`
	TaskType             *UpdateTasks200ResponseAllOfTaskTaskType    `json:"taskType,omitempty"`
	Labels               []string                                    `json:"labels,omitempty"`
	Visibility           *string                                     `json:"visibility,omitempty"`
	TaskOptions          *UpdateTasks200ResponseAllOfTaskTaskOptions `json:"taskOptions,omitempty"`
	File                 *UpdateTasks200ResponseAllOfTaskFile        `json:"file,omitempty"`
	...
	Credential           *UpdateTasks200ResponseAllOfTaskCredential  `json:"credential,omitempty"`
	DateCreated          *time.Time                                  `json:"dateCreated,omitempty"`
	LastUpdated          *time.Time                                  `json:"lastUpdated,omitempty"`
	AdditionalProperties map[string]interface{}                      `json:",remain"`
}

type _UpdateTasks200ResponseAllOfTask UpdateTasks200ResponseAllOfTask
...
func NewUpdateTasks200ResponseAllOfTask() *UpdateTasks200ResponseAllOfTask {
	this := UpdateTasks200ResponseAllOfTask{}
	return &this
}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetCode() bool {
...
func (o *UpdateTasks200ResponseAllOfTask) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *UpdateTasks200ResponseAllOfTask) GetTaskType() UpdateTasks200ResponseAllOfTaskTaskType {
	if o == nil || IsNil(o.TaskType) {
		var ret UpdateTasks200ResponseAllOfTaskTaskType
		return ret
	}
	return *o.TaskType
}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
// SetTaskType gets a reference to the given UpdateTasks200ResponseAllOfTaskTaskType and assigns it to the TaskType field.
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) GetTaskOptions() UpdateTasks200ResponseAllOfTaskTaskOptions {
	if o == nil || IsNil(o.TaskOptions) {
		var ret UpdateTasks200ResponseAllOfTaskTaskOptions
		return ret
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
// SetTaskOptions gets a reference to the given UpdateTasks200ResponseAllOfTaskTaskOptions and assigns it to the TaskOptions field.
...
func (o *UpdateTasks200ResponseAllOfTask) GetFile() UpdateTasks200ResponseAllOfTaskFile {
	if o == nil || IsNil(o.File) {
		var ret UpdateTasks200ResponseAllOfTaskFile
		return ret
	}
	return *o.File
}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
// SetFile gets a reference to the given UpdateTasks200ResponseAllOfTaskFile and assigns it to the File field.
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetResultType() bool {
...
func (o *UpdateTasks200ResponseAllOfTask) SetResultTypeNil() {
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) GetCredential() UpdateTasks200ResponseAllOfTaskCredential {
	if o == nil || IsNil(o.Credential) {
		var ret UpdateTasks200ResponseAllOfTaskCredential
		return ret
	}
	return *o.Credential
}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
// SetCredential gets a reference to the given UpdateTasks200ResponseAllOfTaskCredential and assigns it to the Credential field.
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *UpdateTasks200ResponseAllOfTask) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o UpdateTasks200ResponseAllOfTask) MarshalJSON() ([]byte, error) {
...
func (o UpdateTasks200ResponseAllOfTask) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateTasks200ResponseAllOfTask struct {
	value *UpdateTasks200ResponseAllOfTask
	isSet bool
}

func (v NullableUpdateTasks200ResponseAllOfTask) Get() *UpdateTasks200ResponseAllOfTask {
	return v.value
}

func (v *NullableUpdateTasks200ResponseAllOfTask) Set(val *UpdateTasks200ResponseAllOfTask) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateTasks200ResponseAllOfTask) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateTasks200ResponseAllOfTask) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateTasks200ResponseAllOfTask(val *UpdateTasks200ResponseAllOfTask) *NullableUpdateTasks200ResponseAllOfTask {
	return &NullableUpdateTasks200ResponseAllOfTask{value: val, isSet: true}
}

func (v NullableUpdateTasks200ResponseAllOfTask) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateTasks200ResponseAllOfTask) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableUpdateTasks200ResponseAllOfTask) UnmarshalMapstructure(data any) (any, error) {
...
func (o *UpdateTasks200ResponseAllOfTask) UnmarshalJSON(data []byte) (err error) {
