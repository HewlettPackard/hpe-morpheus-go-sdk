...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetUsedStorage() bool {
	if o != nil && !IsNil(o.UsedStorage) {
		return true
	}
...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetUsedMemory() bool {
	if o != nil && !IsNil(o.UsedMemory) {
		return true
	}
...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetUsedCpu() bool {
	if o != nil && !IsNil(o.UsedCpu) {
		return true
	}
...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetCpuUsage() bool {
	if o != nil && !IsNil(o.CpuUsage) {
		return true
	}
...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetCpuUsagePeak() bool {
	if o != nil && !IsNil(o.CpuUsagePeak) {
		return true
	}
...
func (o *ListInstances200ResponseAllOfInstancesInnerStats) IsSetCpuUsageAvg() bool {
	if o != nil && !IsNil(o.CpuUsageAvg) {
		return true
	}
