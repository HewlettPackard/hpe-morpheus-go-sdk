...
// checks if the AddPricesRequestPriceDatastore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddPricesRequestPriceDatastore{}
...
func NewAddPricesRequestPriceDatastore() *AddPricesRequestPriceDatastore {
	this := AddPricesRequestPriceDatastore{}
	return &this
}
...
func (o *AddPricesRequestPriceDatastore) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddPricesRequestPriceDatastore) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddPricesRequestPriceDatastore) UnmarshalMapstructure(data any) (any, error) {
