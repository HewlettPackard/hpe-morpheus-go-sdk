...
func (o *SNMPConfig6) IsSetOid() bool {
	if o != nil && !IsNil(o.Oid) {
		return true
	}
...
func (o *SNMPConfig6) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SNMPConfig6) IsSetCheckResponse() bool {
	if o != nil && !IsNil(o.CheckResponse) {
		return true
	}
...
func (o *SNMPConfig6) IsSetVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *SNMPConfig6) IsSetCommunity() bool {
	if o != nil && !IsNil(o.Community) {
		return true
	}
...
func (o *SNMPConfig6) IsSetUsername() bool {
	if o != nil && !IsNil(o.Username) {
		return true
	}
...
func (o *SNMPConfig6) IsSetSecurityLevel() bool {
	if o != nil && !IsNil(o.SecurityLevel) {
		return true
	}
...
func (o *SNMPConfig6) IsSetAuth() bool {
	if o != nil && !IsNil(o.Auth) {
		return true
	}
...
func (o *SNMPConfig6) IsSetAuthpassword() bool {
	if o != nil && !IsNil(o.Authpassword) {
		return true
	}
...
func (o *SNMPConfig6) IsSetPriv() bool {
	if o != nil && !IsNil(o.Priv) {
		return true
	}
...
func (o *SNMPConfig6) IsSetPrivpassword() bool {
	if o != nil && !IsNil(o.Privpassword) {
		return true
	}
