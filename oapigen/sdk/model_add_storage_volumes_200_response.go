...
type AddStorageVolumes200Response struct {
	StorageVolume        *AddStorageVolumes200ResponseAllOfStorageVolume `json:"storageVolume,omitempty"`
...
func (v NullableAddStorageVolumes200Response) UnmarshalMapstructure(data any) (any, error) {
