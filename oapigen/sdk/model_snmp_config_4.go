...
// checks if the SNMPConfig4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SNMPConfig4{}

// SNMPConfig4 struct for SNMPConfig4
type SNMPConfig4 struct {
...
func (o *SNMPConfig4) IsSetOid() bool {
	if o != nil && !IsNil(o.Oid) {
		return true
	}
...
func (o *SNMPConfig4) IsSetCheckOperator() bool {
	if o != nil && !IsNil(o.CheckOperator) {
		return true
	}
...
func (o *SNMPConfig4) IsSetCheckResponse() bool {
	if o != nil && !IsNil(o.CheckResponse) {
		return true
	}
...
func (o *SNMPConfig4) IsSetVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *SNMPConfig4) IsSetCommunity() bool {
	if o != nil && !IsNil(o.Community) {
		return true
	}
...
func (o *SNMPConfig4) IsSetUsername() bool {
	if o != nil && !IsNil(o.Username) {
		return true
	}
...
func (o *SNMPConfig4) IsSetSecurityLevel() bool {
	if o != nil && !IsNil(o.SecurityLevel) {
		return true
	}
...
func (o *SNMPConfig4) IsSetAuth() bool {
	if o != nil && !IsNil(o.Auth) {
		return true
	}
...
func (o *SNMPConfig4) IsSetAuthpassword() bool {
	if o != nil && !IsNil(o.Authpassword) {
		return true
	}
...
func (o *SNMPConfig4) IsSetPriv() bool {
	if o != nil && !IsNil(o.Priv) {
		return true
	}
...
func (o *SNMPConfig4) IsSetPrivpassword() bool {
	if o != nil && !IsNil(o.Privpassword) {
		return true
	}
...
func (o SNMPConfig4) MarshalJSON() ([]byte, error) {
...
func (o SNMPConfig4) ToMap() (map[string]interface{}, error) {
...
type NullableSNMPConfig4 struct {
	value *SNMPConfig4
	isSet bool
}

func (v NullableSNMPConfig4) Get() *SNMPConfig4 {
	return v.value
}

func (v *NullableSNMPConfig4) Set(val *SNMPConfig4) {
	v.value = val
	v.isSet = true
}

func (v NullableSNMPConfig4) IsSet() bool {
	return v.isSet
}

func (v *NullableSNMPConfig4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSNMPConfig4(val *SNMPConfig4) *NullableSNMPConfig4 {
	return &NullableSNMPConfig4{value: val, isSet: true}
}

func (v NullableSNMPConfig4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSNMPConfig4) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableSNMPConfig4) UnmarshalMapstructure(data any) (any, error) {
...
func (o *SNMPConfig4) UnmarshalJSON(data []byte) (err error) {
