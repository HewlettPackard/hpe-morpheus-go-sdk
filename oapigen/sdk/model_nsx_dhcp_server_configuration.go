...
// checks if the NSXDHCPServerConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NSXDHCPServerConfiguration{}

// NSXDHCPServerConfiguration Configuration for NSX-T DHCP servers.
type NSXDHCPServerConfiguration struct {
	// Edge Cluster
...
type _NSXDHCPServerConfiguration NSXDHCPServerConfiguration
...
func NewNSXDHCPServerConfiguration() *NSXDHCPServerConfiguration {
	this := NSXDHCPServerConfiguration{}
	return &this
}
...
func (o *NSXDHCPServerConfiguration) IsSetEdgeCluster() bool {
...
func (o *NSXDHCPServerConfiguration) SetEdgeClusterNil() {
...
func (o *NSXDHCPServerConfiguration) IsSetPreferredEdgeNode1() bool {
...
func (o *NSXDHCPServerConfiguration) SetPreferredEdgeNode1Nil() {
...
func (o *NSXDHCPServerConfiguration) IsSetPreferredEdgeNode2() bool {
...
func (o *NSXDHCPServerConfiguration) SetPreferredEdgeNode2Nil() {
...
func (o NSXDHCPServerConfiguration) MarshalJSON() ([]byte, error) {
...
func (o NSXDHCPServerConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableNSXDHCPServerConfiguration struct {
	value *NSXDHCPServerConfiguration
	isSet bool
}

func (v NullableNSXDHCPServerConfiguration) Get() *NSXDHCPServerConfiguration {
	return v.value
}

func (v *NullableNSXDHCPServerConfiguration) Set(val *NSXDHCPServerConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableNSXDHCPServerConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableNSXDHCPServerConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNSXDHCPServerConfiguration(val *NSXDHCPServerConfiguration) *NullableNSXDHCPServerConfiguration {
	return &NullableNSXDHCPServerConfiguration{value: val, isSet: true}
}

func (v NullableNSXDHCPServerConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNSXDHCPServerConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableNSXDHCPServerConfiguration) UnmarshalMapstructure(data any) (any, error) {
...
func (o *NSXDHCPServerConfiguration) UnmarshalJSON(data []byte) (err error) {
