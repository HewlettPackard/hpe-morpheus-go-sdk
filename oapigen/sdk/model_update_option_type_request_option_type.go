...
type UpdateOptionTypeRequestOptionType struct {
	...
	OptionList           *UpdateOptionTypeRequestOptionTypeOptionList `json:"optionList,omitempty"`
...
func (o *UpdateOptionTypeRequestOptionType) GetOptionList() UpdateOptionTypeRequestOptionTypeOptionList {
	if o == nil || IsNil(o.OptionList) {
		var ret UpdateOptionTypeRequestOptionTypeOptionList
		return ret
	}
	return *o.OptionList
}
...
// SetOptionList gets a reference to the given UpdateOptionTypeRequestOptionTypeOptionList and assigns it to the OptionList field.
