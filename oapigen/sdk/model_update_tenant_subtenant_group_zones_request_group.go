...
type UpdateTenantSubtenantGroupZonesRequestGroup struct {
	...
	Zones                []UpdateTenantSubtenantGroupZonesRequestGroupZonesInner `json:"zones"`
...
func (v NullableUpdateTenantSubtenantGroupZonesRequestGroup) UnmarshalMapstructure(data any) (any, error) {
