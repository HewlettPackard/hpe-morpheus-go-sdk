...
// checks if the ElasticSearchConfig9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ElasticSearchConfig9{}

// ElasticSearchConfig9 struct for ElasticSearchConfig9
type ElasticSearchConfig9 struct {
...
type _ElasticSearchConfig9 ElasticSearchConfig9
...
func NewElasticSearchConfig9(esHost string, esPort string) *ElasticSearchConfig9 {
	this := ElasticSearchConfig9{}
	this.EsHost = esHost
	this.EsPort = esPort
	return &this
}

// NewElasticSearchConfig9WithDefaults instantiates a new ElasticSearchConfig9 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewElasticSearchConfig9WithDefaults() *ElasticSearchConfig9 {
	this := ElasticSearchConfig9{}
	return &this
}
...
func (o *ElasticSearchConfig9) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *ElasticSearchConfig9) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *ElasticSearchConfig9) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *ElasticSearchConfig9) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *ElasticSearchConfig9) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o ElasticSearchConfig9) MarshalJSON() ([]byte, error) {
...
func (o ElasticSearchConfig9) ToMap() (map[string]interface{}, error) {
...
type NullableElasticSearchConfig9 struct {
	value *ElasticSearchConfig9
	isSet bool
}

func (v NullableElasticSearchConfig9) Get() *ElasticSearchConfig9 {
	return v.value
}

func (v *NullableElasticSearchConfig9) Set(val *ElasticSearchConfig9) {
	v.value = val
	v.isSet = true
}

func (v NullableElasticSearchConfig9) IsSet() bool {
	return v.isSet
}

func (v *NullableElasticSearchConfig9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableElasticSearchConfig9(val *ElasticSearchConfig9) *NullableElasticSearchConfig9 {
	return &NullableElasticSearchConfig9{value: val, isSet: true}
}

func (v NullableElasticSearchConfig9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableElasticSearchConfig9) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableElasticSearchConfig9) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ElasticSearchConfig9) UnmarshalJSON(data []byte) (err error) {
