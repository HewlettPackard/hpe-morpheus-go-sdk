...
func (o *IntegrationPowerDNS) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetIntegrationType() bool {
	if o != nil && !IsNil(o.IntegrationType) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetServiceFlag() bool {
	if o != nil && !IsNil(o.ServiceFlag) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetIsPlugin() bool {
	if o != nil && !IsNil(o.IsPlugin) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetStatusDate() bool {
	if o != nil && !IsNil(o.StatusDate) {
		return true
	}
...
func (o *IntegrationPowerDNS) IsSetStatusMessage() bool {
...
func (o *IntegrationPowerDNS) SetStatusMessageNil() {
...
func (o *IntegrationPowerDNS) IsSetLastSync() bool {
...
func (o *IntegrationPowerDNS) SetLastSyncNil() {
	o.LastSync.Set(nil)
}
...
func (o *IntegrationPowerDNS) IsSetLastSyncDuration() bool {
...
func (o *IntegrationPowerDNS) SetLastSyncDurationNil() {
...
func (o *IntegrationPowerDNS) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
