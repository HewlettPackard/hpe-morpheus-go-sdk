...
func (o *ArchiveFileLinksArchiveFile) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ArchiveFileLinksArchiveFile) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ArchiveFileLinksArchiveFile) IsSetFilePath() bool {
	if o != nil && !IsNil(o.FilePath) {
		return true
	}
...
func (v NullableArchiveFileLinksArchiveFile) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ArchiveFileLinksArchiveFile) UnmarshalJSON(data []byte) (err error) {
