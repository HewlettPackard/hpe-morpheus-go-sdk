...
// checks if the AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions{}

// AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions Map of custom options depending on selected service plan.
type AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions struct {
	// Core Count
...
func NewAddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions() *AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions {
	this := AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions{}
	return &this
}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions) IsSetMaxCores() bool {
	if o != nil && !IsNil(o.MaxCores) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions) IsSetCoresPerSocket() bool {
	if o != nil && !IsNil(o.CoresPerSocket) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
...
func (o AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions) MarshalJSON() ([]byte, error) {
...
func (o AddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddCatalogItemTypeRequestCatalogItemTypeOneOfConfigServicePlanOptions) UnmarshalMapstructure(data any) (any, error) {
