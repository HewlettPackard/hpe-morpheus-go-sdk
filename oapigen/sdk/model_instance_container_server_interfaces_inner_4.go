...
// checks if the InstanceContainerServerInterfacesInner4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceContainerServerInterfacesInner4{}

// InstanceContainerServerInterfacesInner4 struct for InstanceContainerServerInterfacesInner4
type InstanceContainerServerInterfacesInner4 struct {
...
type _InstanceContainerServerInterfacesInner4 InstanceContainerServerInterfacesInner4
...
func NewInstanceContainerServerInterfacesInner4() *InstanceContainerServerInterfacesInner4 {
	this := InstanceContainerServerInterfacesInner4{}
	return &this
}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetUniqueId() bool {
	if o != nil && !IsNil(o.UniqueId) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetPublicIpAddress() bool {
	if o != nil && !IsNil(o.PublicIpAddress) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetIpAddress() bool {
	if o != nil && !IsNil(o.IpAddress) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetDhcp() bool {
	if o != nil && !IsNil(o.Dhcp) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetPoolAssigned() bool {
	if o != nil && !IsNil(o.PoolAssigned) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetPrimaryInterface() bool {
	if o != nil && !IsNil(o.PrimaryInterface) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetNetwork() bool {
	if o != nil && !IsNil(o.Network) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetNetworkGroup() bool {
	if o != nil && !IsNil(o.NetworkGroup) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetNetworkPool() bool {
	if o != nil && !IsNil(o.NetworkPool) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetIpMode() bool {
	if o != nil && !IsNil(o.IpMode) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetMacAddress() bool {
	if o != nil && !IsNil(o.MacAddress) {
		return true
	}
...
func (o *InstanceContainerServerInterfacesInner4) IsSetInterfaces() bool {
	if o != nil && !IsNil(o.Interfaces) {
		return true
	}
...
func (o InstanceContainerServerInterfacesInner4) MarshalJSON() ([]byte, error) {
...
func (o InstanceContainerServerInterfacesInner4) ToMap() (map[string]interface{}, error) {
...
type NullableInstanceContainerServerInterfacesInner4 struct {
	value *InstanceContainerServerInterfacesInner4
	isSet bool
}

func (v NullableInstanceContainerServerInterfacesInner4) Get() *InstanceContainerServerInterfacesInner4 {
	return v.value
}

func (v *NullableInstanceContainerServerInterfacesInner4) Set(val *InstanceContainerServerInterfacesInner4) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceContainerServerInterfacesInner4) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceContainerServerInterfacesInner4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceContainerServerInterfacesInner4(val *InstanceContainerServerInterfacesInner4) *NullableInstanceContainerServerInterfacesInner4 {
	return &NullableInstanceContainerServerInterfacesInner4{value: val, isSet: true}
}

func (v NullableInstanceContainerServerInterfacesInner4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceContainerServerInterfacesInner4) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableInstanceContainerServerInterfacesInner4) UnmarshalMapstructure(data any) (any, error) {
...
func (o *InstanceContainerServerInterfacesInner4) UnmarshalJSON(data []byte) (err error) {
