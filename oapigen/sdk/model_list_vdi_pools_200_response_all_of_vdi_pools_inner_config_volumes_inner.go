...
// checks if the ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner{}

// ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner struct for ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner
type ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner struct {
...
type _ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner
...
func NewListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner() *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner {
	this := ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner{}
	return &this
}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetVolumeCustomizable() bool {
	if o != nil && !IsNil(o.VolumeCustomizable) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetVId() bool {
	if o != nil && !IsNil(o.VId) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetReadonlyName() bool {
	if o != nil && !IsNil(o.ReadonlyName) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetMaxIOPS() bool {
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) SetMaxIOPSNil() {
	o.MaxIOPS.Set(nil)
}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetRootVolume() bool {
	if o != nil && !IsNil(o.RootVolume) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetStorageType() bool {
	if o != nil && !IsNil(o.StorageType) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetDatastoreId() bool {
	if o != nil && !IsNil(o.DatastoreId) {
		return true
	}
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSetMaxStorage() bool {
	if o != nil && !IsNil(o.MaxStorage) {
		return true
	}
...
func (o ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) MarshalJSON() ([]byte, error) {
...
func (o ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) ToMap() (map[string]interface{}, error) {
...
type NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner struct {
	value *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner
	isSet bool
}

func (v NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) Get() *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner {
	return v.value
}

func (v *NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) Set(val *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner(val *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) *NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner {
	return &NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner{value: val, isSet: true}
}

func (v NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListVDIPools200ResponseAllOfVdiPoolsInnerConfigVolumesInner) UnmarshalJSON(data []byte) (err error) {
