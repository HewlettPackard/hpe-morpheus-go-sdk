...
type AddNodeTypeRequestContainerType struct {
	...
	EnvironmentVariables []AddNodeTypeRequestContainerTypeEnvironmentVariablesInner `json:"environmentVariables,omitempty"`
...
func (o *AddNodeTypeRequestContainerType) GetEnvironmentVariables() []AddNodeTypeRequestContainerTypeEnvironmentVariablesInner {
	if o == nil || IsNil(o.EnvironmentVariables) {
		var ret []AddNodeTypeRequestContainerTypeEnvironmentVariablesInner
		return ret
	}
...
// SetEnvironmentVariables gets a reference to the given []AddNodeTypeRequestContainerTypeEnvironmentVariablesInner and assigns it to the EnvironmentVariables field.
