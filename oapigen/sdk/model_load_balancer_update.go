...
type LoadBalancerUpdate struct {
	...
	Tenants              []LoadBalancerUpdateTenantsInner      `json:"tenants,omitempty"`
	ResourcePermission   *LoadBalancerUpdateResourcePermission `json:"resourcePermission,omitempty"`
...
func (o *LoadBalancerUpdate) GetTenants() []LoadBalancerUpdateTenantsInner {
	if o == nil || IsNil(o.Tenants) {
		var ret []LoadBalancerUpdateTenantsInner
		return ret
	}
	return o.Tenants
}
...
// SetTenants gets a reference to the given []LoadBalancerUpdateTenantsInner and assigns it to the Tenants field.
...
func (o *LoadBalancerUpdate) GetResourcePermission() LoadBalancerUpdateResourcePermission {
	if o == nil || IsNil(o.ResourcePermission) {
		var ret LoadBalancerUpdateResourcePermission
		return ret
	}
...
// SetResourcePermission gets a reference to the given LoadBalancerUpdateResourcePermission and assigns it to the ResourcePermission field.
...
func (v NullableLoadBalancerUpdate) UnmarshalMapstructure(data any) (any, error) {
