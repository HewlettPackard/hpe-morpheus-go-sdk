...
// checks if the AzureInstanceConfiguration6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureInstanceConfiguration6{}

// AzureInstanceConfiguration6 struct for AzureInstanceConfiguration6
type AzureInstanceConfiguration6 struct {
...
type _AzureInstanceConfiguration6 AzureInstanceConfiguration6

func (o AzureInstanceConfiguration6) MarshalJSON() ([]byte, error) {
...
func (o AzureInstanceConfiguration6) ToMap() (map[string]interface{}, error) {
...
type NullableAzureInstanceConfiguration6 struct {
	value *AzureInstanceConfiguration6
	isSet bool
}

func (v NullableAzureInstanceConfiguration6) Get() *AzureInstanceConfiguration6 {
	return v.value
}

func (v *NullableAzureInstanceConfiguration6) Set(val *AzureInstanceConfiguration6) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureInstanceConfiguration6) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureInstanceConfiguration6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureInstanceConfiguration6(val *AzureInstanceConfiguration6) *NullableAzureInstanceConfiguration6 {
	return &NullableAzureInstanceConfiguration6{value: val, isSet: true}
}

func (v NullableAzureInstanceConfiguration6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureInstanceConfiguration6) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAzureInstanceConfiguration6) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AzureInstanceConfiguration6) UnmarshalJSON(data []byte) (err error) {
