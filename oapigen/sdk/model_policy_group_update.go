...
// checks if the PolicyGroupUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyGroupUpdate{}
...
func (o *PolicyGroupUpdate) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *PolicyGroupUpdate) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *PolicyGroupUpdate) IsSetPolicyType() bool {
	if o != nil && !IsNil(o.PolicyType) {
		return true
	}
...
func (o PolicyGroupUpdate) ToMap() (map[string]interface{}, error) {
...
func (v NullablePolicyGroupUpdate) UnmarshalMapstructure(data any) (any, error) {
