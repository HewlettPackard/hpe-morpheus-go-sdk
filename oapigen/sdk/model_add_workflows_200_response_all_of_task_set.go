...
// checks if the AddWorkflows200ResponseAllOfTaskSet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddWorkflows200ResponseAllOfTaskSet{}

// AddWorkflows200ResponseAllOfTaskSet struct for AddWorkflows200ResponseAllOfTaskSet
type AddWorkflows200ResponseAllOfTaskSet struct {
...
type _AddWorkflows200ResponseAllOfTaskSet AddWorkflows200ResponseAllOfTaskSet
...
func NewAddWorkflows200ResponseAllOfTaskSet() *AddWorkflows200ResponseAllOfTaskSet {
	this := AddWorkflows200ResponseAllOfTaskSet{}
	return &this
}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetDescription() bool {
...
func (o *AddWorkflows200ResponseAllOfTaskSet) SetDescriptionNil() {
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetPlatform() bool {
...
func (o *AddWorkflows200ResponseAllOfTaskSet) SetPlatformNil() {
	o.Platform.Set(nil)
}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetTasks() bool {
	if o != nil && !IsNil(o.Tasks) {
		return true
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) GetOptionTypes() []AddWorkflows200ResponseAllOfTaskSetOptionTypesInner {
	if o == nil {
		var ret []AddWorkflows200ResponseAllOfTaskSetOptionTypesInner
		return ret
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetOptionTypes() bool {
	if o != nil && !IsNil(o.OptionTypes) {
		return true
	}
...
// SetOptionTypes gets a reference to the given []AddWorkflows200ResponseAllOfTaskSetOptionTypesInner and assigns it to the OptionTypes field.
...
func (o *AddWorkflows200ResponseAllOfTaskSet) GetTaskSetTasks() []AddWorkflows200ResponseAllOfTaskSetTaskSetTasksInner {
	if o == nil || IsNil(o.TaskSetTasks) {
		var ret []AddWorkflows200ResponseAllOfTaskSetTaskSetTasksInner
		return ret
	}
...
func (o *AddWorkflows200ResponseAllOfTaskSet) IsSetTaskSetTasks() bool {
	if o != nil && !IsNil(o.TaskSetTasks) {
		return true
	}
...
// SetTaskSetTasks gets a reference to the given []AddWorkflows200ResponseAllOfTaskSetTaskSetTasksInner and assigns it to the TaskSetTasks field.
func (o *AddWorkflows200ResponseAllOfTaskSet) SetTaskSetTasks(v []AddWorkflows200ResponseAllOfTaskSetTaskSetTasksInner) {
	o.TaskSetTasks = v
}

func (o AddWorkflows200ResponseAllOfTaskSet) MarshalJSON() ([]byte, error) {
...
func (o AddWorkflows200ResponseAllOfTaskSet) ToMap() (map[string]interface{}, error) {
...
type NullableAddWorkflows200ResponseAllOfTaskSet struct {
	value *AddWorkflows200ResponseAllOfTaskSet
	isSet bool
}

func (v NullableAddWorkflows200ResponseAllOfTaskSet) Get() *AddWorkflows200ResponseAllOfTaskSet {
	return v.value
}

func (v *NullableAddWorkflows200ResponseAllOfTaskSet) Set(val *AddWorkflows200ResponseAllOfTaskSet) {
	v.value = val
	v.isSet = true
}

func (v NullableAddWorkflows200ResponseAllOfTaskSet) IsSet() bool {
	return v.isSet
}

func (v *NullableAddWorkflows200ResponseAllOfTaskSet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddWorkflows200ResponseAllOfTaskSet(val *AddWorkflows200ResponseAllOfTaskSet) *NullableAddWorkflows200ResponseAllOfTaskSet {
	return &NullableAddWorkflows200ResponseAllOfTaskSet{value: val, isSet: true}
}

func (v NullableAddWorkflows200ResponseAllOfTaskSet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddWorkflows200ResponseAllOfTaskSet) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddWorkflows200ResponseAllOfTaskSet) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddWorkflows200ResponseAllOfTaskSet) UnmarshalJSON(data []byte) (err error) {
