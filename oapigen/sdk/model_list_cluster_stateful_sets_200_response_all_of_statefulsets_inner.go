...
func NewListClusterStatefulSets200ResponseAllOfStatefulsetsInner() *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner {
	this := ListClusterStatefulSets200ResponseAllOfStatefulsetsInner{}
	return &this
}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetDescription() bool {
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) SetDescriptionNil() {
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetResourceLevel() bool {
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) SetResourceLevelNil() {
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetResourceType() bool {
	if o != nil && !IsNil(o.ResourceType) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetManaged() bool {
	if o != nil && !IsNil(o.Managed) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) GetOwner() ListClusterStatefulSets200ResponseAllOfStatefulsetsInnerOwner {
	if o == nil || IsNil(o.Owner) {
		var ret ListClusterStatefulSets200ResponseAllOfStatefulsetsInnerOwner
		return ret
	}
	return *o.Owner
}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetOwner() bool {
	if o != nil && !IsNil(o.Owner) {
		return true
	}
...
// SetOwner gets a reference to the given ListClusterStatefulSets200ResponseAllOfStatefulsetsInnerOwner and assigns it to the Owner field.
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetTotalCpuUsage() bool {
	if o != nil && !IsNil(o.TotalCpuUsage) {
		return true
	}
...
func (o *ListClusterStatefulSets200ResponseAllOfStatefulsetsInner) IsSetStats() bool {
	if o != nil && !IsNil(o.Stats) {
		return true
	}
