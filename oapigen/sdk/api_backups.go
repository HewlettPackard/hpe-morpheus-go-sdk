...
func (r ApiExecuteBackupJobsRequest) Execute() (*UpdateBackupJobs200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateBackupJobs200Response
func (a *BackupsAPIService) ExecuteBackupJobsExecute(r ApiExecuteBackupJobsRequest) (*UpdateBackupJobs200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateBackupJobs200Response
	)
...
func (r ApiExecuteBackupRestoreRequest) Execute() (*ExecuteBackupRestore200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ExecuteBackupRestore200Response
func (a *BackupsAPIService) ExecuteBackupRestoreExecute(r ApiExecuteBackupRestoreRequest) (*ExecuteBackupRestore200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ExecuteBackupRestore200Response
	)
...
func (r ApiExecuteBackupsRequest) Execute() (*ExecuteBackups200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return ExecuteBackups200Response
func (a *BackupsAPIService) ExecuteBackupsExecute(r ApiExecuteBackupsRequest) (*ExecuteBackups200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ExecuteBackups200Response
	)
...
func (r ApiRemoveBackupJobsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
func (a *BackupsAPIService) RemoveBackupJobsExecute(r ApiRemoveBackupJobsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
...
func (r ApiRemoveBackupRestoresRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
//
//	@return RemoveExecuteSchedules200Response
func (a *BackupsAPIService) RemoveBackupRestoresExecute(r ApiRemoveBackupRestoresRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiRemoveBackupResultsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
//
//	@return RemoveExecuteSchedules200Response
func (a *BackupsAPIService) RemoveBackupResultsExecute(r ApiRemoveBackupResultsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiRemoveBackupsRequest) Execute() (*RemoveExecuteSchedules200Response, *http.Response, error) {
...
//
//	@return RemoveExecuteSchedules200Response
func (a *BackupsAPIService) RemoveBackupsExecute(r ApiRemoveBackupsRequest) (*RemoveExecuteSchedules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ApiUpdateBackupJobsRequest) Execute() (*UpdateBackupJobs200Response, *http.Response, error) {
...
//
//	@return UpdateBackupJobs200Response
func (a *BackupsAPIService) UpdateBackupJobsExecute(r ApiUpdateBackupJobsRequest) (*UpdateBackupJobs200Response, *http.Response, error) {
	var (
...
func (r ApiUpdateBackupsRequest) Execute() (*UpdateBackups200Response, *http.Response, error) {
...
// Execute executes the request
//
//	@return UpdateBackups200Response
func (a *BackupsAPIService) UpdateBackupsExecute(r ApiUpdateBackupsRequest) (*UpdateBackups200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *UpdateBackups200Response
	)
...
type ApiValidateBackupCreateRequest struct {
	ctx                         context.Context
	ApiService                  *BackupsAPIService
	validateBackupCreateRequest *ValidateBackupCreateRequest
}

func (r ApiValidateBackupCreateRequest) ValidateBackupCreateRequest(validateBackupCreateRequest ValidateBackupCreateRequest) ApiValidateBackupCreateRequest {
	r.validateBackupCreateRequest = &validateBackupCreateRequest
	return r
}

func (r ApiValidateBackupCreateRequest) Execute() (*ValidateBackupCreate200Response, *http.Response, error) {
	return r.ApiService.ValidateBackupCreateExecute(r)
}

/*
ValidateBackupCreate Validates a Backup Configuration
...
It does not persist anything. Use this as a pre-flight check before calling `POST /api/backups`.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiValidateBackupCreateRequest
*/
func (a *BackupsAPIService) ValidateBackupCreate(ctx context.Context) ApiValidateBackupCreateRequest {
	return ApiValidateBackupCreateRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//
//	@return ValidateBackupCreate200Response
func (a *BackupsAPIService) ValidateBackupCreateExecute(r ApiValidateBackupCreateRequest) (*ValidateBackupCreate200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ValidateBackupCreate200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupsAPIService.ValidateBackupCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{err: err}
	}

	localVarPath := localBasePath + "/api/backups/create"
	...
	// body params
	localVarPostBody = r.validateBackupCreateRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
