...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf16 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf16{}

// ListTasks200ResponseAllOfTasksInnerAnyOf16 struct for ListTasks200ResponseAllOfTasksInnerAnyOf16
type ListTasks200ResponseAllOfTasksInnerAnyOf16 struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf16 ListTasks200ResponseAllOfTasksInnerAnyOf16
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf16() *ListTasks200ResponseAllOfTasksInnerAnyOf16 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf16{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetCode() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) SetCodeNil() {
	o.Code.Set(nil)
}

// UnsetCode ensures that no value is present for Code, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) UnsetCode() {
	o.Code.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetResultType() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) SetResultTypeNil() {
	o.ResultType.Set(nil)
}

// UnsetResultType ensures that no value is present for ResultType, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) UnsetResultType() {
	o.ResultType.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf16) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf16) ToMap() (map[string]interface{}, error) {
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf16 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf16
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf16) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf16 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf16) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf16) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf16) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf16) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf16(val *ListTasks200ResponseAllOfTasksInnerAnyOf16) *NullableListTasks200ResponseAllOfTasksInnerAnyOf16 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf16{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf16) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf16) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf16) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf16) UnmarshalJSON(data []byte) (err error) {
