...
func (o *SNMPCheck) IsSetDescription() bool {
...
func (o *SNMPCheck) SetDescriptionNil() {
...
func (o *SNMPCheck) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *SNMPCheck) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *SNMPCheck) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *SNMPCheck) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *SNMPCheck) GetCheckType() SNMPCheckAllOfCheckType {
	if o == nil || IsNil(o.CheckType) {
		var ret SNMPCheckAllOfCheckType
		return ret
	}
	return *o.CheckType
}
...
func (o *SNMPCheck) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
// SetCheckType gets a reference to the given SNMPCheckAllOfCheckType and assigns it to the CheckType field.
...
func (o *SNMPCheck) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given SNMPCheckAllOfConfig and assigns it to the Config field.
