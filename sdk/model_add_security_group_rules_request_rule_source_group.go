...
// checks if the AddSecurityGroupRulesRequestRuleSourceGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddSecurityGroupRulesRequestRuleSourceGroup{}
...
func NewAddSecurityGroupRulesRequestRuleSourceGroup() *AddSecurityGroupRulesRequestRuleSourceGroup {
	this := AddSecurityGroupRulesRequestRuleSourceGroup{}
	return &this
}
...
func (o *AddSecurityGroupRulesRequestRuleSourceGroup) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddSecurityGroupRulesRequestRuleSourceGroup) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddSecurityGroupRulesRequestRuleSourceGroup) UnmarshalMapstructure(data any) (any, error) {
