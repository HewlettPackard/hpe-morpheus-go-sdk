...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf3{}

// ListTasks200ResponseAllOfTasksInnerAnyOf3 struct for ListTasks200ResponseAllOfTasksInnerAnyOf3
type ListTasks200ResponseAllOfTasksInnerAnyOf3 struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf3 ListTasks200ResponseAllOfTasksInnerAnyOf3
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf3() *ListTasks200ResponseAllOfTasksInnerAnyOf3 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf3{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetCode() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) SetCodeNil() {
	o.Code.Set(nil)
}

// UnsetCode ensures that no value is present for Code, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) UnsetCode() {
	o.Code.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetResultType() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) SetResultTypeNil() {
	o.ResultType.Set(nil)
}

// UnsetResultType ensures that no value is present for ResultType, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) UnsetResultType() {
	o.ResultType.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf3) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf3) ToMap() (map[string]interface{}, error) {
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf3 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf3
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf3) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf3 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf3) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf3(val *ListTasks200ResponseAllOfTasksInnerAnyOf3) *NullableListTasks200ResponseAllOfTasksInnerAnyOf3 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf3{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf3) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf3) UnmarshalJSON(data []byte) (err error) {
