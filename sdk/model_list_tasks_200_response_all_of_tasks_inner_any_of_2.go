...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf2{}

// ListTasks200ResponseAllOfTasksInnerAnyOf2 struct for ListTasks200ResponseAllOfTasksInnerAnyOf2
type ListTasks200ResponseAllOfTasksInnerAnyOf2 struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf2 ListTasks200ResponseAllOfTasksInnerAnyOf2
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf2() *ListTasks200ResponseAllOfTasksInnerAnyOf2 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf2{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetCode() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) SetCodeNil() {
	o.Code.Set(nil)
}

// UnsetCode ensures that no value is present for Code, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) UnsetCode() {
	o.Code.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetResultType() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) SetResultTypeNil() {
	o.ResultType.Set(nil)
}

// UnsetResultType ensures that no value is present for ResultType, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) UnsetResultType() {
	o.ResultType.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf2) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf2) ToMap() (map[string]interface{}, error) {
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf2 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf2
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf2) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf2 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf2) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf2(val *ListTasks200ResponseAllOfTasksInnerAnyOf2) *NullableListTasks200ResponseAllOfTasksInnerAnyOf2 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf2{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf2) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf2) UnmarshalJSON(data []byte) (err error) {
