...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf4{}

// ListTasks200ResponseAllOfTasksInnerAnyOf4 struct for ListTasks200ResponseAllOfTasksInnerAnyOf4
type ListTasks200ResponseAllOfTasksInnerAnyOf4 struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf4 ListTasks200ResponseAllOfTasksInnerAnyOf4
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf4() *ListTasks200ResponseAllOfTasksInnerAnyOf4 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf4{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetCode() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) SetCodeNil() {
	o.Code.Set(nil)
}

// UnsetCode ensures that no value is present for Code, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) UnsetCode() {
	o.Code.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetResultType() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) SetResultTypeNil() {
	o.ResultType.Set(nil)
}

// UnsetResultType ensures that no value is present for ResultType, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) UnsetResultType() {
	o.ResultType.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf4) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf4) ToMap() (map[string]interface{}, error) {
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf4 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf4
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf4) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf4 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf4) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf4) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf4) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf4(val *ListTasks200ResponseAllOfTasksInnerAnyOf4) *NullableListTasks200ResponseAllOfTasksInnerAnyOf4 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf4{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf4) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf4) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf4) UnmarshalJSON(data []byte) (err error) {
