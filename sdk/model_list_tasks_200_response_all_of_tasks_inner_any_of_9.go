...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf9{}

// ListTasks200ResponseAllOfTasksInnerAnyOf9 struct for ListTasks200ResponseAllOfTasksInnerAnyOf9
type ListTasks200ResponseAllOfTasksInnerAnyOf9 struct {
	Id *int64 `json:"id,omitempty"`
	AccountId *int64 `json:"accountId,omitempty"`
	Name *string `json:"name,omitempty"`
	Code *string `json:"code,omitempty"`
	TaskType *ListTasks200ResponseAllOfTasksInnerAnyOf9TaskType `json:"taskType,omitempty"`
	Labels []string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *ListTasks200ResponseAllOfTasksInnerAnyOf9TaskOptions `json:"taskOptions,omitempty"`
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf9 ListTasks200ResponseAllOfTasksInnerAnyOf9
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf9() *ListTasks200ResponseAllOfTasksInnerAnyOf9 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf9{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) GetTaskType() ListTasks200ResponseAllOfTasksInnerAnyOf9TaskType {
	if o == nil || IsNil(o.TaskType) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOf9TaskType
		return ret
	}
	return *o.TaskType
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
// SetTaskType gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOf9TaskType and assigns it to the TaskType field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) GetTaskOptions() ListTasks200ResponseAllOfTasksInnerAnyOf9TaskOptions {
	if o == nil || IsNil(o.TaskOptions) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOf9TaskOptions
		return ret
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
// SetTaskOptions gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOf9TaskOptions and assigns it to the TaskOptions field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetResultType() bool {
	if o != nil && !IsNil(o.ResultType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf9) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf9) ToMap() (map[string]interface{}, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf9) UnmarshalJSON(data []byte) (err error) {
	varListTasks200ResponseAllOfTasksInnerAnyOf9 := _ListTasks200ResponseAllOfTasksInnerAnyOf9{}

	err = json.Unmarshal(data, &varListTasks200ResponseAllOfTasksInnerAnyOf9)

	if err != nil {
		return err
	}

	*o = ListTasks200ResponseAllOfTasksInnerAnyOf9(varListTasks200ResponseAllOfTasksInnerAnyOf9)
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf9 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf9
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf9) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf9 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf9) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf9) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf9) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf9(val *ListTasks200ResponseAllOfTasksInnerAnyOf9) *NullableListTasks200ResponseAllOfTasksInnerAnyOf9 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf9{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf9) UnmarshalJSON(src []byte) error {
	v.isSet = true
