...
// checks if the AddPriceSetsRequestPriceSetZonePool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddPriceSetsRequestPriceSetZonePool{}
...
func NewAddPriceSetsRequestPriceSetZonePool() *AddPriceSetsRequestPriceSetZonePool {
	this := AddPriceSetsRequestPriceSetZonePool{}
	return &this
}
...
func (o *AddPriceSetsRequestPriceSetZonePool) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddPriceSetsRequestPriceSetZonePool) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddPriceSetsRequestPriceSetZonePool) UnmarshalMapstructure(data any) (any, error) {
