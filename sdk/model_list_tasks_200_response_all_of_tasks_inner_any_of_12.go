...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) SetResultTypeNil() {
...
func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf12) UnmarshalMapstructure(data any) (any, error) {
