...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf12 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf12{}

// ListTasks200ResponseAllOfTasksInnerAnyOf12 struct for ListTasks200ResponseAllOfTasksInnerAnyOf12
type ListTasks200ResponseAllOfTasksInnerAnyOf12 struct {
	Id *int64 `json:"id,omitempty"`
	AccountId *int64 `json:"accountId,omitempty"`
	Name *string `json:"name,omitempty"`
	Code *string `json:"code,omitempty"`
	TaskType *ListTasks200ResponseAllOfTasksInnerAnyOf12TaskType `json:"taskType,omitempty"`
	Labels []string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *ListTasks200ResponseAllOfTasksInnerAnyOf12TaskOptions `json:"taskOptions,omitempty"`
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf12 ListTasks200ResponseAllOfTasksInnerAnyOf12
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf12() *ListTasks200ResponseAllOfTasksInnerAnyOf12 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf12{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) GetTaskType() ListTasks200ResponseAllOfTasksInnerAnyOf12TaskType {
	if o == nil || IsNil(o.TaskType) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOf12TaskType
		return ret
	}
	return *o.TaskType
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
// SetTaskType gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOf12TaskType and assigns it to the TaskType field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) GetTaskOptions() ListTasks200ResponseAllOfTasksInnerAnyOf12TaskOptions {
	if o == nil || IsNil(o.TaskOptions) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOf12TaskOptions
		return ret
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
// SetTaskOptions gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOf12TaskOptions and assigns it to the TaskOptions field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetResultType() bool {
	if o != nil && !IsNil(o.ResultType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf12) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf12) ToMap() (map[string]interface{}, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf12) UnmarshalJSON(data []byte) (err error) {
	varListTasks200ResponseAllOfTasksInnerAnyOf12 := _ListTasks200ResponseAllOfTasksInnerAnyOf12{}

	err = json.Unmarshal(data, &varListTasks200ResponseAllOfTasksInnerAnyOf12)

	if err != nil {
		return err
	}

	*o = ListTasks200ResponseAllOfTasksInnerAnyOf12(varListTasks200ResponseAllOfTasksInnerAnyOf12)
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf12 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf12
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf12) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf12 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf12) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf12) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf12) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf12) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf12(val *ListTasks200ResponseAllOfTasksInnerAnyOf12) *NullableListTasks200ResponseAllOfTasksInnerAnyOf12 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf12{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf12) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf12) UnmarshalJSON(src []byte) error {
	v.isSet = true
