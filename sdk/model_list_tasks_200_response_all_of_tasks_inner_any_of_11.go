...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf11 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf11{}

// ListTasks200ResponseAllOfTasksInnerAnyOf11 struct for ListTasks200ResponseAllOfTasksInnerAnyOf11
type ListTasks200ResponseAllOfTasksInnerAnyOf11 struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf11 ListTasks200ResponseAllOfTasksInnerAnyOf11
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf11() *ListTasks200ResponseAllOfTasksInnerAnyOf11 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf11{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetResultType() bool {
	if o != nil && !IsNil(o.ResultType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf11) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf11) ToMap() (map[string]interface{}, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf11) UnmarshalJSON(data []byte) (err error) {
	varListTasks200ResponseAllOfTasksInnerAnyOf11 := _ListTasks200ResponseAllOfTasksInnerAnyOf11{}

	err = json.Unmarshal(data, &varListTasks200ResponseAllOfTasksInnerAnyOf11)

	if err != nil {
		return err
	}

	*o = ListTasks200ResponseAllOfTasksInnerAnyOf11(varListTasks200ResponseAllOfTasksInnerAnyOf11)
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf11 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf11
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf11) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf11 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf11) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf11) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf11) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf11) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf11(val *ListTasks200ResponseAllOfTasksInnerAnyOf11) *NullableListTasks200ResponseAllOfTasksInnerAnyOf11 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf11{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf11) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf11) UnmarshalJSON(src []byte) error {
	v.isSet = true
