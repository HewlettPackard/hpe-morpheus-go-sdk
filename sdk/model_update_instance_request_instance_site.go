...
// checks if the UpdateInstanceRequestInstanceSite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateInstanceRequestInstanceSite{}
...
func NewUpdateInstanceRequestInstanceSite() *UpdateInstanceRequestInstanceSite {
	this := UpdateInstanceRequestInstanceSite{}
	return &this
}
...
func (o *UpdateInstanceRequestInstanceSite) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o UpdateInstanceRequestInstanceSite) MarshalJSON() ([]byte, error) {
...
func (o UpdateInstanceRequestInstanceSite) ToMap() (map[string]interface{}, error) {
...
func (v NullableUpdateInstanceRequestInstanceSite) UnmarshalMapstructure(data any) (any, error) {
