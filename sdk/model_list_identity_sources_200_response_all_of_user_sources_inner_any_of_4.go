...
func (o *ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf4) UnmarshalJSON(data []byte) (err error) {
	varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf4 := _ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf4{}

	err = json.Unmarshal(data, &varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf4)

	if err != nil {
		return err
	}

	*o = ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf4(varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf4)
