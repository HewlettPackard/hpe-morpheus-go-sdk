...
// checks if the WebCheck type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebCheck{}

// WebCheck Web check type allows you to perform a standard web request and validate the response came back successfully.  Additionally, you can check for matching text within the result.
type WebCheck struct {
	...
	CheckType            *WebCheckAllOfCheckType `json:"checkType,omitempty"`
	Config               *WebCheckAllOfConfig    `json:"config,omitempty"`
	AdditionalProperties map[string]interface{}  `json:",remain"`
}

type _WebCheck WebCheck
...
func (o *WebCheck) IsSetDescription() bool {
...
func (o *WebCheck) SetDescriptionNil() {
...
func (o *WebCheck) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *WebCheck) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *WebCheck) IsSetActive() bool {
	if o != nil && !IsNil(o.Active) {
		return true
	}
...
func (o *WebCheck) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *WebCheck) GetCheckType() WebCheckAllOfCheckType {
	if o == nil || IsNil(o.CheckType) {
		var ret WebCheckAllOfCheckType
		return ret
	}
	return *o.CheckType
}
...
func (o *WebCheck) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
// SetCheckType gets a reference to the given WebCheckAllOfCheckType and assigns it to the CheckType field.
...
func (o *WebCheck) IsSetConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
// SetConfig gets a reference to the given WebCheckAllOfConfig and assigns it to the Config field.
func (o *WebCheck) SetConfig(v WebCheckAllOfConfig) {
	o.Config = &v
}

func (o WebCheck) MarshalJSON() ([]byte, error) {
...
func (o WebCheck) ToMap() (map[string]interface{}, error) {
...
type NullableWebCheck struct {
	value *WebCheck
	isSet bool
}

func (v NullableWebCheck) Get() *WebCheck {
	return v.value
}

func (v *NullableWebCheck) Set(val *WebCheck) {
	v.value = val
	v.isSet = true
}

func (v NullableWebCheck) IsSet() bool {
	return v.isSet
}

func (v *NullableWebCheck) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebCheck(val *WebCheck) *NullableWebCheck {
	return &NullableWebCheck{value: val, isSet: true}
}

func (v NullableWebCheck) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebCheck) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableWebCheck) UnmarshalMapstructure(data any) (any, error) {
...
func (o *WebCheck) UnmarshalJSON(data []byte) (err error) {
