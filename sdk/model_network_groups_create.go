...
func (o *NetworkGroupsCreate) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *NetworkGroupsCreate) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *NetworkGroupsCreate) IsSetNetworks() bool {
	if o != nil && !IsNil(o.Networks) {
		return true
	}
...
func (o *NetworkGroupsCreate) IsSetSubnets() bool {
	if o != nil && !IsNil(o.Subnets) {
		return true
	}
...
func (o *NetworkGroupsCreate) UnmarshalJSON(data []byte) (err error) {
	varNetworkGroupsCreate := _NetworkGroupsCreate{}

	err = json.Unmarshal(data, &varNetworkGroupsCreate)

	if err != nil {
		return err
	}

	*o = NetworkGroupsCreate(varNetworkGroupsCreate)
