...
func (o *GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4 := _GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4{}

	err = json.Unmarshal(data, &varGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4)

	if err != nil {
		return err
	}

	*o = GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4(varGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4)
...
type NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4 struct {
	value *GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4
	isSet bool
}

func (v NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) Get() *GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4 {
	return v.value
}

func (v *NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) Set(val *GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4(val *GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) *NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4 {
	return &NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4{value: val, isSet: true}
}

func (v NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAlerts200ResponseAllOfChecksInnerConfigAnyOf4) UnmarshalJSON(src []byte) error {
	v.isSet = true
