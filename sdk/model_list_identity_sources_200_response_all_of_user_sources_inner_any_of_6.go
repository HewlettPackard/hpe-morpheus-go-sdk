...
func (o *ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf6) UnmarshalJSON(data []byte) (err error) {
	varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf6 := _ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf6{}

	err = json.Unmarshal(data, &varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf6)

	if err != nil {
		return err
	}

	*o = ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf6(varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf6)
