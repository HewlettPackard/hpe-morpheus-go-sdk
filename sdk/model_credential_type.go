...
func (o *CredentialType) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *CredentialType) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *CredentialType) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *CredentialType) IsSetDescription() bool {
...
func (o *CredentialType) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *CredentialType) IsSetCreatable() bool {
	if o != nil && !IsNil(o.Creatable) {
		return true
	}
...
func (o *CredentialType) IsSetEditable() bool {
	if o != nil && !IsNil(o.Editable) {
		return true
	}
...
func (o *CredentialType) IsSetOptionTypes() bool {
	if o != nil && !IsNil(o.OptionTypes) {
		return true
	}
...
func (v NullableCredentialType) UnmarshalMapstructure(data any) (any, error) {
