...
func (o *GetInstance200ResponseInstanceConfig) UnmarshalJSON(data []byte) (err error) {
	varGetInstance200ResponseInstanceConfig := _GetInstance200ResponseInstanceConfig{}

	err = json.Unmarshal(data, &varGetInstance200ResponseInstanceConfig)

	if err != nil {
		return err
	}

	*o = GetInstance200ResponseInstanceConfig(varGetInstance200ResponseInstanceConfig)
