...
// checks if the AddCatalogItemTypeRequestCatalogItemTypeOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddCatalogItemTypeRequestCatalogItemTypeOneOf{}

// AddCatalogItemTypeRequestCatalogItemTypeOneOf struct for AddCatalogItemTypeRequestCatalogItemTypeOneOf
type AddCatalogItemTypeRequestCatalogItemTypeOneOf struct {
...
type _AddCatalogItemTypeRequestCatalogItemTypeOneOf AddCatalogItemTypeRequestCatalogItemTypeOneOf
...
func NewAddCatalogItemTypeRequestCatalogItemTypeOneOf(config AddCatalogItemTypeRequestCatalogItemTypeOneOfConfig) *AddCatalogItemTypeRequestCatalogItemTypeOneOf {
	this := AddCatalogItemTypeRequestCatalogItemTypeOneOf{}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetCode() bool {
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetCategory() bool {
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) SetCategoryNil() {
	o.Category.Set(nil)
}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetLayoutCode() bool {
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) SetLayoutCodeNil() {
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetIconPath() bool {
	if o != nil && !IsNil(o.IconPath) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetEnabled() bool {
	if o != nil && !IsNil(o.Enabled) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetFeatured() bool {
	if o != nil && !IsNil(o.Featured) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetAllowQuantity() bool {
	if o != nil && !IsNil(o.AllowQuantity) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetInstanceSpec() bool {
	if o != nil && !IsNil(o.InstanceSpec) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetFormType() bool {
	if o != nil && !IsNil(o.FormType) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetForm() bool {
	if o != nil && !IsNil(o.Form) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetOptionTypes() bool {
	if o != nil && !IsNil(o.OptionTypes) {
		return true
	}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSetContent() bool {
	if o != nil && !IsNil(o.Content) {
		return true
	}
...
func (o AddCatalogItemTypeRequestCatalogItemTypeOneOf) MarshalJSON() ([]byte, error) {
...
func (o AddCatalogItemTypeRequestCatalogItemTypeOneOf) ToMap() (map[string]interface{}, error) {
...
type NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf struct {
	value *AddCatalogItemTypeRequestCatalogItemTypeOneOf
	isSet bool
}

func (v NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf) Get() *AddCatalogItemTypeRequestCatalogItemTypeOneOf {
	return v.value
}

func (v *NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf) Set(val *AddCatalogItemTypeRequestCatalogItemTypeOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddCatalogItemTypeRequestCatalogItemTypeOneOf(val *AddCatalogItemTypeRequestCatalogItemTypeOneOf) *NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf {
	return &NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf{value: val, isSet: true}
}

func (v NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableAddCatalogItemTypeRequestCatalogItemTypeOneOf) UnmarshalMapstructure(data any) (any, error) {
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOf) UnmarshalJSON(data []byte) (err error) {
