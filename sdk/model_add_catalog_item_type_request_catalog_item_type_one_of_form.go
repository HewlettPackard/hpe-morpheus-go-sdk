...
// checks if the AddCatalogItemTypeRequestCatalogItemTypeOneOfForm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddCatalogItemTypeRequestCatalogItemTypeOneOfForm{}
...
func NewAddCatalogItemTypeRequestCatalogItemTypeOneOfForm() *AddCatalogItemTypeRequestCatalogItemTypeOneOfForm {
	this := AddCatalogItemTypeRequestCatalogItemTypeOneOfForm{}
	return &this
}
...
func (o *AddCatalogItemTypeRequestCatalogItemTypeOneOfForm) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o AddCatalogItemTypeRequestCatalogItemTypeOneOfForm) MarshalJSON() ([]byte, error) {
...
func (o AddCatalogItemTypeRequestCatalogItemTypeOneOfForm) ToMap() (map[string]interface{}, error) {
...
func (v NullableAddCatalogItemTypeRequestCatalogItemTypeOneOfForm) UnmarshalMapstructure(data any) (any, error) {
