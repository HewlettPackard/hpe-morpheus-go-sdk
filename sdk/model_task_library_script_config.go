...
func (o *TaskLibraryScriptConfig) UnmarshalJSON(data []byte) (err error) {
	varTaskLibraryScriptConfig := _TaskLibraryScriptConfig{}

	err = json.Unmarshal(data, &varTaskLibraryScriptConfig)

	if err != nil {
		return err
	}

	*o = TaskLibraryScriptConfig(varTaskLibraryScriptConfig)
