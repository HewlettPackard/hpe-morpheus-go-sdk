...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf14 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf14{}

// ListTasks200ResponseAllOfTasksInnerAnyOf14 struct for ListTasks200ResponseAllOfTasksInnerAnyOf14
type ListTasks200ResponseAllOfTasksInnerAnyOf14 struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf14 ListTasks200ResponseAllOfTasksInnerAnyOf14
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf14() *ListTasks200ResponseAllOfTasksInnerAnyOf14 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf14{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetCode() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) SetCodeNil() {
	o.Code.Set(nil)
}

// UnsetCode ensures that no value is present for Code, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) UnsetCode() {
	o.Code.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetResultType() bool {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) SetResultTypeNil() {
	o.ResultType.Set(nil)
}

// UnsetResultType ensures that no value is present for ResultType, not even an explicit nil
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) UnsetResultType() {
	o.ResultType.Unset()
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf14) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf14) ToMap() (map[string]interface{}, error) {
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf14 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf14
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf14) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf14 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf14) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf14) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf14) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf14(val *ListTasks200ResponseAllOfTasksInnerAnyOf14) *NullableListTasks200ResponseAllOfTasksInnerAnyOf14 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf14{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf14) UnmarshalJSON(src []byte) error {
	v.isSet = true
	return json.Unmarshal(src, &v.value)
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf14) UnmarshalMapstructure(data any) (any, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf14) UnmarshalJSON(data []byte) (err error) {
