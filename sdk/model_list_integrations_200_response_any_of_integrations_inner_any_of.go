...
func (o *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf) UnmarshalJSON(data []byte) (err error) {
	varListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf := _ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf{}

	err = json.Unmarshal(data, &varListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf)

	if err != nil {
		return err
	}

	*o = ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf(varListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf)
