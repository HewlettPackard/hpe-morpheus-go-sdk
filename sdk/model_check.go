...
func (o *Check) IsSetAccount() bool {
	if o != nil && !IsNil(o.Account) {
		return true
	}
...
func (o *Check) IsSetAvailability() bool {
	if o != nil && !IsNil(o.Availability) {
		return true
	}
...
func (o *Check) IsSetCheckAgent() bool {
	if o != nil && !IsNil(o.CheckAgent) {
		return true
	}
...
func (o *Check) IsSetCheckInterval() bool {
	if o != nil && !IsNil(o.CheckInterval) {
		return true
	}
...
func (o *Check) IsSetCheckSpec() bool {
	if o != nil && !IsNil(o.CheckSpec) {
		return true
	}
...
func (o *Check) IsSetCheckType() bool {
	if o != nil && !IsNil(o.CheckType) {
		return true
	}
...
func (o *Check) IsSetContainer() bool {
	if o != nil && !IsNil(o.Container) {
		return true
	}
...
func (o *Check) IsSetCreateIncident() bool {
	if o != nil && !IsNil(o.CreateIncident) {
		return true
	}
...
func (o *Check) IsSetCreatedBy() bool {
	if o != nil && !IsNil(o.CreatedBy) {
		return true
	}
...
func (o *Check) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *Check) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *Check) IsSetEndDate() bool {
	if o != nil && !IsNil(o.EndDate) {
		return true
	}
...
func (o *Check) IsSetInUptime() bool {
	if o != nil && !IsNil(o.InUptime) {
		return true
	}
...
func (o *Check) IsSetLastBoxStats() bool {
	if o != nil && !IsNil(o.LastBoxStats) {
		return true
	}
...
func (o *Check) IsSetLastCheckStatus() bool {
	if o != nil && !IsNil(o.LastCheckStatus) {
		return true
	}
...
func (o *Check) IsSetLastError() bool {
	if o != nil && !IsNil(o.LastError) {
		return true
	}
...
func (o *Check) IsSetLastErrorDate() bool {
	if o != nil && !IsNil(o.LastErrorDate) {
		return true
	}
...
func (o *Check) IsSetLastMessage() bool {
	if o != nil && !IsNil(o.LastMessage) {
		return true
	}
...
func (o *Check) IsSetLastMetric() bool {
	if o != nil && !IsNil(o.LastMetric) {
		return true
	}
...
func (o *Check) IsSetLastRunDate() bool {
	if o != nil && !IsNil(o.LastRunDate) {
		return true
	}
...
func (o *Check) IsSetLastStats() bool {
	if o != nil && !IsNil(o.LastStats) {
		return true
	}
...
func (o *Check) IsSetLastSuccessDate() bool {
	if o != nil && !IsNil(o.LastSuccessDate) {
		return true
	}
...
func (o *Check) IsSetLastTimer() bool {
	if o != nil && !IsNil(o.LastTimer) {
		return true
	}
...
func (o *Check) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *Check) IsSetLastWarningDate() bool {
	if o != nil && !IsNil(o.LastWarningDate) {
		return true
	}
...
func (o *Check) IsSetNextRunDate() bool {
	if o != nil && !IsNil(o.NextRunDate) {
		return true
	}
...
func (o *Check) IsSetOutageTime() bool {
	if o != nil && !IsNil(o.OutageTime) {
		return true
	}
...
func (o *Check) IsSetSeverity() bool {
	if o != nil && !IsNil(o.Severity) {
		return true
	}
...
func (o *Check) IsSetStartDate() bool {
	if o != nil && !IsNil(o.StartDate) {
		return true
	}
...
func (o *Check) IsSetDeleted() bool {
	if o != nil && !IsNil(o.Deleted) {
		return true
	}
