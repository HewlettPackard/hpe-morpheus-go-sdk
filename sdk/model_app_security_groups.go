...
func (o *AppSecurityGroups) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AppSecurityGroups) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *AppSecurityGroups) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AppSecurityGroups) IsSetDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
