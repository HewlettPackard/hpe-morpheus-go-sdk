...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) SetResultTypeNil() {
...
func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf) UnmarshalMapstructure(data any) (any, error) {
