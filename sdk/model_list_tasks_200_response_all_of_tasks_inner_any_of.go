...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf{}

// ListTasks200ResponseAllOfTasksInnerAnyOf struct for ListTasks200ResponseAllOfTasksInnerAnyOf
type ListTasks200ResponseAllOfTasksInnerAnyOf struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf ListTasks200ResponseAllOfTasksInnerAnyOf
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf() *ListTasks200ResponseAllOfTasksInnerAnyOf {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) GetTaskType() ListTasks200ResponseAllOfTasksInnerAnyOfTaskType {
	if o == nil || IsNil(o.TaskType) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOfTaskType
		return ret
	}
	return *o.TaskType
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
// SetTaskType gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOfTaskType and assigns it to the TaskType field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) GetTaskOptions() ListTasks200ResponseAllOfTasksInnerAnyOfTaskOptions {
	if o == nil || IsNil(o.TaskOptions) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOfTaskOptions
		return ret
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
// SetTaskOptions gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOfTaskOptions and assigns it to the TaskOptions field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetResultType() bool {
	if o != nil && !IsNil(o.ResultType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf) ToMap() (map[string]interface{}, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf) UnmarshalJSON(data []byte) (err error) {
	varListTasks200ResponseAllOfTasksInnerAnyOf := _ListTasks200ResponseAllOfTasksInnerAnyOf{}

	err = json.Unmarshal(data, &varListTasks200ResponseAllOfTasksInnerAnyOf)

	if err != nil {
		return err
	}

	*o = ListTasks200ResponseAllOfTasksInnerAnyOf(varListTasks200ResponseAllOfTasksInnerAnyOf)
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf(val *ListTasks200ResponseAllOfTasksInnerAnyOf) *NullableListTasks200ResponseAllOfTasksInnerAnyOf {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
