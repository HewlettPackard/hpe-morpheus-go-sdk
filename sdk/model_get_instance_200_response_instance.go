...
func (o *GetInstance200ResponseInstance) UnmarshalJSON(data []byte) (err error) {
	varGetInstance200ResponseInstance := _GetInstance200ResponseInstance{}

	err = json.Unmarshal(data, &varGetInstance200ResponseInstance)

	if err != nil {
		return err
	}

	*o = GetInstance200ResponseInstance(varGetInstance200ResponseInstance)
