...
func (o *ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7) UnmarshalJSON(data []byte) (err error) {
	varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7 := _ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7{}

	err = json.Unmarshal(data, &varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7)

	if err != nil {
		return err
	}

	*o = ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7(varListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7)
