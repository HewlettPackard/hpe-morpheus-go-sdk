...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf6{}

// ListTasks200ResponseAllOfTasksInnerAnyOf6 struct for ListTasks200ResponseAllOfTasksInnerAnyOf6
type ListTasks200ResponseAllOfTasksInnerAnyOf6 struct {
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf6 ListTasks200ResponseAllOfTasksInnerAnyOf6
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf6() *ListTasks200ResponseAllOfTasksInnerAnyOf6 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf6{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetResultType() bool {
	if o != nil && !IsNil(o.ResultType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf6) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf6) ToMap() (map[string]interface{}, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf6) UnmarshalJSON(data []byte) (err error) {
	varListTasks200ResponseAllOfTasksInnerAnyOf6 := _ListTasks200ResponseAllOfTasksInnerAnyOf6{}

	err = json.Unmarshal(data, &varListTasks200ResponseAllOfTasksInnerAnyOf6)

	if err != nil {
		return err
	}

	*o = ListTasks200ResponseAllOfTasksInnerAnyOf6(varListTasks200ResponseAllOfTasksInnerAnyOf6)
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf6 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf6
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf6) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf6 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf6) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf6) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf6) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf6(val *ListTasks200ResponseAllOfTasksInnerAnyOf6) *NullableListTasks200ResponseAllOfTasksInnerAnyOf6 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf6{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf6) UnmarshalJSON(src []byte) error {
	v.isSet = true
