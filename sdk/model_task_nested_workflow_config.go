...
func (o *TaskNestedWorkflowConfig) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetCode() bool {
...
func (o *TaskNestedWorkflowConfig) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetResultType() bool {
...
func (o *TaskNestedWorkflowConfig) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *TaskNestedWorkflowConfig) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
