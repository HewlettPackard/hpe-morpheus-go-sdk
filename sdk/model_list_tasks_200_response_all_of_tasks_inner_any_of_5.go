...
// checks if the ListTasks200ResponseAllOfTasksInnerAnyOf5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTasks200ResponseAllOfTasksInnerAnyOf5{}

// ListTasks200ResponseAllOfTasksInnerAnyOf5 struct for ListTasks200ResponseAllOfTasksInnerAnyOf5
type ListTasks200ResponseAllOfTasksInnerAnyOf5 struct {
	Id *int64 `json:"id,omitempty"`
	AccountId *int64 `json:"accountId,omitempty"`
	Name *string `json:"name,omitempty"`
	Code *string `json:"code,omitempty"`
	TaskType *ListTasks200ResponseAllOfTasksInnerAnyOf5TaskType `json:"taskType,omitempty"`
	Labels []string `json:"labels,omitempty"`
	Visibility *string `json:"visibility,omitempty"`
	TaskOptions *ListTasks200ResponseAllOfTasksInnerAnyOf5TaskOptions `json:"taskOptions,omitempty"`
...
type _ListTasks200ResponseAllOfTasksInnerAnyOf5 ListTasks200ResponseAllOfTasksInnerAnyOf5
...
func NewListTasks200ResponseAllOfTasksInnerAnyOf5() *ListTasks200ResponseAllOfTasksInnerAnyOf5 {
	this := ListTasks200ResponseAllOfTasksInnerAnyOf5{}
	return &this
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) GetTaskType() ListTasks200ResponseAllOfTasksInnerAnyOf5TaskType {
	if o == nil || IsNil(o.TaskType) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOf5TaskType
		return ret
	}
	return *o.TaskType
}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
// SetTaskType gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOf5TaskType and assigns it to the TaskType field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) GetTaskOptions() ListTasks200ResponseAllOfTasksInnerAnyOf5TaskOptions {
	if o == nil || IsNil(o.TaskOptions) {
		var ret ListTasks200ResponseAllOfTasksInnerAnyOf5TaskOptions
		return ret
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
// SetTaskOptions gets a reference to the given ListTasks200ResponseAllOfTasksInnerAnyOf5TaskOptions and assigns it to the TaskOptions field.
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetResultType() bool {
	if o != nil && !IsNil(o.ResultType) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf5) MarshalJSON() ([]byte, error) {
...
func (o ListTasks200ResponseAllOfTasksInnerAnyOf5) ToMap() (map[string]interface{}, error) {
...
func (o *ListTasks200ResponseAllOfTasksInnerAnyOf5) UnmarshalJSON(data []byte) (err error) {
	varListTasks200ResponseAllOfTasksInnerAnyOf5 := _ListTasks200ResponseAllOfTasksInnerAnyOf5{}

	err = json.Unmarshal(data, &varListTasks200ResponseAllOfTasksInnerAnyOf5)

	if err != nil {
		return err
	}

	*o = ListTasks200ResponseAllOfTasksInnerAnyOf5(varListTasks200ResponseAllOfTasksInnerAnyOf5)
...
type NullableListTasks200ResponseAllOfTasksInnerAnyOf5 struct {
	value *ListTasks200ResponseAllOfTasksInnerAnyOf5
	isSet bool
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf5) Get() *ListTasks200ResponseAllOfTasksInnerAnyOf5 {
	return v.value
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf5) Set(val *ListTasks200ResponseAllOfTasksInnerAnyOf5) {
	v.value = val
	v.isSet = true
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf5) IsSet() bool {
	return v.isSet
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTasks200ResponseAllOfTasksInnerAnyOf5(val *ListTasks200ResponseAllOfTasksInnerAnyOf5) *NullableListTasks200ResponseAllOfTasksInnerAnyOf5 {
	return &NullableListTasks200ResponseAllOfTasksInnerAnyOf5{value: val, isSet: true}
}

func (v NullableListTasks200ResponseAllOfTasksInnerAnyOf5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTasks200ResponseAllOfTasksInnerAnyOf5) UnmarshalJSON(src []byte) error {
	v.isSet = true
