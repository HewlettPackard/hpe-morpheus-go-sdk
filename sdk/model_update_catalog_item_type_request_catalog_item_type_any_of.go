...
type UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf struct {
	...
	Config        *AddCatalogItemTypeRequestCatalogItemTypeOneOfConfig `json:"config,omitempty"`
...
// SetConfig gets a reference to the given AddCatalogItemTypeRequestCatalogItemTypeOneOfConfig and assigns it to the Config field.
