...
func (o *TaskVroConfig) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *TaskVroConfig) IsSetAccountId() bool {
	if o != nil && !IsNil(o.AccountId) {
		return true
	}
...
func (o *TaskVroConfig) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *TaskVroConfig) IsSetCode() bool {
	if o != nil && !IsNil(o.Code) {
		return true
	}
...
func (o *TaskVroConfig) IsSetTaskType() bool {
	if o != nil && !IsNil(o.TaskType) {
		return true
	}
...
func (o *TaskVroConfig) IsSetLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *TaskVroConfig) IsSetVisibility() bool {
	if o != nil && !IsNil(o.Visibility) {
		return true
	}
...
func (o *TaskVroConfig) IsSetTaskOptions() bool {
	if o != nil && !IsNil(o.TaskOptions) {
		return true
	}
...
func (o *TaskVroConfig) IsSetFile() bool {
	if o != nil && !IsNil(o.File) {
		return true
	}
...
func (o *TaskVroConfig) IsSetResultType() bool {
	if o != nil && !IsNil(o.ResultType) {
		return true
	}
...
func (o *TaskVroConfig) IsSetExecuteTarget() bool {
	if o != nil && !IsNil(o.ExecuteTarget) {
		return true
	}
...
func (o *TaskVroConfig) IsSetRetryable() bool {
	if o != nil && !IsNil(o.Retryable) {
		return true
	}
...
func (o *TaskVroConfig) IsSetRetryCount() bool {
	if o != nil && !IsNil(o.RetryCount) {
		return true
	}
...
func (o *TaskVroConfig) IsSetRetryDelaySeconds() bool {
	if o != nil && !IsNil(o.RetryDelaySeconds) {
		return true
	}
...
func (o *TaskVroConfig) IsSetAllowCustomConfig() bool {
	if o != nil && !IsNil(o.AllowCustomConfig) {
		return true
	}
...
func (o *TaskVroConfig) IsSetCredential() bool {
	if o != nil && !IsNil(o.Credential) {
		return true
	}
...
func (o *TaskVroConfig) IsSetDateCreated() bool {
	if o != nil && !IsNil(o.DateCreated) {
		return true
	}
...
func (o *TaskVroConfig) IsSetLastUpdated() bool {
	if o != nil && !IsNil(o.LastUpdated) {
		return true
	}
...
func (o *TaskVroConfig) UnmarshalJSON(data []byte) (err error) {
	varTaskVroConfig := _TaskVroConfig{}

	err = json.Unmarshal(data, &varTaskVroConfig)

	if err != nil {
		return err
	}

	*o = TaskVroConfig(varTaskVroConfig)
