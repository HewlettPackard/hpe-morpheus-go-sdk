...
// checks if the ServiceNowWorkflowsOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceNowWorkflowsOptions{}
...
func NewServiceNowWorkflowsOptions() *ServiceNowWorkflowsOptions {
	this := ServiceNowWorkflowsOptions{}
	return &this
}
...
func (o *ServiceNowWorkflowsOptions) IsSetName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ServiceNowWorkflowsOptions) IsSetValue() bool {
	if o != nil && !IsNil(o.Value) {
		return true
	}
...
func (o ServiceNowWorkflowsOptions) MarshalJSON() ([]byte, error) {
...
func (o ServiceNowWorkflowsOptions) ToMap() (map[string]interface{}, error) {
...
func (v NullableServiceNowWorkflowsOptions) UnmarshalMapstructure(data any) (any, error) {
