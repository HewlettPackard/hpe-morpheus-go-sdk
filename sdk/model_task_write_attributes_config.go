...
func (o *TaskWriteAttributesConfig) UnmarshalJSON(data []byte) (err error) {
	varTaskWriteAttributesConfig := _TaskWriteAttributesConfig{}

	err = json.Unmarshal(data, &varTaskWriteAttributesConfig)

	if err != nil {
		return err
	}

	*o = TaskWriteAttributesConfig(varTaskWriteAttributesConfig)
