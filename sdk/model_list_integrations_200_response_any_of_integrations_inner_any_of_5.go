...
func (o *ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5) UnmarshalJSON(data []byte) (err error) {
	varListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5 := _ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5{}

	err = json.Unmarshal(data, &varListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5)

	if err != nil {
		return err
	}

	*o = ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5(varListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf5)
