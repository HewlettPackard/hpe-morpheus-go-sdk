...
func (o *IdentitySourcesAzureADConfig) GetAccount() GetAlerts200ResponseAllOfCheckGroupsInnerInstance {
...
// and a boolean to check if the value has been set.
func (o *IdentitySourcesAzureADConfig) GetAccountOk() (*GetAlerts200ResponseAllOfCheckGroupsInnerInstance, bool) {
	if o == nil || IsNil(o.Account) {
		return nil, false
	}
...
func (o *IdentitySourcesAzureADConfig) SetAccount(v GetAlerts200ResponseAllOfCheckGroupsInnerInstance) {
	o.Account = &v
}
