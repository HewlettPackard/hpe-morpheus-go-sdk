...
func (o *NetworkServerGroupMember) IsSetId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *NetworkServerGroupMember) IsSetCategory() bool {
	if o != nil && !IsNil(o.Category) {
		return true
	}
...
func (o *NetworkServerGroupMember) IsSetType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *NetworkServerGroupMember) IsSetDisplayOrder() bool {
	if o != nil && !IsNil(o.DisplayOrder) {
		return true
	}
...
func (o *NetworkServerGroupMember) IsSetExternalId() bool {
	if o != nil && !IsNil(o.ExternalId) {
		return true
	}
...
func (o *NetworkServerGroupMember) IsSetMembers() bool {
	if o != nil && !IsNil(o.Members) {
		return true
	}
