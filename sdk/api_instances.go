...
func (r ApiResizeInstanceRequest) Execute() (*UpdateInstance200Response, *http.Response, error) {
...
func (a *InstancesAPIService) ResizeInstanceExecute(r ApiResizeInstanceRequest) (*UpdateInstance200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
