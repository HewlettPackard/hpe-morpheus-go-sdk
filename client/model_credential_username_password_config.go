...
func (o *CredentialUsernamePasswordConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCredentialUsernamePasswordConfig := _CredentialUsernamePasswordConfig{}

	err = json.Unmarshal(data, &varCredentialUsernamePasswordConfig)

	if err != nil {
		return err
	}

	*o = CredentialUsernamePasswordConfig(varCredentialUsernamePasswordConfig)
