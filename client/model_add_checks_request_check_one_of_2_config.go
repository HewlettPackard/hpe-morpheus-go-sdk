...
// checks if the AddChecksRequestCheckOneOf2Config type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddChecksRequestCheckOneOf2Config{}

// AddChecksRequestCheckOneOf2Config struct for AddChecksRequestCheckOneOf2Config
type AddChecksRequestCheckOneOf2Config struct {
...
func NewAddChecksRequestCheckOneOf2Config(host string, port string, send string, responseMatch string) *AddChecksRequestCheckOneOf2Config {
	this := AddChecksRequestCheckOneOf2Config{}
	this.Host = host
	this.Port = port
	this.Send = send
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetCheckUser() bool {
	if o != nil && !IsNil(o.CheckUser) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetTextCheckOn() bool {
	if o != nil && !IsNil(o.TextCheckOn) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetCheckPassword() bool {
	if o != nil && !IsNil(o.CheckPassword) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetWebTextMatch() bool {
	if o != nil && !IsNil(o.WebTextMatch) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetCheckPasswordHash() bool {
	if o != nil && !IsNil(o.CheckPasswordHash) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetTunnelOn() bool {
	if o != nil && !IsNil(o.TunnelOn) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetSshHost() bool {
	if o != nil && !IsNil(o.SshHost) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetSshPort() bool {
	if o != nil && !IsNil(o.SshPort) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetSshUser() bool {
	if o != nil && !IsNil(o.SshUser) {
		return true
	}
...
func (o *AddChecksRequestCheckOneOf2Config) IsSetSshPassword() bool {
	if o != nil && !IsNil(o.SshPassword) {
		return true
	}
...
func (o AddChecksRequestCheckOneOf2Config) MarshalJSON() ([]byte, error) {
...
func (o AddChecksRequestCheckOneOf2Config) ToMap() (map[string]interface{}, error) {
...
func (o *AddChecksRequestCheckOneOf2Config) UnmarshalJSON(data []byte) (err error) {
...
type NullableAddChecksRequestCheckOneOf2Config struct {
	value *AddChecksRequestCheckOneOf2Config
	isSet bool
}

func (v NullableAddChecksRequestCheckOneOf2Config) Get() *AddChecksRequestCheckOneOf2Config {
	return v.value
}

func (v *NullableAddChecksRequestCheckOneOf2Config) Set(val *AddChecksRequestCheckOneOf2Config) {
	v.value = val
	v.isSet = true
}

func (v NullableAddChecksRequestCheckOneOf2Config) IsSet() bool {
	return v.isSet
}

func (v *NullableAddChecksRequestCheckOneOf2Config) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddChecksRequestCheckOneOf2Config(val *AddChecksRequestCheckOneOf2Config) *NullableAddChecksRequestCheckOneOf2Config {
	return &NullableAddChecksRequestCheckOneOf2Config{value: val, isSet: true}
}

func (v NullableAddChecksRequestCheckOneOf2Config) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddChecksRequestCheckOneOf2Config) UnmarshalJSON(src []byte) error {
	v.isSet = true
