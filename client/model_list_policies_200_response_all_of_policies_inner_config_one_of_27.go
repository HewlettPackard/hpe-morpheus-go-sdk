...
func (o *ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf27) UnmarshalJSON(data []byte) (err error) {
	...
	varListPolicies200ResponseAllOfPoliciesInnerConfigOneOf27 := _ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf27{}

	err = json.Unmarshal(data, &varListPolicies200ResponseAllOfPoliciesInnerConfigOneOf27)

	if err != nil {
		return err
	}

	*o = ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf27(varListPolicies200ResponseAllOfPoliciesInnerConfigOneOf27)
