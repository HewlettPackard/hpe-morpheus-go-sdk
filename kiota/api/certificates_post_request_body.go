...
type CertificatesPostRequestBody struct {
    ...
    certificate CertificatesPostRequestBody_certificateable
}
...
func CreateCertificatesPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewCertificatesPostRequestBody(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *CertificatesPostRequestBody) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCertificate gets the certificate property value. The certificate property
// returns a CertificatesPostRequestBody_certificateable when successful
func (m *CertificatesPostRequestBody) GetCertificate()(CertificatesPostRequestBody_certificateable) {
...
func (m *CertificatesPostRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["certificate"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateCertificatesPostRequestBody_certificateFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetCertificate(val.(CertificatesPostRequestBody_certificateable))
        }
        return nil
    }
    return res
...
func (m *CertificatesPostRequestBody) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCertificate sets the certificate property value. The certificate property
func (m *CertificatesPostRequestBody) SetCertificate(value CertificatesPostRequestBody_certificateable)() {
    m.certificate = value
}
type CertificatesPostRequestBodyable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetCertificate()(CertificatesPostRequestBody_certificateable)
    SetCertificate(value CertificatesPostRequestBody_certificateable)()
}
