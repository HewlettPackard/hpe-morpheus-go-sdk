...
type UsersPostResponse struct {
    ...
    success *bool
    // The user property
    user UsersPostResponse_userable
}
...
func (m *UsersPostResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["user"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateUsersPostResponse_userFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetUser(val.(UsersPostResponse_userable))
        }
        return nil
    }
    return res
...
func (m *UsersPostResponse) GetSuccess()(*bool) {
    return m.success
}
// GetUser gets the user property value. The user property
// returns a UsersPostResponse_userable when successful
func (m *UsersPostResponse) GetUser()(UsersPostResponse_userable) {
    return m.user
}
...
func (m *UsersPostResponse) SetSuccess(value *bool)() {
    m.success = value
}
// SetUser sets the user property value. The user property
func (m *UsersPostResponse) SetUser(value UsersPostResponse_userable)() {
    m.user = value
}
type UsersPostResponseable interface {
    ...
    GetSuccess()(*bool)
    GetUser()(UsersPostResponse_userable)
    SetSuccess(value *bool)()
    SetUser(value UsersPostResponse_userable)()
}
