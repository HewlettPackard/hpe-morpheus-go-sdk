...
import (
    i58fe8092e3549bdc45b8d55c3e0644a989cd4b9ffc15f9bdfd12c69182a80048 "ApiSdk/oauth"
    i78701afdb3c53807cd22385c791098999edf8b3eb0abe3bef7aeea7243ebf133 "ApiSdk/api"
...
func (m *ApiClient) Api()(*i78701afdb3c53807cd22385c791098999edf8b3eb0abe3bef7aeea7243ebf133.ApiRequestBuilder) {
    return i78701afdb3c53807cd22385c791098999edf8b3eb0abe3bef7aeea7243ebf133.NewApiRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
...
func NewApiClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApiClient) {
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("https://{serverURL}")
    }
...
func (m *ApiClient) Oauth()(*i58fe8092e3549bdc45b8d55c3e0644a989cd4b9ffc15f9bdfd12c69182a80048.OauthRequestBuilder) {
    return i58fe8092e3549bdc45b8d55c3e0644a989cd4b9ffc15f9bdfd12c69182a80048.NewOauthRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
